...
{
 public:
  typedef Output_data_reloc<cgccpp::SHT_RELA, true,size, big_endian>
    Reloc_section;
 ...
 public:
  ...
  Target_tilegx(const Target::Target_info* info = &tilegx_info)
    : Sized_target<size, big_endian>(info),
      ...
      rela_irelative_(NULL), copy_relocs_(cgccpp::R_TILEGX_COPY),
  ...
  apply_relocation(const Relocate_info<size, big_endian>* relinfo,
                   typename cgccpp::Cgc_types<size>::Cgc_Addr r_offset,
                   unsigned int r_type,
                   typename cgccpp::Cgc_types<size>::Cgc_Swxword r_addend,
                   const Symbol* gsym,
                   unsigned char* view,
  ...
  class Relocate
  {
   public:
    ...
    relocate(const Relocate_info<size, big_endian>*, Target_tilegx*,
             ...
             unsigned char*, typename cgccpp::Cgc_types<size>::Cgc_Addr,
             section_size_type);
  };
...
public:
  ...
  static const Tilegx_howto howto[cgccpp::R_TILEGX_NUM];
...
private:
  ...
  rela(unsigned char* view,
       ...
       cgccpp::Cgc_Xword srshift, cgccpp::Cgc_Xword doffset,
       cgccpp::Cgc_Xword bitmask)
  {
    ...
    cgccpp::Cgc_Xword dst_mask = bitmask << doffset;

    val &= ~dst_mask;
    reloc &= bitmask;

    cgccpp::Swap<valsize, big_endian>::writeval(wv, val | (reloc<<doffset));
  }
          ...
          cgccpp::Cgc_Xword bitmask)
  {
    ...
    cgccpp::Swap_unaligned<valsize, big_endian>::writeval(wv,
      val | (reloc<<doffset));
  }
  ...
  rela(unsigned char* view,
       ...
       const Symbol_value<size>* psymval,
       typename cgccpp::Swap<size, big_endian>::Valtype addend,
       cgccpp::Cgc_Xword srshift, cgccpp::Cgc_Xword doffset1,
       cgccpp::Cgc_Xword bitmask1, cgccpp::Cgc_Xword doffset2,
       cgccpp::Cgc_Xword bitmask2)
  {
    typedef typename cgccpp::Swap<valsize, big_endian>::Valtype Valtype;
    Valtype* wv = reinterpret_cast<Valtype*>(view);
    Valtype val = cgccpp::Swap<valsize, big_endian>::readval(wv);
    ...
    cgccpp::Cgc_Xword dst_mask = (bitmask1 << doffset1)
                                  | (bitmask2 << doffset2);
    val &= ~dst_mask;
...

  {
    ...
    cgccpp::Swap<valsize, big_endian>::writeval(wv, reloc << doffset);
  }
...
public:
                ...
                Tilegx_howto &r_howto)
  {
    This::template rela<64>(view, object, psymval, addend,
                            (cgccpp::Cgc_Xword)(r_howto.srshift),
                            (cgccpp::Cgc_Xword)(r_howto.doffset),
                            (cgccpp::Cgc_Xword)((1 << r_howto.bsize) - 1));
  }
                         ...
                         unsigned int r_type)
  {
    ...
    cgccpp::Cgc_Xword doffset1 = 0llu;
    cgccpp::Cgc_Xword doffset2 = 0llu;
    cgccpp::Cgc_Xword dmask1   = 0llu;
    cgccpp::Cgc_Xword dmask2   = 0llu;
    cgccpp::Cgc_Xword rshift   = 0llu;
    unsigned int pc_rel        = 0;

    switch (r_type)
      {
      case cgccpp::R_TILEGX_BROFF_X1:
        doffset1 = 31llu;
        doffset2 = 37llu;
        dmask1   = 0x3fllu;
        dmask2   = 0x1ffc0llu;
        ...
        pc_rel   = 1;
        break;
      case cgccpp::R_TILEGX_DEST_IMM8_X1:
        doffset1 = 31llu;
        doffset2 = 43llu;
        dmask1   = 0x3fllu;
        dmask2   = 0xc0llu;
            ...
            tls::Tls_optimization opt_t)
  {
    ...
    Valtype* wv = reinterpret_cast<Valtype*>(view);
    Valtype val = cgccpp::Swap<64, big_endian>::readval(wv);
    Valtype reloc = 0;

    switch (r_type)
    {
      case cgccpp::R_TILEGX_IMM8_X0_TLS_ADD:
        if (opt_t == tls::TLSOPT_NONE) {
          ...
          gold_unreachable();
        break;
      case cgccpp::R_TILEGX_IMM8_X1_TLS_ADD:
        if (opt_t == tls::TLSOPT_NONE) {
          ...
          gold_unreachable();
        break;
      case cgccpp::R_TILEGX_IMM8_Y0_TLS_ADD:
        if (opt_t == tls::TLSOPT_NONE) {
          ...
          gold_unreachable();
        break;
      case cgccpp::R_TILEGX_IMM8_Y1_TLS_ADD:
        if (opt_t == tls::TLSOPT_NONE) {
          reloc = (val & (0x3Fllu << 31)) << 12;
          reloc |= ((size == 32
                     ? TILEGX_Y_ADDX_R0_R0_TP
          ...
          gold_unreachable();
        break;
      case cgccpp::R_TILEGX_IMM8_X0_TLS_GD_ADD:
        if (opt_t == tls::TLSOPT_NONE) {
        ...
        break;
      case cgccpp::R_TILEGX_IMM8_X1_TLS_GD_ADD:
        if (opt_t == tls::TLSOPT_NONE) {
          reloc = TILEGX_X_MOVE_R0_R0 & TILEGX_X1_RRR_SRCB_MASK;
        ...
        break;
      case cgccpp::R_TILEGX_IMM8_Y0_TLS_GD_ADD:
        if (opt_t == tls::TLSOPT_NONE) {
          reloc = TILEGX_Y_MOVE_R0_R0 & TILEGX_Y0_RRR_SRCB_MASK;
        ...
        break;
      case cgccpp::R_TILEGX_IMM8_Y1_TLS_GD_ADD:
        if (opt_t == tls::TLSOPT_NONE) {
          reloc = TILEGX_Y_MOVE_R0_R0 & TILEGX_Y1_RRR_SRCB_MASK;
        ...
        break;
      case cgccpp::R_TILEGX_TLS_IE_LOAD:
        if (opt_t == tls::TLSOPT_NONE) {
          // IE
          reloc = (size == 32
                   ? TILEGX_X_LD4S
          ...
          gold_unreachable();
        break;
      case cgccpp::R_TILEGX_TLS_GD_CALL:
    ...
    cgccpp::Swap<64, big_endian>::writeval(wv, val | reloc);
  }
};

template<>
const Tilegx_relocate_functions<64, false>::Tilegx_howto
Tilegx_relocate_functions<64, false>::howto[cgccpp::R_TILEGX_NUM] =
{
...
Tilegx_relocate_functions<32, false>::howto[cgccpp::R_TILEGX_NUM] =
{
  {  0,  0, 0,  0, 0}, // R_TILEGX_NONE
  {  0,  0, 0, 64, 0}, // R_TILEGX_64
  {  0,  0, 0, 32, 0}, // R_TILEGX_32
...
Tilegx_relocate_functions<64, true>::howto[cgccpp::R_TILEGX_NUM] =
{
  {  0,  0, 0,  0, 0}, // R_TILEGX_NONE
  {  0,  0, 0, 64, 0}, // R_TILEGX_64
  {  0,  0, 0, 32, 0}, // R_TILEGX_32
...
Tilegx_relocate_functions<32, true>::howto[cgccpp::R_TILEGX_NUM] =
{
  {  0,  0, 0,  0, 0}, // R_TILEGX_NONE
  {  0,  0, 0, 64, 0}, // R_TILEGX_64
  {  0,  0, 0, 32, 0}, // R_TILEGX_32
  ...
  if (this->got_ == NULL)
    {
      ...
      layout->add_output_section_data(".got.plt", cgccpp::SHT_PROGBITS,
                                      (cgccpp::SHF_ALLOC
                                       | cgccpp::SHF_WRITE),
  ...
  if (this->rela_irelative_ == NULL)
    {
      ...
      layout->add_output_section_data(".rela.dyn", cgccpp::SHT_RELA,
                                      cgccpp::SHF_ALLOC, this->rela_irelative_,
                                      ORDER_DYNAMIC_RELOCS, false);
                                             ...
                                             unsigned int got_offset)
{
  if (gsym->type() == cgccpp::STT_GNU_IFUNC
    ...
    {
      Reloc_section* rela = this->rela_irelative(symtab, layout);
      rela->add_symbolless_global_addend(gsym, cgccpp::R_TILEGX_IRELATIVE,
                                         this->got_irelative_, got_offset, 0);
    }
  else
    {
      gsym->set_needs_dynsym_entry();
      this->rel_->add_global(gsym, cgccpp::R_TILEGX_JMP_SLOT, this->got_plt_,
                             got_offset, 0);
    }
}
  ...
  if (this->irelative_rel_ == NULL)
    {
      ...
      layout->add_output_section_data(".rela.plt", cgccpp::SHT_RELA,
                                      cgccpp::SHF_ALLOC, this->irelative_rel_,
                                      ORDER_DYNAMIC_PLT_RELOCS, false);
...
Output_data_plt_tilegx<size, big_endian>::fill_plt_entry(
                 unsigned char* pov,
                 typename cgccpp::Cgc_types<size>::Cgc_Addr gotplt_base,
                 unsigned int got_offset,
                 typename cgccpp::Cgc_types<size>::Cgc_Addr plt_base,
                 unsigned int plt_offset, unsigned int plt_index)
{
  ...
  typedef typename cgccpp::Swap<TILEGX_INST_BUNDLE_SIZE, big_endian>::Valtype
    Valtype;
  memcpy(pov, plt_entry, plt_entry_size);

  // first bundle in plt stub - x0
  Valtype* wv = reinterpret_cast<Valtype*>(pov);
  Valtype val = cgccpp::Swap<TILEGX_INST_BUNDLE_SIZE, big_endian>::readval(wv);
  Valtype reloc =
    ((gotplt_base + got_offset) - (plt_base + plt_offset + 8)) >> 16;
  cgccpp::Cgc_Xword dst_mask =
    (cgccpp::Cgc_Xword)(TILEGX_IMM16_MASK) << TILEGX_X0_IMM16_BITOFF;
  val &= ~dst_mask;
  reloc &= TILEGX_IMM16_MASK;
  cgccpp::Swap<TILEGX_INST_BUNDLE_SIZE, big_endian>::writeval(wv,
    val | (reloc<<TILEGX_X0_IMM16_BITOFF));

  // second bundle in plt stub - x1
  wv = reinterpret_cast<Valtype*>(pov + 8);
  val = cgccpp::Swap<TILEGX_INST_BUNDLE_SIZE, big_endian>::readval(wv);
  reloc = (gotplt_base + got_offset) - (plt_base + plt_offset + 8);
  dst_mask = (cgccpp::Cgc_Xword)(TILEGX_IMM16_MASK) << TILEGX_X1_IMM16_BITOFF;
  val &= ~dst_mask;
  reloc &= TILEGX_IMM16_MASK;
  cgccpp::Swap<TILEGX_INST_BUNDLE_SIZE, big_endian>::writeval(wv,
  ...
  dst_mask = (cgccpp::Cgc_Xword)(TILEGX_IMM16_MASK) << TILEGX_X0_IMM16_BITOFF;
  val &= ~dst_mask;
  reloc &= TILEGX_IMM16_MASK;
  cgccpp::Swap<TILEGX_INST_BUNDLE_SIZE, big_endian>::writeval(wv,
    val | (reloc<<TILEGX_X0_IMM16_BITOFF));
...
Output_data_plt_tilegx<size, big_endian>::do_write(Output_file* of)
{
  ...
  typename cgccpp::Cgc_types<size>::Cgc_Addr plt_address = this->address();
  typename cgccpp::Cgc_types<size>::Cgc_Addr got_address =
  ...
  for (unsigned int plt_index = 0;
         ...
         got_offset += size / 8)
    {
      ...
      cgccpp::Swap<size, big_endian>::writeval(got_pov, plt_address);
    }
  ...
  switch (got_type)
    ...
    case GOT_TYPE_STANDARD:
      if (parameters->options().output_is_position_independent())
        rela_dyn->add_local_relative(obj, r_sym, cgccpp::R_TILEGX_RELATIVE,
                                     this->got_, got_offset, 0, false);
      break;
    case GOT_TYPE_TLS_OFFSET:
      rela_dyn->add_local(obj, r_sym,
                          size == 32 ? cgccpp::R_TILEGX_TLS_DTPOFF32
                                       : cgccpp::R_TILEGX_TLS_DTPOFF64,
                          this->got_, got_offset, 0);
      break;
    case GOT_TYPE_TLS_PAIR:
      this->got_->reserve_slot(got_index + 1);
      rela_dyn->add_local(obj, r_sym,
                          size == 32 ? cgccpp::R_TILEGX_TLS_DTPMOD32
                                       : cgccpp::R_TILEGX_TLS_DTPMOD64,
                          this->got_, got_offset, 0);
      break;
      ...
      if (!gsym->final_value_is_known())
        {
          if (gsym->is_from_dynobj()
            ...
            rela_dyn->add_global(gsym, cgccpp::R_TILEGX_GLOB_DAT,
                                 this->got_, got_offset, 0);
          else
            rela_dyn->add_global_relative(gsym, cgccpp::R_TILEGX_RELATIVE,
                                          this->got_, got_offset, 0, false);
        }
      break;
    case GOT_TYPE_TLS_OFFSET:
      rela_dyn->add_global_relative(gsym,
                                    size == 32 ? cgccpp::R_TILEGX_TLS_TPOFF32
                                               : cgccpp::R_TILEGX_TLS_TPOFF64,
                                    this->got_, got_offset, 0, false);
      break;
    case GOT_TYPE_TLS_PAIR:
      this->got_->reserve_slot(got_index + 1);
  ...
  if (this->got_mod_index_offset_ == -1U)
    {
      ...
      rela_dyn->add_local(object, 0,
                          size == 32 ? cgccpp::R_TILEGX_TLS_DTPMOD32
                                       : cgccpp::R_TILEGX_TLS_DTPMOD64, got,
                          got_offset, 0);
      got->add_constant(0);
...
Target_tilegx<size, big_endian>::optimize_tls_reloc(bool is_final, int r_type)
{
  ...
  switch (r_type)
    ...
    case cgccpp::R_TILEGX_IMM8_Y0_TLS_GD_ADD:
    case cgccpp::R_TILEGX_IMM8_Y1_TLS_GD_ADD:
    case cgccpp::R_TILEGX_IMM16_X0_HW0_TLS_GD:
    case cgccpp::R_TILEGX_IMM16_X1_HW0_TLS_GD:
    case cgccpp::R_TILEGX_IMM16_X0_HW0_LAST_TLS_GD:
    case cgccpp::R_TILEGX_IMM16_X1_HW0_LAST_TLS_GD:
    case cgccpp::R_TILEGX_IMM16_X0_HW1_LAST_TLS_GD:
    case cgccpp::R_TILEGX_IMM16_X1_HW1_LAST_TLS_GD:
    ...
    case cgccpp::R_TILEGX_TLS_IE_LOAD:
    case cgccpp::R_TILEGX_IMM16_X0_HW0_TLS_IE:
    case cgccpp::R_TILEGX_IMM16_X1_HW0_TLS_IE:
    case cgccpp::R_TILEGX_IMM16_X0_HW0_LAST_TLS_IE:
    case cgccpp::R_TILEGX_IMM16_X1_HW0_LAST_TLS_IE:
    case cgccpp::R_TILEGX_IMM16_X0_HW1_LAST_TLS_IE:
    case cgccpp::R_TILEGX_IMM16_X1_HW1_LAST_TLS_IE:
    ...
    case cgccpp::R_TILEGX_IMM16_X0_HW0_TLS_LE:
    case cgccpp::R_TILEGX_IMM16_X1_HW0_TLS_LE:
    case cgccpp::R_TILEGX_IMM16_X0_HW0_LAST_TLS_LE:
    case cgccpp::R_TILEGX_IMM16_X1_HW0_LAST_TLS_LE:
    case cgccpp::R_TILEGX_IMM16_X0_HW1_LAST_TLS_LE:
    case cgccpp::R_TILEGX_IMM16_X1_HW1_LAST_TLS_LE:
...
Target_tilegx<size, big_endian>::Scan::get_reference_flags(unsigned int r_type)
{
  switch (r_type)
    {
    case cgccpp::R_TILEGX_NONE:
    case cgccpp::R_TILEGX_GNU_VTINHERIT:
    case cgccpp::R_TILEGX_GNU_VTENTRY:
      // No symbol reference.
      return 0;

    case cgccpp::R_TILEGX_64:
    case cgccpp::R_TILEGX_32:
    case cgccpp::R_TILEGX_16:
    case cgccpp::R_TILEGX_8:
      return Symbol::ABSOLUTE_REF;

    case cgccpp::R_TILEGX_BROFF_X1:
    case cgccpp::R_TILEGX_64_PCREL:
    case cgccpp::R_TILEGX_32_PCREL:
    case cgccpp::R_TILEGX_16_PCREL:
    case cgccpp::R_TILEGX_8_PCREL:
    case cgccpp::R_TILEGX_IMM16_X0_HW0_PCREL:
    case cgccpp::R_TILEGX_IMM16_X1_HW0_PCREL:
    case cgccpp::R_TILEGX_IMM16_X0_HW1_PCREL:
    case cgccpp::R_TILEGX_IMM16_X1_HW1_PCREL:
    case cgccpp::R_TILEGX_IMM16_X0_HW2_PCREL:
    case cgccpp::R_TILEGX_IMM16_X1_HW2_PCREL:
    case cgccpp::R_TILEGX_IMM16_X0_HW3_PCREL:
    case cgccpp::R_TILEGX_IMM16_X1_HW3_PCREL:
    case cgccpp::R_TILEGX_IMM16_X0_HW0_LAST_PCREL:
    case cgccpp::R_TILEGX_IMM16_X1_HW0_LAST_PCREL:
    case cgccpp::R_TILEGX_IMM16_X0_HW1_LAST_PCREL:
    case cgccpp::R_TILEGX_IMM16_X1_HW1_LAST_PCREL:
    case cgccpp::R_TILEGX_IMM16_X0_HW2_LAST_PCREL:
    case cgccpp::R_TILEGX_IMM16_X1_HW2_LAST_PCREL:
      return Symbol::RELATIVE_REF;

    case cgccpp::R_TILEGX_JUMPOFF_X1:
    case cgccpp::R_TILEGX_JUMPOFF_X1_PLT:
    case cgccpp::R_TILEGX_IMM16_X0_HW0_PLT_PCREL:
    case cgccpp::R_TILEGX_IMM16_X1_HW0_PLT_PCREL:
    case cgccpp::R_TILEGX_IMM16_X0_HW1_PLT_PCREL:
    case cgccpp::R_TILEGX_IMM16_X1_HW1_PLT_PCREL:
    case cgccpp::R_TILEGX_IMM16_X0_HW2_PLT_PCREL:
    case cgccpp::R_TILEGX_IMM16_X1_HW2_PLT_PCREL:
    case cgccpp::R_TILEGX_IMM16_X0_HW0_LAST_PLT_PCREL:
    case cgccpp::R_TILEGX_IMM16_X1_HW0_LAST_PLT_PCREL:
    case cgccpp::R_TILEGX_IMM16_X0_HW1_LAST_PLT_PCREL:
    case cgccpp::R_TILEGX_IMM16_X1_HW1_LAST_PLT_PCREL:
    case cgccpp::R_TILEGX_IMM16_X0_HW2_LAST_PLT_PCREL:
    case cgccpp::R_TILEGX_IMM16_X1_HW2_LAST_PLT_PCREL:
      return Symbol::FUNCTION_CALL | Symbol::RELATIVE_REF;

    case cgccpp::R_TILEGX_IMM16_X0_HW0:
    case cgccpp::R_TILEGX_IMM16_X1_HW0:
    case cgccpp::R_TILEGX_IMM16_X0_HW1:
    case cgccpp::R_TILEGX_IMM16_X1_HW1:
    case cgccpp::R_TILEGX_IMM16_X0_HW2:
    case cgccpp::R_TILEGX_IMM16_X1_HW2:
    case cgccpp::R_TILEGX_IMM16_X0_HW3:
    case cgccpp::R_TILEGX_IMM16_X1_HW3:
    case cgccpp::R_TILEGX_IMM16_X0_HW0_LAST:
    case cgccpp::R_TILEGX_IMM16_X1_HW0_LAST:
    case cgccpp::R_TILEGX_IMM16_X0_HW1_LAST:
    case cgccpp::R_TILEGX_IMM16_X1_HW1_LAST:
    case cgccpp::R_TILEGX_IMM16_X0_HW2_LAST:
    case cgccpp::R_TILEGX_IMM16_X1_HW2_LAST:
      return Symbol::ABSOLUTE_REF;

    case cgccpp::R_TILEGX_IMM16_X0_HW0_GOT:
    case cgccpp::R_TILEGX_IMM16_X1_HW0_GOT:
    case cgccpp::R_TILEGX_IMM16_X0_HW0_LAST_GOT:
    case cgccpp::R_TILEGX_IMM16_X1_HW0_LAST_GOT:
    case cgccpp::R_TILEGX_IMM16_X0_HW1_LAST_GOT:
    case cgccpp::R_TILEGX_IMM16_X1_HW1_LAST_GOT:
      // Absolute in GOT.
      return Symbol::ABSOLUTE_REF;
    ...
    case cgccpp::R_TILEGX_IMM16_X0_HW1_LAST_TLS_IE:
    case cgccpp::R_TILEGX_IMM16_X1_HW1_LAST_TLS_IE:
    case cgccpp::R_TILEGX_TLS_DTPOFF64:
    case cgccpp::R_TILEGX_TLS_DTPMOD32:
    case cgccpp::R_TILEGX_TLS_DTPOFF32:
    case cgccpp::R_TILEGX_TLS_TPOFF32:
    case cgccpp::R_TILEGX_TLS_GD_CALL:
    case cgccpp::R_TILEGX_IMM8_X0_TLS_GD_ADD:
    case cgccpp::R_TILEGX_IMM8_X1_TLS_GD_ADD:
    case cgccpp::R_TILEGX_IMM8_Y0_TLS_GD_ADD:
    ...
    case cgccpp::R_TILEGX_COPY:
    case cgccpp::R_TILEGX_GLOB_DAT:
    case cgccpp::R_TILEGX_JMP_SLOT:
    case cgccpp::R_TILEGX_RELATIVE:
    case cgccpp::R_TILEGX_TLS_TPOFF64:
    case cgccpp::R_TILEGX_TLS_DTPMOD64:
    default:
  ...
  Symbol* gsym)
{
  ...
  return ((parameters->options().shared()
           && (gsym->visibility() == cgccpp::STV_INTERNAL
               || gsym->visibility() == cgccpp::STV_PROTECTED
               || gsym->visibility() == cgccpp::STV_HIDDEN))
        ...
        if (gsym->needs_dynamic_reloc(Scan::get_reference_flags(r_type)))
          {
            if (gsym->may_need_copy_reloc())
            ...
            else if (((size == 64 && r_type == cgccpp::R_TILEGX_64)
                      || (size == 32 && r_type == cgccpp::R_TILEGX_32))
                     && gsym->type() == cgccpp::STT_GNU_IFUNC
                     && gsym->can_use_relative_reloc(false)
                     && !gsym->is_from_dynobj()
                     && !gsym->is_undefined()
                     && !gsym->is_preemptible())
              {
                ...
                unsigned int r_type = cgccpp::R_TILEGX_IRELATIVE;
                rela_dyn->add_symbolless_global_addend(gsym, r_type,
                                                   output_section, object,
                                                   data_shndx,
                                                   reloc.get_r_offset(),
                                                   reloc.get_r_addend());
              } else if ((r_type == cgccpp::R_TILEGX_64
                          || r_type == cgccpp::R_TILEGX_32)
                         && gsym->can_use_relative_reloc(false))
              {
                Reloc_section* rela_dyn = target->rela_dyn_section(layout);
                rela_dyn->add_global_relative(gsym, cgccpp::R_TILEGX_RELATIVE,
                                 ...
                                 const unsigned char* plocal_symbols)
{
  ...
  gold::scan_relocs<size, big_endian, Tilegx, cgccpp::SHT_RELA, Scan>(
    symtab,
    layout,
    this,
    object,
    ...
    section_size_type)
{
  ...
  cgccpp::Cgc_Xword addend = rela.get_r_addend();
            ...
            do_update_value:
              if (have_got_offset) {
                if (gsym != NULL) {
                  ...
                  unsigned int r_sym
                     = cgccpp::cgc_r_sym<size>(rela.get_r_info());
                  gold_assert(object->local_has_got_offset(r_sym, got_type));
                  got_offset =
                    object->local_got_offset(r_sym, got_type) - got_base;
                }
    ...
    const Reloc_symbol_changes* reloc_symbol_changes)
{
  ...
  gold::relocate_section<size, big_endian, Tilegx, cgccpp::SHT_RELA,
...
public:
  Target_selector_tilegx()
    : Target_selector(cgccpp::EM_TILEGX, size, big_endian,
                      (size == 64
                       ? (big_endian ? "cgc64-tilegx-be" : "cgc64-tilegx-le")
                          : (big_endian ? "cgc32-tilegx-be"
                                           : "cgc32-tilegx-le")),
                      (size == 64
                       ? (big_endian ? "cgc64tilegx_be" : "cgc64tilegx")
                          : (big_endian ? "cgc32tilegx_be" : "cgc32tilegx")))
  { }
