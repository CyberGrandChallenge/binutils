...
class Plugin_manager
{
 public:
  ...
  // Get the object associated with the handle and check if it is an cgc object.
  // If it is not a Pluginobj, it is an cgc object.
  Object*
  get_cgc_object(const void* handle);
