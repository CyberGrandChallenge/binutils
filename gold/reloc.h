...
private:
  ...
  rel(unsigned char* view,
      typename cgccpp::Swap<valsize, big_endian>::Valtype value)
  {
    typedef typename cgccpp::Swap<valsize, big_endian>::Valtype Valtype;
    Valtype* wv = reinterpret_cast<Valtype*>(view);
    Valtype x = cgccpp::Swap<valsize, big_endian>::readval(wv);
    cgccpp::Swap<valsize, big_endian>::writeval(wv, x + value);
  }
	        ...
	        typename cgccpp::Swap<valsize, big_endian>::Valtype value)
  {
	...
	Valtype;
    Valtype x = cgccpp::Swap_unaligned<valsize, big_endian>::readval(view);
    cgccpp::Swap_unaligned<valsize, big_endian>::writeval(view, x + value);
  }
      ...
      const Symbol_value<size>* psymval)
  {
    ...
    cgccpp::Swap<valsize, big_endian>::writeval(wv, x);
  }
                ...
                const Symbol_value<size>* psymval)
  {
    ...
    Valtype x = cgccpp::Swap_unaligned<valsize, big_endian>::readval(view);
    x = psymval->value(object, x);
    cgccpp::Swap_unaligned<valsize, big_endian>::writeval(view, x);
  }
       ...
       typename cgccpp::Swap<valsize, big_endian>::Valtype addend)
  {
    typedef typename cgccpp::Swap<valsize, big_endian>::Valtype Valtype;
    Valtype* wv = reinterpret_cast<Valtype*>(view);
    cgccpp::Swap<valsize, big_endian>::writeval(wv, value + addend);
  }
	...
	typename cgccpp::Cgc_types<size>::Cgc_Addr address)
  {
    ...
    Valtype* wv = reinterpret_cast<Valtype*>(view);
    Valtype x = cgccpp::Swap<valsize, big_endian>::readval(wv);
    cgccpp::Swap<valsize, big_endian>::writeval(wv, x + value - address);
  }
		  ...
		  typename cgccpp::Cgc_types<size>::Cgc_Addr address)
  {
    typedef typename cgccpp::Swap<valsize, big_endian>::Valtype Valtype;
    Valtype x = cgccpp::Swap_unaligned<valsize, big_endian>::readval(view);
    cgccpp::Swap_unaligned<valsize, big_endian>::writeval(view,
							  x + value - address);
  }
	...
	typename cgccpp::Cgc_types<size>::Cgc_Addr address)
  {
    ...
    Valtype x = cgccpp::Swap<valsize, big_endian>::readval(wv);
    x = psymval->value(object, x);
    cgccpp::Swap<valsize, big_endian>::writeval(wv, x - address);
  }
	 ...
	 typename cgccpp::Cgc_types<size>::Cgc_Addr address)
  {
    typedef typename cgccpp::Swap<valsize, big_endian>::Valtype Valtype;
    Valtype* wv = reinterpret_cast<Valtype*>(view);
    cgccpp::Swap<valsize, big_endian>::writeval(wv, value + addend - address);
  }
...
public:
  ...
  // contents.
  static inline void
  rel16(unsigned char* view, cgccpp::Cgc_Half value)
  ...
  static inline void
  rela16(unsigned char* view, cgccpp::Cgc_Half value, cgccpp::Cgc_Half addend)
  ...
  // the reloc.
  static inline void
  pcrela16(unsigned char* view, cgccpp::Cgc_Half value,
	   cgccpp::Cgc_Half addend,
           typename cgccpp::Cgc_types<size>::Cgc_Addr address)
  ...
  // contents.
  static inline void
  rel32(unsigned char* view, cgccpp::Cgc_Word value)
  { This::template rel<32>(view, value); }

  // Like above but for relocs at unaligned addresses.
  static inline void
  rel32_unaligned(unsigned char* view, cgccpp::Cgc_Word value)
  ...
  static inline void
  rela32(unsigned char* view, cgccpp::Cgc_Word value, cgccpp::Cgc_Word addend)
  ...
  // the relocation.
  static inline void
  pcrela32(unsigned char* view, cgccpp::Cgc_Word value,
           cgccpp::Cgc_Word addend,
           typename cgccpp::Cgc_types<size>::Cgc_Addr address)
  ...
  // contents.
  static inline void
  rel64(unsigned char* view, cgccpp::Cgc_Xword value)
  ...
  static inline void
  rela64(unsigned char* view, cgccpp::Cgc_Xword value,
  ...
  // the section contents.
  static inline void
  pcrel64(unsigned char* view, cgccpp::Cgc_Xword value,
	  typename cgccpp::Cgc_types<size>::Cgc_Addr address)
  ...
  // the relocation.
  static inline void
  pcrela64(unsigned char* view, cgccpp::Cgc_Xword value,
           cgccpp::Cgc_Xword addend,
           typename cgccpp::Cgc_types<size>::Cgc_Addr address)
...
class Track_relocs
{
 public:
  ...
  // (cgccpp::SHT_REL or cgccpp::SHT_RELA).  This returns false if
