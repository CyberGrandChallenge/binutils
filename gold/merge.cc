...
Object_merge_map::initialize_input_to_output_map(
    unsigned int shndx,
    typename cgccpp::Cgc_types<size>::Cgc_Addr starting_address,
    Unordered_map<section_offset_type,
		  typename cgccpp::Cgc_types<size>::Cgc_Addr>* initialize_map)
{
  Input_merge_map* map = this->get_input_merge_map(shndx);
...
Object_merge_map::initialize_input_to_output_map<32>(
    unsigned int shndx,
    cgccpp::Cgc_types<32>::Cgc_Addr starting_address,
    Unordered_map<section_offset_type, cgccpp::Cgc_types<32>::Cgc_Addr>*);
#endif
...
Object_merge_map::initialize_input_to_output_map<64>(
    unsigned int shndx,
    cgccpp::Cgc_types<64>::Cgc_Addr starting_address,
    Unordered_map<section_offset_type, cgccpp::Cgc_types<64>::Cgc_Addr>*);
#endif
