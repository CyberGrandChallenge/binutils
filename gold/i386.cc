...
{
 public:
  typedef Output_data_reloc<cgccpp::SHT_REL, true, 32, false> Reloc_section;
 ...
 protected:
  ...
  fill_first_plt_entry(unsigned char* pov,
		       cgccpp::Cgc_types<32>::Cgc_Addr got_address)
  ...
  do_fill_first_plt_entry(unsigned char* pov,
			  cgccpp::Cgc_types<32>::Cgc_Addr got_address) = 0;
...
class Output_data_plt_i386_dyn : public Output_data_plt_i386_standard
{
 ...
 protected:
  virtual void
  do_fill_first_plt_entry(unsigned char* pov, cgccpp::Cgc_types<32>::Cgc_Addr);

  virtual unsigned int
  do_fill_plt_entry(unsigned char* pov,
		    cgccpp::Cgc_types<32>::Cgc_Addr,
		    unsigned int got_offset,
		    unsigned int plt_offset,
		    unsigned int plt_rel_offset);
 ...
 public:
  ...
  Target_i386(const Target::Target_info* info = &i386_info)
    : Sized_target<32, false>(info),
      ...
      rel_irelative_(NULL), copy_relocs_(cgccpp::R_386_COPY),
  ...
  relocate_relocs(const Relocate_info<32, false>*,
		  ...
		  size_t reloc_count,
		  Output_section* output_section,
		  cgccpp::Cgc_types<32>::Cgc_Off offset_in_output_section,
 ...
 private:
  ...
  struct Scan
  {
    ...
    local(Symbol_table* symtab, Layout* layout, Target_i386* target,
	  ...
	  unsigned int data_shndx,
	  Output_section* output_section,
	  const cgccpp::Rel<32, false>& reloc, unsigned int r_type,
	  const cgccpp::Sym<32, false>& lsym,
	  bool is_discarded);
    ...
    local_reloc_may_be_function_pointer(Symbol_table* symtab, Layout* layout,
					...
					unsigned int data_shndx,
					Output_section* output_section,
					const cgccpp::Rel<32, false>& reloc,
					unsigned int r_type,
					const cgccpp::Sym<32, false>& lsym);
  ...
  class Relocate
  {
   public:
    ...
    relocate(const Relocate_info<32, false>*, Target_i386*, Output_section*,
	     size_t relnum, const cgccpp::Rel<32, false>&,
   ...
   private:
    ...
    tls_gd_to_ie(const Relocate_info<32, false>*, size_t relnum,
		 ...
		 const cgccpp::Rel<32, false>&, unsigned int r_type,
		 cgccpp::Cgc_types<32>::Cgc_Addr value,
		 unsigned char* view,
		 section_size_type view_size);
  ...
  copy_reloc(Symbol_table* symtab, Layout* layout,
	     ...
	     Symbol* sym, const cgccpp::Rel<32, false>& reloc)
  {
  ...
  Copy_relocs<cgccpp::SHT_REL, 32, false> copy_relocs_;
  ...
  if (this->rel_irelative_ == NULL)
    {
      ...
      layout->add_output_section_data(".rel.dyn", cgccpp::SHT_REL,
				      cgccpp::SHF_ALLOC, this->rel_irelative_,
				      ORDER_DYNAMIC_RELOCS, false);
				...
				Symbol* gsym)
{
  ...
  if (gsym->type() == cgccpp::STT_GNU_IFUNC
	...
	this->got_irelative_->current_data_size();
      ...
      rel->add_symbolless_global_addend(gsym, cgccpp::R_386_IRELATIVE,
  ...
  else
    {
      ...
      this->rel_->add_global(gsym, cgccpp::R_386_JUMP_SLOT, this->got_plt_,
			     got_offset);
    }
  ...
  if (this->tls_desc_rel_ == NULL)
    {
      ...
      layout->add_output_section_data(".rel.plt", cgccpp::SHT_REL,
				      cgccpp::SHF_ALLOC, this->tls_desc_rel_,
				      ORDER_DYNAMIC_PLT_RELOCS, false);
    ...
    cgccpp::Cgc_types<32>::Cgc_Addr got_address)
{
  ...
  cgccpp::Swap_unaligned<32, false>::writeval(pov + 2, got_address + 4);
  cgccpp::Swap<32, false>::writeval(pov + 8, got_address + 8);
}
    ...
    unsigned int plt_rel_offset)
{
  ...
  cgccpp::Swap_unaligned<32, false>::writeval(pov + 7, plt_rel_offset);
  cgccpp::Swap<32, false>::writeval(pov + 12, - (plt_offset + 12 + 4));
  return 6;
}
...
{
  memcpy(pov, plt_entry, plt_entry_size);
  cgccpp::Swap_unaligned<32, false>::writeval(pov + 2, got_offset);
  cgccpp::Swap_unaligned<32, false>::writeval(pov + 7, plt_rel_offset);
  cgccpp::Swap<32, false>::writeval(pov + 12, - (plt_offset + 12 + 4));
  return 6;
}
...
Output_data_plt_i386::plt_eh_frame_cie[plt_eh_frame_cie_size] =
{
  ...
  cgccpp::DW_CFA_def_cfa, 4, 4,	// DW_CFA_def_cfa: r4 (esp) ofs 4.
  cgccpp::DW_CFA_offset + 8, 1,	// DW_CFA_offset: r8 (eip) at cfa-4.
...
Output_data_plt_i386_standard::plt_eh_frame_fde[plt_eh_frame_fde_size] =
{
  ...
  0,					// Augmentation size.
  cgccpp::DW_CFA_def_cfa_offset, 8,	// DW_CFA_def_cfa_offset: 8.
  cgccpp::DW_CFA_advance_loc + 6,	// Advance 6 to __PLT__ + 6.
  cgccpp::DW_CFA_def_cfa_offset, 12,	// DW_CFA_def_cfa_offset: 12.
  cgccpp::DW_CFA_advance_loc + 10,	// Advance 10 to __PLT__ + 16.
  cgccpp::DW_CFA_def_cfa_expression,	// DW_CFA_def_cfa_expression.
  11,					// Block length.
  cgccpp::DW_OP_breg4, 4,		// Push %esp + 4.
  cgccpp::DW_OP_breg8, 0,		// Push %eip.
  cgccpp::DW_OP_lit15,			// Push 0xf.
  cgccpp::DW_OP_and,			// & (%eip & 0xf).
  cgccpp::DW_OP_lit11,			// Push 0xb.
  cgccpp::DW_OP_ge,			// >= ((%eip & 0xf) >= 0xb)
  cgccpp::DW_OP_lit2,			// Push 2.
  cgccpp::DW_OP_shl,			// << (((%eip & 0xf) >= 0xb) << 2)
  cgccpp::DW_OP_plus,			// + ((((%eip&0xf)>=0xb)<<2)+%esp+4
...
// and adjusts them as needed.  This is all specified by the i386 CGC
...
Output_data_plt_i386::do_write(Output_file* of)
{
  ...
  cgccpp::Cgc_types<32>::Cgc_Addr plt_address = this->address();
  cgccpp::Cgc_types<32>::Cgc_Addr got_address = this->got_plt_->address();
  ...
  cgccpp::Swap<32, false>::writeval(got_pov, dynamic_addr);
  got_pov += 4;
  memset(got_pov, 0, 8);
  got_pov += 8;

  const int rel_size = cgccpp::Cgc_sizes<32>::rel_size;
  ...
  for (unsigned int i = 0;
	 ...
	 got_offset += 4)
    {
      ...
      cgccpp::Swap<32, false>::writeval(got_pov,
  ...
  for (std::vector<Global_ifunc>::const_iterator p =
	...
	static_cast<const Sized_symbol<32>*>(p->sym);
      cgccpp::Swap<32, false>::writeval(got_irelative_view + p->got_offset,
					ssym->value());
    }
  ...
  if (this->got_mod_index_offset_ == -1U)
    {
      ...
      rel_dyn->add_local(object, 0, cgccpp::R_386_TLS_DTPMOD32, got,
			 got_offset);
      got->add_constant(0);
...
Target_i386::optimize_tls_reloc(bool is_final, int r_type)
{
  ...
  switch (r_type)
    {
    case cgccpp::R_386_TLS_GD:
    case cgccpp::R_386_TLS_GOTDESC:
    case cgccpp::R_386_TLS_DESC_CALL:
    ...
    case cgccpp::R_386_TLS_LDM:
      // This is Local-Dynamic, which refers to a local symbol in the
      // dynamic TLS block.  Since we know that we generating an
      // executable, we can switch to Local-Exec.
      return tls::TLSOPT_TO_LE;

    case cgccpp::R_386_TLS_LDO_32:
      // Another type of Local-Dynamic relocation.
      return tls::TLSOPT_TO_LE;

    case cgccpp::R_386_TLS_IE:
    case cgccpp::R_386_TLS_GOTIE:
    case cgccpp::R_386_TLS_IE_32:
    ...
    case cgccpp::R_386_TLS_LE:
    case cgccpp::R_386_TLS_LE_32:
...
Target_i386::Scan::get_reference_flags(unsigned int r_type)
{
  switch (r_type)
    {
    case cgccpp::R_386_NONE:
    case cgccpp::R_386_GNU_VTINHERIT:
    case cgccpp::R_386_GNU_VTENTRY:
    case cgccpp::R_386_GOTPC:
      // No symbol reference.
      return 0;

    case cgccpp::R_386_32:
    case cgccpp::R_386_16:
    case cgccpp::R_386_8:
      return Symbol::ABSOLUTE_REF;

    case cgccpp::R_386_PC32:
    case cgccpp::R_386_PC16:
    case cgccpp::R_386_PC8:
    case cgccpp::R_386_GOTOFF:
      return Symbol::RELATIVE_REF;

    case cgccpp::R_386_PLT32:
      return Symbol::FUNCTION_CALL | Symbol::RELATIVE_REF;

    case cgccpp::R_386_GOT32:
      // Absolute in GOT.
      return Symbol::ABSOLUTE_REF;

    case cgccpp::R_386_TLS_GD:            // Global-dynamic
    case cgccpp::R_386_TLS_GOTDESC:       // Global-dynamic (from ~oliva url)
    case cgccpp::R_386_TLS_DESC_CALL:
    case cgccpp::R_386_TLS_LDM:           // Local-dynamic
    case cgccpp::R_386_TLS_LDO_32:        // Alternate local-dynamic
    case cgccpp::R_386_TLS_IE:            // Initial-exec
    case cgccpp::R_386_TLS_IE_32:
    case cgccpp::R_386_TLS_GOTIE:
    case cgccpp::R_386_TLS_LE:            // Local-exec
    case cgccpp::R_386_TLS_LE_32:
      return Symbol::TLS_REF;

    case cgccpp::R_386_COPY:
    case cgccpp::R_386_GLOB_DAT:
    case cgccpp::R_386_JUMP_SLOT:
    case cgccpp::R_386_RELATIVE:
    case cgccpp::R_386_IRELATIVE:
    case cgccpp::R_386_TLS_TPOFF:
    case cgccpp::R_386_TLS_DTPMOD32:
    case cgccpp::R_386_TLS_DTPOFF32:
    case cgccpp::R_386_TLS_TPOFF32:
    case cgccpp::R_386_TLS_DESC:
    case cgccpp::R_386_32PLT:
    case cgccpp::R_386_TLS_GD_32:
    case cgccpp::R_386_TLS_GD_PUSH:
    case cgccpp::R_386_TLS_GD_CALL:
    case cgccpp::R_386_TLS_GD_POP:
    case cgccpp::R_386_TLS_LDM_32:
    case cgccpp::R_386_TLS_LDM_PUSH:
    case cgccpp::R_386_TLS_LDM_CALL:
    case cgccpp::R_386_TLS_LDM_POP:
    case cgccpp::R_386_USED_BY_INTEL_200:
    default:
			 ...
			 bool is_discarded)
{
  ...
  if (lsym.get_st_type() == cgccpp::STT_GNU_IFUNC
  ...
  switch (r_type)
      ...
      if (parameters->options().output_is_position_independent())
	{
	  ...
	  unsigned int r_sym = cgccpp::cgc_r_sym<32>(reloc.get_r_info());
	  rel_dyn->add_local_relative(object, r_sym, cgccpp::R_386_RELATIVE,
	...
	switch (r_type)
	  ...
	  case cgccpp::R_386_TLS_GD:          // Global-dynamic
		...
		if (!is_ordinary)
		  ...
		  got->add_local_pair_with_rel(object, r_sym, shndx,
					       ...
					       cgccpp::R_386_TLS_DTPMOD32);
	      }
	    else if (optimized_type != tls::TLSOPT_TO_LE)
	      unsupported_reloc_local(object, r_type);
	    break;

	  case cgccpp::R_386_TLS_GOTDESC:     // Global-dynamic (from ~oliva)
		...
		if (!object->local_has_got_offset(r_sym, GOT_TYPE_TLS_DESC))
		  {
		    ...
		    rt->add_absolute(cgccpp::R_386_TLS_DESC, got, got_offset);
		  }
	      }
	    else if (optimized_type != tls::TLSOPT_TO_LE)
	      unsupported_reloc_local(object, r_type);
	  ...
	  case cgccpp::R_386_TLS_GOTIE:
		...
		Output_data_got<32, false>* got
		    = target->got_section(symtab, layout);
		unsigned int r_sym = cgccpp::cgc_r_sym<32>(reloc.get_r_info());
		unsigned int dyn_r_type = (r_type == cgccpp::R_386_TLS_IE_32
					   ? cgccpp::R_386_TLS_TPOFF32
					   : cgccpp::R_386_TLS_TPOFF);
		unsigned int got_type = (r_type == cgccpp::R_386_TLS_IE_32
					 ? GOT_TYPE_TLS_OFFSET
	  ...
	  case cgccpp::R_386_TLS_LE_32:
		...
		unsigned int r_sym = cgccpp::cgc_r_sym<32>(reloc.get_r_info());
		unsigned int dyn_r_type = (r_type == cgccpp::R_386_TLS_LE_32
					   ? cgccpp::R_386_TLS_TPOFF32
					   : cgccpp::R_386_TLS_TPOFF);
		Reloc_section* rel_dyn = target->rel_dyn_section(layout);
...
Target_i386::Scan::local_reloc_may_be_function_pointer(
  ...
  unsigned int ,
  Output_section* ,
  const cgccpp::Rel<32, false>& ,
  unsigned int r_type,
  const cgccpp::Sym<32, false>&)
{
				 ...
				 Symbol* gsym)
{
  ...
  switch (r_type)
	...
	if (gsym->needs_dynamic_reloc(Scan::get_reference_flags(r_type)))
	  {
	    ...
	    else if (r_type == cgccpp::R_386_32
		...
		rel_dyn->add_symbolless_global_addend(gsym,
	      ...
	      {
		Reloc_section* rel_dyn = target->rel_dyn_section(layout);
		rel_dyn->add_global_relative(gsym, cgccpp::R_386_RELATIVE,
	...
	switch (r_type)
	  ...
	  case cgccpp::R_386_TLS_GOTDESC:     // Global-dynamic (~oliva url)
	    target->define_tls_base_symbol(symtab, layout);
	    if (optimized_type == tls::TLSOPT_NONE)
	      {
		// Create a double GOT entry with an R_386_TLS_DESC
...
Target_i386::gc_process_relocs(Symbol_table* symtab,
				      ...
				      const unsigned char* plocal_symbols)
{
  gold::gc_process_relocs<32, false, Target_i386, cgccpp::SHT_REL,
			  Target_i386::Scan,
				...
				const unsigned char* plocal_symbols)
{
  ...
  gold::scan_relocs<32, false, Target_i386, cgccpp::SHT_REL,
		    Target_i386::Scan>(
    symtab,
    layout,
    this,
  ...
  switch (r_type)
      ...
      else
	{
	  unsigned int got_type = (optimized_type == tls::TLSOPT_TO_IE
				   ...
				   : GOT_TYPE_TLS_DESC);
	  unsigned int got_offset = 0;
	  if (r_type == cgccpp::R_386_TLS_GOTDESC
      ...
      if (optimized_type == tls::TLSOPT_TO_LE)
	{
	  ...
	  // does as well.
	  cgccpp::Shdr<32, false> shdr(relinfo->data_shdr);
	  if ((shdr.get_sh_flags() & cgccpp::SHF_EXECINSTR) != 0)
	    {
	      if (tls_segment == NULL)
		{
		  gold_assert(parameters->errors()->error_count() > 0
    ...
    section_size_type view_size)
{
  if (r_type == cgccpp::R_386_TLS_GOTDESC)
  ...
  else
    {
      ...
      // ==> nop; nop
      gold_assert(r_type == cgccpp::R_386_TLS_DESC_CALL);
      tls::check_range(relinfo, relnum, rel.get_r_offset(), view_size, 2);
      tls::check_tls(relinfo, relnum, rel.get_r_offset(),
				    ...
				    section_size_type view_size)
{
  ...
  value = tls_segment->memsz() - value;
  if (r_type == cgccpp::R_386_TLS_IE || r_type == cgccpp::R_386_TLS_GOTIE)
    value = - value;
			      ...
			      const Reloc_symbol_changes* reloc_symbol_changes)
{
  ...
  gold::relocate_section<32, false, Target_i386, cgccpp::SHT_REL,
				     ...
				     Relocatable_relocs* rr)
{
  ...
  typedef gold::Default_scan_relocatable_relocs<cgccpp::SHT_REL,
    Relocatable_size_for_reloc> Scan_relocatable_relocs;

  gold::scan_relocatable_relocs<32, false, cgccpp::SHT_REL,
    ...
    section_size_type reloc_view_size)
{
  ...
  gold::relocate_relocs<32, false, cgccpp::SHT_REL>(
    relinfo,
    prelocs,
    reloc_count,
    output_section,
...
{
  return (sym->type() == cgccpp::STT_FUNC
...
public:
  Target_selector_i386()
    : Target_selector_freebsd(cgccpp::EM_386, 32, false,
			      "cgc32-i386", "cgc32-i386-freebsd",
			      "cgc_i386")
  { }
    ...
    unsigned int plt_rel_offset)
{
  ...
  cgccpp::Swap_unaligned<32, false>::writeval(pov + 2,
					      got_address + got_offset);
  cgccpp::Swap_unaligned<32, false>::writeval(pov + 33, plt_rel_offset);
  cgccpp::Swap<32, false>::writeval(pov + 38, - (plt_offset + 38 + 4));
  return 32;
}
...
Output_data_plt_i386_nacl::plt_eh_frame_fde[plt_eh_frame_fde_size] =
{
  ...
  cgccpp::DW_OP_and,			// & (%eip & 0x3f).
  cgccpp::DW_OP_const1u, 37,            // Push 0x25.
  cgccpp::DW_OP_ge,			// >= ((%eip & 0x3f) >= 0x25)
  cgccpp::DW_OP_lit2,			// Push 2.
  cgccpp::DW_OP_shl,			// << (((%eip & 0x3f) >= 0x25) << 2)
  cgccpp::DW_OP_plus,			// + ((((%eip&0x3f)>=0x25)<<2)+%esp+4
  cgccpp::DW_CFA_nop,			// Align to 32 bytes.
  cgccpp::DW_CFA_nop
};
