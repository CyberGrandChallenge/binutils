...
// Comparison routine used when sorting into an CGC strtab.  We want
...
// Turn the stringpool into an CGC strtab: determine the offsets of
...
// Get the offset of a string in the CGC strtab.  The string must
// exist.
...
// Write the CGC strtab into the buffer.
...
// Write the CGC strtab into the output file at the specified offset.
