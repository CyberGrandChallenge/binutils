// testfile.cc -- Dummy CGC objects for testing purposes.
...
class Target_test : public Sized_target<size, big_endian>
{
 public:
  ...
  relocate_relocs(const Relocate_info<size, big_endian>*,
		  ...
		  Output_section*, typename cgccpp::Cgc_types<size>::Cgc_Off,
...
const Target::Target_info Target_test<size, big_endian>::test_target_info =
{
  ...
  static_cast<cgccpp::EM>(0xffff),	// machine_code
...
// A simple CGC object with one empty section, named ".test" and one
