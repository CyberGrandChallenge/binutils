// binary_unittest.cc -- test Binary_to_cgc
...
Sized_binary_test()
{
  ...
  Binary_to_cgc binary(static_cast<cgccpp::EM>(0xffff), size, big_endian,
		       gold::program_name);
  ...
  Object* object = make_cgc_object("test.o", &input_file, 0,
  ...
  CHECK(object->section_flags(1) == (cgccpp::SHF_ALLOC | cgccpp::SHF_WRITE));
