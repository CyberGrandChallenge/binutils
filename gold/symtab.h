...
class Symbol
{
 public:
  ...
  is_func() const
  {
    return (this->type_ == cgccpp::STT_FUNC
	    || this->type_ == cgccpp::STT_GNU_IFUNC);
  }
  ...
  // Return whether this symbol has been seen in a real CGC object.
  // (IN_REG will return TRUE if the symbol has been seen in either
  // a real CGC object or an object claimed by a plugin.)
  bool
  in_real_cgc() const
  { return this->in_real_cgc_; }

  // Mark this symbol as having been seen in a real CGC object.
  void
  set_in_real_cgc()
  ...
  is_undefined() const
  {
    ...
    return ((this->source_ == FROM_OBJECT
	     && this->shndx(&is_ordinary) == cgccpp::SHN_UNDEF
	     && is_ordinary)
  ...
  { return this->is_undefined() && this->binding() == cgccpp::STB_WEAK; }
  ...
  is_absolute() const
  {
    bool is_ordinary;
    return ((this->source_ == FROM_OBJECT
	     && this->shndx(&is_ordinary) == cgccpp::SHN_ABS
	     && !is_ordinary)
  ...
  is_common() const
  {
    if (this->source_ != FROM_OBJECT)
      return false;
    if (this->type_ == cgccpp::STT_COMMON)
      return true;
    bool is_ordinary;
    unsigned int shndx = this->shndx(&is_ordinary);
  ...
  {
    return ((this->visibility_ == cgccpp::STV_DEFAULT
             || this->visibility_ == cgccpp::STV_PROTECTED)
  ...
  is_preemptible() const
  {
    ...
    if (this->visibility_ != cgccpp::STV_DEFAULT)
      return false;
    ...
    // linker does.
    if (this->type() != cgccpp::STT_OBJECT
  ...
  needs_plt_entry() const
  {
    ...
    // doing a static link.
    if (this->type() == cgccpp::STT_GNU_IFUNC)
      return true;
 ...
 protected:
  ...
  // Initialize fields from an CGC symbol in OBJECT.  ST_SHNDX is the
  ...
  void
  init_base_constant(const char* name, const char* version, cgccpp::STT type,
		     cgccpp::STB binding, cgccpp::STV visibility,
		     unsigned char nonvis, bool is_predefined);

  // Initialize fields for an undefined symbol.
  void
  init_base_undefined(const char* name, const char* version, cgccpp::STT type,
		      cgccpp::STB binding, cgccpp::STV visibility,
		      unsigned char nonvis);
  ...
  template<int size, bool big_endian>
  void
  override_base(const cgccpp::Sym<size, big_endian>&, unsigned int st_shndx,
 ...
 private:
  ...
  cgccpp::STB binding_ : 4;
  // Symbol visibility (bits 8 to 9).
  cgccpp::STV visibility_ : 2;
  ...
  // True if we've seen this symbol in a "real" CGC object (bit 30).
  ...
  // a dynamic object doesn't count as a "real" CGC, and we'll simply
...
{
 public:
  typedef typename cgccpp::Cgc_types<size>::Cgc_Addr Value_type;
  typedef typename cgccpp::Cgc_types<size>::Cgc_WXword Size_type;
  ...
  init_output_data(const char* name, const char* version, Output_data*,
		   Value_type value, Size_type symsize, cgccpp::STT,
		   cgccpp::STB, cgccpp::STV, unsigned char nonvis,
  ...
  init_constant(const char* name, const char* version, Value_type value,
		Size_type symsize, cgccpp::STT, cgccpp::STB, cgccpp::STV,
		unsigned char nonvis, bool is_predefined);

  // Initialize fields for an undefined symbol.
  void
  init_undefined(const char* name, const char* version, cgccpp::STT,
		 cgccpp::STB, cgccpp::STV, unsigned char nonvis);

  // Override existing symbol.
  template<bool big_endian>
  void
  override(const cgccpp::Sym<size, big_endian>&, unsigned int st_shndx,
	   bool is_ordinary, Object* object, const char* version);
...
class Symbol_table
{
 public:
  ...
  add_from_incrobj(Object* obj, const char* name,
		   const char* ver, cgccpp::Sym<size, big_endian>* sym);
  ...
  define_as_constant(const char* name, const char* version, Defined,
		     uint64_t value, uint64_t symsize, cgccpp::STT type,
		     cgccpp::STB binding, cgccpp::STV visibility,
 ...
 private:
  ...
  add_from_object(Object*, const char* name, Stringpool::Key name_key,
		  ...
		  bool def, const cgccpp::Sym<size, big_endian>& sym,
  ...
  // resolve.cc.
  static bool
  should_override(const Symbol*, unsigned int, cgccpp::STT, Defined,
		  Object*, bool*, bool*);
  ...
  override(Sized_symbol<size>* tosym,
	   const cgccpp::Sym<size, big_endian>& fromsym,
	   unsigned int st_shndx, bool is_ordinary,
  ...
  static bool
  should_override_with_special(const Symbol*, cgccpp::STT, Defined);
  ...
  do_define_in_output_data(const char* name, const char* version, Defined,
			   ...
			   typename cgccpp::Cgc_types<size>::Cgc_WXword ssize,
			   cgccpp::STT type, cgccpp::STB binding,
			   cgccpp::STV visibility, unsigned char nonvis,
			   bool offset_is_from_end, bool only_if_ref);
