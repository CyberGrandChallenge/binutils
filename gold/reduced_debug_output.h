...
{
 public:
  Output_reduced_debug_abbrev_section(const char* name, cgccpp::Cgc_Word flags,
			              cgccpp::Cgc_Xword type)
...
{
 public:
  Output_reduced_debug_info_section(const char* name, cgccpp::Cgc_Word flags,
			            cgccpp::Cgc_Xword type)
