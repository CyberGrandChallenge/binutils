...
class Sized_cgc_reloc_mapper : public Cgc_reloc_mapper
{
 public:
  Sized_cgc_reloc_mapper(Object* object, const unsigned char* symtab,
			 off_t symtab_size)
 ...
 private:
  ...
  // The object file.
  Object* object_;
  // The CGC symbol table.
  const unsigned char* symtab_;
  // The size of the CGC symbol table.
  off_t symtab_size_;
...
class Dwarf_ranges_table
{
 ...
 private:
  ...
  Cgc_reloc_mapper* ranges_reloc_mapper_;
  // Type of the relocation section (SHT_REL or SHT_RELA).
  unsigned int reloc_type_;
...
class Dwarf_pubnames_table
{
 ...
 private:
  ...
  Cgc_reloc_mapper* reloc_mapper_;
  // Type of the relocation section (SHT_REL or SHT_RELA).
  unsigned int reloc_type_;
};
...
class Dwarf_die
{
 public:
  ...
  bool
  is_declaration()
  { return this->flag_attribute(cgccpp::DW_AT_declaration); }
...
class Dwarf_info_reader
{
 public:
  ...
  // Return a pointer to the object file's CGC symbol table.
  const unsigned char*
  symtab() const
  { return this->symtab_; }

  // Return the size of the object file's CGC symbol table.
  off_t
  symtab_size() const
...
class Sized_dwarf_line_info : public Dwarf_line_info
{
 ...
 private:
  ...
  Sized_cgc_reloc_mapper<size, big_endian>* reloc_mapper_;
