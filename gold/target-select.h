...
// selector, which specifies an CGC machine number and a recognition
...
class Target_selector
{
 ...
 protected:
  ...
  // CGC version value.  When this is called we already know that they
...
// Select the target for an CGC file.
