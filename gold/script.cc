...
{
  cgccpp::STV vis = this->hidden_ ? cgccpp::STV_HIDDEN : cgccpp::STV_DEFAULT;
                 ...
                 int first_token, Lex::Mode lex_mode)
{
  ...
  if (posdep.format_enum() == General_options::OBJECT_FORMAT_BINARY)
    posdep.set_format_enum(General_options::OBJECT_FORMAT_CGC);
...
#define PHDR_TYPE(NAME) { #NAME, sizeof(#NAME) - 1, cgccpp::NAME }
