...
{
public:
  typedef typename cgccpp::Cgc_types<size>::Cgc_Addr Address;
  ...
  Powerpc_relobj(const std::string& name, Input_file* input_file, off_t offset,
		 const typename cgccpp::Ehdr<size, big_endian>& ehdr)
  ...
  add_reference(Object* src_obj,
		...
		typename cgccpp::Cgc_types<size>::Cgc_Addr dst_off)
  {
  ...
  // at DST_OFF
  void
  add_gc_mark(typename cgccpp::Cgc_types<size>::Cgc_Addr dst_off)
  {
  ...
  int
  abiversion() const
  { return this->e_flags_ & cgccpp::EF_PPC64_ABI; }
  ...
  { return cgccpp::ppc64_decode_local_entry(sym->nonvis() >> 3); }

  unsigned int
  ppc64_local_entry_offset(unsigned int symndx) const
  { return cgccpp::ppc64_decode_local_entry(this->st_other_[symndx] >> 5); }
...
private:
  ...
  // Header e_flags
  cgccpp::Cgc_Word e_flags_;

  // CGC st_other field for local symbols.
...
class Target_powerpc : public Sized_target<size, big_endian>
{
 public:
  typedef
    Output_data_reloc<cgccpp::SHT_RELA, true, size, big_endian> Reloc_section;
  typedef typename cgccpp::Cgc_types<size>::Cgc_Addr Address;
  typedef typename cgccpp::Cgc_types<size>::Cgc_Swxword Signed_address;
  ...
  Target_powerpc()
    : Sized_target<size, big_endian>(&powerpc_info),
      ...
      glink_(NULL), rela_dyn_(NULL), copy_relocs_(cgccpp::R_POWERPC_COPY),
	      ...
	      unsigned int r_type, unsigned int r_sym, Address addend)
  {
    ...
    if (r_type == cgccpp::R_POWERPC_REL14
	|| r_type == cgccpp::R_POWERPC_REL14_BRTAKEN
	|| r_type == cgccpp::R_POWERPC_REL14_BRNTAKEN)
  ...
  relocate_relocs(const Relocate_info<size, big_endian>*,
		  ...
		  size_t reloc_count,
		  Output_section* output_section,
		  typename cgccpp::Cgc_types<size>::Cgc_Off
  ...
  do_make_cgc_object(const std::string&, Input_file*, off_t,
		     const cgccpp::Ehdr<size, big_endian>&);
  ...
  write_branch_lookup_table(unsigned char *oview)
  {
    for (typename Branch_lookup_table::const_iterator p
	 ...
	 ++p)
      {
	cgccpp::Swap<size, big_endian>::writeval(oview + p->second, p->first);
      }
  }
  ...
  int
  abiversion () const
  { return this->processor_specific_flags() & cgccpp::EF_PPC64_ABI; }

  void
  set_abiversion (int ver)
  {
    cgccpp::Cgc_Word flags = this->processor_specific_flags();
    flags &= ~cgccpp::EF_PPC64_ABI;
    flags |= ver & cgccpp::EF_PPC64_ABI;
 ...
 private:
  ...
  public:
    ...
    {
      bool is_tls_call = ((r_type == cgccpp::R_POWERPC_REL24
			   || r_type == cgccpp::R_PPC_PLTREL24)
			  && gsym != NULL
  ...
  public:
    ...
    local(Symbol_table* symtab, Layout* layout, Target_powerpc* target,
	  ...
	  unsigned int data_shndx,
	  Output_section* output_section,
	  const cgccpp::Rela<size, big_endian>& reloc, unsigned int r_type,
	  const cgccpp::Sym<size, big_endian>& lsym,
	  bool is_discarded);
    ...
    local_reloc_may_be_function_pointer(Symbol_table* , Layout* ,
					...
					unsigned int ,
					Output_section* ,
					const cgccpp::Rela<size, big_endian>& ,
					unsigned int r_type,
					const cgccpp::Sym<size, big_endian>&)
    {
  ...
  class Relocate : protected Track_tls
  {
   public:
    ...
    relocate(const Relocate_info<size, big_endian>*, Target_powerpc*,
	     ...
	     unsigned char*,
	     typename cgccpp::Cgc_types<size>::Cgc_Addr,
	     section_size_type);
  };
  ...
  copy_reloc(Symbol_table* symtab, Layout* layout,
	     ...
	     Symbol* sym, const cgccpp::Rela<size, big_endian>& reloc)
  {
  ...
  Copy_relocs<cgccpp::SHT_RELA, size, big_endian> copy_relocs_;
...
is_branch_reloc(unsigned int r_type)
{
  return (r_type == cgccpp::R_POWERPC_REL24
	  || r_type == cgccpp::R_PPC_PLTREL24
	  || r_type == cgccpp::R_PPC_LOCAL24PC
	  || r_type == cgccpp::R_POWERPC_REL14
	  || r_type == cgccpp::R_POWERPC_REL14_BRTAKEN
	  || r_type == cgccpp::R_POWERPC_REL14_BRNTAKEN
	  || r_type == cgccpp::R_POWERPC_ADDR24
	  || r_type == cgccpp::R_POWERPC_ADDR14
	  || r_type == cgccpp::R_POWERPC_ADDR14_BRTAKEN
	  || r_type == cgccpp::R_POWERPC_ADDR14_BRNTAKEN);
}
...
private:
  ...
  {
    typedef typename cgccpp::Swap<valsize, big_endian>::Valtype Valtype;
    Valtype* wv = reinterpret_cast<Valtype*>(view);
    cgccpp::Swap<valsize, big_endian>::writeval(wv, value);
  ...
  rela(unsigned char* view,
       ...
       typename cgccpp::Valtype_base<valsize>::Valtype dst_mask,
       Address value,
       Overflow_check overflow)
  {
    typedef typename cgccpp::Swap<valsize, big_endian>::Valtype Valtype;
    Valtype* wv = reinterpret_cast<Valtype*>(view);
    Valtype val = cgccpp::Swap<valsize, big_endian>::readval(wv);
    Valtype reloc = value >> right_shift;
    val &= ~dst_mask;
    reloc &= dst_mask;
    cgccpp::Swap<valsize, big_endian>::writeval(wv, val | reloc);
  ...
  {
    cgccpp::Swap_unaligned<valsize, big_endian>::writeval(view, value);
    return overflowed<valsize>(value, overflow);
  }
  ...
  rela_ua(unsigned char* view,
	  ...
	  Overflow_check overflow)
  {
    typedef typename cgccpp::Swap_unaligned<valsize, big_endian>::Valtype
      Valtype;
    Valtype val = cgccpp::Swap<valsize, big_endian>::readval(view);
    Valtype reloc = value >> right_shift;
    val &= ~dst_mask;
    reloc &= dst_mask;
    cgccpp::Swap_unaligned<valsize, big_endian>::writeval(view, val | reloc);
    return overflowed<valsize>(value >> right_shift, overflow);
  }
    ...
    Read_symbols_data* sd)
{
  ...
  if (s != NULL)
    {
      unsigned int ndx = (s - pshdrs) / cgccpp::Cgc_sizes<size>::shdr_size;
      this->special_ = ndx;
      if (size == 64)
	{
	  if (this->abiversion() == 0)
    ...
    const unsigned char* plocal_syms)
{
  if (size == 64)
    {
      typedef typename Reloc_types<cgccpp::SHT_RELA, size, big_endian>::Reloc
	Reltype;
      const int reloc_size
	= Reloc_types<cgccpp::SHT_RELA, size, big_endian>::reloc_size;
      const int sym_size = cgccpp::Cgc_sizes<size>::sym_size;
      ...
      for (size_t i = 0; i < reloc_count; ++i, prelocs += reloc_size)
	{
	  ...
	  typename cgccpp::Cgc_types<size>::Cgc_WXword r_info
	    = reloc.get_r_info();
	  unsigned int r_type = cgccpp::cgc_r_type<size>(r_info);
	  if (r_type == cgccpp::R_PPC64_ADDR64)
	    {
	      unsigned int r_sym = cgccpp::cgc_r_sym<size>(r_info);
	      typename cgccpp::Cgc_types<size>::Cgc_Addr value;
	      bool is_ordinary;
	      unsigned int shndx;
	      if (r_sym < this->local_symbol_count())
		{
		  typename cgccpp::Sym<size, big_endian>
	  ...
	  else if (r_type == cgccpp::R_PPC64_TOC)
	    {
...
Powerpc_relobj<size, big_endian>::do_read_symbols(Read_symbols_data* sd)
{
  ...
  if (size == 64)
    {
      const int shdr_size = cgccpp::Cgc_sizes<size>::shdr_size;
      const unsigned char* const pshdrs = sd->section_headers->data();
...
Powerpc_dynobj<size, big_endian>::do_read_symbols(Read_symbols_data* sd)
{
  ...
  if (size == 64)
      ...
      while (1)
	{
	  ...
	  typename cgccpp::Shdr<size, big_endian> shdr(s);
	  if (shdr.get_sh_type() == cgccpp::SHT_PROGBITS
      ...
      for (unsigned int i = 1; i < this->shnum(); ++i, s += shdr_size)
	{
	  ...
	  if (shdr.get_sh_type() == cgccpp::SHT_PROGBITS
	      && ((shdr.get_sh_flags()
		   & (cgccpp::SHF_ALLOC | cgccpp::SHF_EXECINSTR))
		  == (cgccpp::SHF_ALLOC | cgccpp::SHF_EXECINSTR))
	      && shdr.get_sh_size() != 0)
	    {
	...
	{
	  typedef typename cgccpp::Swap<64, big_endian>::Valtype Valtype;
	  const Valtype* valp = reinterpret_cast<const Valtype*>(p);
	  Valtype val = cgccpp::Swap<64, big_endian>::readval(valp);
	  if (val == 0)
  ...
  if (size == 32)
      ...
      if (sdasym != NULL && sdasym->is_undefined())
	{
	  ...
	  symtab->define_in_output_data("_SDA_BASE_", NULL,
					Symbol_table::PREDEFINED,
					os, 32768, 0, cgccpp::STT_OBJECT,
					cgccpp::STB_LOCAL, cgccpp::STV_HIDDEN,
					0, false, false);
	}
    }
  else
...
template<int size, bool big_endian>
Object*
Target_powerpc<size, big_endian>::do_make_cgc_object(
    const std::string& name,
    Input_file* input_file,
    off_t offset, const cgccpp::Ehdr<size, big_endian>& ehdr)
{
  ...
  if (et == cgccpp::ET_REL
    ...
    {
      gold_error(_("%s: unsupported CGC file type %d"), name.c_str(), et);
      return NULL;
    }
}
...
{
public:
  typedef typename cgccpp::Cgc_types<size>::Cgc_Addr Valtype;
  typedef Output_data_reloc<cgccpp::SHT_RELA, true, size, big_endian> Rela_dyn;
  ...
  if (this->rela_dyn_ == NULL)
    {
      ...
      layout->add_output_section_data(".rela.dyn", cgccpp::SHT_RELA,
				      cgccpp::SHF_ALLOC, this->rela_dyn_,
    ...
    Symbol_table* symtab) const
{
  ...
  if (gsym != NULL
  ...
  else
    {
      ...
      if (this->r_type_ == cgccpp::R_POWERPC_REL14
	  || this->r_type_ == cgccpp::R_POWERPC_REL14_BRTAKEN
	  || this->r_type_ == cgccpp::R_POWERPC_REL14_BRNTAKEN)
	max_branch_offset = 1 << 15;
      else if (this->r_type_ == cgccpp::R_POWERPC_REL24
	       || this->r_type_ == cgccpp::R_PPC_PLTREL24
	       || this->r_type_ == cgccpp::R_PPC_LOCAL24PC)
...
{
 public:
  typedef Output_data_reloc<cgccpp::SHT_RELA, true,
...
Output_data_plt_powerpc<size, big_endian>::add_entry(Symbol* gsym)
{
  if (!gsym->has_plt_offset())
	...
	off += this->first_plt_entry_offset();
      ...
      unsigned int dynrel = cgccpp::R_POWERPC_JMP_SLOT;
  ...
  if (!gsym->has_plt_offset())
    {
      section_size_type off = this->current_data_size();
      gsym->set_plt_offset(off);
      unsigned int dynrel = cgccpp::R_POWERPC_IRELATIVE;
      if (size == 64 && this->targ_->abiversion() < 2)
	dynrel = cgccpp::R_PPC64_JMP_IREL;
...
Output_data_plt_powerpc<size, big_endian>::do_write(Output_file* of)
{
  if (size == 32 && this->name_[3] != 'I')
	...
	= this->targ_->glink_section();
      cgccpp::Cgc_types<32>::Cgc_Addr branch_tab = glink->address();

      while (pov < endpov)
	{
	  cgccpp::Swap<32, big_endian>::writeval(pov, branch_tab);
	  pov += 4;
	  branch_tab += 4;
	}
						   ...
						   Layout* layout)
{
  if (this->plt_ == NULL)
	...
	make_glink_section(layout);
      ...
      layout->add_output_section_data(".rela.plt", cgccpp::SHT_RELA,
				      cgccpp::SHF_ALLOC, plt_rel,
...
class Output_data_brlt_powerpc : public Output_section_data_build
{
 public:
  ...
  { this->rel_->add_relative(cgccpp::R_POWERPC_RELATIVE, this, off, to); }
...
const unsigned char Eh_cie<size>::eh_frame_cie[] =
{
  ...
  65,					// RA reg.
  1,					// Augmentation size.
  (cgccpp::DW_EH_PE_pcrel
   | cgccpp::DW_EH_PE_sdata4),		// FDE encoding.
  cgccpp::DW_CFA_def_cfa, 1, 0		// def_cfa: r1 offset 0.
};
...
static const unsigned char glink_eh_frame_fde_64v1[] =
{
  ...
  0,					// Augmentation size.
  cgccpp::DW_CFA_advance_loc + 1,
  cgccpp::DW_CFA_register, 65, 12,
  cgccpp::DW_CFA_advance_loc + 4,
  cgccpp::DW_CFA_restore_extended, 65
};
...
{
  cgccpp::Swap<32, big_endian>::writeval(p, v);
}
...
class Stub_table : public Output_relaxed_input_section
{
 ...
 private:
  ...
  plt_off(typename Plt_stub_entries::const_iterator p, bool* is_iplt) const
  {
    ...
    if (gsym != NULL)
      {
	*is_iplt = (gsym->type() == cgccpp::STT_GNU_IFUNC
  ...
  public:
    ...
    typename cgccpp::Cgc_types<size>::Cgc_Addr addend_;
...
Output_data_glink<size, big_endian>::do_write(Output_file* of)
{
  ...
  if (size == 64)
      ...
      if (this->end_branch_table_ != 0)
	{
	  ...
	  cgccpp::Swap<64, big_endian>::writeval(p, pltoff),	p += 8;
	   ...
	   ++ge)
	{
	  ...
	  if (ge->first->type() == cgccpp::STT_GNU_IFUNC
      ...
      if (writing)
	{
	  ...
	  if (refd)
	    symtab->define_in_output_data(sym, NULL, Symbol_table::PREDEFINED,
					  ...
					  cgccpp::STT_FUNC, cgccpp::STB_GLOBAL,
					  cgccpp::STV_HIDDEN, 0, false, false);
	}
    }
}
  ...
  if (this->glink_ == NULL)
    {
      ...
      layout->add_output_section_data(".text", cgccpp::SHT_PROGBITS,
				      cgccpp::SHF_ALLOC | cgccpp::SHF_EXECINSTR,
...
Target_powerpc<size, big_endian>::make_plt_entry(Symbol_table* symtab,
						 ...
						 Symbol* gsym)
{
  if (gsym->type() == cgccpp::STT_GNU_IFUNC
      && gsym->can_use_relative_reloc(false))
    {
      if (this->iplt_ == NULL)
	this->make_iplt_section(symtab, layout);
    ...
    Sized_relobj_file<size, big_endian>* object)
{
  if (this->tlsld_got_offset_ == -1U)
	...
	= this->got_section(symtab, layout);
      ...
      rela_dyn->add_local(object, 0, cgccpp::R_POWERPC_DTPMOD, got,
			  got_offset, 0);
    ...
    const Target_powerpc* target)
{
  ...
  switch (r_type)
    {
    case cgccpp::R_POWERPC_NONE:
    case cgccpp::R_POWERPC_GNU_VTINHERIT:
    case cgccpp::R_POWERPC_GNU_VTENTRY:
    case cgccpp::R_PPC64_TOC:
      // No symbol reference.
      break;

    case cgccpp::R_PPC64_ADDR64:
    case cgccpp::R_PPC64_UADDR64:
    case cgccpp::R_POWERPC_ADDR32:
    case cgccpp::R_POWERPC_UADDR32:
    case cgccpp::R_POWERPC_ADDR16:
    case cgccpp::R_POWERPC_UADDR16:
    case cgccpp::R_POWERPC_ADDR16_LO:
    case cgccpp::R_POWERPC_ADDR16_HI:
    case cgccpp::R_POWERPC_ADDR16_HA:
      ref = Symbol::ABSOLUTE_REF;
      break;

    case cgccpp::R_POWERPC_ADDR24:
    case cgccpp::R_POWERPC_ADDR14:
    case cgccpp::R_POWERPC_ADDR14_BRTAKEN:
    case cgccpp::R_POWERPC_ADDR14_BRNTAKEN:
      ref = Symbol::FUNCTION_CALL | Symbol::ABSOLUTE_REF;
      break;

    case cgccpp::R_PPC64_REL64:
    case cgccpp::R_POWERPC_REL32:
    case cgccpp::R_PPC_LOCAL24PC:
    case cgccpp::R_POWERPC_REL16:
    case cgccpp::R_POWERPC_REL16_LO:
    case cgccpp::R_POWERPC_REL16_HI:
    case cgccpp::R_POWERPC_REL16_HA:
      ref = Symbol::RELATIVE_REF;
      break;

    case cgccpp::R_POWERPC_REL24:
    case cgccpp::R_PPC_PLTREL24:
    case cgccpp::R_POWERPC_REL14:
    case cgccpp::R_POWERPC_REL14_BRTAKEN:
    case cgccpp::R_POWERPC_REL14_BRNTAKEN:
      ref = Symbol::FUNCTION_CALL | Symbol::RELATIVE_REF;
      break;

    case cgccpp::R_POWERPC_GOT16:
    case cgccpp::R_POWERPC_GOT16_LO:
    case cgccpp::R_POWERPC_GOT16_HI:
    case cgccpp::R_POWERPC_GOT16_HA:
    case cgccpp::R_PPC64_GOT16_DS:
    case cgccpp::R_PPC64_GOT16_LO_DS:
    case cgccpp::R_PPC64_TOC16:
    case cgccpp::R_PPC64_TOC16_LO:
    case cgccpp::R_PPC64_TOC16_HI:
    case cgccpp::R_PPC64_TOC16_HA:
    case cgccpp::R_PPC64_TOC16_DS:
    case cgccpp::R_PPC64_TOC16_LO_DS:
      // Absolute in GOT.
      ref = Symbol::ABSOLUTE_REF;
      break;

    case cgccpp::R_POWERPC_GOT_TPREL16:
    case cgccpp::R_POWERPC_TLS:
      ref = Symbol::TLS_REF;
      break;

    case cgccpp::R_POWERPC_COPY:
    case cgccpp::R_POWERPC_GLOB_DAT:
    case cgccpp::R_POWERPC_JMP_SLOT:
    case cgccpp::R_POWERPC_RELATIVE:
    case cgccpp::R_POWERPC_DTPMOD:
    default:
...
Target_powerpc<size, big_endian>::Scan::check_non_pic(Relobj* object,
						      unsigned int r_type)
{
  gold_assert(r_type != cgccpp::R_POWERPC_NONE);
  ...
  switch (r_type)
    ...
    case cgccpp::R_POWERPC_GLOB_DAT:
    case cgccpp::R_POWERPC_DTPMOD:
    case cgccpp::R_POWERPC_DTPREL:
    case cgccpp::R_POWERPC_TPREL:
    case cgccpp::R_POWERPC_JMP_SLOT:
    case cgccpp::R_POWERPC_COPY:
    case cgccpp::R_POWERPC_IRELATIVE:
    case cgccpp::R_POWERPC_ADDR32:
    case cgccpp::R_POWERPC_UADDR32:
    case cgccpp::R_POWERPC_ADDR24:
    case cgccpp::R_POWERPC_ADDR16:
    ...
    case cgccpp::R_POWERPC_REL32:
    case cgccpp::R_POWERPC_REL24:
    case cgccpp::R_POWERPC_TPREL16:
    case cgccpp::R_POWERPC_TPREL16_LO:
    case cgccpp::R_POWERPC_TPREL16_HI:
    case cgccpp::R_POWERPC_TPREL16_HA:
      return;
  ...
  if (size == 64)
	...
	case cgccpp::R_PPC64_ADDR64:
	case cgccpp::R_PPC64_UADDR64:
	case cgccpp::R_PPC64_JMP_IREL:
	case cgccpp::R_PPC64_ADDR16_DS:
	case cgccpp::R_PPC64_ADDR16_LO_DS:
	case cgccpp::R_PPC64_ADDR16_HIGH:
	case cgccpp::R_PPC64_ADDR16_HIGHA:
	case cgccpp::R_PPC64_ADDR16_HIGHER:
	case cgccpp::R_PPC64_ADDR16_HIGHEST:
	case cgccpp::R_PPC64_ADDR16_HIGHERA:
	case cgccpp::R_PPC64_ADDR16_HIGHESTA:
	case cgccpp::R_PPC64_REL64:
	case cgccpp::R_POWERPC_ADDR30:
	case cgccpp::R_PPC64_TPREL16_DS:
	case cgccpp::R_PPC64_TPREL16_LO_DS:
	case cgccpp::R_PPC64_TPREL16_HIGH:
	case cgccpp::R_PPC64_TPREL16_HIGHA:
	case cgccpp::R_PPC64_TPREL16_HIGHER:
	case cgccpp::R_PPC64_TPREL16_HIGHEST:
	case cgccpp::R_PPC64_TPREL16_HIGHERA:
	case cgccpp::R_PPC64_TPREL16_HIGHESTA:
	  return;
	...
	case cgccpp::R_POWERPC_DTPREL16:
	case cgccpp::R_POWERPC_DTPREL16_LO:
	case cgccpp::R_POWERPC_DTPREL16_HI:
	case cgccpp::R_POWERPC_DTPREL16_HA:
	  return;
...
Target_powerpc<size, big_endian>::Scan::local(
    ...
    unsigned int data_shndx,
    Output_section* output_section,
    const cgccpp::Rela<size, big_endian>& reloc,
    unsigned int r_type,
    const cgccpp::Sym<size, big_endian>& lsym,
    bool is_discarded)
{
  ...
  if ((size == 64 && r_type == cgccpp::R_PPC64_TLSGD)
      || (size == 32 && r_type == cgccpp::R_PPC_TLSGD))
    {
  ...
  else if ((size == 64 && r_type == cgccpp::R_PPC64_TLSLD)
	   || (size == 32 && r_type == cgccpp::R_PPC_TLSLD))
    {
      this->expect_tls_get_addr_call();
  ...
  if (is_discarded)
    {
	  ...
	  && r_type == cgccpp::R_PPC64_ADDR64)
	ppc_object->set_opd_discard(reloc.get_r_offset());
      return;
    }

  // A local STT_GNU_IFUNC symbol may require a PLT entry.
  bool is_ifunc = lsym.get_st_type() == cgccpp::STT_GNU_IFUNC;
  if (is_ifunc && this->reloc_needs_plt_for_ifunc(target, object, r_type, true))
    {
      unsigned int r_sym = cgccpp::cgc_r_sym<size>(reloc.get_r_info());
  ...
  switch (r_type)
	  ...
	  || (size == 64 && is_ifunc && target->abiversion() < 2))
	{
	  Reloc_section* rela_dyn = target->rela_dyn_section(symtab, layout,
							     is_ifunc);
	  if ((size == 32 && r_type == cgccpp::R_POWERPC_ADDR32)
	      || (size == 64 && r_type == cgccpp::R_PPC64_ADDR64))
	    {
	      unsigned int r_sym = cgccpp::cgc_r_sym<size>(reloc.get_r_info());
	      unsigned int dynrel = (is_ifunc ? cgccpp::R_POWERPC_IRELATIVE
				     : cgccpp::R_POWERPC_RELATIVE);
    ...
    case cgccpp::R_POWERPC_REL14_BRNTAKEN:
      if (!is_ifunc)
	target->push_branch(ppc_object, data_shndx, reloc.get_r_offset(),
			    r_type, cgccpp::cgc_r_sym<size>(reloc.get_r_info()),
			    reloc.get_r_addend());
      break;
    ...
    case cgccpp::R_POWERPC_REL16_HI:
    case cgccpp::R_POWERPC_REL16_HA:
    case cgccpp::R_POWERPC_SECTOFF:
    case cgccpp::R_POWERPC_SECTOFF_LO:
    case cgccpp::R_POWERPC_SECTOFF_HI:
    case cgccpp::R_POWERPC_SECTOFF_HA:
    case cgccpp::R_PPC64_SECTOFF_DS:
    case cgccpp::R_PPC64_SECTOFF_LO_DS:
    case cgccpp::R_POWERPC_TPREL16:
    case cgccpp::R_POWERPC_TPREL16_LO:
    case cgccpp::R_POWERPC_TPREL16_HI:
    case cgccpp::R_POWERPC_TPREL16_HA:
    ...
    case cgccpp::R_POWERPC_DTPREL16_HI:
    case cgccpp::R_POWERPC_DTPREL16_HA:
    case cgccpp::R_PPC64_DTPREL16_DS:
    case cgccpp::R_PPC64_DTPREL16_LO_DS:
    case cgccpp::R_PPC64_DTPREL16_HIGH:
    case cgccpp::R_PPC64_DTPREL16_HIGHA:
    case cgccpp::R_PPC64_DTPREL16_HIGHER:
    case cgccpp::R_PPC64_DTPREL16_HIGHERA:
    case cgccpp::R_PPC64_DTPREL16_HIGHEST:
    case cgccpp::R_PPC64_DTPREL16_HIGHESTA:
    case cgccpp::R_PPC64_TLSGD:
    case cgccpp::R_PPC64_TLSLD:
      break;
    ...
    case cgccpp::R_POWERPC_GOT_TLSGD16:
    case cgccpp::R_POWERPC_GOT_TLSGD16_LO:
    case cgccpp::R_POWERPC_GOT_TLSGD16_HI:
    case cgccpp::R_POWERPC_GOT_TLSGD16_HA:
      {
	const tls::Tls_optimization tls_type = target->optimize_tls_gd(true);
	if (tls_type == tls::TLSOPT_NONE)
	  {
	    ...
	    got->add_local_tls_pair(object, r_sym, GOT_TYPE_TLSGD,
				    rela_dyn, cgccpp::R_POWERPC_DTPMOD);
	  }
    ...
    case cgccpp::R_POWERPC_GOT_TLSLD16:
    case cgccpp::R_POWERPC_GOT_TLSLD16_LO:
    case cgccpp::R_POWERPC_GOT_TLSLD16_HI:
    case cgccpp::R_POWERPC_GOT_TLSLD16_HA:
      {
	const tls::Tls_optimization tls_type = target->optimize_tls_ld();
	if (tls_type == tls::TLSOPT_NONE)
    ...
    case cgccpp::R_POWERPC_GOT_DTPREL16:
    case cgccpp::R_POWERPC_GOT_DTPREL16_LO:
    case cgccpp::R_POWERPC_GOT_DTPREL16_HI:
    case cgccpp::R_POWERPC_GOT_DTPREL16_HA:
      {
	Output_data_got_powerpc<size, big_endian>* got
	  = target->got_section(symtab, layout);
	unsigned int r_sym = cgccpp::cgc_r_sym<size>(reloc.get_r_info());
    ...
    case cgccpp::R_POWERPC_GOT_TPREL16:
    case cgccpp::R_POWERPC_GOT_TPREL16_LO:
    case cgccpp::R_POWERPC_GOT_TPREL16_HI:
    case cgccpp::R_POWERPC_GOT_TPREL16_HA:
      {
    ...
    Symbol* gsym)
{
  ...
  bool is_ifunc = gsym->type() == cgccpp::STT_GNU_IFUNC;
	...
	if (gsym->needs_plt_entry())
	  {
		...
		target->push_branch(ppc_object, data_shndx,
				    ...
				    cgccpp::cgc_r_sym<size>(reloc.get_r_info()),
				    reloc.get_r_addend());
		target->make_plt_entry(symtab, layout, gsym);
	      }
	  }
	...
	if (gsym->needs_dynamic_reloc(Scan::get_reference_flags(r_type, target))
	    || (size == 64 && is_ifunc && target->abiversion() < 2))
	  {
		...
		target->copy_reloc(symtab, layout, object,
			...
			&& r_type == cgccpp::R_POWERPC_ADDR32)
		       || (size == 64
			   && r_type == cgccpp::R_PPC64_ADDR64
			   && target->abiversion() >= 2))
		      && gsym->can_use_relative_reloc(false)
	...
	if (gsym->final_value_is_known())
	...
	else if (!gsym->has_got_offset(GOT_TYPE_STANDARD))
	  {
		...
		rela_dyn->add_global_relative(gsym, dynrel, got, off, 0, false);
	      ...
	      {
		unsigned int dynrel = cgccpp::R_POWERPC_GLOB_DAT;
	...
	if (tls_type == tls::TLSOPT_NONE)
	  {
	    ...
	    got->add_global_pair_with_rel(gsym, GOT_TYPE_TLSGD, rela_dyn,
					  cgccpp::R_POWERPC_DTPMOD,
					  cgccpp::R_POWERPC_DTPREL);
	  }
	else if (tls_type == tls::TLSOPT_TO_IE)
	  {
		...
		if (gsym->is_undefined()
		...
		else
		  {
		    ...
		    unsigned int dynrel = cgccpp::R_POWERPC_TPREL;
    ...
    const unsigned char* plocal_symbols)
{
  ...
  gold::gc_process_relocs<size, big_endian, Powerpc, cgccpp::SHT_RELA, Scan,
    ...
    const unsigned char* plocal_symbols)
{
  ...
  gold::scan_relocs<size, big_endian, Powerpc, cgccpp::SHT_RELA, Scan>(
    symtab,
    layout,
    this,
    object,
    ...
    Symbol_table* symtab)
{
  if (parameters->doing_static_link())
    {
      // At least some versions of glibc cgc-init.o have a strong
      ...
      if (this->iplt_ != NULL)
	{
	  ...
	  symtab->define_in_output_data("__rela_iplt_start", NULL,
					...
					cgccpp::STT_NOTYPE, cgccpp::STB_GLOBAL,
					cgccpp::STV_HIDDEN, 0, false, true);
	  symtab->define_in_output_data("__rela_iplt_end", NULL,
					Symbol_table::PREDEFINED, rel, 0, 0,
					cgccpp::STT_NOTYPE, cgccpp::STB_GLOBAL,
					cgccpp::STV_HIDDEN, 0, true, true);
	}
      else
	{
	  symtab->define_as_constant("__rela_iplt_start", NULL,
				     ...
				     cgccpp::STT_NOTYPE, cgccpp::STB_GLOBAL,
				     cgccpp::STV_HIDDEN, 0, true, false);
	  ...
	  if (this->got_ != NULL)
	    {
	      ...
	      odyn->add_section_plus_offset(cgccpp::DT_PPC_GOT,
	  ...
	  if (this->glink_ != NULL)
	    {
	      ...
	      odyn->add_section_plus_offset(cgccpp::DT_PPC64_GLINK,
					    this->glink_,
...
Target_powerpc<size, big_endian>::Relocate::relocate(
    ...
    Output_section* os,
    size_t relnum,
    const cgccpp::Rela<size, big_endian>& rela,
    unsigned int r_type,
    const Sized_symbol<size>* gsym,
    const Symbol_value<size>* psymval,
    unsigned char* view,
    ...
    section_size_type view_size)
{
  ...
  typedef typename cgccpp::Swap<32, big_endian>::Valtype Insn;
  Powerpc_relobj<size, big_endian>* const object
    = static_cast<Powerpc_relobj<size, big_endian>*>(relinfo->object);
  Address value = 0;
  bool has_plt_value = false;
  unsigned int r_sym = cgccpp::cgc_r_sym<size>(rela.get_r_info());
  if ((gsym != NULL
  ...
  if (r_type == cgccpp::R_POWERPC_GOT16
      || r_type == cgccpp::R_POWERPC_GOT16_LO
      || r_type == cgccpp::R_POWERPC_GOT16_HI
      || r_type == cgccpp::R_POWERPC_GOT16_HA
      || r_type == cgccpp::R_PPC64_GOT16_DS
      || r_type == cgccpp::R_PPC64_GOT16_LO_DS)
    {
      if (gsym != NULL)
	{
	  ...
	  if (rela.get_r_offset() + 8 <= view_size)
	    {
	      ...
	      Valtype insn2 = cgccpp::Swap<32, big_endian>::readval(wv + 1);
	      if ((insn & 1) != 0
		  && (insn2 == nop
		      || insn2 == cror_15_15_15 || insn2 == cror_31_31_31))
		{
		  cgccpp::Swap<32, big_endian>::
  ...
  else if (r_type == cgccpp::R_POWERPC_GOT_TLSGD16
	   || r_type == cgccpp::R_POWERPC_GOT_TLSGD16_LO
	   || r_type == cgccpp::R_POWERPC_GOT_TLSGD16_HI
	   || r_type == cgccpp::R_POWERPC_GOT_TLSGD16_HA)
    {
	...
	{
	  if (r_type == cgccpp::R_POWERPC_GOT_TLSGD16
	      || r_type == cgccpp::R_POWERPC_GOT_TLSGD16_LO)
	    {
	      Insn* iview = reinterpret_cast<Insn*>(view - 2 * big_endian);
	      Insn insn = cgccpp::Swap<32, big_endian>::readval(iview);
	      insn &= (1 << 26) - (1 << 16); // extract rt,ra from addi
	      if (size == 32)
		insn |= 32 << 26; // lwz
	      else
		insn |= 58 << 26; // ld
	      cgccpp::Swap<32, big_endian>::writeval(iview, insn);
	    }
	  r_type += (cgccpp::R_POWERPC_GOT_TPREL16
		     - cgccpp::R_POWERPC_GOT_TLSGD16);
	}
      else if (tls_type == tls::TLSOPT_TO_LE)
	{
	  if (r_type == cgccpp::R_POWERPC_GOT_TLSGD16
		...
		insn = addis_3_2;
	      cgccpp::Swap<32, big_endian>::writeval(iview, insn);
	      r_type = cgccpp::R_POWERPC_TPREL16_HA;
	  ...
	  else
	    {
	      ...
	      Insn insn = nop;
	      cgccpp::Swap<32, big_endian>::writeval(iview, insn);
	      r_type = cgccpp::R_POWERPC_NONE;
	    }
	}
    }
  else if (r_type == cgccpp::R_POWERPC_GOT_TLSLD16
	   || r_type == cgccpp::R_POWERPC_GOT_TLSLD16_LO
	   || r_type == cgccpp::R_POWERPC_GOT_TLSLD16_HI
	   || r_type == cgccpp::R_POWERPC_GOT_TLSLD16_HA)
    {
      ...
      else
	{
	  ...
	  if (r_type == cgccpp::R_POWERPC_GOT_TLSLD16
	      || r_type == cgccpp::R_POWERPC_GOT_TLSLD16_LO)
	    {
	      Insn* iview = reinterpret_cast<Insn*>(view - 2 * big_endian);
	      Insn insn = addis_3_13;
  ...
  else if (r_type == cgccpp::R_POWERPC_GOT_DTPREL16
	   || r_type == cgccpp::R_POWERPC_GOT_DTPREL16_LO
	   || r_type == cgccpp::R_POWERPC_GOT_DTPREL16_HI
	   || r_type == cgccpp::R_POWERPC_GOT_DTPREL16_HA)
    {
  ...
  else if (r_type == cgccpp::R_POWERPC_GOT_TPREL16
	   || r_type == cgccpp::R_POWERPC_GOT_TPREL16_LO
	   || r_type == cgccpp::R_POWERPC_GOT_TPREL16_HI
	   || r_type == cgccpp::R_POWERPC_GOT_TPREL16_HA)
    {
	...
	{
	  gold_assert(tls_type == tls::TLSOPT_TO_LE);
	  if (r_type == cgccpp::R_POWERPC_GOT_TPREL16
	      || r_type == cgccpp::R_POWERPC_GOT_TPREL16_LO)
	    {
	      Insn* iview = reinterpret_cast<Insn*>(view - 2 * big_endian);
	      Insn insn = cgccpp::Swap<32, big_endian>::readval(iview);
  ...
  else if ((size == 64 && r_type == cgccpp::R_PPC64_TLSGD)
	   || (size == 32 && r_type == cgccpp::R_PPC_TLSGD))
    {
      ...
      if (tls_type != tls::TLSOPT_NONE)
	{
	  if (tls_type == tls::TLSOPT_TO_IE)
	  ...
	  else
	    {
	      ...
	      Insn insn = addi_3_3;
	      cgccpp::Swap<32, big_endian>::writeval(iview, insn);
	      r_type = cgccpp::R_POWERPC_TPREL16_LO;
	      view += 2 * big_endian;
	      value = psymval->value(object, rela.get_r_addend());
	    }
	  this->skip_next_tls_get_addr_call();
  ...
  else if (r_type == cgccpp::R_POWERPC_TLS)
    {
  ...
  else if (!has_plt_value)
    {
      Address addend = 0;
      unsigned int dest_shndx;
      if (r_type != cgccpp::R_PPC_PLTREL24)
      ...
      if (size == 64 && is_branch_reloc(r_type))
	{
      ...
      if (r_type == cgccpp::R_POWERPC_REL24
	  || r_type == cgccpp::R_PPC_PLTREL24
	  || r_type == cgccpp::R_PPC_LOCAL24PC)
	max_branch_offset = 1 << 25;
      else if (r_type == cgccpp::R_POWERPC_REL14
	       || r_type == cgccpp::R_POWERPC_REL14_BRTAKEN
	       || r_type == cgccpp::R_POWERPC_REL14_BRNTAKEN)
	max_branch_offset = 1 << 15;
  ...
  if (size == 64)
	...
	case cgccpp::R_PPC64_TOC16_HA:
	  if (parameters->options().toc_optimize())
		...
		{
		  cgccpp::Swap<32, big_endian>::writeval(iview, nop);
		  return true;
		}
	    }
	  break;
  ...
  switch (r_type)
    ...
    case cgccpp::R_POWERPC_GOT16_HI:
    case cgccpp::R_POWERPC_GOT16_HA:
    case cgccpp::R_POWERPC_PLT16_HI:
    case cgccpp::R_POWERPC_PLT16_HA:
    case cgccpp::R_POWERPC_SECTOFF_HI:
    case cgccpp::R_POWERPC_SECTOFF_HA:
    case cgccpp::R_PPC64_TOC16_HI:
    case cgccpp::R_PPC64_TOC16_HA:
    case cgccpp::R_PPC64_PLTGOT16_HI:
    case cgccpp::R_PPC64_PLTGOT16_HA:
    case cgccpp::R_POWERPC_TPREL16_HI:
    case cgccpp::R_POWERPC_TPREL16_HA:
    case cgccpp::R_POWERPC_DTPREL16_HI:
    case cgccpp::R_POWERPC_DTPREL16_HA:
  ...
  switch (r_type)
    ...
    case cgccpp::R_PPC_EMB_SDA2I16:
    case cgccpp::R_PPC_EMB_SDA2REL:
      if (size == 32)
	goto unsupp;
      // R_PPC64_TLSGD, R_PPC64_TLSLD
      break;

    case cgccpp::R_POWERPC_PLT32:
    case cgccpp::R_POWERPC_PLTREL32:
    case cgccpp::R_POWERPC_PLT16_LO:
    case cgccpp::R_POWERPC_PLT16_HI:
    case cgccpp::R_POWERPC_PLT16_HA:
    case cgccpp::R_PPC_SDAREL16:
    case cgccpp::R_POWERPC_ADDR30:
    case cgccpp::R_PPC64_PLT64:
    case cgccpp::R_PPC64_PLTREL64:
    case cgccpp::R_PPC64_PLTGOT16:
    case cgccpp::R_PPC64_PLTGOT16_LO:
    case cgccpp::R_PPC64_PLTGOT16_HI:
    case cgccpp::R_PPC64_PLTGOT16_HA:
    case cgccpp::R_PPC64_PLT16_LO_DS:
    case cgccpp::R_PPC64_PLTGOT16_DS:
    case cgccpp::R_PPC64_PLTGOT16_LO_DS:
    case cgccpp::R_PPC_EMB_RELSDA:
    case cgccpp::R_PPC_TOC16:
    default:
    unsupp:
      gold_error_at_location(relinfo, relnum, rela.get_r_offset(),
    ...
    const Reloc_symbol_changes* reloc_symbol_changes)
{
  ...
  gold_assert(sh_type == cgccpp::SHT_RELA);

  gold::relocate_section<size, big_endian, Powerpc, cgccpp::SHT_RELA,
    ...
    Relocatable_relocs* rr)
{
  ...
  gold::scan_relocatable_relocs<size, big_endian, cgccpp::SHT_RELA,
...
Target_powerpc<size, big_endian>::relocate_relocs(
    ...
    size_t reloc_count,
    Output_section* output_section,
    typename cgccpp::Cgc_types<size>::Cgc_Off offset_in_output_section,
    ...
    section_size_type reloc_view_size)
{
  ...
  typedef typename Reloc_types<cgccpp::SHT_RELA, size, big_endian>::Reloc
    Reltype;
  typedef typename Reloc_types<cgccpp::SHT_RELA, size, big_endian>::Reloc_write
    Reltype_write;
  const int reloc_size
    = Reloc_types<cgccpp::SHT_RELA, size, big_endian>::reloc_size;
  ...
  for (size_t i = 0; i < reloc_count; ++i, prelocs += reloc_size)
	...
	continue;
      ...
      typename cgccpp::Cgc_types<size>::Cgc_WXword r_info = reloc.get_r_info();
      unsigned int r_sym = cgccpp::cgc_r_sym<size>(r_info);
      unsigned int r_type = cgccpp::cgc_r_type<size>(r_info);
      const unsigned int orig_r_sym = r_sym;
      typename cgccpp::Cgc_types<size>::Cgc_Swxword addend
	= reloc.get_r_addend();
      ...
      if (!parameters->options().relocatable())
	{
      ...
      reloc_write.put_r_info(cgccpp::cgc_r_info<size>(r_sym, r_type));
...
public:
  Target_selector_powerpc()
    : Target_selector(size == 64 ? cgccpp::EM_PPC64 : cgccpp::EM_PPC,
		      size, big_endian,
		      (size == 64
		       ? (big_endian ? "cgc64-powerpc" : "cgc64-powerpcle")
		       : (big_endian ? "cgc32-powerpc" : "cgc32-powerpcle")),
		      (size == 64
		       ? (big_endian ? "cgc64ppc" : "cgc64lppc")
		       : (big_endian ? "cgc32ppc" : "cgc32lppc")))
  { }
