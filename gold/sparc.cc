...
{
 public:
  typedef Output_data_reloc<cgccpp::SHT_RELA, true, size, big_endian> Reloc_section;

  Target_sparc()
    : Sized_target<size, big_endian>(&sparc_info),
      got_(NULL), plt_(NULL), rela_dyn_(NULL), rela_ifunc_(NULL),
      copy_relocs_(cgccpp::R_SPARC_COPY),
      got_mod_index_offset_(-1U), tls_get_addr_sym_(NULL),
      cgc_machine_(sparc_info.machine_code), cgc_flags_(0),
      cgc_flags_set_(false)
  {
  }
  ...
  relocate_section(const Relocate_info<size, big_endian>*,
		   ...
		   bool needs_special_offset_handling,
		   unsigned char* view,
		   typename cgccpp::Cgc_types<size>::Cgc_Addr view_address,
  ...
  do_is_defined_by_abi(const Symbol* sym) const
  {
    ...
    if (sym->type() == cgccpp::STT_SPARC_REGISTER)
      return 1;
 ...
 protected:
  ...
  do_make_cgc_object(const std::string&, Input_file*, off_t,
		     const cgccpp::Ehdr<size, big_endian>& ehdr);
 ...
 private:
  ...
  class Relocate
  {
   ...
   private:
    ...
    relocate_tls(const Relocate_info<size, big_endian>*, Target_sparc* target,
		 size_t relnum, const cgccpp::Rela<size, big_endian>&,
		 unsigned int r_type, const Sized_symbol<size>*,
		 const Symbol_value<size>*,
		 unsigned char*,
		 typename cgccpp::Cgc_types<size>::Cgc_Addr,
  ...
  // Accumulated cgc machine type
  cgccpp::Cgc_Half cgc_machine_;
  // Accumulated cgc header flags
  cgccpp::Cgc_Word cgc_flags_;
  // Whether cgc_flags_ has been set for the first time yet
  bool cgc_flags_set_;
};
...
Target::Target_info Target_sparc<64, true>::sparc_info =
{
  64,			// size
  true,			// is_big_endian
  cgccpp::EM_SPARCV9,	// machine_code
  false,		// has_make_symbol
  false,		// has_resolve
  false,		// has_code_fill
  true,			// is_default_stack_executable
...
private:
  ...
  rela(unsigned char* view,
       ...
       typename cgccpp::Cgc_types<valsize>::Cgc_Addr dst_mask,
       typename cgccpp::Swap<size, big_endian>::Valtype value,
       typename cgccpp::Swap<size, big_endian>::Valtype addend)
  {
  ...
  rela(unsigned char* view,
       ...
       typename cgccpp::Swap<valsize, big_endian>::Valtype addend)
  {
    typedef typename cgccpp::Swap<valsize, big_endian>::Valtype Valtype;
    Valtype* wv = reinterpret_cast<Valtype*>(view);
    Valtype val = cgccpp::Swap<valsize, big_endian>::readval(wv);
  ...
  rela_ua(unsigned char* view,
	  unsigned int right_shift, cgccpp::Cgc_Xword dst_mask,
	  const Sized_relobj_file<size, big_endian>* object,
	  const Symbol_value<size>* psymval,
	  typename cgccpp::Swap<size, big_endian>::Valtype addend)
  {
    typedef typename cgccpp::Swap_unaligned<valsize,
	    big_endian>::Valtype Valtype;
    unsigned char* wv = view;
    Valtype val = cgccpp::Swap_unaligned<valsize, big_endian>::readval(wv);
    Valtype reloc = (psymval->value(object, addend) >> right_shift);

    val &= ~dst_mask;
    reloc &= dst_mask;

    cgccpp::Swap_unaligned<valsize, big_endian>::writeval(wv, val | reloc);
  }
  ...
  pcrela(unsigned char* view,
	 ...
	 const Symbol_value<size>* psymval,
	 typename cgccpp::Swap<size, big_endian>::Valtype addend,
	 typename cgccpp::Cgc_types<size>::Cgc_Addr address)
  {
    typedef typename cgccpp::Swap<valsize, big_endian>::Valtype Valtype;
    Valtype* wv = reinterpret_cast<Valtype*>(view);
    Valtype val = cgccpp::Swap<valsize, big_endian>::readval(wv);
		   ...
		   typename cgccpp::Cgc_types<size>::Cgc_Addr address)
  {
    ...
    cgccpp::Swap_unaligned<valsize, big_endian>::writeval(wv, reloc);
  }
...
public:
  ...
  wdisp30(unsigned char* view,
	   const Sized_relobj_file<size, big_endian>* object,
	   const Symbol_value<size>* psymval,
	   typename cgccpp::Cgc_types<size>::Cgc_Addr addend,
	   typename cgccpp::Cgc_types<size>::Cgc_Addr address)
  {
  ...
  wdisp16(unsigned char* view,
	  ...
	  typename cgccpp::Cgc_types<size>::Cgc_Addr address)
  {
    typedef typename cgccpp::Swap<32, true>::Valtype Valtype;
    Valtype* wv = reinterpret_cast<Valtype*>(view);
    Valtype val = cgccpp::Swap<32, true>::readval(wv);
    Valtype reloc = ((psymval->value(object, addend) - address)
		     >> 2);
    ...
    cgccpp::Swap<32, true>::writeval(wv, val | reloc);
  }
  ...
  olo10(unsigned char* view,
	...
	const Symbol_value<size>* psymval,
	typename cgccpp::Cgc_types<size>::Cgc_Addr addend,
	typename cgccpp::Cgc_types<size>::Cgc_Addr addend2)
  {
    typedef typename cgccpp::Swap<32, true>::Valtype Valtype;
    Valtype* wv = reinterpret_cast<Valtype*>(view);
    Valtype val = cgccpp::Swap<32, true>::readval(wv);
  ...
  ua64(unsigned char* view,
       ...
       typename cgccpp::Cgc_types<size>::Cgc_Addr addend)
  {
    This::template rela_ua<64>(view, 0, ~(cgccpp::Cgc_Xword) 0,
  ...
  if (this->rela_ifunc_ == NULL)
    {
      ...
      layout->add_output_section_data(".rela.dyn", cgccpp::SHT_RELA,
				      cgccpp::SHF_ALLOC, this->rela_ifunc_,
				      ORDER_DYNAMIC_RELOCS, false);
						   ...
						   Symbol* gsym)
{
  ...
  if (gsym->type() == cgccpp::STT_GNU_IFUNC
  ...
  else
    {
      ...
      this->rel_->add_global(gsym, cgccpp::R_SPARC_JMP_SLOT, this,
			     plt_offset, 0);
    }
...
Output_data_plt_sparc<size, big_endian>::emit_pending_ifunc_relocs()
{
  ...
  for (typename std::vector<Global_ifunc>::const_iterator p =
       ...
       ++p)
    {
      ...
      p->rel->add_symbolless_global_addend(p->gsym, cgccpp::R_SPARC_JMP_IREL,
					   this, plt_offset, 0);
    }
  ...
  if (this->ifunc_rel_ == NULL)
    {
      ...
      layout->add_output_section_data(".rela.plt", cgccpp::SHT_RELA,
				      cgccpp::SHF_ALLOC, this->ifunc_rel_,
				      ORDER_DYNAMIC_PLT_RELOCS, false);
...
Output_data_plt_sparc<size, big_endian>::do_write(Output_file* of)
{
  ...
  if (size == 64)
	...
	{
	  cgccpp::Swap<32, true>::writeval(pov + 0x00,
					   sparc_sethi_g1 + plt_offset);
	  cgccpp::Swap<32, true>::writeval(pov + 0x04,
					   sparc_branch_always_pt +
					   (((base_plt_entry_size -
					      (plt_offset + 4)) >> 2) &
					    0x7ffff));
	  cgccpp::Swap<32, true>::writeval(pov + 0x08, sparc_nop);
	  cgccpp::Swap<32, true>::writeval(pov + 0x0c, sparc_nop);
	  cgccpp::Swap<32, true>::writeval(pov + 0x10, sparc_nop);
	  cgccpp::Swap<32, true>::writeval(pov + 0x14, sparc_nop);
	  cgccpp::Swap<32, true>::writeval(pov + 0x18, sparc_nop);
	  cgccpp::Swap<32, true>::writeval(pov + 0x1c, sparc_nop);
      ...
      if (count > 32768)
	{
	  ...
	  for (unsigned int i = 0; i < blks; ++i)
	      ...
	      for (unsigned int j = 0; j < plt_entries_per_block; ++j)
		{
		  ...
		  cgccpp::Swap<32, true>::writeval(pov + 0x04,
						   sparc_call_plus_8);
		  cgccpp::Swap<32, true>::writeval(pov + 0x08,
						   sparc_nop);
		  cgccpp::Swap<32, true>::writeval(pov + 0x0c,
						   sparc_ldx_o7_imm_g1 +
						   (data_off & 0x1fff));
		  cgccpp::Swap<32, true>::writeval(pov + 0x10,
						   sparc_jmpl_o7_g1_g1);
		  cgccpp::Swap<32, true>::writeval(pov + 0x14,
						   sparc_mov_g5_o7);

		  cgccpp::Swap<64, big_endian>::writeval(
				pov + 0x4 + data_off,
				(cgccpp::Cgc_Xword) (oview - (pov + 0x04)));
      ...
      for (unsigned int i = 0; i < count; ++i)
	{
      ...
      cgccpp::Swap<32, true>::writeval(pov, sparc_nop);
      pov += 4;
    }
  ...
  if (this->got_mod_index_offset_ == -1U)
    {
      ...
      rela_dyn->add_local(object, 0,
			  (size == 64 ?
			   cgccpp::R_SPARC_TLS_DTPMOD64 :
			   cgccpp::R_SPARC_TLS_DTPMOD32), got,
			  got_offset, 0);
      got->add_constant(0);
...
optimize_tls_reloc(bool is_final, int r_type)
{
  ...
  switch (r_type)
    {
    case cgccpp::R_SPARC_TLS_GD_HI22: // Global-dynamic
    case cgccpp::R_SPARC_TLS_GD_LO10:
    case cgccpp::R_SPARC_TLS_GD_ADD:
    case cgccpp::R_SPARC_TLS_GD_CALL:
    ...
    case cgccpp::R_SPARC_TLS_LDM_HI22:	// Local-dynamic
    case cgccpp::R_SPARC_TLS_LDM_LO10:
    case cgccpp::R_SPARC_TLS_LDM_ADD:
    case cgccpp::R_SPARC_TLS_LDM_CALL:
      // This is Local-Dynamic, which refers to a local symbol in the
      // dynamic TLS block.  Since we know that we generating an
      // executable, we can switch to Local-Exec.
      return tls::TLSOPT_TO_LE;

    case cgccpp::R_SPARC_TLS_LDO_HIX22:	// Alternate local-dynamic
    case cgccpp::R_SPARC_TLS_LDO_LOX10:
    case cgccpp::R_SPARC_TLS_LDO_ADD:
      // Another type of Local-Dynamic relocation.
      return tls::TLSOPT_TO_LE;

    case cgccpp::R_SPARC_TLS_IE_HI22:	// Initial-exec
    case cgccpp::R_SPARC_TLS_IE_LO10:
    case cgccpp::R_SPARC_TLS_IE_LD:
    case cgccpp::R_SPARC_TLS_IE_LDX:
    case cgccpp::R_SPARC_TLS_IE_ADD:
    ...
    case cgccpp::R_SPARC_TLS_LE_HIX22:	// Local-exec
    case cgccpp::R_SPARC_TLS_LE_LOX10:
...
Target_sparc<size, big_endian>::Scan::get_reference_flags(unsigned int r_type)
{
  ...
  switch (r_type)
    {
    case cgccpp::R_SPARC_NONE:
    case cgccpp::R_SPARC_REGISTER:
    case cgccpp::R_SPARC_GNU_VTINHERIT:
    case cgccpp::R_SPARC_GNU_VTENTRY:
      // No symbol reference.
      return 0;

    case cgccpp::R_SPARC_UA64:
    case cgccpp::R_SPARC_64:
    case cgccpp::R_SPARC_HIX22:
    case cgccpp::R_SPARC_LOX10:
    case cgccpp::R_SPARC_H34:
    case cgccpp::R_SPARC_H44:
    case cgccpp::R_SPARC_M44:
    case cgccpp::R_SPARC_L44:
    case cgccpp::R_SPARC_HH22:
    case cgccpp::R_SPARC_HM10:
    case cgccpp::R_SPARC_LM22:
    case cgccpp::R_SPARC_HI22:
    case cgccpp::R_SPARC_LO10:
    case cgccpp::R_SPARC_OLO10:
    case cgccpp::R_SPARC_UA32:
    case cgccpp::R_SPARC_32:
    case cgccpp::R_SPARC_UA16:
    case cgccpp::R_SPARC_16:
    case cgccpp::R_SPARC_11:
    case cgccpp::R_SPARC_10:
    case cgccpp::R_SPARC_8:
    case cgccpp::R_SPARC_7:
    case cgccpp::R_SPARC_6:
    case cgccpp::R_SPARC_5:
      return Symbol::ABSOLUTE_REF;

    case cgccpp::R_SPARC_DISP8:
    case cgccpp::R_SPARC_DISP16:
    case cgccpp::R_SPARC_DISP32:
    case cgccpp::R_SPARC_DISP64:
    case cgccpp::R_SPARC_PC_HH22:
    case cgccpp::R_SPARC_PC_HM10:
    case cgccpp::R_SPARC_PC_LM22:
    case cgccpp::R_SPARC_PC10:
    case cgccpp::R_SPARC_PC22:
    case cgccpp::R_SPARC_WDISP30:
    case cgccpp::R_SPARC_WDISP22:
    case cgccpp::R_SPARC_WDISP19:
    case cgccpp::R_SPARC_WDISP16:
    case cgccpp::R_SPARC_WDISP10:
      return Symbol::RELATIVE_REF;

    case cgccpp::R_SPARC_PLT64:
    case cgccpp::R_SPARC_PLT32:
    case cgccpp::R_SPARC_HIPLT22:
    case cgccpp::R_SPARC_LOPLT10:
    case cgccpp::R_SPARC_PCPLT10:
      return Symbol::FUNCTION_CALL | Symbol::ABSOLUTE_REF;

    case cgccpp::R_SPARC_PCPLT32:
    case cgccpp::R_SPARC_PCPLT22:
    case cgccpp::R_SPARC_WPLT30:
      return Symbol::FUNCTION_CALL | Symbol::RELATIVE_REF;

    case cgccpp::R_SPARC_GOTDATA_OP:
    case cgccpp::R_SPARC_GOTDATA_OP_HIX22:
    case cgccpp::R_SPARC_GOTDATA_OP_LOX10:
    case cgccpp::R_SPARC_GOT10:
    case cgccpp::R_SPARC_GOT13:
    case cgccpp::R_SPARC_GOT22:
      // Absolute in GOT.
      return Symbol::ABSOLUTE_REF;
    ...
    case cgccpp::R_SPARC_TLS_LDO_LOX10:
    case cgccpp::R_SPARC_TLS_LDO_ADD:
    case cgccpp::R_SPARC_TLS_LE_HIX22:
    case cgccpp::R_SPARC_TLS_LE_LOX10:
    case cgccpp::R_SPARC_TLS_IE_HI22:	// Initial-exec
    case cgccpp::R_SPARC_TLS_IE_LO10:
    case cgccpp::R_SPARC_TLS_IE_LD:
    ...
    case cgccpp::R_SPARC_COPY:
    case cgccpp::R_SPARC_GLOB_DAT:
    case cgccpp::R_SPARC_JMP_SLOT:
    case cgccpp::R_SPARC_JMP_IREL:
    case cgccpp::R_SPARC_RELATIVE:
    case cgccpp::R_SPARC_IRELATIVE:
    case cgccpp::R_SPARC_TLS_DTPMOD64:
    case cgccpp::R_SPARC_TLS_DTPMOD32:
    case cgccpp::R_SPARC_TLS_DTPOFF64:
    case cgccpp::R_SPARC_TLS_DTPOFF32:
    case cgccpp::R_SPARC_TLS_TPOFF64:
    case cgccpp::R_SPARC_TLS_TPOFF32:
    default:
...
{
  gold_assert(r_type != cgccpp::R_SPARC_NONE);
			...
			bool is_discarded)
{
  ...
  switch (r_type)
      ...
      if (parameters->options().output_is_position_independent())
	{
	  ...
	  unsigned int r_sym = cgccpp::cgc_r_sym<size>(reloc.get_r_info());
	  rela_dyn->add_local_relative(object, r_sym, cgccpp::R_SPARC_RELATIVE,
	...
	r_sym = cgccpp::cgc_r_sym<size>(reloc.get_r_info());
	...
	switch (r_type)
	  ...
	  case cgccpp::R_SPARC_TLS_GD_CALL:
		...
		if (!is_ordinary)
		  ...
		  got->add_local_pair_with_rel(object, r_sym,
					       ...
					       (size == 64
						? cgccpp::R_SPARC_TLS_DTPMOD64
						: cgccpp::R_SPARC_TLS_DTPMOD32));
		if (r_type == cgccpp::R_SPARC_TLS_GD_CALL)
	  ...
	  case cgccpp::R_SPARC_TLS_LDM_CALL:
		...
		if (r_type == cgccpp::R_SPARC_TLS_LDM_CALL)
		  generate_tls_call(symtab, layout, target);
	      }
	    else if (optimized_type != tls::TLSOPT_TO_LE)
	      unsupported_reloc_local(object, r_type);
		...
		if (!object->local_has_got_offset(r_sym, GOT_TYPE_TLS_OFFSET))
		  {
		    ...
		    rela_dyn->add_symbolless_local_addend(object, r_sym,
							  (size == 64 ?
							   cgccpp::R_SPARC_TLS_TPOFF64 :
							   cgccpp::R_SPARC_TLS_TPOFF32),
							  got, off, 0);
		  }
	      }
	    else if (optimized_type != tls::TLSOPT_TO_LE)
	...
	if (gsym->needs_dynamic_reloc(Scan::get_reference_flags(r_type)))
	  {
	    ...
	    switch (r_type)
	      ...
	      case cgccpp::R_SPARC_16:
		if (r_off & 0x1)
		  orig_r_type = r_type = cgccpp::R_SPARC_UA16;
		break;
	      case cgccpp::R_SPARC_32:
		if (r_off & 0x3)
		  orig_r_type = r_type = cgccpp::R_SPARC_UA32;
		break;
	      case cgccpp::R_SPARC_64:
		if (r_off & 0x7)
		  orig_r_type = r_type = cgccpp::R_SPARC_UA64;
		break;
	      case cgccpp::R_SPARC_UA16:
		if (!(r_off & 0x1))
		  orig_r_type = r_type = cgccpp::R_SPARC_16;
		break;
	      case cgccpp::R_SPARC_UA32:
		if (!(r_off & 0x3))
		  orig_r_type = r_type = cgccpp::R_SPARC_32;
		break;
	      case cgccpp::R_SPARC_UA64:
		if (!(r_off & 0x7))
		  orig_r_type = r_type = cgccpp::R_SPARC_64;
		break;
	      }
	    ...
	    else if (((size == 64 && r_type == cgccpp::R_SPARC_64)
		      || (size == 32 && r_type == cgccpp::R_SPARC_32))
		     && gsym->type() == cgccpp::STT_GNU_IFUNC
		     && gsym->can_use_relative_reloc(false)
		     && !gsym->is_from_dynobj()
		     && !gsym->is_undefined()
		     && !gsym->is_preemptible())
		...
		unsigned int r_type = cgccpp::R_SPARC_IRELATIVE;
	    ...
	    else if ((r_type == cgccpp::R_SPARC_32
		      || r_type == cgccpp::R_SPARC_64)
		     && gsym->can_use_relative_reloc(false))
	      {
		Reloc_section* rela_dyn = target->rela_dyn_section(layout);
		rela_dyn->add_global_relative(gsym, cgccpp::R_SPARC_RELATIVE,
					      output_section, object,
					      data_shndx, reloc.get_r_offset(),
					      reloc.get_r_addend(), is_ifunc);
	      }
	...
	if (gsym->final_value_is_known())
	...
	else
	  {
		...
		|| (gsym->type() == cgccpp::STT_GNU_IFUNC
	      ...
	      {
		unsigned int r_type = cgccpp::R_SPARC_GLOB_DAT;
	  ...
	  case cgccpp::R_SPARC_TLS_GD_CALL:
		...
		got->add_global_pair_with_rel(gsym, GOT_TYPE_TLS_PAIR,
					      ...
					      (size == 64
					       ...
					       : cgccpp::R_SPARC_TLS_DTPMOD32),
					      (size == 64
					       ? cgccpp::R_SPARC_TLS_DTPOFF64
					       : cgccpp::R_SPARC_TLS_DTPOFF32));
			...
			const unsigned char* plocal_symbols)
{
  ...
  gold::gc_process_relocs<size, big_endian, Sparc, cgccpp::SHT_RELA, Scan,
			...
			const unsigned char* plocal_symbols)
{
  ...
  gold::scan_relocs<size, big_endian, Sparc, cgccpp::SHT_RELA, Scan>(
    symtab,
    layout,
    this,
    object,
			...
			section_size_type view_size)
{
  ...
  if (this->ignore_gd_add_)
    {
      if (r_type != cgccpp::R_SPARC_TLS_GD_ADD)
  ...
  const cgccpp::Cgc_Xword addend = rela.get_r_addend();
  ...
  switch (r_type)
    ...
    case cgccpp::R_SPARC_22:
      Reloc::rela32_22(view, object, psymval, addend);
      break;

    case cgccpp::R_SPARC_13:
    ...
    case cgccpp::R_SPARC_GOTDATA_OP:
      if (gdop_valid)
	{
	  typedef typename cgccpp::Swap<32, true>::Valtype Insntype;
	  Insntype* wv = reinterpret_cast<Insntype*>(view);
	  Insntype val;

	  // {ld,ldx} [%rs1 + %rs2], %rd --> add %rs1, %rs2, %rd
	  val = cgccpp::Swap<32, true>::readval(wv);
	  val = 0x80000000 | (val & 0x3e07c01f);
	  cgccpp::Swap<32, true>::writeval(wv, val);
	}
      break;
    ...
    case cgccpp::R_SPARC_TLS_GD_HI22:
    case cgccpp::R_SPARC_TLS_GD_LO10:
    case cgccpp::R_SPARC_TLS_GD_ADD:
    case cgccpp::R_SPARC_TLS_GD_CALL:
    case cgccpp::R_SPARC_TLS_LDM_HI22:
    case cgccpp::R_SPARC_TLS_LDM_LO10:
    case cgccpp::R_SPARC_TLS_LDM_ADD:
    case cgccpp::R_SPARC_TLS_LDM_CALL:
    case cgccpp::R_SPARC_TLS_LDO_HIX22:
    case cgccpp::R_SPARC_TLS_LDO_LOX10:
    case cgccpp::R_SPARC_TLS_LDO_ADD:
    case cgccpp::R_SPARC_TLS_IE_HI22:
    case cgccpp::R_SPARC_TLS_IE_LO10:
    case cgccpp::R_SPARC_TLS_IE_LD:
    case cgccpp::R_SPARC_TLS_IE_LDX:
    case cgccpp::R_SPARC_TLS_IE_ADD:
			...
			section_size_type)
{
  ...
  const cgccpp::Cgc_Xword addend = rela.get_r_addend();
  typename cgccpp::Cgc_types<size>::Cgc_Addr value = psymval->value(object, 0);
  ...
  switch (r_type)
      ...
      if (optimized_type == tls::TLSOPT_TO_LE)
	{
	  ...
	  switch (r_type)
	    ...
	    case cgccpp::R_SPARC_TLS_GD_CALL:
	      ...
	      cgccpp::Swap<32, true>::writeval(wv, sparc_nop);
	      break;
	    }
	  break;
	}
      else
	{
	  ...
	  if (optimized_type == tls::TLSOPT_TO_IE)
		...
		case cgccpp::R_SPARC_TLS_GD_CALL:
		  ...
		  // equal to %o0
		  val = cgccpp::Swap<32, true>::readval(wv + 1);
		  ...
		  cgccpp::Swap<32, true>::writeval(wv, 0x9001c008);
		  break;
		}
	      break;
	    }
      ...
      if (optimized_type == tls::TLSOPT_TO_LE)
	{
	  ...
	  switch (r_type)
	    ...
	    case cgccpp::R_SPARC_TLS_LDM_CALL:
	      cgccpp::Swap<32, true>::writeval(wv, sparc_mov_g0_o0);
	      break;
	    }
	  break;
	}
	...
	{
	  Insntype* wv = reinterpret_cast<Insntype*>(view);
	  Insntype val = cgccpp::Swap<32, true>::readval(wv);
    ...
    section_size_type view_size)
{
  ...
  // object or a 32-bit object with CGC machine type EF_SPARC32PLUS,
  ...
  call_insn = cgccpp::Swap<32, true>::readval(wv);
  delay_insn = cgccpp::Swap<32, true>::readval(wv + 1);
  ...
  if ((size == 64 || target->cgc_machine_ == cgccpp::EM_SPARC32PLUS)
      && ((off & 0x3c0000) == 0
  ...
  cgccpp::Swap<32, true>::writeval(wv, call_insn);
  ...
  if (op3 == 0x02
	...
	return;
      ...
      set_insn = cgccpp::Swap<32, true>::readval(wv - 1);
	...
	return;
      ...
      cgccpp::Swap<32, true>::writeval(wv + 1, sparc_nop);
    }
}
			...
			const Reloc_symbol_changes* reloc_symbol_changes)
{
  ...
  gold::relocate_section<size, big_endian, Sparc, cgccpp::SHT_RELA,
			...
			Relocatable_relocs* rr)
{
  ...
  typedef gold::Default_scan_relocatable_relocs<cgccpp::SHT_RELA,
    ...
    section_size_type reloc_view_size)
{
  ...
  gold::relocate_relocs<size, big_endian, cgccpp::SHT_RELA>(
    relinfo,
    prelocs,
    reloc_count,
    output_section,
...
// of the CGC headers.  Hence we need to have our own CGC object creation.

template<int size, bool big_endian>
Object*
Target_sparc<size, big_endian>::do_make_cgc_object(
    const std::string& name,
    Input_file* input_file,
    off_t offset, const cgccpp::Ehdr<size, big_endian>& ehdr)
{
  cgccpp::Cgc_Half machine = ehdr.get_e_machine();
  cgccpp::Cgc_Word flags = ehdr.get_e_flags();
  cgccpp::Cgc_Word omm, mm;

  switch (machine)
    {
    case cgccpp::EM_SPARC32PLUS:
      this->cgc_machine_ = cgccpp::EM_SPARC32PLUS;
      break;

    case cgccpp::EM_SPARC:
    case cgccpp::EM_SPARCV9:
      break;
  ...
  if (!this->cgc_flags_set_)
    {
      this->cgc_flags_ = flags;
      this->cgc_flags_set_ = true;
    }
  else
    {
      // Accumulate cpu feature bits.
      this->cgc_flags_ |= (flags & (cgccpp::EF_SPARC_32PLUS
				    | cgccpp::EF_SPARC_SUN_US1
				    | cgccpp::EF_SPARC_HAL_R1
				    | cgccpp::EF_SPARC_SUN_US3));

      // Bump the memory model setting to the most restrictive
      // one we encounter.
      omm = (this->cgc_flags_ & cgccpp::EF_SPARCV9_MM);
      mm = (flags & cgccpp::EF_SPARCV9_MM);
      if (omm != mm)
	{
	  if (mm == cgccpp::EF_SPARCV9_TSO)
	    {
	      this->cgc_flags_ &= ~cgccpp::EF_SPARCV9_MM;
	      this->cgc_flags_ |= cgccpp::EF_SPARCV9_TSO;
	    }
	  else if (mm == cgccpp::EF_SPARCV9_PSO
		   && omm == cgccpp::EF_SPARCV9_RMO)
	    {
	      this->cgc_flags_ &= ~cgccpp::EF_SPARCV9_MM;
	      this->cgc_flags_ |= cgccpp::EF_SPARCV9_PSO;
	    }
	}
    }
  ...
  // been instantiated.
  if (!(flags & cgccpp::EF_SPARC_LEDATA) != big_endian)
    {
      if (big_endian)
	gold_error(_("%s: little endian cgc flag set on BE object"),
		     name.c_str());
      else
	gold_error(_("%s: little endian cgc flag clear on LE object"),
		     name.c_str());
    }

  return Target::do_make_cgc_object(name, input_file, offset, ehdr);
}
...
template<int size, bool big_endian>
void
Target_sparc<size, big_endian>::do_adjust_cgc_header(
    unsigned char* view,
    int len)
{
  cgccpp::Ehdr_write<size, big_endian> oehdr(view);

  oehdr.put_e_machine(this->cgc_machine_);
  oehdr.put_e_flags(this->cgc_flags_);

  Sized_target<size, big_endian>::do_adjust_cgc_header(view, len);
}
...
public:
  Target_selector_sparc()
    : Target_selector(cgccpp::EM_NONE, size, big_endian,
		      (size == 64 ? "cgc64-sparc" : "cgc32-sparc"),
		      (size == 64 ? "cgc64_sparc" : "cgc32_sparc"))
  { }
  ...
  do_recognize(Input_file*, off_t, int machine, int, int)
  {
    switch (size)
      {
      case 64:
	if (machine != cgccpp::EM_SPARCV9)
	  return NULL;
	break;

      case 32:
	if (machine != cgccpp::EM_SPARC
	    && machine != cgccpp::EM_SPARC32PLUS)
	  return NULL;
	break;
