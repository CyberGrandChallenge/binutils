...
class Layout
{
 public:
  ...
  Output_section*
  init_fixed_output_section(const char*, cgccpp::Shdr<size, big_endian>&);
  ...
  {
    // Identifier for the segment.  CGC segments dont have names.  This
  ...
  // for relro sections.
  Output_section*
  add_output_section_data(const char* name, cgccpp::Cgc_Word type,
  ...
  Output_segment*
  find_output_segment(cgccpp::PT type, cgccpp::Cgc_Word set,
  ...
  Output_segment*
  make_output_segment(cgccpp::Cgc_Word type, cgccpp::Cgc_Word flags);
  ...
  static cgccpp::Cgc_Word
  section_flags_to_segment(cgccpp::Cgc_Xword flags);
 ...
 private:
  ...
  // output section.
  cgccpp::Cgc_Xword
  get_output_section_flags (cgccpp::Cgc_Xword input_section_flags);
  ...
  make_output_section(const char* name, cgccpp::Cgc_Word type,
		      cgccpp::Cgc_Xword flags, Output_section_order order,
		      bool is_relro);
  ...
  typedef std::pair<Stringpool::Key,
		    std::pair<cgccpp::Cgc_Word, cgccpp::Cgc_Xword> > Key;
