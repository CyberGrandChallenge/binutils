// arm.h -- CGC definitions specific to EM_ARM  -*- C++ -*-
...
// e_flags values used for ARM.  We only support flags defined in AACGC.
...
inline Cgc_Word
arm_eabi_version(Cgc_Word flags)
