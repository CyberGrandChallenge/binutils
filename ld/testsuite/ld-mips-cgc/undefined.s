...
# by mips_cgc_calculate_relocation() once the result of the
...
#
# would additionally be reported in mips_cgc_global_got_index(), because
...
# referred and set its h->dynindx in _bfd_mips_cgc_check_relocs(), but
