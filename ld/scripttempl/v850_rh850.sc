cat << EOF
OUTPUT_FORMAT("cgc32-v850-rh850", "cgc32-v850-rh850",
	      "cgc32-v850-rh850")
...
SECTIONS
{
  /* This saves a little space in the CGC file, since the zda starts
     at a higher location that the CGC headers take up.  */
