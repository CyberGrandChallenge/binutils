SCRIPT_NAME=cgc64hppa
CGCSIZE=64
OUTPUT_FORMAT="cgc64-hppa"
NO_REL_RELOCS=yes
...
# The PA64 CGC port treats .plt sections differently than most.  We also have
...
# The PA64 CGC port has an additional huge bss section.
OTHER_BSS_SECTIONS="
...
# The PA64 CGC port needs two additional initializer sections and also wants
