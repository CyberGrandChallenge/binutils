...
# cgc64bmip.sh cgc64btsmip.sh cgc32btsmipn32.sh cgc32bmipn32.sh

# This is an CGC platform.
SCRIPT_NAME=cgc

# Handle both big- and little-ended 32-bit MIPS objects.
ARCH=mips
OUTPUT_FORMAT="cgc32-bigmips"
