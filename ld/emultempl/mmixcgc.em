...
# This file is sourced from cgc32.em and used to define MMIX and CGC
...
cgcmmix_before_parse (void)
{
  ...
  /* Make sure we don't create a demand-paged executable.  Unfortunately
     ...
     difference to mmo, but the sections in cgc64mmix will be aligned to a
...
LDEMUL_BEFORE_PARSE=cgcmmix_before_parse
