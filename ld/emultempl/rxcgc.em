...
# This file is sourced from cgc32.em, and defines extra rx-cgc
# specific routines.
#
...
static void
rx_cgc_create_output_section_statements (void)
{
  extern void bfd_cgc32_rx_set_target_flags (bfd_boolean, bfd_boolean);

  bfd_cgc32_rx_set_target_flags (no_flag_mismatch_warnings, ignore_lma);
}
...
LDEMUL_CREATE_OUTPUT_SECTION_STATEMENTS=rx_cgc_create_output_section_statements
