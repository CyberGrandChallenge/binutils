...
# This file is sourced from cgc32.em, and defines extra m68hc12-cgc
# and m68hc11-cgc specific routines.  It is used to generate the
...
static asection *m68hc11cgc_add_stub_section (const char *, asection *);
...
static void
m68hc11_cgc_${EMULATION_NAME}_before_allocation (void)
{
  ...
  ret = cgc32_m68hc11_setup_section_lists (link_info.output_bfd, &link_info);
  if (ret != 0 && no_trampoline == 0)
      ...
      if (ret < 0)
	{
      ...
      if (!cgc32_m68hc11_size_stubs (link_info.output_bfd,
				     stub_file->the_bfd,
				     &link_info,
				     &m68hc11cgc_add_stub_section))
	{
	  einfo ("%X%P: can not size stub section: %E\n");
	  return;
	}
  ...
  if (region->length != 0)
    {
      ...
      pinfo = &m68hc11_cgc_hash_table (&link_info)->pinfo;
...
static void
m68hc11cgc_create_output_section_statements (void)
{
...
/* Call-back for cgc32_m68hc11_size_stubs.  */

/* Create a new stub section, and arrange for it to be linked
   immediately before INPUT_SECTION.  */

static asection *
m68hc11cgc_add_stub_section (const char *stub_sec_name,
...
static void
m68hc11cgc_after_allocation (void)
{
  ...
  if (stub_file->the_bfd->sections != NULL)
				     ...
				     &link_info, 0))
	{
      ...
      if (!cgc32_m68hc11_build_stubs (link_info.output_bfd, &link_info))
...
# Put these extra m68hc11cgc routines in ld_${EMULATION_NAME}_emulation
#
LDEMUL_BEFORE_ALLOCATION=m68hc11_cgc_${EMULATION_NAME}_before_allocation
LDEMUL_AFTER_ALLOCATION=m68hc11cgc_after_allocation
LDEMUL_CREATE_OUTPUT_SECTION_STATEMENTS=m68hc11cgc_create_output_section_statements
