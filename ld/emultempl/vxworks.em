...
vxworks_after_open (void)
{
  ...
  if (force_dynamic
      ...
      && bfd_get_flavour (link_info.output_bfd) == bfd_target_cgc_flavour
      && !_bfd_cgc_link_create_dynamic_sections (link_info.input_bfds,
						 &link_info))
...
#	replaced cgc32.em's default definition, so we simply #define
