...
extern struct bfd_cgc_version_expr *lang_new_vers_pattern
  (struct bfd_cgc_version_expr *, const char *, const char *, bfd_boolean);
extern struct bfd_cgc_version_tree *lang_new_vers_node
  (struct bfd_cgc_version_expr *, struct bfd_cgc_version_expr *);
extern struct bfd_cgc_version_deps *lang_add_vers_depend
  (struct bfd_cgc_version_deps *, const char *);
extern void lang_register_vers_node
  (const char *, struct bfd_cgc_version_tree *, struct bfd_cgc_version_deps *);
extern void lang_append_dynamic_list (struct bfd_cgc_version_expr *);
