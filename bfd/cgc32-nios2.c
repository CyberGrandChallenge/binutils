/* 32-bit CGC support for Nios II.
...
/* This file handles Altera Nios II CGC targets.  */
...
static bfd_reloc_status_type nios2_cgc32_ignore_reloc
  (bfd *, arelent *, asymbol *, void *, asection *, bfd *, char **);
static bfd_reloc_status_type nios2_cgc32_hi16_relocate
  (bfd *, arelent *, asymbol *, void *, asection *, bfd *, char **);
static bfd_reloc_status_type nios2_cgc32_lo16_relocate
  (bfd *, arelent *, asymbol *, void *, asection *, bfd *, char **);
static bfd_reloc_status_type nios2_cgc32_hiadj16_relocate
  (bfd *, arelent *, asymbol *, void *, asection *, bfd *, char **);
static bfd_reloc_status_type nios2_cgc32_pcrel_lo16_relocate
  (bfd *, arelent *, asymbol *, void *, asection *, bfd *, char **);
static bfd_reloc_status_type nios2_cgc32_pcrel_hiadj16_relocate
  (bfd *, arelent *, asymbol *, void *, asection *, bfd *, char **);
static bfd_reloc_status_type nios2_cgc32_pcrel16_relocate
  (bfd *, arelent *, asymbol *, void *, asection *, bfd *, char **);
static bfd_reloc_status_type nios2_cgc32_call26_relocate
  (bfd *, arelent *, asymbol *, void *, asection *, bfd *, char **);
static bfd_reloc_status_type nios2_cgc32_gprel_relocate
  (bfd *, arelent *, asymbol *, void *, asection *, bfd *, char **);
static bfd_reloc_status_type nios2_cgc32_ujmp_relocate
  (bfd *, arelent *, asymbol *, void *, asection *, bfd *, char **);
static bfd_reloc_status_type nios2_cgc32_cjmp_relocate
  (bfd *, arelent *, asymbol *, void *, asection *, bfd *, char **);
static bfd_reloc_status_type nios2_cgc32_callr_relocate
  (bfd *, arelent *, asymbol *, void *, asection *, bfd *, char **);

/* Target vector.  */
extern const bfd_target bfd_cgc32_littlenios2_vec;
extern const bfd_target bfd_cgc32_bignios2_vec;
...
static reloc_howto_type cgc_nios2_howto_table_rel[] = {
  /* No relocation.  */
  ...
  HOWTO (R_NIOS2_S16,		/* type */
	 ...
	 bfd_cgc_generic_reloc,	/* special function */
	 "R_NIOS2_S16",		/* name */
	 FALSE,			/* partial_inplace */
	 0x003fffc0,		/* src_mask */
  ...
  HOWTO (R_NIOS2_PCREL16,	/* type */
	 ...
	 6,			/* bitpos */
	 complain_overflow_signed,	/* complain on overflow */
	 nios2_cgc32_pcrel16_relocate,	/* special function */
  ...
  HOWTO (R_NIOS2_CALL26,	/* type */
	 ...
	 nios2_cgc32_call26_relocate,	/* special function */
	 "R_NIOS2_CALL26",	/* name */
	 FALSE,			/* partial_inplace */
	 0xffffffc0,		/* src_mask */
	 0xffffffc0,		/* dst_mask */
  ...
  HOWTO (R_NIOS2_PCREL_LO,
	 ...
	 6,
	 complain_overflow_dont,
	 nios2_cgc32_pcrel_lo16_relocate,
	 "R_NIOS2_PCREL_LO",
	 FALSE,
	 0x003fffc0,
	 0x003fffc0,
  ...
  HOWTO (R_NIOS2_PCREL_HA,
	 ...
	 6,
	 complain_overflow_dont,
	 nios2_cgc32_pcrel_hiadj16_relocate,
	 "R_NIOS2_PCREL_HA",
	 FALSE,
	 0x003fffc0,
	 0x003fffc0,
...
static unsigned char cgc_code_to_howto_index[R_NIOS2_ILLEGAL + 1];
...
lookup_howto (unsigned int rtype)
{
  ...
  int i;
  int howto_tbl_size = (int) (sizeof (cgc_nios2_howto_table_rel)
			      / sizeof (cgc_nios2_howto_table_rel[0]));

  if (!initialized)
    {
      initialized = 1;
      memset (cgc_code_to_howto_index, 0xff,
	      sizeof (cgc_code_to_howto_index));
      for (i = 0; i < howto_tbl_size; i++)
	cgc_code_to_howto_index[cgc_nios2_howto_table_rel[i].type] = i;
    }

  BFD_ASSERT (rtype <= R_NIOS2_ILLEGAL);
  i = cgc_code_to_howto_index[rtype];
  if (i >= howto_tbl_size)
    return 0;
  return cgc_nios2_howto_table_rel + i;
}
...
struct cgc_reloc_map
{
  ...
  enum cgc_nios2_reloc_type cgc_val;
};

static const struct cgc_reloc_map nios2_reloc_map[] = {
...
struct cgc32_nios2_dyn_relocs
{
  struct cgc32_nios2_dyn_relocs *next;
...
/* Nios II CGC linker hash entry.  */

struct cgc32_nios2_link_hash_entry
{
  struct cgc_link_hash_entry root;

  /* Track dynamic relocs copied for this symbol.  */
  struct cgc32_nios2_dyn_relocs *dyn_relocs;
...
#define cgc32_nios2_hash_entry(ent) \
  ((struct cgc32_nios2_link_hash_entry *) (ent))

/* Get the Nios II cgc linker hash table from a link_info structure.  */
#define cgc32_nios2_hash_table(info) \
  ((struct cgc32_nios2_link_hash_table *) ((info)->hash))

/* Nios II CGC linker hash table.  */
struct cgc32_nios2_link_hash_table
  {
    /* The main hash table.  */
...
#define cgc32_nios2_tdata(abfd) \
  ((struct nios2_cgc32_obj_tdata *) (abfd)->tdata.any)

#define cgc32_nios2_local_got_tls_type(abfd) \
  (cgc32_nios2_tdata (abfd)->local_got_tls_type)
...
/* Implement cgc_backend_grok_prstatus:
   Support for core dump NOTE sections.  */
static bfd_boolean
nios2_grok_prstatus (bfd *abfd, Cgc_Internal_Note *note)
{
  int offset;
  size_t size;
  ...
  switch (note->descsz)
    ...
    case 212:	      /* Linux/Nios II */
      ...
      /* pr_pid */
      cgc_tdata (abfd)->core->pid = bfd_get_32 (abfd, note->descdata + 24);
...
/* Implement cgc_backend_grok_psinfo.  */
static bfd_boolean
nios2_grok_psinfo (bfd *abfd, Cgc_Internal_Note *note)
{
  switch (note->descsz)
    {
    default:
    ...
    case 124:	      /* Linux/Nios II cgc_prpsinfo */
...
/* Create an entry in a Nios II CGC linker hash table.  */
		   ...
		   struct bfd_hash_table *table, const char *string)
{
  ...
  if (entry == NULL)
    {
      entry = bfd_hash_allocate (table,
				 sizeof (struct cgc32_nios2_link_hash_entry));
      if (entry == NULL)
	return entry;
    }
  ...
  if (entry)
    {
      struct cgc32_nios2_link_hash_entry *eh;

      eh = (struct cgc32_nios2_link_hash_entry *) entry;
      eh->dyn_relocs = NULL;
...
/* Implement bfd_cgc32_bfd_reloc_type_lookup:
   Given a BFD reloc type, return a howto structure.  */
static reloc_howto_type *
nios2_cgc32_bfd_reloc_type_lookup (bfd *abfd ATTRIBUTE_UNUSED,
				   bfd_reloc_code_real_type code)
{
  int i;
  for (i = 0;
       i < (int) (sizeof (nios2_reloc_map) / sizeof (struct cgc_reloc_map));
       ++i)
    if (nios2_reloc_map[i].bfd_val == code)
      return &cgc_nios2_howto_table_rel[(int) nios2_reloc_map[i].cgc_val];
  return NULL;
}

/* Implement bfd_cgc32_bfd_reloc_name_lookup:
   Given a reloc name, return a howto structure.  */
static reloc_howto_type *
nios2_cgc32_bfd_reloc_name_lookup (bfd *abfd ATTRIBUTE_UNUSED,
				   const char *r_name)
{
  unsigned int i;
  for (i = 0;
       i < (sizeof (cgc_nios2_howto_table_rel)
	    / sizeof (cgc_nios2_howto_table_rel[0]));
       i++)
    if (cgc_nios2_howto_table_rel[i].name
	&& strcasecmp (cgc_nios2_howto_table_rel[i].name, r_name) == 0)
      return &cgc_nios2_howto_table_rel[i];

  return NULL;	
}

/* Implement cgc_info_to_howto:
   Given a CGC32 relocation, fill in a arelent structure.  */
static void
nios2_cgc32_info_to_howto (bfd *abfd ATTRIBUTE_UNUSED, arelent *cache_ptr,
			   Cgc_Internal_Rela *dst)
{
  ...
  cache_ptr->howto = &cgc_nios2_howto_table_rel[r_type];
}
...
static bfd_boolean
nios2_cgc_assign_gp (bfd *output_bfd, bfd_vma *pgp, struct bfd_link_info *info)
{
...
nios2_cgc_final_gp (bfd *output_bfd, asymbol *symbol, bfd_boolean relocatable, 
...
static bfd_reloc_status_type
nios2_cgc32_do_hi16_relocate (bfd *abfd, reloc_howto_type *howto, 
...
static bfd_reloc_status_type
nios2_cgc32_do_lo16_relocate (bfd *abfd, reloc_howto_type *howto,
			      asection *input_section ATTRIBUTE_UNUSED, 
			      bfd_byte *data, bfd_vma offset, 
			      bfd_vma symbol_value, bfd_vma addend)
{
...
static bfd_reloc_status_type
nios2_cgc32_do_hiadj16_relocate (bfd *abfd, reloc_howto_type *howto,
				 asection *input_section ATTRIBUTE_UNUSED, 
				 bfd_byte *data, bfd_vma offset,
				 bfd_vma symbol_value, bfd_vma addend)
{
...
static bfd_reloc_status_type
nios2_cgc32_do_pcrel_lo16_relocate (bfd *abfd, reloc_howto_type *howto,
				    asection *input_section ATTRIBUTE_UNUSED,
				    bfd_byte *data, bfd_vma offset,
				    bfd_vma symbol_value, bfd_vma addend)
{
...
static bfd_reloc_status_type
nios2_cgc32_do_pcrel_hiadj16_relocate (bfd *abfd, reloc_howto_type *howto,
...
static bfd_reloc_status_type
nios2_cgc32_do_pcrel16_relocate (bfd *abfd, reloc_howto_type *howto,
				 asection *input_section ATTRIBUTE_UNUSED, 
				 bfd_byte *data, bfd_vma offset, 
				 bfd_vma symbol_value, bfd_vma addend)
{
...
static bfd_reloc_status_type
nios2_cgc32_do_call26_relocate (bfd *abfd, reloc_howto_type *howto,
				asection *input_section ATTRIBUTE_UNUSED, 
				bfd_byte *data, bfd_vma offset, 
				bfd_vma symbol_value, bfd_vma addend)
{
...
static bfd_reloc_status_type
nios2_cgc32_do_gprel_relocate (bfd *abfd, reloc_howto_type *howto,
			       asection *input_section ATTRIBUTE_UNUSED, 
			       bfd_byte *data, bfd_vma offset, 
			       bfd_vma symbol_value, bfd_vma addend)
{
  /* Because we need the output_bfd, the special handling is done
     in nios2_cgc32_relocate_section or in nios2_cgc32_gprel_relocate.  */
  return _bfd_final_link_relocate (howto, abfd, input_section,
				   data, offset, symbol_value, addend);
}

static bfd_reloc_status_type
nios2_cgc32_do_ujmp_relocate (bfd *abfd, reloc_howto_type *howto,
			      asection *input_section ATTRIBUTE_UNUSED, 
			      bfd_byte *data, bfd_vma offset, 
			      bfd_vma symbol_value, bfd_vma addend)
{
...
static bfd_reloc_status_type
nios2_cgc32_do_cjmp_relocate (bfd *abfd, reloc_howto_type *howto,
			      asection *input_section ATTRIBUTE_UNUSED, 
			      bfd_byte *data, bfd_vma offset, 
			      bfd_vma symbol_value, bfd_vma addend)
{
...
static bfd_reloc_status_type
nios2_cgc32_do_callr_relocate (bfd *abfd, reloc_howto_type *howto,
			       asection *input_section ATTRIBUTE_UNUSED, 
			       bfd_byte *data, bfd_vma offset, 
			       bfd_vma symbol_value, bfd_vma addend)
{
...
static bfd_reloc_status_type
nios2_cgc32_ignore_reloc (bfd *abfd ATTRIBUTE_UNUSED, arelent *reloc_entry,
...
static bfd_reloc_status_type
nios2_cgc32_hi16_relocate (bfd *abfd, arelent *reloc_entry, asymbol *symbol, 
			   void *data, asection *input_section, 
			   bfd *output_bfd, 
			   char **error_message ATTRIBUTE_UNUSED)
{
  /* This part is from bfd_cgc_generic_reloc.  */
  if (output_bfd != NULL
  ...
  return nios2_cgc32_do_hi16_relocate (abfd, reloc_entry->howto,
				       input_section,
...
static bfd_reloc_status_type
nios2_cgc32_lo16_relocate (bfd *abfd, arelent *reloc_entry, asymbol *symbol,
			   void *data, asection *input_section, 
			   bfd *output_bfd, 
			   char **error_message ATTRIBUTE_UNUSED)
{
  ...
  return nios2_cgc32_do_lo16_relocate (abfd, reloc_entry->howto,
				       input_section,
				       data, reloc_entry->address,
				       (symbol->value
					+ symbol->section->output_section->vma
...
static bfd_reloc_status_type
nios2_cgc32_hiadj16_relocate (bfd *abfd, arelent *reloc_entry, asymbol *symbol,
			      void *data, asection *input_section, 
			      bfd *output_bfd, 
			      char **error_message ATTRIBUTE_UNUSED)
{
  ...
  return nios2_cgc32_do_hiadj16_relocate (abfd, reloc_entry->howto,
					  input_section,
					  data, reloc_entry->address,
					  (symbol->value
					   + symbol->section->output_section->vma
...
static bfd_reloc_status_type
nios2_cgc32_pcrel_lo16_relocate (bfd *abfd, arelent *reloc_entry,
				 ...
				 char **error_message ATTRIBUTE_UNUSED)
{
  ...
  return nios2_cgc32_do_pcrel_lo16_relocate (
...
static bfd_reloc_status_type
nios2_cgc32_pcrel_hiadj16_relocate (bfd *abfd, arelent *reloc_entry,
				    asymbol *symbol, void *data,
				    asection *input_section, bfd *output_bfd,
				    char **error_message ATTRIBUTE_UNUSED)
{
  ...
  return nios2_cgc32_do_pcrel_hiadj16_relocate (
    abfd, reloc_entry->howto, input_section, data, reloc_entry->address,
    (symbol->value + symbol->section->output_section->vma
     + symbol->section->output_offset),
    reloc_entry->addend);
...
static bfd_reloc_status_type
nios2_cgc32_pcrel16_relocate (bfd *abfd, arelent *reloc_entry, asymbol *symbol,
			      void *data, asection *input_section, 
			      bfd *output_bfd, 
			      char **error_message ATTRIBUTE_UNUSED)
{
  ...
  return nios2_cgc32_do_pcrel16_relocate (abfd, reloc_entry->howto,
					  input_section,
					  data, reloc_entry->address,
					  (symbol->value
					   + symbol->section->output_section->vma
...
static bfd_reloc_status_type
nios2_cgc32_call26_relocate (bfd *abfd, arelent *reloc_entry, asymbol *symbol,
			     void *data, asection *input_section, 
			     bfd *output_bfd, 
			     char **error_message ATTRIBUTE_UNUSED)
{
  ...
  return nios2_cgc32_do_call26_relocate (abfd, reloc_entry->howto,
					 input_section,
					 data, reloc_entry->address,
					 (symbol->value
					  + symbol->section->output_section->vma
...
static bfd_reloc_status_type
nios2_cgc32_gprel_relocate (bfd *abfd, arelent *reloc_entry, asymbol *symbol,
			    void *data, asection *input_section, 
			    bfd *output_bfd, char **msg)
{
  ...
  r = nios2_cgc_final_gp (abfd, symbol, FALSE, msg, &gp);
  if (r == bfd_reloc_ok)
    {
	...
	r = nios2_cgc32_do_gprel_relocate (abfd, reloc_entry->howto,
					   input_section,
					   data, reloc_entry->address,
...
static bfd_reloc_status_type
nios2_cgc32_ujmp_relocate (bfd *abfd, arelent *reloc_entry, asymbol *symbol,
			   void *data, asection *input_section, 
			   bfd *output_bfd, char **msg ATTRIBUTE_UNUSED)
{
  ...
  return nios2_cgc32_do_ujmp_relocate (abfd, reloc_entry->howto,
				       input_section,
				       data, reloc_entry->address,
				       (symbol->value
					+ symbol->section->output_section->vma
...
static bfd_reloc_status_type
nios2_cgc32_cjmp_relocate (bfd *abfd, arelent *reloc_entry, asymbol *symbol,
			   void *data, asection *input_section, 
			   bfd *output_bfd, char **msg ATTRIBUTE_UNUSED)
{
  /* This part is from bfd_cgc_generic_reloc.  */
  ...
  return nios2_cgc32_do_cjmp_relocate (abfd, reloc_entry->howto,
				       input_section,
				       data, reloc_entry->address,
				       (symbol->value
					+ symbol->section->output_section->vma
...
static bfd_reloc_status_type
nios2_cgc32_callr_relocate (bfd *abfd, arelent *reloc_entry, asymbol *symbol,
			    void *data, asection *input_section, 
			    bfd *output_bfd, char **msg ATTRIBUTE_UNUSED)
{
  /* This part is from bfd_cgc_generic_reloc.  */
  ...
  return nios2_cgc32_do_callr_relocate (abfd, reloc_entry->howto,
					input_section,
					data, reloc_entry->address,
					(symbol->value
					 + symbol->section->output_section->vma
...
/* Implement cgc_backend_relocate_section.  */
static bfd_boolean
nios2_cgc32_relocate_section (bfd *output_bfd,
			      ...
			      asection **local_sections)
{
  ...
  struct cgc32_nios2_link_hash_table *htab;
  asection *sgot;
  asection *splt;
  ...
  htab = cgc32_nios2_hash_table (info);
  sgot = htab->root.sgot;
  splt = htab->root.splt;
  ...
  for (rel = relocs; rel < relend; rel++)
    {
      ...
      howto = lookup_howto ((unsigned) CGC32_R_TYPE (rel->r_info));
      h = NULL;
      sym = NULL;
      sec = NULL;
      ...
      if (howto)
	{
	  switch (howto->type)
	    {
	    case R_NIOS2_HI16:
	      r = nios2_cgc32_do_hi16_relocate (input_bfd, howto,
						input_section,
						contents, rel->r_offset,
						relocation, rel->r_addend);
	      break;
	    case R_NIOS2_LO16:
	      r = nios2_cgc32_do_lo16_relocate (input_bfd, howto,
						input_section,
						contents, rel->r_offset,
						relocation, rel->r_addend);
	      break;
	    case R_NIOS2_PCREL_LO:
	      r = nios2_cgc32_do_pcrel_lo16_relocate (input_bfd, howto,
						      input_section,
						      contents,
						      rel->r_offset,
						      relocation,
	    ...
	    case R_NIOS2_HIADJ16:
	      r = nios2_cgc32_do_hiadj16_relocate (input_bfd, howto,
						   input_section, contents,
						   rel->r_offset, relocation,
						   rel->r_addend);
	      break;
	    case R_NIOS2_PCREL_HA:
	      r = nios2_cgc32_do_pcrel_hiadj16_relocate (input_bfd, howto,
							 input_section,
							 contents,
							 rel->r_offset,
							 relocation,
	    ...
	    case R_NIOS2_PCREL16:
	      r = nios2_cgc32_do_pcrel16_relocate (input_bfd, howto,
						   input_section, contents,
						   rel->r_offset, relocation,
						   rel->r_addend);
	      break;
	    case R_NIOS2_GPREL:
	      ...
	      if (!nios2_cgc_assign_gp (output_bfd, &gp, info))
		{
	      ...
	      else
		{
	      ...
	      break;
	    case R_NIOS2_UJMP:
	      r = nios2_cgc32_do_ujmp_relocate (input_bfd, howto,
						input_section,
						contents, rel->r_offset,
						relocation, rel->r_addend);
	      break;
	    case R_NIOS2_CJMP:
	      r = nios2_cgc32_do_cjmp_relocate (input_bfd, howto,
						input_section,
						contents, rel->r_offset,
						relocation, rel->r_addend);
	      break;
	    case R_NIOS2_CALLR:
	      r = nios2_cgc32_do_callr_relocate (input_bfd, howto,
						 input_section, contents,
						 rel->r_offset, relocation,
						 rel->r_addend);
	      break;
	      ...
	      if (h != NULL && splt != NULL && h->plt.offset != (bfd_vma) -1)
		{
	      ...
	      r = nios2_cgc32_do_call26_relocate (input_bfd, howto,
						  input_section, contents,
						  rel->r_offset, relocation,
						  rel->r_addend);
	      break;
	    case R_NIOS2_ALIGN:
		 ...
		 r = nios2_cgc32_do_ignore_reloc (input_bfd, howto,
						  input_section, contents,
						  rel->r_offset, relocation,
						  rel->r_addend);
	      ...
	      if (h != NULL)
		{
		  ...
		  eh = (struct cgc32_nios2_link_hash_entry *)h;
		  ...
		  if ((off & 1) != 0)
		      ...
		      if (info->shared)
			{
			  ...
			  outrel.r_offset = (sgot->output_section->vma
					     + sgot->output_offset
					     + off);
			  outrel.r_info = CGC32_R_INFO (0, R_NIOS2_RELATIVE);
		  ...
		  if (info->shared)
			...
			abort ();
		      ...
		      outrel.r_offset = (htab->root.sgot->output_section->vma
					 ...
					 + off);
		      outrel.r_info = CGC32_R_INFO (0, R_NIOS2_TLS_DTPMOD);
		...
		if (h != NULL)
		  {
		    ...
		    off = h->got.offset;
		    tls_type = (((struct cgc32_nios2_link_hash_entry *) h)
				->tls_type);
		  }
		else
		  {
		    if (local_got_offsets == NULL)
		      abort ();
		    off = local_got_offsets[r_symndx];
		    tls_type = (cgc32_nios2_local_got_tls_type (input_bfd)
				[r_symndx]);
		  }
...
/* Implement cgc-backend_section_flags:
   Convert NIOS2 specific section flags to bfd internal section flags.  */
static bfd_boolean
nios2_cgc32_section_flags (flagword *flags, const Cgc_Internal_Shdr *hdr)
{
...
/* Implement cgc_backend_fake_sections:
   Set the correct type for an NIOS2 CGC section.  We do this by the
   section name, which is a hack, but ought to work.  */
static bfd_boolean
nios2_cgc32_fake_sections (bfd *abfd ATTRIBUTE_UNUSED,
...
/* Implement cgc_backend_create_dynamic_sections:
   Create .plt, .rela.plt, .got, .got.plt, .rela.got, .dynbss, and
   .rela.bss sections in DYNOBJ, and set up shortcuts to them in our
   hash table.  */
static bfd_boolean
nios2_cgc32_create_dynamic_sections (bfd *dynobj, struct bfd_link_info *info)
{
  struct cgc32_nios2_link_hash_table *htab;
  ...
  _bfd_cgc_create_dynamic_sections (dynobj, info);
...
/* Implement cgc_backend_copy_indirect_symbol:
   Copy the extra info we tack onto an cgc_link_hash_entry.  */
static void
nios2_cgc32_copy_indirect_symbol (struct bfd_link_info *info,
				  struct cgc_link_hash_entry *dir,
				  struct cgc_link_hash_entry *ind)
{
  struct cgc32_nios2_link_hash_entry *edir, *eind;

  edir = (struct cgc32_nios2_link_hash_entry *) dir;
  eind = (struct cgc32_nios2_link_hash_entry *) ind;

  if (eind->dyn_relocs != NULL)
    {
      if (edir->dyn_relocs != NULL)
	{
	  struct cgc32_nios2_dyn_relocs **pp;
	  struct cgc32_nios2_dyn_relocs *p;

	  /* Add reloc counts against the indirect sym to the direct sym
	     list.  Merge any entries against the same section.  */
	  for (pp = &eind->dyn_relocs; (p = *pp) != NULL; )
	    {
	      struct cgc32_nios2_dyn_relocs *q;
...
/* Implement cgc_backend_check_relocs:
   Look through the relocs for a section during the first phase.  */
static bfd_boolean
nios2_cgc32_check_relocs (bfd *abfd, struct bfd_link_info *info,
			  asection *sec, const Cgc_Internal_Rela *relocs)
{
  ...
  sym_hashes_end = (sym_hashes
		    + symtab_hdr->sh_size / sizeof (Cgc32_External_Sym));
  ...
  for (rel = relocs; rel < rel_end; rel++)
	...
	case R_NIOS2_TLS_IE16:
	  /* This symbol requires a global offset table entry.  */
	  {
		...
		nios2_cgc32_create_dynamic_sections (dynobj, info);
	      }
	    ...
	    if (h != NULL)
	      {
		struct cgc32_nios2_link_hash_entry *eh
		  = (struct cgc32_nios2_link_hash_entry *)h;
		h->got.refcount++;
		old_tls_type = cgc32_nios2_hash_entry(h)->tls_type;
		...
		if (local_got_refcounts == NULL)
		  {
		    ...
		    cgc32_nios2_local_got_tls_type (abfd)
		      = (char *) (local_got_refcounts + symtab_hdr->sh_info);
		  }
		local_got_refcounts[r_symndx]++;
		old_tls_type = cgc32_nios2_local_got_tls_type (abfd) [r_symndx];
	      }
	    ...
	    if (old_tls_type != tls_type)
	      {
		if (h != NULL)
		  cgc32_nios2_hash_entry (h)->tls_type = tls_type;
		else
		  cgc32_nios2_local_got_tls_type (abfd) [r_symndx] = tls_type;
	      }
	  }
	  /* Fall through */
	case R_NIOS2_TLS_LDM16:
	...
	case R_NIOS2_GNU_VTENTRY:
	  if (!bfd_cgc_gc_record_vtentry (abfd, sec, h, rel->r_addend))
	    return FALSE;
	  break;
	...
	case R_NIOS2_LO16:
	  ...
	  if (info->shared
	    ...
	    {
	      struct cgc32_nios2_dyn_relocs *p;
	      struct cgc32_nios2_dyn_relocs **head;
	      ...
	      if (sreloc == NULL)
		{
		 ...
		 relocations we need for this symbol.  */
	      if (h != NULL)
		head = &((struct cgc32_nios2_link_hash_entry *) h)->dyn_relocs;
	      else
		{
		  ...
		  head = (struct cgc32_nios2_dyn_relocs **) vpp;
		}
	      ...
	      if (p == NULL || p->sec != sec)
		{
		  ...
		  p = ((struct cgc32_nios2_dyn_relocs *)
...
/* Implement cgc_backend_gc_mark_hook:
   Return the section that should be marked against GC for a given
   relocation.  */
static asection *
nios2_cgc32_gc_mark_hook (asection *sec,
...
/* Implement cgc_backend_gc_sweep_hook:
   Update the got entry reference counts for the section being removed.  */
static bfd_boolean
nios2_cgc32_gc_sweep_hook (bfd *abfd,
			   struct bfd_link_info *info,
			   asection *sec,
...
static void
nios2_cgc32_install_imm16 (asection *sec, bfd_vma offset, bfd_vma value)
{
...
/* Install COUNT 32-bit values DATA starting at offset OFFSET into
   section SEC. */
static void
nios2_cgc32_install_data (asection *sec, const bfd_vma *data, bfd_vma offset,
			  int count)
{
  while (count--)
    {
...
/* Implement cgc_backend_finish_dynamic_symbols:
   Finish up dynamic symbol handling.  We set the contents of various
   dynamic sections here.  */
static bfd_boolean
nios2_cgc32_finish_dynamic_symbol (bfd *output_bfd,
				   struct bfd_link_info *info,
				   struct cgc_link_hash_entry *h,
				   Cgc_Internal_Sym *sym)
{
  ...
  if (h->plt.offset != (bfd_vma) -1)
    {
	 ...
	 it up.  */
      ...
      if (info->shared)
	{
	  nios2_cgc32_install_data (splt, nios2_so_plt_entry, h->plt.offset,
				    3);
	  plt_index = (h->plt.offset - 24) / 12;
	  got_offset = (plt_index + 3) * 4;
	  nios2_cgc32_install_imm16 (splt, h->plt.offset,
				     hiadj(plt_index * 4));
	  nios2_cgc32_install_imm16 (splt, h->plt.offset + 4,
				     (plt_index * 4) & 0xffff);
	  nios2_cgc32_install_imm16 (splt, h->plt.offset + 8,
				     0xfff4 - h->plt.offset);
      ...
      else
	{
	  ...
	  nios2_cgc32_install_data (splt, nios2_plt_entry, h->plt.offset, 3);
	  got_address = (sgotplt->output_section->vma + sgotplt->output_offset
			 + got_offset);
	  nios2_cgc32_install_imm16 (splt, h->plt.offset, hiadj(got_address));
	  nios2_cgc32_install_imm16 (splt, h->plt.offset + 4,
				     got_address & 0xffff);
      ...
      rela.r_info = CGC32_R_INFO (h->dynindx, R_NIOS2_JUMP_SLOT);
      rela.r_addend = 0;
  ...
  if (!use_plt && h->got.offset != (bfd_vma) -1
      && (cgc32_nios2_hash_entry (h)->tls_type & GOT_TLS_GD) == 0
      && (cgc32_nios2_hash_entry (h)->tls_type & GOT_TLS_IE) == 0)
    {
      asection *sgot;
      asection *srela;
      Cgc_Internal_Rela rela;
	...
	{
	  rela.r_info = CGC32_R_INFO (0, R_NIOS2_RELATIVE);
      ...
      else
	{
	  bfd_put_32 (output_bfd, (bfd_vma) 0,
		      sgot->contents + offset);
	  rela.r_info = CGC32_R_INFO (h->dynindx, R_NIOS2_GLOB_DAT);
	  rela.r_addend = 0;
	}
  ...
  if (h->needs_copy)
    {
      ...
      rela.r_info = CGC32_R_INFO (h->dynindx, R_NIOS2_COPY);
      rela.r_addend = 0;
...
/* Implement cgc_backend_finish_dynamic_sections.  */
static bfd_boolean
nios2_cgc32_finish_dynamic_sections (bfd *output_bfd,
				     struct bfd_link_info *info)
{
  bfd *dynobj;
  asection *sgotplt;
	  ...
	  if (info->shared)
	    {
	      ...
	      nios2_cgc32_install_data (splt, nios2_so_plt0_entry, 0, 6);
	      nios2_cgc32_install_imm16 (splt, 4, hiadj (corrected));
	      nios2_cgc32_install_imm16 (splt, 12, (corrected & 0xffff) + 4);
	      nios2_cgc32_install_imm16 (splt, 16, (corrected & 0xffff) + 8);
	    }
	  else
	    {
		...
		bfd_put_32 (output_bfd,
	      ...
	      nios2_cgc32_install_data (splt, nios2_plt0_entry, res_size, 7);
	      nios2_cgc32_install_imm16 (splt, res_size, hiadj (res_start));
	      nios2_cgc32_install_imm16 (splt, res_size + 4,
					 res_start & 0xffff);
	      nios2_cgc32_install_imm16 (splt, res_size + 12,
					 hiadj (got_address));
	      nios2_cgc32_install_imm16 (splt, res_size + 16,
					 (got_address & 0xffff) + 4);
	      nios2_cgc32_install_imm16 (splt, res_size + 20,
...
/* Implement cgc_backend_adjust_dynamic_symbol:
   ...
   understand.  */
static bfd_boolean
nios2_cgc32_adjust_dynamic_symbol (struct bfd_link_info *info,
				   struct cgc_link_hash_entry *h)
{
  struct cgc32_nios2_link_hash_table *htab;
  bfd *dynobj;
...
/* Worker function for nios2_cgc32_size_dynamic_sections.  */
static bfd_boolean
adjust_dynrelocs (struct cgc_link_hash_entry *h, PTR inf)
{
  struct bfd_link_info *info;
  struct cgc32_nios2_link_hash_table *htab;
...
/* Another worker function for nios2_cgc32_size_dynamic_sections.
   Allocate space in .plt, .got and associated reloc sections for
   dynamic relocs.  */
static bfd_boolean
allocate_dynrelocs (struct cgc_link_hash_entry *h, PTR inf)
{
  struct bfd_link_info *info;
  struct cgc32_nios2_link_hash_table *htab;
  struct cgc32_nios2_link_hash_entry *eh;
  ...
  if (htab->root.dynamic_sections_created
      ...
      if (WILL_CALL_FINISH_DYNAMIC_SYMBOL (1, info->shared, h))
	{
	  ...
	  htab->root.srelplt->size += sizeof (Cgc32_External_Rela);
  ...
  if (h->got.refcount > 0)
	...
	{
	  if (tls_type & GOT_TLS_IE)
	    htab->root.srelgot->size += sizeof (Cgc32_External_Rela);
...
/* Implement cgc_backend_size_dynamic_sections:
   Set the sizes of the dynamic sections.  */
static bfd_boolean
nios2_cgc32_size_dynamic_sections (bfd *output_bfd ATTRIBUTE_UNUSED,
				   struct bfd_link_info *info)
{
  bfd *dynobj;
  asection *s;
  ...
  for (ibfd = info->input_bfds; ibfd != NULL; ibfd = ibfd->link_next)
	...
	continue;
      ...
      local_tls_type = cgc32_nios2_local_got_tls_type (ibfd);
      s = htab->root.sgot;
  ...
  if (htab->res_n_size)
    cgc_link_hash_traverse (& htab->root, adjust_dynrelocs, info);

  if (cgc_hash_table (info)->dynamic_sections_created)
    {
      /* Add some entries to the .dynamic section.  We fill in the
	 values later, in cgc_nios2_finish_dynamic_sections, but we
...
/* Implement bfd_cgc32_bfd_link_hash_table_create.  */
static struct bfd_link_hash_table *
nios2_cgc32_link_hash_table_create (bfd *abfd)
{
  struct cgc32_nios2_link_hash_table *ret;
  bfd_size_type amt = sizeof (struct cgc32_nios2_link_hash_table);
...
/* Implement cgc_backend_reloc_type_class.  */
static enum cgc_reloc_type_class
nios2_cgc32_reloc_type_class (const struct bfd_link_info *info ATTRIBUTE_UNUSED,
...
static bfd_boolean
is_nios2_cgc_target (const struct bfd_target *targ)
{
  return (targ == &bfd_cgc32_littlenios2_vec
	  || targ == &bfd_cgc32_bignios2_vec);
}

/* Implement cgc_backend_add_symbol_hook.
   This hook is called by the linker when adding symbols from an object
   file.  We use it to put .comm items in .sbss, and not .bss.  */
static bfd_boolean
nios2_cgc_add_symbol_hook (bfd *abfd,
			   struct bfd_link_info *info,
			   Cgc_Internal_Sym *sym,
			   ...
			   bfd_vma *valp)
{
  ...
  if (sym->st_shndx == SHN_COMMON
      ...
      && is_nios2_cgc_target (info->output_bfd->xvec))
    {
...
/* Implement cgc_backend_can_make_relative_eh_frame:
   Decide whether to attempt to turn absptr or lsda encodings in
   shared libraries into pcrel within the given input section.  */
static bfd_boolean
nios2_cgc32_can_make_relative_eh_frame (bfd *input_bfd ATTRIBUTE_UNUSED,
					struct bfd_link_info *info
					ATTRIBUTE_UNUSED,
...
/* Implement cgc_backend_special_sections.  */
const struct bfd_cgc_special_section cgc32_nios2_special_sections[] =
{
...
#define CGC_ARCH			bfd_arch_nios2
#define CGC_TARGET_ID			NIOS2_CGC_DATA
#define CGC_MACHINE_CODE		EM_ALTERA_NIOS2
...
#define bfd_cgc32_bfd_link_hash_table_create \
					  nios2_cgc32_link_hash_table_create

/* Relocation table lookup macros.  */

#define bfd_cgc32_bfd_reloc_type_lookup	  nios2_cgc32_bfd_reloc_type_lookup
#define bfd_cgc32_bfd_reloc_name_lookup	  nios2_cgc32_bfd_reloc_name_lookup

/* JUMP_TABLE_LINK macros.  */

/* cgc_info_to_howto (using RELA relocations).  */

#define cgc_info_to_howto		  nios2_cgc32_info_to_howto

/* cgc backend functions.  */
...
#define cgc_backend_relocate_section	  nios2_cgc32_relocate_section
#define cgc_backend_section_flags	  nios2_cgc32_section_flags
#define cgc_backend_fake_sections	  nios2_cgc32_fake_sections
#define cgc_backend_check_relocs	  nios2_cgc32_check_relocs

#define cgc_backend_gc_mark_hook	  nios2_cgc32_gc_mark_hook
#define cgc_backend_gc_sweep_hook	  nios2_cgc32_gc_sweep_hook
#define cgc_backend_create_dynamic_sections \
					  nios2_cgc32_create_dynamic_sections
#define cgc_backend_finish_dynamic_symbol nios2_cgc32_finish_dynamic_symbol
#define cgc_backend_finish_dynamic_sections \
					  nios2_cgc32_finish_dynamic_sections
#define cgc_backend_adjust_dynamic_symbol nios2_cgc32_adjust_dynamic_symbol
#define cgc_backend_reloc_type_class	  nios2_cgc32_reloc_type_class
#define cgc_backend_size_dynamic_sections nios2_cgc32_size_dynamic_sections
#define cgc_backend_add_symbol_hook	  nios2_cgc_add_symbol_hook
#define cgc_backend_copy_indirect_symbol  nios2_cgc32_copy_indirect_symbol

#define cgc_backend_grok_prstatus	  nios2_grok_prstatus
#define cgc_backend_grok_psinfo		  nios2_grok_psinfo

#undef cgc_backend_can_make_relative_eh_frame
#define cgc_backend_can_make_relative_eh_frame \
					  nios2_cgc32_can_make_relative_eh_frame

#define cgc_backend_special_sections	  cgc32_nios2_special_sections

#define TARGET_LITTLE_SYM		bfd_cgc32_littlenios2_vec
#define TARGET_LITTLE_NAME		"cgc32-littlenios2"
#define TARGET_BIG_SYM			bfd_cgc32_bignios2_vec
#define TARGET_BIG_NAME			"cgc32-bignios2"
