/* M32R-specific support for 32-bit CGC.
...
/* Functions for the M32R CGC linker.  */
...
m32r_cgc_do_10_pcrel_reloc (bfd *abfd,
...
static bfd_reloc_status_type
m32r_cgc_10_pcrel_reloc (bfd * abfd,
			 arelent * reloc_entry,
			 asymbol * symbol,
			 void * data,
			 asection * input_section,
			 ...
			 char ** error_message ATTRIBUTE_UNUSED)
{
  ...
  return m32r_cgc_do_10_pcrel_reloc (abfd, reloc_entry->howto,
				     input_section,
...
/* Do generic partial_inplace relocation.
   This is a local replacement for bfd_cgc_generic_reloc.  */

static bfd_reloc_status_type
m32r_cgc_generic_reloc (bfd *input_bfd,
			arelent *reloc_entry,
			asymbol *symbol,
			void * data,
			asection *input_section,
			...
			char **error_message ATTRIBUTE_UNUSED)
{
  ...
  /* Now do the reloc in the usual way.
     ??? It would be nice to call bfd_cgc_generic_reloc here,
     but we have partial_inplace set.  bfd_cgc_generic_reloc will
...
static bfd_reloc_status_type
m32r_cgc_sda16_reloc (bfd *abfd ATTRIBUTE_UNUSED,
		      arelent *reloc_entry,
		      asymbol *symbol,
...
/* Handle the R_M32R_HI16_[SU]LO relocs.
   ...
   This code is copied from the cgc32-mips.c.  We also support an arbitrary
...
static bfd_reloc_status_type
m32r_cgc_hi16_reloc (bfd *abfd ATTRIBUTE_UNUSED,
		     arelent *reloc_entry,
		     asymbol *symbol,
		     void * data,
		     asection *input_section,
...
/* Handle an M32R CGC HI16 reloc.  */

static void
m32r_cgc_relocate_hi16 (bfd *input_bfd,
			int type,
...
static bfd_reloc_status_type
m32r_cgc_lo16_reloc (bfd *input_bfd,
		     arelent *reloc_entry,
		     asymbol *symbol,
		     void * data,
		     asection *input_section,
		     ...
		     char **error_message)
{
  ...
  /* Now do the LO16 reloc in the usual way.
     ...
     pass the handling back to bfd_install_relocation which will install
     a section relative addend which is wrong.  */
  return m32r_cgc_generic_reloc (input_bfd, reloc_entry, symbol, data,
				input_section, output_bfd, error_message);
}


static reloc_howto_type m32r_cgc_howto_table[] =
{
  ...
  HOWTO (R_M32R_16,		/* type */
	 ...
	 0,			/* bitpos */
	 complain_overflow_bitfield, /* complain_on_overflow */
	 m32r_cgc_generic_reloc,/* special_function */
	 "R_M32R_16",		/* name */
  ...
  HOWTO (R_M32R_10_PCREL,	/* type */
	 ...
	 m32r_cgc_10_pcrel_reloc, /* special_function */
  ...
  HOWTO (R_M32R_HI16_ULO,	/* type */
	 ...
	 m32r_cgc_hi16_reloc,	/* special_function */
  ...
  HOWTO (R_M32R_LO16,		/* type */
	 ...
	 0,			/* bitpos */
	 complain_overflow_dont, /* complain_on_overflow */
	 m32r_cgc_lo16_reloc,	/* special_function */
	 "R_M32R_LO16",		/* name */
	 TRUE,			/* partial_inplace */
	 0x0000ffff,		/* src_mask */
	 0x0000ffff,		/* dst_mask */
  ...
  HOWTO (R_M32R_SDA16,		/* type */
	 ...
	 0,			/* bitpos */
	 complain_overflow_signed, /* complain_on_overflow */
	 m32r_cgc_sda16_reloc,	/* special_function */
	 "R_M32R_SDA16",	/* name */
...
/* Map BFD reloc types to M32R CGC reloc types.  */
				 ...
				 bfd_reloc_code_real_type code)
{
  ...
  for (i = 0;
    ...
    if (m32r_reloc_map_old[i].bfd_reloc_val == code)
      return &m32r_cgc_howto_table[m32r_reloc_map_old[i].cgc_reloc_val];
  ...
  for (i = 0;
    ...
    if (m32r_reloc_map[i].bfd_reloc_val == code)
      return &m32r_cgc_howto_table[m32r_reloc_map[i].cgc_reloc_val];
#endif
				 ...
				 const char *r_name)
{
  ...
  for (i = 0;
       i < sizeof (m32r_cgc_howto_table) / sizeof (m32r_cgc_howto_table[0]);
       i++)
    if (m32r_cgc_howto_table[i].name != NULL
	&& strcasecmp (m32r_cgc_howto_table[i].name, r_name) == 0)
      return &m32r_cgc_howto_table[i];

  return NULL;
}

/* Set the howto pointer for an M32R CGC reloc.  */
			...
			Cgc_Internal_Rela *dst)
{
  ...
  BFD_ASSERT (CGC32_R_TYPE(dst->r_info) <= (unsigned int) R_M32R_GNU_VTENTRY);
  cache_ptr->howto = &m32r_cgc_howto_table[r_type];
}
...
m32r_info_to_howto (bfd *abfd ATTRIBUTE_UNUSED,
		    ...
		    Cgc_Internal_Rela *dst)
{
  BFD_ASSERT ((CGC32_R_TYPE(dst->r_info) == (unsigned int) R_M32R_NONE)
              || ((CGC32_R_TYPE(dst->r_info) > (unsigned int) R_M32R_GNU_VTENTRY)
                  && (CGC32_R_TYPE(dst->r_info) < (unsigned int) R_M32R_max)));
  cache_ptr->howto = &m32r_cgc_howto_table[CGC32_R_TYPE(dst->r_info)];
}
...
static bfd_boolean
_bfd_m32r_cgc_section_from_bfd_section (bfd *abfd ATTRIBUTE_UNUSED,
					asection *sec,
					int *retval)
{
...
/* M32R CGC uses two common sections.  One is the usual one, and the other
...
static asection m32r_cgc_scom_section;
static asymbol m32r_cgc_scom_symbol;
static asymbol *m32r_cgc_scom_symbol_ptr;

/* Handle the special M32R section numbers that a symbol may use.  */

static void
_bfd_m32r_cgc_symbol_processing (bfd *abfd ATTRIBUTE_UNUSED, asymbol *asym)
{
  ...
  switch (cgcsym->internal_cgc_sym.st_shndx)
    ...
    case SHN_M32R_SCOMMON:
      if (m32r_cgc_scom_section.name == NULL)
	{
	  /* Initialize the small common section.  */
	  m32r_cgc_scom_section.name = ".scommon";
	  m32r_cgc_scom_section.flags = SEC_IS_COMMON;
	  m32r_cgc_scom_section.output_section = &m32r_cgc_scom_section;
	  m32r_cgc_scom_section.symbol = &m32r_cgc_scom_symbol;
	  m32r_cgc_scom_section.symbol_ptr_ptr = &m32r_cgc_scom_symbol_ptr;
	  m32r_cgc_scom_symbol.name = ".scommon";
	  m32r_cgc_scom_symbol.flags = BSF_SECTION_SYM;
	  m32r_cgc_scom_symbol.section = &m32r_cgc_scom_section;
	  m32r_cgc_scom_symbol_ptr = &m32r_cgc_scom_symbol;
	}
      asym->section = &m32r_cgc_scom_section;
...
static bfd_boolean
m32r_cgc_add_symbol_hook (bfd *abfd,
			  ...
			  bfd_vma *valp)
{
  if (! info->relocatable
    ...
    {
      /* This is simpler than using _bfd_cgc_create_linker_section
	 (our needs are simpler than ppc's needs).  Also
	 _bfd_cgc_create_linker_section currently has a bug where if a .sdata
	 ...
	 screws of _SDA_BASE_ address calcs because output_offset != 0.  */
      ...
      /* The following code was cobbled from cgc32-ppc.c and cgclink.c.  */
      if (s == NULL)
	{
...
static bfd_reloc_status_type
m32r_cgc_final_sda_base (bfd *output_bfd,
			 struct bfd_link_info *info,
			 ...
			 bfd_vma *psb)
{
  if (cgc_gp (output_bfd) == 0)
	...
	cgc_gp (output_bfd) = (h->u.def.value
			       + h->u.def.section->output_section->vma
			       + h->u.def.section->output_offset);
      else
	{
	  /* Only get the error once.  */
	  *psb = cgc_gp (output_bfd) = 4;
	  *error_message =
	    (const char *) _("SDA relocation when _SDA_BASE_ not defined");
	  return bfd_reloc_dangerous;
	}
    }
  *psb = cgc_gp (output_bfd);
  return bfd_reloc_ok;
}

/* Return size of a PLT entry.  */
#define cgc_m32r_sizeof_plt(info) PLT_ENTRY_SIZE
...
struct cgc_m32r_pcrel_relocs_copied
{
  /* Next section.  */
  struct cgc_m32r_pcrel_relocs_copied *next;
  /* A section in dynobj.  */
  asection *section;
...
struct cgc_m32r_dyn_relocs
{
  struct cgc_m32r_dyn_relocs *next;
...
/* m32r CGC linker hash entry.  */

struct cgc_m32r_link_hash_entry
{
  struct cgc_link_hash_entry root;

  /* Track dynamic relocs copied for this symbol.  */
  struct cgc_m32r_dyn_relocs *dyn_relocs;
};

/* m32r CGC linker hash table.  */

struct cgc_m32r_link_hash_table
{
...
/* Traverse an m32r CGC linker hash table.  */

#define m32r_cgc_link_hash_traverse(table, func, info)			\
  (cgc_link_hash_traverse						\
   (&(table)->root,							\
    (bfd_boolean (*) (struct cgc_link_hash_entry *, void *)) (func),	\
    (info)))

/* Get the m32r CGC linker hash table from a link_info structure.  */

#define m32r_cgc_hash_table(p) \
  (cgc_hash_table_id ((struct cgc_link_hash_table *) ((p)->hash)) \
  == M32R_CGC_DATA ? ((struct cgc_m32r_link_hash_table *) ((p)->hash)) : NULL)

/* Create an entry in an m32r CGC linker hash table.  */

static struct bfd_hash_entry *
m32r_cgc_link_hash_newfunc (struct bfd_hash_entry *entry,
			    struct bfd_hash_table *table,
			    const char *string)
{
  struct cgc_m32r_link_hash_entry *ret =
    (struct cgc_m32r_link_hash_entry *) entry;

  /* Allocate the structure if it has not already been allocated by a
     subclass.  */
  if (ret == NULL)
    ret = bfd_hash_allocate (table,
			     sizeof (struct cgc_m32r_link_hash_entry));
  if (ret == NULL)
    return NULL;

  /* Call the allocation method of the superclass.  */
  ret = ((struct cgc_m32r_link_hash_entry *)
         _bfd_cgc_link_hash_newfunc ((struct bfd_hash_entry *) ret,
                                     table, string));
  if (ret != NULL)
    {
      struct cgc_m32r_link_hash_entry *eh;

      eh = (struct cgc_m32r_link_hash_entry *) ret;
      eh->dyn_relocs = NULL;
    }
...
/* Create an m32r CGC linker hash table.  */

static struct bfd_link_hash_table *
m32r_cgc_link_hash_table_create (bfd *abfd)
{
  struct cgc_m32r_link_hash_table *ret;
  bfd_size_type amt = sizeof (struct cgc_m32r_link_hash_table);
...
{
  struct cgc_m32r_link_hash_table *htab;

  if (! _bfd_cgc_create_got_section (dynobj, info))
    return FALSE;

  htab = m32r_cgc_hash_table (info);
  if (htab == NULL)
    return FALSE;
...
static bfd_boolean
m32r_cgc_create_dynamic_sections (bfd *abfd, struct bfd_link_info *info)
{
  struct cgc_m32r_link_hash_table *htab;
...
static void
m32r_cgc_copy_indirect_symbol (struct bfd_link_info *info,
                               struct cgc_link_hash_entry *dir,
                               struct cgc_link_hash_entry *ind)
{
  struct cgc_m32r_link_hash_entry * edir;
  struct cgc_m32r_link_hash_entry * eind;

  edir = (struct cgc_m32r_link_hash_entry *) dir;
  eind = (struct cgc_m32r_link_hash_entry *) ind;

  if (eind->dyn_relocs != NULL)
    {
      if (edir->dyn_relocs != NULL)
        {
          struct cgc_m32r_dyn_relocs **pp;
          struct cgc_m32r_dyn_relocs *p;

          /* Add reloc counts against the indirect sym to the direct sym
             list.  Merge any entries against the same section.  */
          for (pp = &eind->dyn_relocs; (p = *pp) != NULL;)
            {
              struct cgc_m32r_dyn_relocs *q;
...
static bfd_boolean
m32r_cgc_adjust_dynamic_symbol (struct bfd_link_info *info,
				struct cgc_link_hash_entry *h)
{
  struct cgc_m32r_link_hash_table *htab;
  struct cgc_m32r_link_hash_entry *eh;
...
#ifdef DEBUG_PIC
  printf ("m32r_cgc_adjust_dynamic_symbol()\n");
#endif
  ...
  eh = (struct cgc_m32r_link_hash_entry *) h;
...
static bfd_boolean
m32r_cgc_size_dynamic_sections (bfd *output_bfd ATTRIBUTE_UNUSED,
				struct bfd_link_info *info)
{
  struct cgc_m32r_link_hash_table *htab;
  bfd *dynobj;
...
#ifdef DEBUG_PIC
  printf ("m32r_cgc_size_dynamic_sections()\n");
#endif
      ...
      for (s = ibfd->sections; s != NULL; s = s->next)
        {
          ...
          for (p = ((struct cgc_m32r_dyn_relocs *)
  ...
  if (htab->root.dynamic_sections_created)
    {
	 ...
	 values later, in m32r_cgc_finish_dynamic_sections, but we
      ...
      if (relocs)
        {
          ...
          if ((info->flags & DF_TEXTREL) == 0)
            cgc_link_hash_traverse (&htab->root, readonly_dynrelocs,
                                    info);
...
/* Relocate an M32R/D CGC section.
...
static bfd_boolean
m32r_cgc_relocate_section (bfd *output_bfd ATTRIBUTE_UNUSED,
			   struct bfd_link_info *info,
			   bfd *input_bfd,
			   asection *input_section,
			   bfd_byte *contents,
			   ...
			   asection **local_sections)
{
  ...
  struct cgc_m32r_link_hash_table *htab = m32r_cgc_hash_table (info);
  bfd *dynobj;
  ...
  for (; rel < relend; rel++)
    {
      ...
      struct cgc_link_hash_entry *h;
      /* We can't modify r_addend here as cgc_link_input_bfd has an assert to
      ...
      if (r_type < 0 || r_type >= (int) R_M32R_max)
	{
      ...
      howto = m32r_cgc_howto_table + r_type;
	  ...
	  if (r_type != R_M32R_HI16_SLO && r_type != R_M32R_HI16_ULO)
	  ...
	  else
	    {
		 ...
		 itself.  */
	      for (lorel = rel + 1;
		   (lorel < relend
		    && (CGC32_R_TYPE (lorel->r_info) == R_M32R_HI16_SLO
			|| CGC32_R_TYPE (lorel->r_info) == R_M32R_HI16_ULO));
		   lorel++)
		continue;
	      if (lorel < relend
		  && CGC32_R_TYPE (lorel->r_info) == R_M32R_LO16)
		{
		  m32r_cgc_relocate_hi16 (input_bfd, r_type, rel, lorel,
					  contents, addend);
		  r = bfd_reloc_ok;
		}
	      else
      ...
      else
	{
	  ...
	  switch ((int) r_type)
                      ...
                      if (info->shared)
                        {
                          ...
                          outrel.r_offset = (sgot->output_section->vma
                                             + sgot->output_offset
                                             + off);
                          outrel.r_info = CGC32_R_INFO (0, R_M32R_RELATIVE);
	    ...
	    case (int) R_M32R_10_PCREL :
	      r = m32r_cgc_do_10_pcrel_reloc (input_bfd, howto, input_section,
					      contents, offset,
		...
		if (   strcmp (name, ".sdata") == 0
		    ...
		    || strcmp (name, ".scommon") == 0)
		  {
		    ...
		    r = m32r_cgc_final_sda_base (out_bfd, info,
						 &errmsg,
						 &sda_base);
		    if (r != bfd_reloc_ok)
		      {
		...
		else
		  {
		    (*_bfd_error_handler)
		      (_("%B: The target (%s) of an %s relocation is in the wrong section (%A)"),
		       ...
		       sec,
		       sym_name,
		       m32r_cgc_howto_table[(int) r_type].name);
...
static bfd_boolean
m32r_cgc_finish_dynamic_symbol (bfd *output_bfd,
				struct bfd_link_info *info,
				struct cgc_link_hash_entry *h,
				Cgc_Internal_Sym *sym)
{
...
#ifdef DEBUG_PIC
  printf ("m32r_cgc_finish_dynamic_symbol()\n");
#endif
  ...
  if (h->plt.offset != (bfd_vma) -1)
    {
      ...
      rela.r_offset = (sgot->output_section->vma
                       + sgot->output_offset
                       + got_offset);
      rela.r_info = CGC32_R_INFO (h->dynindx, R_M32R_JMP_SLOT);
      rela.r_addend = 0;
      loc = srela->contents;
      loc += plt_index * sizeof (Cgc32_External_Rela);
  ...
  if (h->got.offset != (bfd_vma) -1)
    {
      ...
      if (info->shared
          ...
          && h->def_regular)
        {
          rela.r_info = CGC32_R_INFO (0, R_M32R_RELATIVE);
	  ...
	  BFD_ASSERT ((h->got.offset & 1) == 0);
          ...
          rela.r_info = CGC32_R_INFO (h->dynindx, R_M32R_GLOB_DAT);
          rela.r_addend = 0;
        }
  ...
  if (h->needs_copy)
    {
      ...
      rela.r_offset = (h->root.u.def.value
                       + h->root.u.def.section->output_section->vma
                       + h->root.u.def.section->output_offset);
      rela.r_info = CGC32_R_INFO (h->dynindx, R_M32R_COPY);
      rela.r_addend = 0;
      loc = s->contents;
      loc += s->reloc_count * sizeof (Cgc32_External_Rela);
      bfd_cgc32_swap_reloca_out (output_bfd, &rela, loc);
      ++s->reloc_count;
    }
...
static bfd_boolean
m32r_cgc_finish_dynamic_sections (bfd *output_bfd,
				  struct bfd_link_info *info)
{
  struct cgc_m32r_link_hash_table *htab;
  bfd *dynobj;
...
#ifdef DEBUG_PIC
  printf ("m32r_cgc_finish_dynamic_sections()\n");
#endif
...
static bfd_boolean
m32r_cgc_object_p (bfd *abfd)
{
  switch (cgc_cgcheader (abfd)->e_flags & EF_M32R_ARCH)
    {
    default:
...
static void
m32r_cgc_final_write_processing (bfd *abfd,
				 bfd_boolean linker ATTRIBUTE_UNUSED)
{
  ...
  cgc_cgcheader (abfd)->e_flags &=~ EF_M32R_ARCH;
...
static bfd_boolean
m32r_cgc_set_private_flags (bfd *abfd, flagword flags)
{
...
static bfd_boolean
m32r_cgc_merge_private_bfd_data (bfd *ibfd, bfd *obfd)
{
  flagword out_flags;
  flagword in_flags;
...
static bfd_boolean
m32r_cgc_print_private_bfd_data (bfd *abfd, void * ptr)
{
  FILE * file = (FILE *) ptr;
...
static asection *
m32r_cgc_gc_mark_hook (asection *sec,
		       struct bfd_link_info *info,
...
static bfd_boolean
m32r_cgc_gc_sweep_hook (bfd *abfd ATTRIBUTE_UNUSED,
  ...
  for (rel = relocs; rel < relend; rel++)
	...
	case R_M32R_26_PCREL_RELA:
	  if (h != NULL)
		...
		if (p->sec == sec)
		  {
		    if (   CGC32_R_TYPE (rel->r_info) == R_M32R_26_PCREL_RELA
			|| CGC32_R_TYPE (rel->r_info) == R_M32R_18_PCREL_RELA
			|| CGC32_R_TYPE (rel->r_info) == R_M32R_10_PCREL_RELA
			|| CGC32_R_TYPE (rel->r_info) == R_M32R_REL32)
		      p->pc_count -= 1;
		    p->count -= 1;
		    if (p->count == 0)
		      *pp = p->next;
...
static bfd_boolean
m32r_cgc_check_relocs (bfd *abfd,
		       struct bfd_link_info *info,
		       asection *sec,
        ...
        case R_M32R_26_PCREL_RELA:
          ...
          if ((info->shared
	       ...
	       && ((   r_type != R_M32R_26_PCREL_RELA
            ...
            {
              struct cgc_m32r_dyn_relocs *p;
              struct cgc_m32r_dyn_relocs **head;
		  ...
		  if (sreloc == NULL)
		    return FALSE;
              ...
              if (h != NULL)
                head = &((struct cgc_m32r_link_hash_entry *) h)->dyn_relocs;
              else
                {
		  ...
		  vpp = &cgc_section_data (s)->local_dynrel;
                  head = (struct cgc_m32r_dyn_relocs **) vpp;
                }
...
static const struct bfd_cgc_special_section m32r_cgc_special_sections[] =
{
...
m32r_cgc_reloc_type_class (const struct bfd_link_info *info ATTRIBUTE_UNUSED,
...

#define CGC_ARCH		bfd_arch_m32r
#define CGC_TARGET_ID		M32R_CGC_DATA
#define CGC_MACHINE_CODE	EM_M32R
#define CGC_MACHINE_ALT1	EM_CYGNUS_M32R
#define CGC_MAXPAGESIZE		0x1 /* Explicitly requested by Mitsubishi.  */

#define TARGET_BIG_SYM          bfd_cgc32_m32r_vec
#define TARGET_BIG_NAME		"cgc32-m32r"
#define TARGET_LITTLE_SYM       bfd_cgc32_m32rle_vec
#define TARGET_LITTLE_NAME      "cgc32-m32rle"

#define cgc_info_to_howto			m32r_info_to_howto
#define cgc_info_to_howto_rel			m32r_info_to_howto_rel
#define cgc_backend_section_from_bfd_section	_bfd_m32r_cgc_section_from_bfd_section
#define cgc_backend_symbol_processing		_bfd_m32r_cgc_symbol_processing
#define cgc_backend_add_symbol_hook		m32r_cgc_add_symbol_hook
#define cgc_backend_relocate_section		m32r_cgc_relocate_section
#define cgc_backend_gc_mark_hook                m32r_cgc_gc_mark_hook
#define cgc_backend_gc_sweep_hook               m32r_cgc_gc_sweep_hook
#define cgc_backend_check_relocs                m32r_cgc_check_relocs

#define cgc_backend_create_dynamic_sections     m32r_cgc_create_dynamic_sections
#define bfd_cgc32_bfd_link_hash_table_create    m32r_cgc_link_hash_table_create
#define cgc_backend_size_dynamic_sections       m32r_cgc_size_dynamic_sections
#define cgc_backend_omit_section_dynsym \
  ((bfd_boolean (*) (bfd *, struct bfd_link_info *, asection *)) bfd_true)
#define cgc_backend_finish_dynamic_sections     m32r_cgc_finish_dynamic_sections
#define cgc_backend_adjust_dynamic_symbol       m32r_cgc_adjust_dynamic_symbol
#define cgc_backend_finish_dynamic_symbol       m32r_cgc_finish_dynamic_symbol
#define cgc_backend_reloc_type_class            m32r_cgc_reloc_type_class
#define cgc_backend_copy_indirect_symbol        m32r_cgc_copy_indirect_symbol
...
#define cgc_backend_object_p			m32r_cgc_object_p
#define cgc_backend_final_write_processing 	m32r_cgc_final_write_processing
#define bfd_cgc32_bfd_merge_private_bfd_data 	m32r_cgc_merge_private_bfd_data
#define bfd_cgc32_bfd_set_private_flags		m32r_cgc_set_private_flags
#define bfd_cgc32_bfd_print_private_bfd_data	m32r_cgc_print_private_bfd_data
#define cgc_backend_special_sections		m32r_cgc_special_sections
...
#define TARGET_BIG_SYM          bfd_cgc32_m32rlin_vec
#undef  TARGET_BIG_NAME
#define TARGET_BIG_NAME         "cgc32-m32r-linux"
#undef  TARGET_LITTLE_SYM
#define TARGET_LITTLE_SYM       bfd_cgc32_m32rlelin_vec
#undef  TARGET_LITTLE_NAME
#define TARGET_LITTLE_NAME      "cgc32-m32rle-linux"
#undef  cgc32_bed
#define cgc32_bed               cgc32_m32r_lin_bed
