/* D30V-specific support for 32-bit CGC
...
static bfd_reloc_status_type
bfd_cgc_d30v_reloc_21 (bfd *abfd,
		       arelent *reloc_entry,
		       asymbol *symbol,
		       void * data,
		       asection *input_section,
...
static reloc_howto_type cgc_d30v_howto_table[] =
{
  ...
  HOWTO (R_D30V_9_PCREL,	/* Type.  */
	 ...
	 bfd_cgc_d30v_reloc_21,	/* Special_function.  */
	 "R_D30V_9_PCREL",	/* Name.  */
	 FALSE,			/* Partial_inplace.  */
	 0x3f,			/* Src_mask.  */
	 0x3f,			/* Dst_mask.  */
  ...
  HOWTO (R_D30V_32,		/* Type.  */
	 ...
	 0,			/* Bitpos.  */
	 complain_overflow_bitfield, /* Complain_on_overflow.  */
	 bfd_cgc_d30v_reloc,	/* Special_function.  */
	 "R_D30V_32",		/* Name.  */
	 FALSE,			/* Partial_inplace.  */
	 0xffffffff,		/* Src_mask.  */
	 0xffffffff,		/* Dst_mask.  */
...
/* Map BFD reloc types to D30V CGC reloc types.  */
				 ...
				 bfd_reloc_code_real_type code)
{
  ...
  for (i = 0;
	...
	return &cgc_d30v_howto_table[d30v_reloc_map[i].cgc_reloc_val];
    }
				 ...
				 const char *r_name)
{
  ...
  for (i = 0;
       i < sizeof (cgc_d30v_howto_table) / sizeof (cgc_d30v_howto_table[0]);
       i++)
    if (cgc_d30v_howto_table[i].name != NULL
	&& strcasecmp (cgc_d30v_howto_table[i].name, r_name) == 0)
      return &cgc_d30v_howto_table[i];

  return NULL;
}

/* Set the howto pointer for an D30V CGC reloc (type REL).  */
			...
			Cgc_Internal_Rela *dst)
{
  ...
  cache_ptr->howto = &cgc_d30v_howto_table[r_type];
}

/* Set the howto pointer for an D30V CGC reloc (type RELA).  */
...
#define CGC_ARCH		bfd_arch_d30v
#define CGC_MACHINE_CODE	EM_D30V
#define CGC_MACHINE_ALT1	EM_CYGNUS_D30V
#define CGC_MAXPAGESIZE		0x1000

#define TARGET_BIG_SYM          bfd_cgc32_d30v_vec
#define TARGET_BIG_NAME		"cgc32-d30v"

#define cgc_info_to_howto	d30v_info_to_howto_rela
#define cgc_info_to_howto_rel	d30v_info_to_howto_rel
