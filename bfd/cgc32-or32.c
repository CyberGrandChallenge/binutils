/* OR32-specific support for 32-bit CGC
...
/* Try to minimize the amount of space occupied by relocation tables
   on the ROM (not that the ROM won't be swamped by other CGC overhead).  */
#define USE_REL	1

/* Set the right machine number for an OR32 CGC file.  */

static bfd_boolean
or32_cgc_object_p (bfd *abfd)
{
  (void) bfd_default_set_arch_mach (abfd, bfd_arch_or32, 0);
  return TRUE;
}

/* The final processing done just before writing out an OR32 CGC object file.
   This gets the OR32 architecture right based on the machine number.  */

static void
or32_cgc_final_write_processing (bfd *abfd,
				 bfd_boolean linker ATTRIBUTE_UNUSED)
{
  cgc_cgcheader (abfd)->e_flags &=~ EF_OR32_MACH;
}

static bfd_reloc_status_type
or32_cgc_32_reloc (bfd *abfd,
		   arelent *reloc_entry,
		   asymbol *symbol,
		   void * data,
...
static bfd_reloc_status_type
or32_cgc_8_reloc (bfd *abfd ATTRIBUTE_UNUSED,
		  arelent *reloc_entry,
		  asymbol *symbol,
		  void * data,
		  asection *input_section,
...
/* Do a R_OR32_CONSTH relocation.  This has to be done in combination
   ...
   actual relocation when we see the LO16.  OR32 CGC requires that the
   LO16 immediately follow the HI16.  As a GNU extension, we permit an
   arbitrary number of HI16 relocs to be associated with a single LO16
   reloc.  This extension permits gcc to output the HI and LO relocs
   itself. This code is copied from the cgc32-mips.c.  */
...
static bfd_reloc_status_type
or32_cgc_consth_reloc (bfd *abfd ATTRIBUTE_UNUSED,
		       arelent *reloc_entry,
		       asymbol *symbol,
		       void * data,
		       asection *input_section,
...
static bfd_reloc_status_type
or32_cgc_jumptarg_reloc (bfd *abfd,
			 arelent *reloc_entry,
...
static reloc_howto_type cgc_or32_howto_table[] =
{
  ...
  HOWTO (R_OR32_32,		/* type */
	 ...
	 0,	                /* bitpos */
	 complain_overflow_bitfield, /* complain_on_overflow */
	 or32_cgc_32_reloc, 	/* special_function */
	 "R_OR32_32",		/* name */
	 FALSE,	                /* partial_inplace */
	 0xffffffff,	        /* src_mask */
	 0xffffffff,   		/* dst_mask */
  ...
  HOWTO (R_OR32_16,		/* type */
	 ...
	 0,	                /* bitpos */
	 complain_overflow_bitfield, /* complain_on_overflow */
	 or32_cgc_16_reloc, 	/* special_function */
	 "R_OR32_16",		/* name */
	 FALSE,	                /* partial_inplace */
	 0x0000ffff,	        /* src_mask */
	 0x0000ffff,   		/* dst_mask */
  ...
  HOWTO (R_OR32_8,		/* type */
	 ...
	 0,	                /* bitpos */
	 complain_overflow_bitfield, /* complain_on_overflow */
	 or32_cgc_8_reloc, 	/* special_function */
	 "R_OR32_8",		/* name */
	 FALSE,	                /* partial_inplace */
	 0x000000ff,	        /* src_mask */
	 0x000000ff,   		/* dst_mask */
  ...
  HOWTO (R_OR32_CONST,		/* type */
	 ...
	 or32_cgc_const_reloc,	/* special_function */
	 "R_OR32_CONST",	/* name */
	 FALSE,			/* partial_inplace */
	 0x0000ffff,		/* src_mask */
	 0x0000ffff,		/* dst_mask */
  ...
  HOWTO (R_OR32_CONSTH,		/* type */
	 ...
	 0,			/* bitpos */
	 complain_overflow_dont, /* complain_on_overflow */
	 or32_cgc_consth_reloc,	/* special_function */
	 "R_OR32_CONSTH",	/* name */
	 FALSE,			/* partial_inplace */
	 0xffff0000,		/* src_mask */
	 0x0000ffff,		/* dst_mask */
  ...
  HOWTO (R_OR32_JUMPTARG,	/* type */
	 ...
	 or32_cgc_jumptarg_reloc,/* special_function */
...
/* Map BFD reloc types to OR32 CGC reloc types.  */
				 ...
				 bfd_reloc_code_real_type code)
{
  ...
  for (i = ARRAY_SIZE (or32_reloc_map); i--;)
    if (or32_reloc_map[i].bfd_reloc_val == code)
      return &cgc_or32_howto_table[or32_reloc_map[i].cgc_reloc_val];
				 ...
				 const char *r_name)
{
  ...
  for (i = 0;
       i < sizeof (cgc_or32_howto_table) / sizeof (cgc_or32_howto_table[0]);
       i++)
    if (cgc_or32_howto_table[i].name != NULL
	&& strcasecmp (cgc_or32_howto_table[i].name, r_name) == 0)
      return &cgc_or32_howto_table[i];

  return NULL;
}

/* Set the howto pointer for an OR32 CGC reloc.  */
			...
			Cgc_Internal_Rela *dst)
{
  ...
  cache_ptr->howto = &cgc_or32_howto_table[r_type];
}

#define TARGET_LITTLE_SYM	bfd_cgc32_or32_little_vec
#define TARGET_LITTLE_NAME	"cgc32-littleor32"
#define TARGET_BIG_SYM		bfd_cgc32_or32_big_vec
#define TARGET_BIG_NAME		"cgc32-or32"
#define CGC_ARCH		bfd_arch_or32
#define CGC_MACHINE_CODE	EM_OR32
#define CGC_MAXPAGESIZE		0x1000

#define cgc_info_to_howto	0
#define cgc_info_to_howto_rel	or32_info_to_howto_rel
#define cgc_backend_object_p	or32_cgc_object_p
#define cgc_backend_final_write_processing \
				or32_cgc_final_write_processing
