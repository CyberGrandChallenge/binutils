/* AArch64-specific support for CGC.
...
_bfd_aarch64_cgc_put_addend (bfd *abfd,
...
bfd_vma
_bfd_aarch64_cgc_resolve_relocation (bfd_reloc_code_real_type r_type,
...
bfd_boolean
_bfd_aarch64_cgc_add_symbol_hook (bfd *abfd, struct bfd_link_info *info,
...
bfd_boolean
_bfd_aarch64_cgc_grok_prstatus (bfd *abfd, Cgc_Internal_Note *note)
{
  int offset;
  size_t size;
  ...
  switch (note->descsz)
	...
	return FALSE;
      ...
      case 392:		/* sizeof(struct cgc_prstatus) on Linux/arm64.  */
	/* pr_cursig */
