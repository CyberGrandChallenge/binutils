/* Xtensa-specific support for 32-bit CGC.
...
static bfd_reloc_status_type bfd_cgc_xtensa_reloc
  (bfd *, arelent *, asymbol *, void *, asection *, bfd *, char **);
static bfd_boolean do_fix_for_relocatable_link
  (Cgc_Internal_Rela *, bfd *, asection *, bfd_byte *);
static void do_fix_for_final_link
  (Cgc_Internal_Rela *, bfd *, asection *, bfd_byte *, bfd_vma *);
...
static xtensa_opcode get_relocation_opcode
  (bfd *, asection *, bfd_byte *, Cgc_Internal_Rela *);
...
static bfd_reloc_status_type cgc_xtensa_do_asm_simplify
  (bfd_byte *, bfd_vma, bfd_vma, char **);
static bfd_reloc_status_type contract_asm_expansion
  (bfd_byte *, bfd_vma, Cgc_Internal_Rela *, char **);
...
static Cgc_Internal_Rela *retrieve_internal_relocs
  (bfd *, asection *, bfd_boolean);
static void pin_internal_relocs (asection *, Cgc_Internal_Rela *);
static void release_internal_relocs (asection *, Cgc_Internal_Rela *);
...
static Cgc_Internal_Sym *retrieve_local_syms (bfd *);

/* Miscellaneous utility functions.  */

static asection *cgc_xtensa_get_plt_section (struct bfd_link_info *, int);
static asection *cgc_xtensa_get_gotplt_section (struct bfd_link_info *, int);
static asection *get_cgc_r_symndx_section (bfd *, unsigned long);
static struct cgc_link_hash_entry *get_cgc_r_symndx_hash_entry
  (bfd *, unsigned long);
static bfd_vma get_cgc_r_symndx_offset (bfd *, unsigned long);
static bfd_boolean is_reloc_sym_weak (bfd *, Cgc_Internal_Rela *);
...
int cgc32xtensa_no_literal_movement = 1;
...
static reloc_howto_type cgc_howto_table[] =
{
  HOWTO (R_XTENSA_NONE, 0, 0, 0, FALSE, 0, complain_overflow_dont,
	 bfd_cgc_xtensa_reloc, "R_XTENSA_NONE",
	 FALSE, 0, 0, FALSE),
  HOWTO (R_XTENSA_32, 0, 2, 32, FALSE, 0, complain_overflow_bitfield,
	 bfd_cgc_xtensa_reloc, "R_XTENSA_32",
...
cgc_xtensa_reloc_type_lookup (bfd *abfd ATTRIBUTE_UNUSED,
			      bfd_reloc_code_real_type code)
{
  switch (code)
    ...
    case BFD_RELOC_NONE:
      ...
      return &cgc_howto_table[(unsigned) R_XTENSA_NONE ];

    case BFD_RELOC_32:
      TRACE ("BFD_RELOC_32");
      return &cgc_howto_table[(unsigned) R_XTENSA_32 ];

    case BFD_RELOC_32_PCREL:
      TRACE ("BFD_RELOC_32_PCREL");
      return &cgc_howto_table[(unsigned) R_XTENSA_32_PCREL ];

    case BFD_RELOC_XTENSA_DIFF8:
      TRACE ("BFD_RELOC_XTENSA_DIFF8");
      return &cgc_howto_table[(unsigned) R_XTENSA_DIFF8 ];

    case BFD_RELOC_XTENSA_DIFF16:
      TRACE ("BFD_RELOC_XTENSA_DIFF16");
      return &cgc_howto_table[(unsigned) R_XTENSA_DIFF16 ];

    case BFD_RELOC_XTENSA_DIFF32:
      TRACE ("BFD_RELOC_XTENSA_DIFF32");
      return &cgc_howto_table[(unsigned) R_XTENSA_DIFF32 ];

    case BFD_RELOC_XTENSA_RTLD:
      TRACE ("BFD_RELOC_XTENSA_RTLD");
      return &cgc_howto_table[(unsigned) R_XTENSA_RTLD ];

    case BFD_RELOC_XTENSA_GLOB_DAT:
      TRACE ("BFD_RELOC_XTENSA_GLOB_DAT");
      return &cgc_howto_table[(unsigned) R_XTENSA_GLOB_DAT ];

    case BFD_RELOC_XTENSA_JMP_SLOT:
      TRACE ("BFD_RELOC_XTENSA_JMP_SLOT");
      return &cgc_howto_table[(unsigned) R_XTENSA_JMP_SLOT ];

    case BFD_RELOC_XTENSA_RELATIVE:
      TRACE ("BFD_RELOC_XTENSA_RELATIVE");
      return &cgc_howto_table[(unsigned) R_XTENSA_RELATIVE ];

    case BFD_RELOC_XTENSA_PLT:
      TRACE ("BFD_RELOC_XTENSA_PLT");
      return &cgc_howto_table[(unsigned) R_XTENSA_PLT ];

    case BFD_RELOC_XTENSA_OP0:
      TRACE ("BFD_RELOC_XTENSA_OP0");
      return &cgc_howto_table[(unsigned) R_XTENSA_OP0 ];

    case BFD_RELOC_XTENSA_OP1:
      TRACE ("BFD_RELOC_XTENSA_OP1");
      return &cgc_howto_table[(unsigned) R_XTENSA_OP1 ];

    case BFD_RELOC_XTENSA_OP2:
      TRACE ("BFD_RELOC_XTENSA_OP2");
      return &cgc_howto_table[(unsigned) R_XTENSA_OP2 ];

    case BFD_RELOC_XTENSA_ASM_EXPAND:
      TRACE ("BFD_RELOC_XTENSA_ASM_EXPAND");
      return &cgc_howto_table[(unsigned) R_XTENSA_ASM_EXPAND ];

    case BFD_RELOC_XTENSA_ASM_SIMPLIFY:
      TRACE ("BFD_RELOC_XTENSA_ASM_SIMPLIFY");
      return &cgc_howto_table[(unsigned) R_XTENSA_ASM_SIMPLIFY ];

    case BFD_RELOC_VTABLE_INHERIT:
      TRACE ("BFD_RELOC_VTABLE_INHERIT");
      return &cgc_howto_table[(unsigned) R_XTENSA_GNU_VTINHERIT ];

    case BFD_RELOC_VTABLE_ENTRY:
      TRACE ("BFD_RELOC_VTABLE_ENTRY");
      return &cgc_howto_table[(unsigned) R_XTENSA_GNU_VTENTRY ];

    case BFD_RELOC_XTENSA_TLSDESC_FN:
      TRACE ("BFD_RELOC_XTENSA_TLSDESC_FN");
      return &cgc_howto_table[(unsigned) R_XTENSA_TLSDESC_FN ];

    case BFD_RELOC_XTENSA_TLSDESC_ARG:
      TRACE ("BFD_RELOC_XTENSA_TLSDESC_ARG");
      return &cgc_howto_table[(unsigned) R_XTENSA_TLSDESC_ARG ];

    case BFD_RELOC_XTENSA_TLS_DTPOFF:
      TRACE ("BFD_RELOC_XTENSA_TLS_DTPOFF");
      return &cgc_howto_table[(unsigned) R_XTENSA_TLS_DTPOFF ];

    case BFD_RELOC_XTENSA_TLS_TPOFF:
      TRACE ("BFD_RELOC_XTENSA_TLS_TPOFF");
      return &cgc_howto_table[(unsigned) R_XTENSA_TLS_TPOFF ];

    case BFD_RELOC_XTENSA_TLS_FUNC:
      TRACE ("BFD_RELOC_XTENSA_TLS_FUNC");
      return &cgc_howto_table[(unsigned) R_XTENSA_TLS_FUNC ];

    case BFD_RELOC_XTENSA_TLS_ARG:
      TRACE ("BFD_RELOC_XTENSA_TLS_ARG");
      return &cgc_howto_table[(unsigned) R_XTENSA_TLS_ARG ];

    case BFD_RELOC_XTENSA_TLS_CALL:
      TRACE ("BFD_RELOC_XTENSA_TLS_CALL");
      return &cgc_howto_table[(unsigned) R_XTENSA_TLS_CALL ];
...
static reloc_howto_type *
cgc_xtensa_reloc_name_lookup (bfd *abfd ATTRIBUTE_UNUSED,
			      const char *r_name)
{
  unsigned int i;
...
/* Given an CGC "rela" relocation, find the corresponding howto and record
   it in the BFD internal arelent representation of the relocation.  */

static void
cgc_xtensa_info_to_howto_rela (bfd *abfd ATTRIBUTE_UNUSED,
			       arelent *cache_ptr,
...

/* Functions for the Xtensa CGC linker.  */

/* The name of the dynamic interpreter.  This is put in the .interp
   section.  */

#define CGC_DYNAMIC_INTERPRETER "/lib/ld.so"
...
static const bfd_byte cgc_xtensa_be_plt_entry[PLT_ENTRY_SIZE] =
{
...
static const bfd_byte cgc_xtensa_le_plt_entry[PLT_ENTRY_SIZE] =
{
...
struct cgc_xtensa_link_hash_entry
{
...
#define cgc_xtensa_hash_entry(ent) ((struct cgc_xtensa_link_hash_entry *)(ent))

struct cgc_xtensa_obj_tdata
{
...
#define cgc_xtensa_tdata(abfd) \
  ((struct cgc_xtensa_obj_tdata *) (abfd)->tdata.any)

#define cgc_xtensa_local_got_tls_type(abfd) \
  (cgc_xtensa_tdata (abfd)->local_got_tls_type)

#define cgc_xtensa_local_tlsfunc_refcounts(abfd) \
  (cgc_xtensa_tdata (abfd)->local_tlsfunc_refcounts)

#define is_xtensa_cgc(bfd) \
  (bfd_get_flavour (bfd) == bfd_target_cgc_flavour \
   && cgc_tdata (bfd) != NULL \
   && cgc_object_id (bfd) == XTENSA_CGC_DATA)

static bfd_boolean
cgc_xtensa_mkobject (bfd *abfd)
{
  return bfd_cgc_allocate_object (abfd, sizeof (struct cgc_xtensa_obj_tdata),
				  XTENSA_CGC_DATA);
}

/* Xtensa CGC linker hash table.  */

struct cgc_xtensa_link_hash_table
{
  ...
  struct cgc_xtensa_link_hash_entry *tlsbase;
};

/* Get the Xtensa CGC linker hash table from a link_info structure.  */

#define cgc_xtensa_hash_table(p) \
  (cgc_hash_table_id ((struct cgc_link_hash_table *) ((p)->hash)) \
  == XTENSA_CGC_DATA ? ((struct cgc_xtensa_link_hash_table *) ((p)->hash)) : NULL)

/* Create an entry in an Xtensa CGC linker hash table.  */

static struct bfd_hash_entry *
cgc_xtensa_link_hash_newfunc (struct bfd_hash_entry *entry,
			      ...
			      const char *string)
{
  ...
  if (entry == NULL)
    {
      entry = bfd_hash_allocate (table,
				 sizeof (struct cgc_xtensa_link_hash_entry));
      if (entry == NULL)
	return entry;
    }
  ...
  if (entry != NULL)
    {
      struct cgc_xtensa_link_hash_entry *eh = cgc_xtensa_hash_entry (entry);
...
/* Create an Xtensa CGC linker hash table.  */

static struct bfd_link_hash_table *
cgc_xtensa_link_hash_table_create (bfd *abfd)
{
  struct cgc_link_hash_entry *tlsbase;
  struct cgc_xtensa_link_hash_table *ret;
  bfd_size_type amt = sizeof (struct cgc_xtensa_link_hash_table);
  ...
  /* Create a hash entry for "_TLS_MODULE_BASE_" to speed up checking
     for it later.  */
  tlsbase = cgc_link_hash_lookup (&ret->cgc, "_TLS_MODULE_BASE_",
				  TRUE, FALSE, FALSE);
  tlsbase->root.type = bfd_link_hash_new;
  tlsbase->root.u.undef.abfd = NULL;
  tlsbase->non_cgc = 0;
  ret->tlsbase = cgc_xtensa_hash_entry (tlsbase);
...
static void
cgc_xtensa_copy_indirect_symbol (struct bfd_link_info *info,
				 struct cgc_link_hash_entry *dir,
				 struct cgc_link_hash_entry *ind)
{
  struct cgc_xtensa_link_hash_entry *edir, *eind;

  edir = cgc_xtensa_hash_entry (dir);
  eind = cgc_xtensa_hash_entry (ind);
...
cgc_xtensa_dynamic_symbol_p (struct cgc_link_hash_entry *h,
			     struct bfd_link_info *info)
{
  ...
  return _bfd_cgc_dynamic_symbol_p (h, info, 0);
}
			   ...
			   bfd_boolean output_addr)
{
  ...
  Cgc_Internal_Rela *internal_relocs, *irel, *rel_end;
  ...
  if (internal_relocs && !table_section->reloc_done)
    {
      qsort (internal_relocs, table_section->reloc_count,
	     sizeof (Cgc_Internal_Rela), internal_reloc_compare);
  ...
  for (off = 0; off < table_size; off += table_entry_size)
    {
	 ...
	 table entry.  */
      while (irel &&
	     (irel->r_offset < off
	      || (irel->r_offset == off
		  && CGC32_R_TYPE (irel->r_info) == R_XTENSA_NONE)))
	{
	  irel += 1;
	  if (irel >= rel_end)
	    irel = 0;
      ...
      if (irel && irel->r_offset == off)
	{
	  ...
	  BFD_ASSERT (CGC32_R_TYPE (irel->r_info) == R_XTENSA_32);

	  if (get_cgc_r_symndx_section (abfd, r_symndx) != section)
	    continue;

	  sym_off = get_cgc_r_symndx_offset (abfd, r_symndx);
...
cgc_xtensa_find_property_entry (property_table_entry *property_table,
...
static bfd_boolean
cgc_xtensa_in_literal_pool (property_table_entry *lit_table,
			    int lit_table_size,
			    bfd_vma addr)
{
  if (cgc_xtensa_find_property_entry (lit_table, lit_table_size, addr))
    return TRUE;
...
static bfd_boolean
cgc_xtensa_check_relocs (bfd *abfd,
			 struct bfd_link_info *info,
			 asection *sec,
			 const Cgc_Internal_Rela *relocs)
{
  struct cgc_xtensa_link_hash_table *htab;
  ...
  BFD_ASSERT (is_xtensa_cgc (abfd));

  htab = cgc_xtensa_hash_table (info);
  if (htab == NULL)
    return FALSE;
  ...
  for (rel = relocs; rel < rel_end; rel++)
    {
      ...
      struct cgc_xtensa_link_hash_entry *eh;
	...
	case R_XTENSA_TLSDESC_ARG:
	  if (info->shared)
	    ...
	    {
	      tls_type = GOT_TLS_IE;
	      if (h && cgc_xtensa_hash_entry (h) != htab->tlsbase)
		is_got = TRUE;
	    }
	  break;
      ...
      else
	{
	  ...
	  if (cgc_local_got_refcounts (abfd) == NULL)
	    {
	      ...
	      if (mem == NULL)
		return FALSE;
	      cgc_local_got_refcounts (abfd) = (bfd_signed_vma *) mem;

	      mem = bfd_zalloc (abfd, size);
	      if (mem == NULL)
		return FALSE;
	      cgc_xtensa_local_got_tls_type (abfd) = (char *) mem;

	      mem = bfd_zalloc (abfd, size * sizeof (bfd_signed_vma));
	      if (mem == NULL)
		return FALSE;
	      cgc_xtensa_local_tlsfunc_refcounts (abfd)
		= (bfd_signed_vma *) mem;
	    }
	  ...
	  if (is_tlsfunc)
	    cgc_xtensa_local_tlsfunc_refcounts (abfd) [r_symndx] += 1;

	  old_tls_type = cgc_xtensa_local_got_tls_type (abfd) [r_symndx];
	}
      ...
      if (old_tls_type != tls_type)
	{
	  if (eh)
	    ...
	    cgc_xtensa_local_got_tls_type (abfd) [r_symndx] = tls_type;
	}
    }
...
static void
cgc_xtensa_make_sym_local (struct bfd_link_info *info,
...
static void
cgc_xtensa_hide_symbol (struct bfd_link_info *info,
                        struct cgc_link_hash_entry *h,
                        bfd_boolean force_local)
{
  /* For a shared link, move the plt refcount to the got refcount to leave
     space for RELATIVE relocs.  */
  cgc_xtensa_make_sym_local (info, h);
...
static asection *
cgc_xtensa_gc_mark_hook (asection *sec,
			 struct bfd_link_info *info,
			 ...
			 Cgc_Internal_Sym *sym)
{
  /* Property sections are marked "KEEP" in the linker scripts, but they
     ...
     on cgc_xtensa_discard_info to remove property table entries that
...
static bfd_boolean
cgc_xtensa_gc_sweep_hook (bfd *abfd,
			  struct bfd_link_info *info,
			  asection *sec,
			  const Cgc_Internal_Rela *relocs)
{
  ...
  for (rel = relocs; rel < relend; rel++)
      ...
      else
	{
	  if (is_got || is_plt)
		...
		= &cgc_local_got_refcounts (abfd) [r_symndx];
	      if (*got_refcount > 0)
		*got_refcount -= 1;
	    }
	  if (is_tlsfunc)
	    {
	      bfd_signed_vma *tlsfunc_refcount
		= &cgc_xtensa_local_tlsfunc_refcounts (abfd) [r_symndx];
...
static bfd_boolean
cgc_xtensa_create_dynamic_sections (bfd *dynobj, struct bfd_link_info *info)
{
  struct cgc_xtensa_link_hash_table *htab;
  ...
  for (chunk = count / PLT_ENTRIES_PER_CHUNK; chunk > 0; chunk--)
    {
      ...
      if (cgc_xtensa_get_plt_section (info, chunk))
	break;
...
static bfd_boolean
cgc_xtensa_adjust_dynamic_symbol (struct bfd_link_info *info ATTRIBUTE_UNUSED,
				  struct cgc_link_hash_entry *h)
{
...
static bfd_boolean
cgc_xtensa_allocate_dynrelocs (struct cgc_link_hash_entry *h, void *arg)
{
  struct bfd_link_info *info;
  struct cgc_xtensa_link_hash_table *htab;
  struct cgc_xtensa_link_hash_entry *eh = cgc_xtensa_hash_entry (h);
  ...
  if (! cgc_xtensa_dynamic_symbol_p (h, info))
    cgc_xtensa_make_sym_local (info, h);

  if (h->plt.refcount > 0)
    htab->srelplt->size += (h->plt.refcount * sizeof (Cgc32_External_Rela));

  if (h->got.refcount > 0)
    htab->srelgot->size += (h->got.refcount * sizeof (Cgc32_External_Rela));
...
static void
cgc_xtensa_allocate_local_got_size (struct bfd_link_info *info)
{
  struct cgc_xtensa_link_hash_table *htab;
  bfd *i;
  ...
  for (i = info->input_bfds; i; i = i->link_next)
    {
      ...
      local_got_refcounts = cgc_local_got_refcounts (i);
      ...
      for (j = 0; j < cnt; ++j)
	{
	  ...
	  if ((cgc_xtensa_local_got_tls_type (i) [j] & GOT_TLS_IE) != 0)
	    {
	      bfd_signed_vma *tlsfunc_refcount
		= &cgc_xtensa_local_tlsfunc_refcounts (i) [j];
...
static bfd_boolean
cgc_xtensa_size_dynamic_sections (bfd *output_bfd ATTRIBUTE_UNUSED,
				  struct bfd_link_info *info)
{
  struct cgc_xtensa_link_hash_table *htab;
  bfd *dynobj, *abfd;
  ...
  if (cgc_hash_table (info)->dynamic_sections_created)
      ...
      if (info->executable)
	{
	 ...
	 reference local symbols.  */
      if (info->shared)
	cgc_xtensa_allocate_local_got_size (info);
	 ...
	 8-byte entry in ".xt.lit.plt".  */
      ...
      plt_entries = srelplt->size / sizeof (Cgc32_External_Rela);
      plt_chunks =
	(plt_entries + PLT_ENTRIES_PER_CHUNK - 1) / PLT_ENTRIES_PER_CHUNK;
	 ...
	 was an overestimate.  */
      for (chunk = 0;
	   (splt = cgc_xtensa_get_plt_section (info, chunk)) != NULL;
	   chunk++)
	{
	  int chunk_entries;

	  sgotplt = cgc_xtensa_get_gotplt_section (info, chunk);
	  ...
	  if (chunk_entries != 0)
	    {
	      ...
	      srelgot->size += 2 * sizeof (Cgc32_External_Rela);
	      spltlittbl->size += 8;
	    }
	  else
	    {
  ...
  if (cgc_hash_table (info)->dynamic_sections_created)
      ...
      for (chunk = 0; chunk < plt_chunks; chunk++)
	{
	  ...
	  irela.r_offset = 0;
	  irela.r_info = CGC32_R_INFO (0, R_XTENSA_RTLD);
	  irela.r_addend = 0;

	  loc = (srelgot->contents
		 + srelgot->reloc_count * sizeof (Cgc32_External_Rela));
	  bfd_cgc32_swap_reloca_out (output_bfd, &irela, loc);
	  bfd_cgc32_swap_reloca_out (output_bfd, &irela,
				     loc + sizeof (Cgc32_External_Rela));
	  srelgot->reloc_count += 2;
	}

      /* Add some entries to the .dynamic section.  We fill in the
	 values later, in cgc_xtensa_finish_dynamic_sections, but we
...
static bfd_boolean
cgc_xtensa_always_size_sections (bfd *output_bfd,
				 struct bfd_link_info *info)
{
  struct cgc_xtensa_link_hash_table *htab;
  asection *tls_sec;
  ...
  tls_sec = htab->cgc.tls_sec;

  if (tls_sec && (htab->tlsbase->tls_type & GOT_TLS_ANY) != 0)
    {
      struct cgc_link_hash_entry *tlsbase = &htab->tlsbase->cgc;
...
cgc_xtensa_do_reloc (reloc_howto_type *howto,
		     bfd *abfd,
		     ...
		     char **error_message)
{
  ...
  switch (howto->type)
	...
	bfd_reloc_status_type retval =
	  cgc_xtensa_do_asm_simplify (contents, address, input_size,
				      error_message);
	...
	address += 3;
	self_address += 3;
	howto = &cgc_howto_table[(unsigned) R_XTENSA_SLOT0_OP ];
      }
      break;
		      ...
		      char **error_message)
{
  ...
  /* CGC relocs are against symbols.  If we are producing relocatable
     ...
     to what bfd_cgc_generic_reloc does except that it lets relocs with
  ...
  flag = cgc_xtensa_do_reloc (howto, abfd, input_section, relocation,
...
static bfd_vma
cgc_xtensa_create_plt_entry (struct bfd_link_info *info,
			     bfd *output_bfd,
			     unsigned reloc_index)
{
  ...
  splt = cgc_xtensa_get_plt_section (info, chunk);
  sgotplt = cgc_xtensa_get_gotplt_section (info, chunk);
  ...
  /* Fill in the literal entry.  This is the offset of the dynamic
     relocation entry.  */
  bfd_put_32 (output_bfd, reloc_index * sizeof (Cgc32_External_Rela),
	      sgotplt->contents + lit_offset);

  /* Fill in the entry in the procedure linkage table.  */
  memcpy (splt->contents + code_offset,
	  (bfd_big_endian (output_bfd)
	   ? cgc_xtensa_be_plt_entry
	   : cgc_xtensa_le_plt_entry),
	  PLT_ENTRY_SIZE);
...
static bfd_boolean
replace_tls_insn (Cgc_Internal_Rela *rel,
		  bfd *abfd,
		  asection *input_section,
		  bfd_byte *contents,
...
/* Relocate an Xtensa CGC section.  This is invoked by the linker for
   both relocatable and final links.  */

static bfd_boolean
cgc_xtensa_relocate_section (bfd *output_bfd,
			     struct bfd_link_info *info,
			     bfd *input_bfd,
			     asection *input_section,
			     bfd_byte *contents,
			     ...
			     asection **local_sections)
{
  ...
  BFD_ASSERT (is_xtensa_cgc (input_bfd));
  ...
  local_got_tls_types = cgc_xtensa_local_got_tls_type (input_bfd);
  ...
  for (; rel < relend; rel++)
	...
	{
	  bfd_vma dest_addr;
	  asection * sym_sec = get_cgc_r_symndx_section (input_bfd, r_symndx);
	  ...
	  dest_addr = sym_sec->output_section->vma + sym_sec->output_offset
	    + get_cgc_r_symndx_offset (input_bfd, r_symndx) + rel->r_addend;
	  ...
	  if (howto->partial_inplace && rel->r_addend)
	    {
	      r = cgc_xtensa_do_reloc (howto, input_bfd, input_section,
      ...
      if (relaxing_section)
	{
	  ...
	  && CGC32_R_TYPE (rel->r_info) != R_XTENSA_NONE)
	{
	  (*_bfd_error_handler)
	  ...
	  && IS_XTENSA_TLS_RELOC (r_type) != (sym_type == STT_TLS))
	{
      ...
      dynamic_symbol = cgc_xtensa_dynamic_symbol_p (h, info);

      tls_type = GOT_UNKNOWN;
      if (h)
	tls_type = cgc_xtensa_hash_entry (h)->tls_type;
	  ...
	  if (cgc_hash_table (info)->dynamic_sections_created
	      ...
	      else
		{
		  ...
		  if ((input_section->flags & SEC_READONLY) != 0
		      && !cgc_xtensa_in_literal_pool (lit_table, ltblsize,
						      outrel.r_offset))
		    {
		      error_message =
		  ...
		  if (dynamic_symbol)
			...
			{
			  outrel.r_info =
			    CGC32_R_INFO (h->dynindx, R_XTENSA_GLOB_DAT);
			  relocation = 0;
			}
		      else /* r_type == R_XTENSA_PLT */
			{
			  outrel.r_info =
			    CGC32_R_INFO (h->dynindx, R_XTENSA_JMP_SLOT);

			  /* Create the PLT entry and set the initial
			     contents of the literal entry to the address of
			     the PLT entry.  */
			  relocation =
			    cgc_xtensa_create_plt_entry (info, output_bfd,
							 srel->reloc_count);
			}
		      unresolved_reloc = FALSE;
		    }
		  else
		    {
		      ...
		      outrel.r_info = CGC32_R_INFO (0, R_XTENSA_RELATIVE);
		      outrel.r_addend = 0;
		    }
		}

	      loc = (srel->contents
		     + srel->reloc_count++ * sizeof (Cgc32_External_Rela));
	      bfd_cgc32_swap_reloca_out (output_bfd, &outrel, loc);
	      BFD_ASSERT (sizeof (Cgc32_External_Rela) * srel->reloc_count
			  <= srel->size);
	    }
	...
	case R_XTENSA_TLS_CALL:
	  ...
	  if ((tls_type & GOT_TLS_IE) != 0)
	    {
	      bfd_boolean is_ld_model =
		(h && cgc_xtensa_hash_entry (h) == htab->tlsbase);
...
static bfd_boolean
cgc_xtensa_finish_dynamic_symbol (bfd *output_bfd ATTRIBUTE_UNUSED,
...
static int
cgc_xtensa_combine_prop_entries (bfd *output_bfd,
				 asection *sxtlit,
				 asection *sgotloc)
{
  bfd_byte *contents;
...
static bfd_boolean
cgc_xtensa_finish_dynamic_sections (bfd *output_bfd,
				    struct bfd_link_info *info)
{
  struct cgc_xtensa_link_hash_table *htab;
  bfd *dynobj;
  ...
  if (srelplt && srelplt->size != 0)
	...
	{
	  loc = srelgot->contents + rtld_reloc * sizeof (Cgc32_External_Rela);
	  bfd_cgc32_swap_reloca_in (output_bfd, loc, &irela);
	  if (CGC32_R_TYPE (irela.r_info) == R_XTENSA_RTLD)
	    break;
	}
      ...
      for (chunk = 0; chunk < plt_chunks; chunk++)
	{
	  ...
	  loc = srelgot->contents + rtld_reloc * sizeof (Cgc32_External_Rela);
	  bfd_cgc32_swap_reloca_in (output_bfd, loc, &irela);
	  BFD_ASSERT (CGC32_R_TYPE (irela.r_info) == R_XTENSA_RTLD);
	 ...
	 Make sure the relocation sections are the correct size.  */
      if (srelgot->size != (sizeof (Cgc32_External_Rela)
			    * srelgot->reloc_count)
	  || srelplt->size != (sizeof (Cgc32_External_Rela)
			       * srelplt->reloc_count))
	abort ();
  ...
  if (sxtlit)
    {
      num_xtlit_entries =
	cgc_xtensa_combine_prop_entries (output_bfd, sxtlit, sgotloc);
  ...
  for (; dyncon < dynconend; dyncon++)
	...
	case DT_RELASZ:
	  /* Adjust RELASZ to not include JMPREL.  This matches what
	     glibc expects and what is done for several other CGC
...
static bfd_boolean
cgc_xtensa_merge_private_bfd_data (bfd *ibfd, bfd *obfd)
{
  ...
  out_flag = cgc_cgcheader (obfd)->e_flags;
  in_flag = cgc_cgcheader (ibfd)->e_flags;
  ...
  if (! cgc_flags_init (obfd))
    {
      ...
      cgc_cgcheader (obfd)->e_flags = in_flag;
  ...
  if ((out_flag & EF_XTENSA_XT_INSN) != (in_flag & EF_XTENSA_XT_INSN))
    cgc_cgcheader (obfd)->e_flags &= (~ EF_XTENSA_XT_INSN);

  if ((out_flag & EF_XTENSA_XT_LIT) != (in_flag & EF_XTENSA_XT_LIT))
    cgc_cgcheader (obfd)->e_flags &= (~ EF_XTENSA_XT_LIT);
...
static bfd_boolean
cgc_xtensa_set_private_flags (bfd *abfd, flagword flags)
{
...
static bfd_boolean
cgc_xtensa_print_private_bfd_data (bfd *abfd, void *farg)
{
  FILE *f = (FILE *) farg;
  flagword e_flags = cgc_cgcheader (abfd)->e_flags;
  ...
  return _bfd_cgc_print_private_bfd_data (abfd, farg);
}


/* Set the right machine number for an Xtensa CGC file.  */

static bfd_boolean
cgc_xtensa_object_p (bfd *abfd)
{
  int mach;
  unsigned long arch = cgc_cgcheader (abfd)->e_flags & EF_XTENSA_MACH;
...
/* The final processing done just before writing out an Xtensa CGC object
   file.  This gets the Xtensa architecture right based on the machine
   number.  */

static void
cgc_xtensa_final_write_processing (bfd *abfd,
				   bfd_boolean linker ATTRIBUTE_UNUSED)
{
  ...
  cgc_cgcheader (abfd)->e_flags &=  (~ EF_XTENSA_MACH);
  cgc_cgcheader (abfd)->e_flags |= val;
}


static enum cgc_reloc_type_class
cgc_xtensa_reloc_type_class (const struct bfd_link_info *info ATTRIBUTE_UNUSED,
...

static bfd_boolean
cgc_xtensa_discard_info_for_section (bfd *abfd,
				     ...
				     asection *sec)
{
  ...
  qsort (cookie->rels, sec->reloc_count, sizeof (Cgc_Internal_Rela),
  ...
  for (offset = 0; offset < sec->size; offset += entry_size)
	     ...
	     && cookie->rel->r_offset < offset)
	{
      ...
      while (cookie->rel < cookie->relend
	     && cookie->rel->r_offset == offset)
	{
	  if (bfd_cgc_reloc_symbol_deleted_p (offset, cookie))
	    {
	      /* Remove the table entry.  (If the reloc type is NONE, then
		 the entry has already been merged with another and deleted
		 during relaxation.)  */
	      if (CGC32_R_TYPE (cookie->rel->r_info) != R_XTENSA_NONE)
		{
	      ...
	      cookie->rel->r_info = CGC32_R_INFO (0, R_XTENSA_NONE);
	    }
  ...
  if (removed_bytes != 0)
	...
	{
	  asection *sgotloc = cgc_xtensa_hash_table (info)->sgotloc;
	  if (sgotloc)
...
static bfd_boolean
cgc_xtensa_discard_info (bfd *abfd,
			 struct cgc_reloc_cookie *cookie,
			 struct bfd_link_info *info)
{
  asection *sec;
  ...
  for (sec = abfd->sections; sec != NULL; sec = sec->next)
    {
      if (xtensa_is_property_section (sec))
	{
	  if (cgc_xtensa_discard_info_for_section (abfd, cookie, info, sec))
	    changed = TRUE;
	}
    }
...
static bfd_boolean
cgc_xtensa_ignore_discarded_relocs (asection *sec)
{
...
static unsigned int
cgc_xtensa_action_discarded (asection *sec)
{
...
static bfd_boolean
cgc_xtensa_grok_prstatus (bfd *abfd, Cgc_Internal_Note *note)
{
  int offset;
  unsigned int size;
...
static bfd_boolean
cgc_xtensa_grok_psinfo (bfd *abfd, Cgc_Internal_Note *note)
{
  switch (note->descsz)
    {
      default:
	return FALSE;
      ...
      case 128:		/* GNU/Linux cgc_prpsinfo */
		       ...
		       Cgc_Internal_Rela *irel)
{
  ...
  fmt = xtensa_format_decode (isa, ibuff);
  slot = get_relocation_slot (CGC32_R_TYPE (irel->r_info));
  if (slot == XTENSA_UNDEFINED)
    return XTENSA_UNDEFINED;
  xtensa_format_get_slot (isa, fmt, slot, ibuff, sbuff);
...
{
  xtensa_opcode opcode;
  if (!is_operand_relocation (CGC32_R_TYPE (irel->r_info)))
    return FALSE;
...
static bfd_reloc_status_type
cgc_xtensa_do_asm_simplify (bfd_byte *contents,
			    bfd_vma address,
...
{
  bfd_reloc_status_type retval =
    cgc_xtensa_do_asm_simplify (contents, irel->r_offset, content_length,
				error_message);
  ...
  irel->r_offset += 3;
  irel->r_info = CGC32_R_INFO (CGC32_R_SYM (irel->r_info), R_XTENSA_SLOT0_OP);
  return bfd_reloc_ok;
}
...
/* Through the relaxation process, we need to keep track of the values
   that will result from evaluating relocations.  The standard CGC
   ...
   records both the input file (bfd) and CGC relocation.
...
r_reloc_get_target_offset (const r_reloc *r_rel)
{
  ...
  r_symndx = CGC32_R_SYM (r_rel->rela.r_info);
  target_offset = get_cgc_r_symndx_offset (r_rel->abfd, r_symndx);
...
{
  unsigned long r_symndx = CGC32_R_SYM (r_rel->rela.r_info);
  return get_cgc_r_symndx_hash_entry (r_rel->abfd, r_symndx);
}
...
{
  unsigned long r_symndx = CGC32_R_SYM (r_rel->rela.r_info);
  return get_cgc_r_symndx_section (r_rel->abfd, r_symndx);
}
  ...
  if (irel)
    {
      ...
      r_type = CGC32_R_TYPE (r_rel->rela.r_info);
      howto = &cgc_howto_table[r_type];
      if (howto->partial_inplace)
	{
	  bfd_vma inplace_val;
  ...
  for (i = 0; i < src_count; i++)
    {
	  ...
	  && (CGC32_R_TYPE (src_relocs[i].r_rel.rela.r_info)
	      == CGC32_R_TYPE (irel->r_info)))
	return &src_relocs[i];
    }
...
{
  struct cgc_link_hash_entry *h1, *h2;
  ...
  if (CGC32_R_TYPE (src1->r_rel.rela.r_info)
      != CGC32_R_TYPE (src2->r_rel.rela.r_info))
    return FALSE;
  ...
  /* Now check for the same section (if defined) or the same cgc_hash
  ...
  if (!r_reloc_is_const (&src->r_rel))
    {
      ...
      /* Now check for the same section and the same cgc_hash.  */
...
struct xtensa_relax_info_struct
{
  ...
  Cgc_Internal_Rela *allocated_relocs;
  unsigned relocs_count;
  unsigned allocated_relocs_count;
};

struct cgc_xtensa_section_data
{
...
static bfd_boolean
cgc_xtensa_new_section_hook (bfd *abfd, asection *sec)
{
  if (!sec->used_by_bfd)
    {
      struct cgc_xtensa_section_data *sdata;
...
{
  struct cgc_xtensa_section_data *section_data;

  /* No info available if no section or if it is an output section.  */
  if (!sec || sec == sec->output_section)
    return NULL;

  section_data = (struct cgc_xtensa_section_data *) cgc_section_data (sec);
...
struct section_cache_struct
{
  ...
  Cgc_Internal_Rela *relocs;	/* Cache of the section relocations.  */
...
retrieve_internal_relocs (bfd *abfd, asection *sec, bfd_boolean keep_memory)
{
  ...
  internal_relocs = cgc_section_data (sec)->relocs;
...
static void
pin_internal_relocs (asection *sec, Cgc_Internal_Rela *internal_relocs)
{
...
static void
release_internal_relocs (asection *sec, Cgc_Internal_Rela *internal_relocs)
{
  if (internal_relocs
      && cgc_section_data (sec)->relocs != internal_relocs)
...
{
  if (contents && cgc_section_data (sec)->this_hdr.contents != contents)
    free (contents);
}


static Cgc_Internal_Sym *
retrieve_local_syms (bfd *input_bfd)
{
  ...
  if (isymbuf && isymbuf != (Cgc_Internal_Sym *) symtab_hdr->contents)
...
static bfd_boolean is_resolvable_asm_expansion
  (bfd *, asection *, bfd_byte *, Cgc_Internal_Rela *, struct bfd_link_info *,
   bfd_boolean *);
static Cgc_Internal_Rela *find_associated_l32r_irel
  (bfd *, asection *, bfd_byte *, Cgc_Internal_Rela *, Cgc_Internal_Rela *);
static bfd_boolean compute_text_actions
  (bfd *, asection *, struct bfd_link_info *);
static bfd_boolean compute_ebb_proposed_actions (ebb_constraint *);
static bfd_boolean compute_ebb_actions (ebb_constraint *);
static bfd_boolean check_section_ebb_pcrels_fit
  (bfd *, asection *, bfd_byte *, Cgc_Internal_Rela *, const ebb_constraint *,
   const xtensa_opcode *);
...
static Cgc_Internal_Rela *get_irel_at_offset
  (asection *, Cgc_Internal_Rela *, bfd_vma);
...
static bfd_boolean remove_dead_literal
  (bfd *, asection *, struct bfd_link_info *, Cgc_Internal_Rela *,
   Cgc_Internal_Rela *, source_reloc *, property_table_entry *, int);
static bfd_boolean identify_literal_placement
  (bfd *, asection *, bfd_byte *, struct bfd_link_info *,
   value_map_hash_table *, bfd_boolean *, Cgc_Internal_Rela *, int,
...
static void shrink_dynamic_reloc_sections
  (struct bfd_link_info *, bfd *, asection *, Cgc_Internal_Rela *);
static bfd_boolean move_literal
  (bfd *, struct bfd_link_info *, asection *, bfd_vma, bfd_byte *,
   xtensa_relax_info *, Cgc_Internal_Rela **, const literal_value *);
...
static bfd_boolean
cgc_xtensa_relax_section (bfd *abfd,
			  asection *sec,
			  struct bfd_link_info *link_info,
			  bfd_boolean *again)
{
			 ...
			 bfd_boolean *is_relaxable_p)
{
  ...
  for (i = 0; i < sec->reloc_count; i++)
    {
      Cgc_Internal_Rela *irel = &internal_relocs[i];
      r_reloc r_rel;
      asection *target_sec;
	 ...
	 the section as "relaxable".  */
	  ...
	  && CGC32_R_TYPE (irel->r_info) == R_XTENSA_ASM_EXPAND)
	{
	  ...
	  if (opcode != XTENSA_UNDEFINED)
	    {
	      ...
	      if (!is_alt_relocation (CGC32_R_TYPE (irel->r_info))
		  || is_l32r_reloc)
		       ...
		       struct bfd_link_info *link_info)
{
  ...
  for (i = 0; i < sec->reloc_count; i++)
	      ...
	      || target_relax_info->is_relaxable_asm_section))
	{
	  ...
	  else if (is_operand_relocation (CGC32_R_TYPE (irel->r_info)))
	    {
	      opcode = get_relocation_opcode (abfd, sec, contents, irel);
	      opnd = get_relocation_opnd (opcode, CGC32_R_TYPE (irel->r_info));
	    }
  ...
  for (i = 0; i < sec->reloc_count; i++)
      ...
      if (is_reachable)
	{
	  ...
	  l32r_irel->r_info = CGC32_R_INFO (0, R_XTENSA_NONE);
      ...
      else
	{
	  ...
	  irel->r_info = CGC32_R_INFO (0, R_XTENSA_NONE);
	  pin_internal_relocs (sec, internal_relocs);
	}
    }
			     ...
			     bfd_boolean *is_reachable_p)
{
  ...
  *is_reachable_p = FALSE;
  ...
  if (CGC32_R_TYPE (irel->r_info) != R_XTENSA_ASM_EXPAND)
    return FALSE;
		      ...
		      struct bfd_link_info *link_info)
{
  ...
  if (internal_relocs)
    qsort (internal_relocs, sec->reloc_count, sizeof (Cgc_Internal_Rela),
	   internal_reloc_compare);
  ...
  for (i = 0; i < sec->reloc_count; i++)
    {
      ...
      if (irel && CGC32_R_TYPE (irel->r_info) != R_XTENSA_ASM_SIMPLIFY)
	continue;
      ...
      if (simplify_size == 0)
	{
	 ...
	 relaxation.  */
      the_entry = cgc_xtensa_find_property_entry (prop_table, ptblsize,
      ...
      while (offset != end_offset)
	{
	  ...
	  while (rel_idx < ebb->end_reloc_idx
		 && (ebb->relocs[rel_idx].r_offset < offset
		     || (ebb->relocs[rel_idx].r_offset == offset
			 && (CGC32_R_TYPE (ebb->relocs[rel_idx].r_info)
			     != R_XTENSA_ASM_SIMPLIFY))))
	    rel_idx++;
	  ...
	  if (irel->r_offset == offset
	      && CGC32_R_TYPE (irel->r_info) == R_XTENSA_ASM_SIMPLIFY)
	    {
	      bfd_size_type simplify_size;
...
compute_ebb_actions (ebb_constraint *ebb_table)
{
  ...
  for (seg_idx_end = 0; seg_idx_end < ebb_table->action_count; seg_idx_end++)
	...
	requires_text_end_align = TRUE;
      ...
      if (cgc32xtensa_size_opt && !requires_text_end_align
      ...
      else
	{
	  ...
	  for (j = 0; j < longcall_count; j++)
	      ...
	      if (desire_narrow <= narrowable_count)
		{
	      ...
	      if (desire_widen <= widenable_count && !cgc32xtensa_size_opt)
		{
		  narrowable_convert_count = 0;
		  longcall_convert_count = longcall_count - j;
			      ...
			      const xtensa_opcode *reloc_opcodes)
{
  ...
  for (i = 0; i < sec->reloc_count; i++)
      ...
      else
	{
	  ...
	  opnum = get_relocation_opnd (opcode, CGC32_R_TYPE (irel->r_info));
  ...
  for (i = 0; i < relax_info->src_count; i++)
	...
	continue;
	 ...
	 the difference of two symbols is used in a literal.  */
      if (irel && (CGC32_R_TYPE (irel->r_info) != R_XTENSA_32
		   && CGC32_R_TYPE (irel->r_info) != R_XTENSA_PLT))
	continue;
		    ...
		    bfd_vma offset)
{
  ...
  irel = bsearch (&key, internal_relocs, sec->reloc_count,
		  sizeof (Cgc_Internal_Rela), internal_reloc_matches);
  if (!irel)
    return NULL;
		      ...
		      int ptblsize)
{
  ...
  entry = cgc_xtensa_find_property_entry (prop_table, ptblsize,
		     ...
		     int ptblsize)
{
  ...
  if (sec->alignment_power > 2)
	...
	entry_sec_offset = rel->r_rel.target_offset + 4;
	 ...
	 do not add fill.  */
      the_add_entry = cgc_xtensa_find_property_entry (prop_table, ptblsize,
						      entry_sec_offset);
  ...
  if (irel)
    {
      if (cgc_hash_table (link_info)->dynamic_sections_created)
			    ...
			    bfd_boolean is_abs_literal)
{
  ...
  final_static_link =
    (!link_info->relocatable
     && !cgc_hash_table (link_info)->dynamic_sections_created);
			 ...
			 value_map *val_map)
{
  ...
  entry = cgc_xtensa_find_property_entry
		     ...
		     section_cache_t *target_sec_cache)
{
  ...
  if (cgc32xtensa_no_literal_movement)
    return FALSE;
  ...
  src_entry = cgc_xtensa_find_property_entry
    (prop_table, ptblsize, sec->vma + rel->r_rel.target_offset);

  if (!section_cache_section (target_sec_cache, target_sec, link_info))
    return FALSE;

  target_entry = cgc_xtensa_find_property_entry
  ...
  if (target_sec->alignment_power > 2 && target_entry != src_entry)
	...
	target_entry->address - target_sec->vma + target_entry->size;
	 ...
	 do not add fill.  */
      fill_extra_space = 0;
      the_add_entry =
	cgc_xtensa_find_property_entry (target_sec_cache->ptbl,
...
relax_section (bfd *abfd, asection *sec, struct bfd_link_info *link_info)
{
  ...
  if (internal_relocs)
      ...
      for (i = 0; i < sec->reloc_count; i++)
	{
	  ...
	  if (! cgc_xtensa_ignore_discarded_relocs (sec)
	      && cgc_xtensa_action_discarded (sec) == PRETEND
	      && sec->sec_info_type != SEC_INFO_TYPE_STABS
	      && target_sec != NULL
	      && discarded_section (target_sec))
	    {
	      /* It would be natural to call _bfd_cgc_check_kept_section
		 here, but it's not exported from cgclink.c.  It's also a
		 ...
		 _bfd_cgc_check_kept_section fails later, it won't matter,
	      ...
	      if (kept != NULL)
		{
		  if ((kept->flags & SEC_GROUP) != 0)
		    {
		      asection *first = cgc_next_in_group (kept);
		      asection *s = first;
	  ...
	  if (target_relax_info
		...
		{
		  unsigned r_symndx = CGC32_R_SYM (new_reloc.rela.r_info);
		  irel->r_info = CGC32_R_INFO (r_symndx, r_type);
...
translate_reloc (const r_reloc *orig_rel, r_reloc *new_rel, asection *sec)
{
  ...
  *new_rel = *orig_rel;
  ...
  removed = FALSE;
  if (is_operand_relocation (CGC32_R_TYPE (orig_rel->rela.r_info)))
    {
      /* Check if the original relocation is against a literal being
	 removed.  */
      removed = find_removed_literal (&relax_info->removed_list,
			       ...
			       Cgc_Internal_Rela *rel)
{
  ...
  if ((r_type == R_XTENSA_32 || r_type == R_XTENSA_PLT)
	...
	srel = htab->srelgot;
      ...
      BFD_ASSERT (srel != NULL);
      BFD_ASSERT (srel->size >= sizeof (Cgc32_External_Rela));
      ...
      if (is_plt)
	{
	  ...
	  reloc_index = srel->size / sizeof (Cgc32_External_Rela);
...
move_literal (bfd *abfd,
	      ...
	      bfd_byte *contents,
	      xtensa_relax_info *relax_info,
	      Cgc_Internal_Rela **internal_relocs_p,
	      const literal_value *lit)
{
  Cgc_Internal_Rela *new_relocs = NULL;
  size_t new_relocs_count = 0;
  Cgc_Internal_Rela this_rela;
  const r_reloc *r_rel;

  r_rel = &lit->r_rel;
  BFD_ASSERT (cgc_section_data (sec)->relocs == *internal_relocs_p);
  ...
  if (r_reloc_is_const (r_rel))
  ...
  else
    {
      ...
      this_rela.r_info = CGC32_R_INFO (0, r_type);
      this_rela.r_addend =
	r_rel->target_offset - r_reloc_get_target_offset (r_rel);
      bfd_put_32 (abfd, lit->value, contents + offset);
	  ...
	  || sec->reloc_count + 1 > relax_info->allocated_relocs_count)
	{
	  ...
	  new_relocs = (Cgc_Internal_Rela *)
	    bfd_zmalloc (sizeof (Cgc_Internal_Rela) * (new_relocs_count));
	  if (!new_relocs)
	    return FALSE;
	  ...
	  if (insert_at != 0)
	    memcpy (new_relocs, *internal_relocs_p,
		    insert_at * sizeof (Cgc_Internal_Rela));
	  ...
	  cgc_section_data (sec)->relocs = new_relocs;
	  sec->reloc_count++;
			...
			struct bfd_link_info *link_info)
{
  ...
  if (internal_relocs && (!link_info->relocatable
    ...
    {
      Cgc_Internal_Rela *last_irel = NULL;
      Cgc_Internal_Rela *irel, *next_rel, *rel_end;
      int removed_bytes = 0;
      bfd_vma offset;
      flagword predef_flags;
      ...
      for (offset = 0; offset < sec->size; offset += entry_size)
	{
	  Cgc_Internal_Rela *offset_rel, *extra_rel;
	  ...
	  if (offset_rel)
		...
		{
		  if (CGC32_R_TYPE (irel->r_info) != R_XTENSA_NONE)
		    {
		      extra_rel = irel;
		      break;
		    }
	  ...
	  if (size == 0
		...
		remove_this_rel = TRUE;
		   ...
		   && CGC32_R_TYPE (offset_rel->r_info) == R_XTENSA_32)
	    {
	      if (last_irel)
		{
		  flagword old_flags;
		  ...
		  if ((CGC32_R_SYM (offset_rel->r_info)
		       == CGC32_R_SYM (last_irel->r_info))
	  ...
	  if (remove_this_rel)
	    {
	      offset_rel->r_info = CGC32_R_INFO (0, R_XTENSA_NONE);
      ...
      if (removed_bytes)
	{
	  ...
	  if (xtensa_is_littable_section (sec))
	    {
	      asection *sgotloc = cgc_xtensa_hash_table (link_info)->sgotloc;
	      if (sgotloc)
		sgotloc->size -= removed_bytes;
	    }
	}
...
relax_section_symbols (bfd *abfd, asection *sec)
{
  ...
  num_syms = symtab_hdr->sh_size / sizeof (Cgc32_External_Sym);
  ...
  for (i = 0; i < num_locals; i++)
      ...
      if (isym->st_shndx == sec_shndx)
	{
	  ...
	  if (CGC32_ST_TYPE (isym->st_info) == STT_FUNC)
	    isym->st_size -=
  ...
  for (i = 0; i < (num_syms - num_locals); i++)
    {
      ...
      sym_hash = cgc_sym_hashes (abfd)[i];

      if (sym_hash->root.type == bfd_link_hash_warning)
	sym_hash = (struct cgc_link_hash_entry *) sym_hash->root.u.i.link;
...
static bfd_boolean
do_fix_for_relocatable_link (Cgc_Internal_Rela *rel,
			     bfd *input_bfd,
			     asection *input_section,
			     bfd_byte *contents)
{
  ...
  bfd_vma old_offset;
  int r_type = CGC32_R_TYPE (rel->r_info);
  reloc_bfd_fix *fix;
...
static void
do_fix_for_final_link (Cgc_Internal_Rela *rel,
		       bfd *input_bfd,
		       asection *input_section,
		       bfd_byte *contents,
		       bfd_vma *relocationp)
{
  ...
  if (cgc_howto_table[fix->src_type].partial_inplace)
    {
      bfd_vma inplace_val;
...
static asection *
cgc_xtensa_get_plt_section (struct bfd_link_info *info, int chunk)
{
  struct cgc_xtensa_link_hash_table *htab;
  bfd *dynobj;
  char plt_name[10];
...
static asection *
cgc_xtensa_get_gotplt_section (struct bfd_link_info *info, int chunk)
{
  struct cgc_xtensa_link_hash_table *htab;
  bfd *dynobj;
  char got_name[14];
...
static asection *
get_cgc_r_symndx_section (bfd *abfd, unsigned long r_symndx)
{
  Cgc_Internal_Shdr *symtab_hdr = &cgc_tdata (abfd)->symtab_hdr;
  ...
  if (r_symndx < symtab_hdr->sh_info)
	...
	target_sec = bfd_section_from_cgc_index (abfd, section_index);
    }
  else
    {
      unsigned long indx = r_symndx - symtab_hdr->sh_info;
      struct cgc_link_hash_entry *h = cgc_sym_hashes (abfd)[indx];
...
static struct cgc_link_hash_entry *
get_cgc_r_symndx_hash_entry (bfd *abfd, unsigned long r_symndx)
{
  unsigned long indx;
  struct cgc_link_hash_entry *h;
  Cgc_Internal_Shdr *symtab_hdr = &cgc_tdata (abfd)->symtab_hdr;
...
static bfd_vma
get_cgc_r_symndx_offset (bfd *abfd, unsigned long r_symndx)
{
  Cgc_Internal_Shdr *symtab_hdr = &cgc_tdata (abfd)->symtab_hdr;
  bfd_vma offset = 0;
...
static bfd_boolean
is_reloc_sym_weak (bfd *abfd, Cgc_Internal_Rela *rel)
{
  unsigned long r_symndx = CGC32_R_SYM (rel->r_info);
  struct cgc_link_hash_entry *h;

  h = get_cgc_r_symndx_hash_entry (abfd, r_symndx);
...
{
  const Cgc_Internal_Rela *a = (const Cgc_Internal_Rela *) ap;
  const Cgc_Internal_Rela *b = (const Cgc_Internal_Rela *) bp;
...
match_section_group (bfd *abfd ATTRIBUTE_UNUSED, asection *sec, void *inf)
{
  ...
  const char *group_name = cgc_group_name (sec);
...
xtensa_make_property_section (asection *sec, const char *base_name)
{
  ...
  if (! prop_sec)
	...
	return 0;
      ...
      cgc_group_name (prop_sec) = cgc_group_name (sec);
    }
				     ...
				     void *closure)
{
  ...
  /* Only CGC files are supported for Xtensa.  Check here to avoid a segfault
...
static const struct bfd_cgc_special_section cgc_xtensa_special_sections[] =
{
...

#define CGC_TARGET_ID			XTENSA_CGC_DATA
#ifndef CGC_ARCH
#define TARGET_LITTLE_SYM		bfd_cgc32_xtensa_le_vec
#define TARGET_LITTLE_NAME		"cgc32-xtensa-le"
#define TARGET_BIG_SYM			bfd_cgc32_xtensa_be_vec
#define TARGET_BIG_NAME			"cgc32-xtensa-be"
#define CGC_ARCH			bfd_arch_xtensa

#define CGC_MACHINE_CODE		EM_XTENSA
#define CGC_MACHINE_ALT1		EM_XTENSA_OLD

#if XCHAL_HAVE_MMU
#define CGC_MAXPAGESIZE			(1 << XCHAL_MMU_MIN_PTE_PAGE_SIZE)
#else /* !XCHAL_HAVE_MMU */
...
#define cgc_backend_want_dynbss		0
#define cgc_backend_want_got_plt	1

#define cgc_info_to_howto		     cgc_xtensa_info_to_howto_rela

#define bfd_cgc32_mkobject		     cgc_xtensa_mkobject

#define bfd_cgc32_bfd_merge_private_bfd_data cgc_xtensa_merge_private_bfd_data
#define bfd_cgc32_new_section_hook	     cgc_xtensa_new_section_hook
#define bfd_cgc32_bfd_print_private_bfd_data cgc_xtensa_print_private_bfd_data
#define bfd_cgc32_bfd_relax_section	     cgc_xtensa_relax_section
#define bfd_cgc32_bfd_reloc_type_lookup	     cgc_xtensa_reloc_type_lookup
#define bfd_cgc32_bfd_reloc_name_lookup \
  cgc_xtensa_reloc_name_lookup
#define bfd_cgc32_bfd_set_private_flags	     cgc_xtensa_set_private_flags
#define bfd_cgc32_bfd_link_hash_table_create cgc_xtensa_link_hash_table_create

#define cgc_backend_adjust_dynamic_symbol    cgc_xtensa_adjust_dynamic_symbol
#define cgc_backend_check_relocs	     cgc_xtensa_check_relocs
#define cgc_backend_create_dynamic_sections  cgc_xtensa_create_dynamic_sections
#define cgc_backend_discard_info	     cgc_xtensa_discard_info
#define cgc_backend_ignore_discarded_relocs  cgc_xtensa_ignore_discarded_relocs
#define cgc_backend_final_write_processing   cgc_xtensa_final_write_processing
#define cgc_backend_finish_dynamic_sections  cgc_xtensa_finish_dynamic_sections
#define cgc_backend_finish_dynamic_symbol    cgc_xtensa_finish_dynamic_symbol
#define cgc_backend_gc_mark_hook	     cgc_xtensa_gc_mark_hook
#define cgc_backend_gc_sweep_hook	     cgc_xtensa_gc_sweep_hook
#define cgc_backend_grok_prstatus	     cgc_xtensa_grok_prstatus
#define cgc_backend_grok_psinfo		     cgc_xtensa_grok_psinfo
#define cgc_backend_hide_symbol		     cgc_xtensa_hide_symbol
#define cgc_backend_object_p		     cgc_xtensa_object_p
#define cgc_backend_reloc_type_class	     cgc_xtensa_reloc_type_class
#define cgc_backend_relocate_section	     cgc_xtensa_relocate_section
#define cgc_backend_size_dynamic_sections    cgc_xtensa_size_dynamic_sections
#define cgc_backend_always_size_sections     cgc_xtensa_always_size_sections
#define cgc_backend_omit_section_dynsym \
  ((bfd_boolean (*) (bfd *, struct bfd_link_info *, asection *)) bfd_true)
#define cgc_backend_special_sections	     cgc_xtensa_special_sections
#define cgc_backend_action_discarded	     cgc_xtensa_action_discarded
#define cgc_backend_copy_indirect_symbol     cgc_xtensa_copy_indirect_symbol
