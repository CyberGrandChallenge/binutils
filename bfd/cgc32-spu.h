...
struct spu_cgc_params
{
  /* Stash various callbacks for --auto-overlay.  */
  void (*place_spu_section) (asection *, asection *, const char *);
  bfd_size_type (*spu_cgc_load_ovl_mgr) (void);
  FILE *(*spu_cgc_open_overlay_script) (void);
  void (*spu_cgc_relink) (void);
...
struct _spu_cgc_section_data
{
  ...
  union {
    ...
    struct {
      ...
      struct spu_cgc_stack_info *stack_info;
    } i;
...
#define spu_cgc_section_data(sec) \
  ((struct _spu_cgc_section_data *) cgc_section_data (sec))
...
extern void spu_cgc_setup (struct bfd_link_info *, struct spu_cgc_params *);
extern void spu_cgc_plugin (int);
extern bfd_boolean spu_cgc_open_builtin_lib (bfd **,
					     const struct _ovl_stream *);
extern bfd_boolean spu_cgc_create_sections (struct bfd_link_info *);
extern bfd_boolean spu_cgc_size_sections (bfd *, struct bfd_link_info *);
extern int spu_cgc_find_overlays (struct bfd_link_info *);
extern int spu_cgc_size_stubs (struct bfd_link_info *);
extern void spu_cgc_place_overlay_data (struct bfd_link_info *);
extern asection *spu_cgc_check_vma (struct bfd_link_info *);
