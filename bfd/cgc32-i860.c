/* Intel i860 specific support for 32-bit CGC.
                       ...
                       char **error_message ATTRIBUTE_UNUSED)
{
  ...
  /* Used cgc32-mips.c as an example.  */
...
static reloc_howto_type cgc32_i860_howto_table [] =
{
...

static unsigned char cgc_code_to_howto_index[R_860_max + 1];
...
lookup_howto (unsigned int rtype)
{
  ...
  int i;
  int howto_tbl_size = (int) (sizeof (cgc32_i860_howto_table)
			/ sizeof (cgc32_i860_howto_table[0]));
  ...
  if (! initialized)
    {
      ...
      for (i = 0; i < howto_tbl_size; i++)
        cgc_code_to_howto_index[cgc32_i860_howto_table[i].type] = i;
    }
  ...
  if (i >= howto_tbl_size)
    return 0;
  return cgc32_i860_howto_table + i;
}

/* Given a BFD reloc, return the matching HOWTO structure.  */
static reloc_howto_type *
cgc32_i860_reloc_type_lookup (bfd *abfd ATTRIBUTE_UNUSED,
...
static reloc_howto_type *
cgc32_i860_reloc_name_lookup (bfd *abfd ATTRIBUTE_UNUSED,
			      const char *r_name)
{
  unsigned int i;

  for (i = 0;
       i < (sizeof (cgc32_i860_howto_table)
	    / sizeof (cgc32_i860_howto_table[0]));
       i++)
    if (cgc32_i860_howto_table[i].name != NULL
	&& strcasecmp (cgc32_i860_howto_table[i].name, r_name) == 0)
      return &cgc32_i860_howto_table[i];
...
static void
cgc32_i860_info_to_howto_rela (bfd *abfd ATTRIBUTE_UNUSED,
			       arelent *bfd_reloc,
			       Cgc_Internal_Rela *cgc_reloc)
{
  bfd_reloc->howto
    = lookup_howto ((unsigned) CGC32_R_TYPE (cgc_reloc->r_info));
}

...
static bfd_reloc_status_type
cgc32_i860_relocate_splitn (bfd *input_bfd,
			    ...
			    bfd_vma value)
{
  ...
  howto = lookup_howto ((unsigned) CGC32_R_TYPE (rello->r_info));
...
/* Specialized relocation handler for R_860_PC16.  This relocation
   ...
   parts.  */
static bfd_reloc_status_type
cgc32_i860_relocate_pc16 (bfd *input_bfd,
			  asection *input_section,
			  Cgc_Internal_Rela *rello,
			  bfd_byte *contents,
			  bfd_vma value)
...
static bfd_reloc_status_type
cgc32_i860_relocate_pc26 (bfd *input_bfd,
			  asection *input_section,
			  Cgc_Internal_Rela *rello,
			  bfd_byte *contents,
			  bfd_vma value)
...
static bfd_reloc_status_type
cgc32_i860_relocate_highadj (bfd *input_bfd,
...
/* Relocate an i860 CGC section.
   ...
   accordingly.  */
static bfd_boolean
cgc32_i860_relocate_section (bfd *output_bfd ATTRIBUTE_UNUSED,
			     ...
			     asection **local_sections)
{
  ...
  for (rel = relocs; rel < relend; rel ++)
	...
	case R_860_HIGHADJ:
	  r = cgc32_i860_relocate_highadj (input_bfd, rel, contents,
					   relocation);
	  break;

	case R_860_PC16:
	  r = cgc32_i860_relocate_pc16 (input_bfd, input_section, rel,
					contents, relocation);
	  break;

	case R_860_PC26:
	  r = cgc32_i860_relocate_pc26 (input_bfd, input_section, rel,
					contents, relocation);
	  break;
	...
	case R_860_SPLIT1:
	case R_860_SPLIT2:
	  r = cgc32_i860_relocate_splitn (input_bfd, rel, contents,
					  relocation);
	  break;
...
static bfd_boolean
cgc32_i860_is_local_label_name (bfd *abfd, const char *name)
{
...

#define TARGET_BIG_SYM		bfd_cgc32_i860_vec
#define TARGET_BIG_NAME		"cgc32-i860"
#define TARGET_LITTLE_SYM	bfd_cgc32_i860_little_vec
#define TARGET_LITTLE_NAME	"cgc32-i860-little"
#define CGC_ARCH		bfd_arch_i860
#define CGC_MACHINE_CODE	EM_860
#define CGC_MAXPAGESIZE		4096

#define cgc_backend_rela_normal			1
#define cgc_info_to_howto_rel                   NULL
#define cgc_info_to_howto			cgc32_i860_info_to_howto_rela
#define cgc_backend_relocate_section		cgc32_i860_relocate_section
#define bfd_cgc32_bfd_reloc_type_lookup		cgc32_i860_reloc_type_lookup
#define bfd_cgc32_bfd_reloc_name_lookup	cgc32_i860_reloc_name_lookup
#define bfd_cgc32_bfd_is_local_label_name	cgc32_i860_is_local_label_name
