/* PowerPC64-specific support for 64-bit CGC.
   Copyright 1999, 2000, 2001, 2002, 2003, 2004, 2005, 2006, 2007, 2008,
   2009, 2010, 2011, 2012 Free Software Foundation, Inc.
   Written by Linus Nordberg, Swox AB <info@swox.com>,
   based on cgc32-ppc.c by Ian Lance Taylor.
...
/* The 64-bit PowerPC CGC ABI may be found at
   http://www.linuxbase.org/spec/CGC/ppc64/PPC-cgc64abi.txt, and
   http://www.linuxbase.org/spec/CGC/ppc64/spec/book1.html  */
...
static bfd_reloc_status_type ppc64_cgc_ha_reloc
  (bfd *, arelent *, asymbol *, void *, asection *, bfd *, char **);
static bfd_reloc_status_type ppc64_cgc_branch_reloc
  (bfd *, arelent *, asymbol *, void *, asection *, bfd *, char **);
static bfd_reloc_status_type ppc64_cgc_brtaken_reloc
  (bfd *, arelent *, asymbol *, void *, asection *, bfd *, char **);
static bfd_reloc_status_type ppc64_cgc_sectoff_reloc
  (bfd *, arelent *, asymbol *, void *, asection *, bfd *, char **);
static bfd_reloc_status_type ppc64_cgc_sectoff_ha_reloc
  (bfd *, arelent *, asymbol *, void *, asection *, bfd *, char **);
static bfd_reloc_status_type ppc64_cgc_toc_reloc
  (bfd *, arelent *, asymbol *, void *, asection *, bfd *, char **);
static bfd_reloc_status_type ppc64_cgc_toc_ha_reloc
  (bfd *, arelent *, asymbol *, void *, asection *, bfd *, char **);
static bfd_reloc_status_type ppc64_cgc_toc64_reloc
  (bfd *, arelent *, asymbol *, void *, asection *, bfd *, char **);
static bfd_reloc_status_type ppc64_cgc_unhandled_reloc
  (bfd *, arelent *, asymbol *, void *, asection *, bfd *, char **);
static bfd_vma opd_entry_value
  (asection *, bfd_vma, asection **, bfd_vma *, bfd_boolean);

#define TARGET_LITTLE_SYM	bfd_cgc64_powerpcle_vec
#define TARGET_LITTLE_NAME	"cgc64-powerpcle"
#define TARGET_BIG_SYM		bfd_cgc64_powerpc_vec
#define TARGET_BIG_NAME		"cgc64-powerpc"
#define CGC_ARCH		bfd_arch_powerpc
#define CGC_TARGET_ID		PPC64_CGC_DATA
#define CGC_MACHINE_CODE	EM_PPC64
#define CGC_MAXPAGESIZE		0x10000
#define CGC_COMMONPAGESIZE	0x1000
#define cgc_info_to_howto	ppc64_cgc_info_to_howto

#define cgc_backend_want_got_sym 0
#define cgc_backend_want_plt_sym 0
#define cgc_backend_plt_alignment 3
#define cgc_backend_plt_not_loaded 1
...
#define bfd_cgc64_mkobject		      ppc64_cgc_mkobject
#define bfd_cgc64_bfd_reloc_type_lookup	      ppc64_cgc_reloc_type_lookup
#define bfd_cgc64_bfd_reloc_name_lookup	      ppc64_cgc_reloc_name_lookup
#define bfd_cgc64_bfd_merge_private_bfd_data  ppc64_cgc_merge_private_bfd_data
#define bfd_cgc64_bfd_print_private_bfd_data  ppc64_cgc_print_private_bfd_data
#define bfd_cgc64_new_section_hook	      ppc64_cgc_new_section_hook
#define bfd_cgc64_bfd_link_hash_table_create  ppc64_cgc_link_hash_table_create
#define bfd_cgc64_bfd_link_hash_table_free    ppc64_cgc_link_hash_table_free
#define bfd_cgc64_get_synthetic_symtab	      ppc64_cgc_get_synthetic_symtab
#define bfd_cgc64_bfd_link_just_syms	      ppc64_cgc_link_just_syms

#define cgc_backend_object_p		      ppc64_cgc_object_p
#define cgc_backend_grok_prstatus	      ppc64_cgc_grok_prstatus
#define cgc_backend_grok_psinfo		      ppc64_cgc_grok_psinfo
#define cgc_backend_write_core_note	      ppc64_cgc_write_core_note
#define cgc_backend_create_dynamic_sections   ppc64_cgc_create_dynamic_sections
#define cgc_backend_copy_indirect_symbol      ppc64_cgc_copy_indirect_symbol
#define cgc_backend_add_symbol_hook	      ppc64_cgc_add_symbol_hook
#define cgc_backend_check_directives	      ppc64_cgc_process_dot_syms
#define cgc_backend_notice_as_needed	      ppc64_cgc_notice_as_needed
#define cgc_backend_archive_symbol_lookup     ppc64_cgc_archive_symbol_lookup
#define cgc_backend_check_relocs	      ppc64_cgc_check_relocs
#define cgc_backend_gc_keep		      ppc64_cgc_gc_keep
#define cgc_backend_gc_mark_dynamic_ref       ppc64_cgc_gc_mark_dynamic_ref
#define cgc_backend_gc_mark_hook	      ppc64_cgc_gc_mark_hook
#define cgc_backend_gc_sweep_hook	      ppc64_cgc_gc_sweep_hook
#define cgc_backend_adjust_dynamic_symbol     ppc64_cgc_adjust_dynamic_symbol
#define cgc_backend_hide_symbol		      ppc64_cgc_hide_symbol
#define cgc_backend_maybe_function_sym	      ppc64_cgc_maybe_function_sym
#define cgc_backend_always_size_sections      ppc64_cgc_func_desc_adjust
#define cgc_backend_size_dynamic_sections     ppc64_cgc_size_dynamic_sections
#define cgc_backend_hash_symbol		      ppc64_cgc_hash_symbol
#define cgc_backend_init_index_section	      _bfd_cgc_init_2_index_sections
#define cgc_backend_action_discarded	      ppc64_cgc_action_discarded
#define cgc_backend_relocate_section	      ppc64_cgc_relocate_section
#define cgc_backend_finish_dynamic_symbol     ppc64_cgc_finish_dynamic_symbol
#define cgc_backend_reloc_type_class	      ppc64_cgc_reloc_type_class
#define cgc_backend_finish_dynamic_sections   ppc64_cgc_finish_dynamic_sections
#define cgc_backend_link_output_symbol_hook   ppc64_cgc_output_symbol_hook
#define cgc_backend_special_sections	      ppc64_cgc_special_sections
#define cgc_backend_post_process_headers      _bfd_cgc_set_osabi
#define cgc_backend_merge_symbol_attribute    ppc64_cgc_merge_symbol_attribute
...
/* Relocation HOWTO's.  */
static reloc_howto_type *ppc64_cgc_howto_table[(int) R_PPC64_max];

static reloc_howto_type ppc64_cgc_howto_raw[] = {
  ...
  HOWTO (R_PPC64_ADDR16_HA,	/* type */
	 ...
	 0,			/* bitpos */
	 complain_overflow_signed, /* complain_on_overflow */
	 ppc64_cgc_ha_reloc,	/* special_function */
  ...
  HOWTO (R_PPC64_ADDR14,	/* type */
	 ...
	 0,			/* bitpos */
	 complain_overflow_bitfield, /* complain_on_overflow */
	 ppc64_cgc_branch_reloc, /* special_function */
	 "R_PPC64_ADDR14",	/* name */
	 FALSE,			/* partial_inplace */
	 0,			/* src_mask */
	 0x0000fffc,		/* dst_mask */
  ...
  HOWTO (R_PPC64_ADDR14_BRTAKEN, /* type */
	 ...
	 0,			/* bitpos */
	 complain_overflow_bitfield, /* complain_on_overflow */
	 ppc64_cgc_brtaken_reloc, /* special_function */
  ...
  HOWTO (R_PPC64_GOT16,		/* type */
	 ...
	 0,			/* bitpos */
	 complain_overflow_signed, /* complain_on_overflow */
	 ppc64_cgc_unhandled_reloc, /* special_function */
	 "R_PPC64_GOT16",	/* name */
	 FALSE,			/* partial_inplace */
	 0,			/* src_mask */
	 0xffff,		/* dst_mask */
  ...
  HOWTO (R_PPC64_SECTOFF,	/* type */
	 ...
	 0,			/* bitpos */
	 complain_overflow_bitfield, /* complain_on_overflow */
	 ppc64_cgc_sectoff_reloc, /* special_function */
  ...
  HOWTO (R_PPC64_SECTOFF_HA,	/* type */
	 ...
	 0,			/* bitpos */
	 complain_overflow_signed, /* complain_on_overflow */
	 ppc64_cgc_sectoff_ha_reloc, /* special_function */
  ...
  /* Relocs in the 64-bit PowerPC CGC ABI, not in the 32-bit ABI.  */
  ...
  HOWTO (R_PPC64_TOC16,		/* type */
	 ...
	 0,			/* bitpos */
	 complain_overflow_signed, /* complain_on_overflow */
	 ppc64_cgc_toc_reloc,	/* special_function */
	 "R_PPC64_TOC16",	/* name */
	 FALSE,			/* partial_inplace */
	 0,			/* src_mask */
	 0xffff,		/* dst_mask */
  ...
  HOWTO (R_PPC64_TOC16_HA,	/* type */
	 ...
	 0,			/* bitpos */
	 complain_overflow_signed, /* complain_on_overflow */
	 ppc64_cgc_toc_ha_reloc, /* special_function */
  ...
  HOWTO (R_PPC64_TOC,		/* type */
	 ...
	 0,			/* bitpos */
	 complain_overflow_bitfield, /* complain_on_overflow */
	 ppc64_cgc_toc64_reloc,	/* special_function */
	 "R_PPC64_TOC",		/* name */
	 FALSE,			/* partial_inplace */
	 0,			/* src_mask */
	 ONES (64),		/* dst_mask */
...

/* Initialize the ppc64_cgc_howto_table, so that linear accesses can
   be done.  */
...
ppc_howto_init (void)
{
  ...
  for (i = 0;
       i < sizeof (ppc64_cgc_howto_raw) / sizeof (ppc64_cgc_howto_raw[0]);
       i++)
    {
      type = ppc64_cgc_howto_raw[i].type;
      BFD_ASSERT (type < (sizeof (ppc64_cgc_howto_table)
			  / sizeof (ppc64_cgc_howto_table[0])));
      ppc64_cgc_howto_table[type] = &ppc64_cgc_howto_raw[i];
    }
}

static reloc_howto_type *
ppc64_cgc_reloc_type_lookup (bfd *abfd ATTRIBUTE_UNUSED,
			     bfd_reloc_code_real_type code)
{
  enum cgc_ppc64_reloc_type r = R_PPC64_NONE;

  if (!ppc64_cgc_howto_table[R_PPC64_ADDR32])
  ...
  return ppc64_cgc_howto_table[r];
};

static reloc_howto_type *
ppc64_cgc_reloc_name_lookup (bfd *abfd ATTRIBUTE_UNUSED,
			     const char *r_name)
{
  unsigned int i;
  ...
  for (i = 0;
       i < sizeof (ppc64_cgc_howto_raw) / sizeof (ppc64_cgc_howto_raw[0]);
       i++)
    if (ppc64_cgc_howto_raw[i].name != NULL
	&& strcasecmp (ppc64_cgc_howto_raw[i].name, r_name) == 0)
      return &ppc64_cgc_howto_raw[i];

  return NULL;
}

/* Set the howto pointer for a PowerPC CGC reloc.  */

static void
ppc64_cgc_info_to_howto (bfd *abfd ATTRIBUTE_UNUSED, arelent *cache_ptr,
			 Cgc_Internal_Rela *dst)
{
  ...
  type = CGC64_R_TYPE (dst->r_info);
  if (type >= (sizeof (ppc64_cgc_howto_table)
	       / sizeof (ppc64_cgc_howto_table[0])))
    {
  ...
  cache_ptr->howto = ppc64_cgc_howto_table[type];
}

/* Handle the R_PPC64_ADDR16_HA and similar relocs.  */

static bfd_reloc_status_type
ppc64_cgc_ha_reloc (bfd *abfd, arelent *reloc_entry, asymbol *symbol,
		    ...
		    bfd *output_bfd, char **error_message)
{
  /* If this is a relocatable link (output_bfd test tells us), just
     ...
     link time.  */
  if (output_bfd != NULL)
    return bfd_cgc_generic_reloc (abfd, reloc_entry, symbol, data,
...
static bfd_reloc_status_type
ppc64_cgc_branch_reloc (bfd *abfd, arelent *reloc_entry, asymbol *symbol,
			void *data, asection *input_section,
			bfd *output_bfd, char **error_message)
{
  if (output_bfd != NULL)
...
static bfd_reloc_status_type
ppc64_cgc_brtaken_reloc (bfd *abfd, arelent *reloc_entry, asymbol *symbol,
			 void *data, asection *input_section,
			 bfd *output_bfd, char **error_message)
{
  long insn;
  enum cgc_ppc64_reloc_type r_type;
 ...
 out:
  return ppc64_cgc_branch_reloc (abfd, reloc_entry, symbol, data,
				 input_section, output_bfd, error_message);
}

static bfd_reloc_status_type
ppc64_cgc_sectoff_reloc (bfd *abfd, arelent *reloc_entry, asymbol *symbol,
			 void *data, asection *input_section,
			 bfd *output_bfd, char **error_message)
{
  /* If this is a relocatable link (output_bfd test tells us), just
...
static bfd_reloc_status_type
ppc64_cgc_sectoff_ha_reloc (bfd *abfd, arelent *reloc_entry, asymbol *symbol,
			    void *data, asection *input_section,
			    bfd *output_bfd, char **error_message)
{
  /* If this is a relocatable link (output_bfd test tells us), just
...
static bfd_reloc_status_type
ppc64_cgc_toc_reloc (bfd *abfd, arelent *reloc_entry, asymbol *symbol,
		     void *data, asection *input_section,
		     bfd *output_bfd, char **error_message)
{
  bfd_vma TOCstart;
  ...
  if (TOCstart == 0)
    TOCstart = ppc64_cgc_set_toc (NULL, input_section->output_section->owner);
...
static bfd_reloc_status_type
ppc64_cgc_toc_ha_reloc (bfd *abfd, arelent *reloc_entry, asymbol *symbol,
			void *data, asection *input_section,
			bfd *output_bfd, char **error_message)
{
  bfd_vma TOCstart;
...
static bfd_reloc_status_type
ppc64_cgc_toc64_reloc (bfd *abfd, arelent *reloc_entry, asymbol *symbol,
		       void *data, asection *input_section,
		       bfd *output_bfd, char **error_message)
{
  bfd_vma TOCstart;
...
static bfd_reloc_status_type
ppc64_cgc_unhandled_reloc (bfd *abfd, arelent *reloc_entry, asymbol *symbol,
			   void *data, asection *input_section,
			   bfd *output_bfd, char **error_message)
{
  /* If this is a relocatable link (output_bfd test tells us), just
...
struct got_entry
{
  ...
  /* Unlike other CGC targets, we use separate GOT entries for the same
...
struct ppc64_cgc_obj_tdata
{
  struct cgc_obj_tdata cgc;
...
#define ppc64_cgc_tdata(bfd) \
  ((struct ppc64_cgc_obj_tdata *) (bfd)->tdata.any)

#define ppc64_tlsld_got(bfd) \
  (&ppc64_cgc_tdata (bfd)->tlsld_got)

#define is_ppc64_cgc(bfd) \
  (bfd_get_flavour (bfd) == bfd_target_cgc_flavour \
   && cgc_object_id (bfd) == PPC64_CGC_DATA)

/* Override the generic function because we store some extras.  */

static bfd_boolean
ppc64_cgc_mkobject (bfd *abfd)
{
  return bfd_cgc_allocate_object (abfd, sizeof (struct ppc64_cgc_obj_tdata),
				  PPC64_CGC_DATA);
}
...
static bfd_boolean
ppc64_cgc_object_p (bfd *abfd)
{
  if (abfd->arch_info->the_default && abfd->arch_info->bits_per_word == 32)
    {
      Cgc_Internal_Ehdr *i_ehdr = cgc_cgcheader (abfd);

      if (i_ehdr->e_ident[EI_CLASS] == CGCCLASS64)
	{
...
static bfd_boolean
ppc64_cgc_grok_prstatus (bfd *abfd, Cgc_Internal_Note *note)
{
  size_t offset, size;
  ...
  /* pr_pid */
  cgc_tdata (abfd)->core->lwpid = bfd_get_32 (abfd, note->descdata + 32);
...
static bfd_boolean
ppc64_cgc_grok_psinfo (bfd *abfd, Cgc_Internal_Note *note)
{
  if (note->descsz != 136)
    return FALSE;
  ...
  cgc_tdata (abfd)->core->program
    = _bfd_cgccore_strndup (abfd, note->descdata + 40, 16);
  cgc_tdata (abfd)->core->command
    = _bfd_cgccore_strndup (abfd, note->descdata + 56, 80);

  return TRUE;
}

static char *
ppc64_cgc_write_core_note (bfd *abfd, char *buf, int *bufsiz, int note_type,
			   ...)
{
  switch (note_type)
    {
...
static const struct bfd_cgc_special_section ppc64_cgc_special_sections[]=
{
...
struct _ppc64_cgc_section_data
{
...
#define ppc64_cgc_section_data(sec) \
  ((struct _ppc64_cgc_section_data *) cgc_section_data (sec))

static bfd_boolean
ppc64_cgc_new_section_hook (bfd *abfd, asection *sec)
{
  if (!sec->used_by_bfd)
    {
      struct _ppc64_cgc_section_data *sdata;
...
{
  if (sec != NULL
      && ppc64_cgc_section_data (sec) != NULL
      && ppc64_cgc_section_data (sec)->sec_type == sec_opd)
    return &ppc64_cgc_section_data (sec)->u.opd;
  return NULL;
}
...
abiversion (bfd *abfd)
{
  return cgc_cgcheader (abfd)->e_flags & EF_PPC64_ABI;
}

static inline void
set_abiversion (bfd *abfd, int ver)
{
  cgc_cgcheader (abfd)->e_flags &= ~EF_PPC64_ABI;
  cgc_cgcheader (abfd)->e_flags |= ver & EF_PPC64_ABI;
}

/* Parameters for the qsort hook.  */
static bfd_boolean synthetic_relocatable;

/* qsort comparison function for ppc64_cgc_get_synthetic_symtab.  */
...
static long
ppc64_cgc_get_synthetic_symtab (bfd *abfd,
	  ...
	  for (; extdyn < extdynend; extdyn += extdynsize)
	      ...
	      if (dyn.d_tag == DT_PPC64_GLINK)
		{
		  /* The first glink stub starts at offset 32; see
		     comment in ppc64_cgc_finish_dynamic_sections. */
      ...
      if (glink != NULL)
	{
	  ...
	  if (relplt != NULL)
		...
		goto free_contents_and_exit;
	      ...
	      plt_count = relplt->size / sizeof (Cgc64_External_Rela);
...

/* The following functions are specific to the CGC linker, while
   functions above are used generally.  Those named ppc64_cgc_* are
   called by the main CGC linker code.  They appear in this file more
   or less in the order in which they are called.  eg.
   ppc64_cgc_check_relocs is called early in the link process,
   ppc64_cgc_finish_dynamic_sections is one of the last functions
   called.

   PowerPC64-CGC uses a similar scheme to PowerPC64-XCOFF in that
   ...
   Secondly, the generic part of the cgc linker will make .foo a dynamic
...
struct ppc_link_hash_entry
{
  ...
  /* Whether global opd/toc sym has been adjusted or not.
     After ppc64_cgc_edit_opd/ppc64_cgc_edit_toc has run, this flag
...
struct ppc_link_hash_table
{
  ...
  struct map_stub {
    ...
    /* The stub section.  */
    asection *stub_sec;
    /* Along with cgc_gp, specifies the TOC pointer used in this group.  */
    bfd_vma toc_off;
  } *stub_group;
  ...
  /* Temp used by ppc64_cgc_process_dot_syms.  */
...
/* Get the ppc64 CGC linker hash table from a link_info structure.  */

#define ppc_hash_table(p) \
  (cgc_hash_table_id ((struct cgc_link_hash_table *) ((p)->hash)) \
  == PPC64_CGC_DATA ? ((struct ppc_link_hash_table *) ((p)->hash)) : NULL)
...
/* Create an entry in a ppc64 CGC linker hash table.  */
...
/* Create a ppc64 CGC linker hash table.  */

static struct bfd_link_hash_table *
ppc64_cgc_link_hash_table_create (bfd *abfd)
{
  struct ppc_link_hash_table *htab;
  ...
  if (!_bfd_cgc_link_hash_table_init (&htab->cgc, abfd, link_hash_newfunc,
				      sizeof (struct ppc_link_hash_entry),
				      PPC64_CGC_DATA))
    {
      free (htab);
  ...
  htab->cgc.init_got_refcount.refcount = 0;
  htab->cgc.init_got_refcount.glist = NULL;
  htab->cgc.init_plt_refcount.refcount = 0;
  htab->cgc.init_plt_refcount.glist = NULL;
  htab->cgc.init_got_offset.offset = 0;
  htab->cgc.init_got_offset.glist = NULL;
  htab->cgc.init_plt_offset.offset = 0;
  htab->cgc.init_plt_offset.glist = NULL;

  return &htab->cgc.root;
}

/* Free the derived linker hash table.  */

static void
ppc64_cgc_link_hash_table_free (struct bfd_link_hash_table *hash)
{
...
create_linkage_sections (bfd *dynobj, struct bfd_link_info *info)
{
  ...
  htab->cgc.iplt = bfd_make_section_anyway_with_flags (dynobj, ".iplt", flags);
  if (htab->cgc.iplt == NULL
      || ! bfd_set_section_alignment (dynobj, htab->cgc.iplt, 3))
    return FALSE;
  ...
  if (htab->cgc.irelplt == NULL
      || ! bfd_set_section_alignment (dynobj, htab->cgc.irelplt, 3))
    return FALSE;
...
/* Satisfy the CGC linker by filling in some fields in our fake bfd.  */

bfd_boolean
ppc64_cgc_init_stub_bfd (bfd *abfd, struct bfd_link_info *info)
{
  struct ppc_link_hash_table *htab;

  cgc_cgcheader (abfd)->e_ident[EI_CLASS] = CGCCLASS64;
...
/* Always hook our dynamic sections into the first bfd, which is the
  ...
  return create_linkage_sections (htab->cgc.dynobj, info);
}
	       ...
	       const Cgc_Internal_Rela *rel)
{
  ...
  if (h)
    {
      len = 8 + 1 + strlen (h->cgc.root.root.string) + 1 + 8 + 1;
	...
	return stub_name;
      ...
      len = sprintf (stub_name, "%08x.%x:%x+%x",
		     ...
		     (int) CGC64_R_SYM (rel->r_info) & 0xffffffff,
		     (int) rel->r_addend & 0xffffffff);
    }
...
create_got_section (bfd *abfd, struct bfd_link_info *info)
{
  ...
  if (!is_ppc64_cgc (abfd))
    return FALSE;
  if (htab == NULL)
    return FALSE;

  if (!htab->cgc.sgot
      && !_bfd_cgc_create_got_section (htab->cgc.dynobj, info))
    return FALSE;
  ...
  ppc64_cgc_tdata (abfd)->got = got;
  ppc64_cgc_tdata (abfd)->relgot = relgot;
  return TRUE;
}
...
static bfd_boolean
ppc64_cgc_create_dynamic_sections (bfd *dynobj, struct bfd_link_info *info)
{
  struct ppc_link_hash_table *htab;
  ...
  if (!htab->cgc.sgot || !htab->cgc.splt || !htab->cgc.srelplt || !htab->dynbss
...
static inline struct cgc_link_hash_entry *
cgc_follow_link (struct cgc_link_hash_entry *h)
{
  return (struct cgc_link_hash_entry *) follow_link (&h->root);
}

static inline struct ppc_link_hash_entry *
ppc_follow_link (struct ppc_link_hash_entry *h)
{
  return (struct ppc_link_hash_entry *) follow_link (&h->cgc.root);
}
...
{
  if (from->cgc.plt.plist != NULL)
    {
      if (to->cgc.plt.plist != NULL)
	{
	  struct plt_entry **entp;
	  struct plt_entry *ent;

	  for (entp = &from->cgc.plt.plist; (ent = *entp) != NULL; )
	    {
	      struct plt_entry *dent;

	      for (dent = to->cgc.plt.plist; dent != NULL; dent = dent->next)
	  ...
	  *entp = to->cgc.plt.plist;
	}

      to->cgc.plt.plist = from->cgc.plt.plist;
      from->cgc.plt.plist = NULL;
    }
}
...
static void
ppc64_cgc_copy_indirect_symbol (struct bfd_link_info *info,
				...
				struct cgc_link_hash_entry *ind)
{
  ...
  if (!(ELIMINATE_COPY_RELOCS
	&& eind->cgc.root.type != bfd_link_hash_indirect
	&& edir->cgc.dynamic_adjusted))
    edir->cgc.non_got_ref |= eind->cgc.non_got_ref;

  edir->cgc.ref_dynamic |= eind->cgc.ref_dynamic;
  edir->cgc.ref_regular |= eind->cgc.ref_regular;
  edir->cgc.ref_regular_nonweak |= eind->cgc.ref_regular_nonweak;
  edir->cgc.needs_plt |= eind->cgc.needs_plt;
  edir->cgc.pointer_equality_needed |= eind->cgc.pointer_equality_needed;
  ...
  /* If we were called to copy over info for a weak sym, that's all.
     ...
     code in ppc64_cgc_adjust_dynamic_symbol needs to check for
     dyn_relocs in read-only sections, and it does so on what is the
     DIR sym here.  */
  if (eind->cgc.root.type != bfd_link_hash_indirect)
    return;

  /* Copy over got entries that we may have already seen to the
     symbol which just became indirect.  */
  if (eind->cgc.got.glist != NULL)
    {
      if (edir->cgc.got.glist != NULL)
	{
	  struct got_entry **entp;
	  struct got_entry *ent;

	  for (entp = &eind->cgc.got.glist; (ent = *entp) != NULL; )
	    {
	      struct got_entry *dent;

	      for (dent = edir->cgc.got.glist; dent != NULL; dent = dent->next)
		if (dent->addend == ent->addend
	  ...
	  *entp = edir->cgc.got.glist;
	}

      edir->cgc.got.glist = eind->cgc.got.glist;
      eind->cgc.got.glist = NULL;
    }

  /* And plt entries.  */
  move_plt_plist (eind, edir);

  if (eind->cgc.dynindx != -1)
    {
      if (edir->cgc.dynindx != -1)
	_bfd_cgc_strtab_delref (cgc_hash_table (info)->dynstr,
				edir->cgc.dynstr_index);
      edir->cgc.dynindx = eind->cgc.dynindx;
      edir->cgc.dynstr_index = eind->cgc.dynstr_index;
      eind->cgc.dynindx = -1;
      eind->cgc.dynstr_index = 0;
    }
}
...
lookup_fdh (struct ppc_link_hash_entry *fh, struct ppc_link_hash_table *htab)
{
  ...
  if (fdh == NULL)
    {
      const char *fd_name = fh->cgc.root.root.string + 1;

      fdh = (struct ppc_link_hash_entry *)
	cgc_link_hash_lookup (&htab->cgc, fd_name, FALSE, FALSE, FALSE);
      if (fdh == NULL)
	return fdh;
	  ...
	  struct ppc_link_hash_entry *fh)
{
  ...
  abfd = fh->cgc.root.u.undef.abfd;
  newsym = bfd_make_empty_symbol (abfd);
  newsym->name = fh->cgc.root.root.string + 1;
...
static bfd_boolean
ppc64_cgc_add_symbol_hook (bfd *ibfd,
			   struct bfd_link_info *info,
			   ...
			   bfd_vma *value ATTRIBUTE_UNUSED)
{
  if ((ibfd->flags & DYNAMIC) == 0
      && CGC_ST_BIND (isym->st_info) == STB_GNU_UNIQUE)
  ...
  else if (CGC_ST_TYPE (isym->st_info) == STT_FUNC)
    ;
  else if (*sec != NULL
	   && strcmp ((*sec)->name, ".opd") == 0)
    isym->st_info = CGC_ST_INFO (CGC_ST_BIND (isym->st_info), STT_FUNC);
...
static void
ppc64_cgc_merge_symbol_attribute (struct cgc_link_hash_entry *h,
				  const Cgc_Internal_Sym *isym,
				  bfd_boolean definition,
				  bfd_boolean dynamic)
{
  if (definition && !dynamic)
    h->other = ((isym->st_other & ~CGC_ST_VISIBILITY (-1))
...
ppc64_cgc_archive_symbol_lookup (bfd *abfd,
				 struct bfd_link_info *info,
				 const char *name)
{
  ...
  h = _bfd_cgc_archive_symbol_lookup (abfd, info, name);
  if (h != NULL
  ...
  h = _bfd_cgc_archive_symbol_lookup (abfd, info, dot_name);
...
add_symbol_adjust (struct ppc_link_hash_entry *eh, struct bfd_link_info *info)
{
  ...
  if (eh->cgc.root.type == bfd_link_hash_indirect)
    return TRUE;

  if (eh->cgc.root.type == bfd_link_hash_warning)
    eh = (struct ppc_link_hash_entry *) eh->cgc.root.u.i.link;

  if (eh->cgc.root.root.string[0] != '.')
    abort ();
  ...
  if (fdh == NULL)
    {
      if (!info->relocatable
	  && (eh->cgc.root.type == bfd_link_hash_undefined
	      || eh->cgc.root.type == bfd_link_hash_undefweak)
	  && eh->cgc.ref_regular)
	{
	  ...
	  if (fdh == NULL)
	    return FALSE;
	  fdh->cgc.ref_regular = 1;
	}
    }
  else
    {
      unsigned entry_vis = CGC_ST_VISIBILITY (eh->cgc.other) - 1;
      unsigned descr_vis = CGC_ST_VISIBILITY (fdh->cgc.other) - 1;
      if (entry_vis < descr_vis)
	fdh->cgc.other += entry_vis - descr_vis;
      else if (entry_vis > descr_vis)
	eh->cgc.other += descr_vis - entry_vis;

      if ((fdh->cgc.root.type == bfd_link_hash_defined
	   || fdh->cgc.root.type == bfd_link_hash_defweak)
	  && eh->cgc.root.type == bfd_link_hash_undefined)
	{
	  eh->cgc.root.type = bfd_link_hash_undefweak;
	  eh->was_undefined = 1;
...
static bfd_boolean
ppc64_cgc_process_dot_syms (bfd *ibfd, struct bfd_link_info *info)
{
  struct ppc_link_hash_table *htab;
  struct ppc_link_hash_entry **p, *eh;

  if (!is_ppc64_cgc (info->output_bfd))
    return TRUE;
  htab = ppc_hash_table (info);
  if (htab == NULL)
    return FALSE;

  if (is_ppc64_cgc (ibfd))
    {
      p = &htab->dot_syms;
      while ((eh = *p) != NULL)
	{
	  *p = NULL;
	  if (&eh->cgc == htab->cgc.hgot)
	    ;
	  else if (htab->cgc.hgot == NULL
		   && strcmp (eh->cgc.root.root.string, ".TOC.") == 0)
	    htab->cgc.hgot = &eh->cgc;
  ...
  if (htab->twiddled_syms)
    {
      bfd_link_repair_undef_list (&htab->cgc.root);
...
static bfd_boolean
ppc64_cgc_notice_as_needed (bfd *ibfd,
			    struct bfd_link_info *info,
			    enum notice_asneeded_action act)
{
  ...
  return _bfd_cgc_notice_as_needed (ibfd, info, act);
}
...
static void
ppc64_cgc_link_just_syms (asection *sec, struct bfd_link_info *info)
{
  if ((sec->flags & SEC_CODE) != 0
      && (sec->owner->flags & (EXEC_P | DYNAMIC)) != 0
      && is_ppc64_cgc (sec->owner))
    {
      asection *got = bfd_get_section_by_name (sec->owner, ".got");
      if (got != NULL
	  && got->size >= cgc_backend_got_header_size
	  && bfd_get_section_by_name (sec->owner, ".opd") != NULL)
	sec->has_toc_reloc = 1;
    }
  _bfd_cgc_link_just_syms (sec, info);
}

static struct plt_entry **
update_local_sym_info (bfd *abfd, Cgc_Internal_Shdr *symtab_hdr,
		       unsigned long r_symndx, bfd_vma r_addend, int tls_type)
{
  struct got_entry **local_got_ents = cgc_local_got_ents (abfd);
  ...
  if (local_got_ents == NULL)
    {
      ...
      if (local_got_ents == NULL)
	return NULL;
      cgc_local_got_ents (abfd) = local_got_ents;
    }
...
static bfd_boolean
is_branch_reloc (enum cgc_ppc64_reloc_type r_type)
{
...
static bfd_boolean
ppc64_cgc_check_relocs (bfd *abfd, struct bfd_link_info *info,
			asection *sec, const Cgc_Internal_Rela *relocs)
{
  ...
  struct cgc_link_hash_entry *tga, *dottga;
  ...
  BFD_ASSERT (is_ppc64_cgc (abfd));

  htab = ppc_hash_table (info);
  if (htab == NULL)
    return FALSE;

  tga = cgc_link_hash_lookup (&htab->cgc, "__tls_get_addr",
			      FALSE, FALSE, TRUE);
  dottga = cgc_link_hash_lookup (&htab->cgc, ".__tls_get_addr",
				 FALSE, FALSE, TRUE);
  ...
  if (strcmp (sec->name, ".opd") == 0)
      ...
      else if (abiversion (abfd) == 2)
	{
      ...
      if (opd_sym_map == NULL)
	return FALSE;
      ppc64_cgc_section_data (sec)->u.opd.func_sec = opd_sym_map;
      BFD_ASSERT (ppc64_cgc_section_data (sec)->sec_type == sec_normal);
      ppc64_cgc_section_data (sec)->sec_type = sec_opd;
    }
  ...
  for (rel = relocs; rel < rel_end; rel++)
    {
      ...
      enum cgc_ppc64_reloc_type r_type;
      int tls_type;
      struct _ppc64_cgc_section_data *ppc64_sec;
	...
	{
	  Cgc_Internal_Sym *isym = bfd_sym_from_r_symndx (&htab->sym_cache,
							  abfd, r_symndx);
	  if (isym == NULL)
	    return FALSE;
      ...
      if (is_branch_reloc (r_type))
	{
	  if (h != NULL && (h == tga || h == dottga))
	    {
	      if (rel != relocs
		  && (CGC64_R_TYPE (rel[-1].r_info) == R_PPC64_TLSGD
		      || CGC64_R_TYPE (rel[-1].r_info) == R_PPC64_TLSLD))
	...
	case R_PPC64_GOT16_LO_DS:
	  ...
	  if (r_type == R_PPC64_GOT_TLSLD16
	    ...
	    {
	      htab->do_multi_toc = 1;
	      ppc64_cgc_tdata (abfd)->has_small_toc_reloc = 1;
	    }

	  if (ppc64_cgc_tdata (abfd)->got == NULL
	  ...
	  if (h != NULL)
	    {
	      ...
	      for (ent = eh->cgc.got.glist; ent != NULL; ent = ent->next)
	      ...
	      if (ent == NULL)
		{
		  ...
		  if (ent == NULL)
		    return FALSE;
		  ent->next = eh->cgc.got.glist;
		  ent->addend = rel->r_addend;
		  ent->owner = abfd;
		  ent->tls_type = tls_type;
		  ent->is_indirect = FALSE;
		  ent->got.refcount = 0;
		  eh->cgc.got.glist = ent;
		}
	      ent->got.refcount += 1;
	...
	case R_PPC64_REL14_BRNTAKEN:
	  {
		...
		dest = bfd_section_from_cgc_index (abfd, isym->st_shndx);
	      }

	    if (dest != sec)
	      ppc64_cgc_section_data (sec)->has_14bit_branch = 1;
	  }
	  /* Fall through.  */
	...
	case R_PPC64_DTPMOD64:
	  if (rel + 1 < rel_end
	      && rel[1].r_info == CGC64_R_INFO (r_symndx, R_PPC64_DTPREL64)
	...
	case R_PPC64_DTPREL64:
	  ...
	  if (rel != relocs
	      && rel[-1].r_info == CGC64_R_INFO (r_symndx, R_PPC64_DTPMOD64)
	      && rel[-1].r_offset == rel->r_offset - 8)
	...
	dotlstoc:
	  ...
	  ppc64_sec = ppc64_cgc_section_data (sec);
	...
	case R_PPC64_ADDR64:
	  if (opd_sym_map != NULL
	      && rel + 1 < rel_end
	      && CGC64_R_TYPE ((rel + 1)->r_info) == R_PPC64_TOC)
	    {
	      if (h != NULL)
		{
		  if (h->root.root.string[0] == '.'
	...
	dodyn:
	  if ((info->shared
	      ...
	      if (h != NULL)
		{
		  ...
		  if (p == NULL || p->sec != sec)
		    {
		      p = bfd_alloc (htab->cgc.dynobj, sizeof *p);
		      if (p == NULL)
			return FALSE;
		      p->next = *head;
		      *head = p;
	      ...
	      else
		{
		  ...
		  is_ifunc = CGC_ST_TYPE (isym->st_info) == STT_GNU_IFUNC;
		  p = *head;
...
static bfd_boolean
ppc64_cgc_merge_private_bfd_data (bfd *ibfd, bfd *obfd)
{
  ...
  if (!is_ppc64_cgc (ibfd) || !is_ppc64_cgc (obfd))
    return TRUE;

  if (!_bfd_generic_verify_endian_match (ibfd, obfd))
    return FALSE;

  iflags = cgc_cgcheader (ibfd)->e_flags;
  oflags = cgc_cgcheader (obfd)->e_flags;

  if (!cgc_flags_init (obfd) || oflags == 0)
    {
      cgc_flags_init (obfd) = TRUE;
      cgc_cgcheader (obfd)->e_flags = iflags;
    }
...
static bfd_boolean
ppc64_cgc_print_private_bfd_data (bfd *abfd, void *ptr)
{
  /* Print normal CGC private data.  */
  _bfd_cgc_print_private_bfd_data (abfd, ptr);

  if (cgc_cgcheader (abfd)->e_flags != 0)
    {
      FILE *file = ptr;

      /* xgettext:c-format */
      fprintf (file, _("private flags = 0x%lx:"),
	       cgc_cgcheader (abfd)->e_flags);

      if ((cgc_cgcheader (abfd)->e_flags & EF_PPC64_ABI) != 0)
		 ...
		 bfd_boolean in_code_sec)
{
  ...
  if (opd_sec->reloc_count == 0)
    {
      bfd_byte *contents = ppc64_cgc_tdata (opd_bfd)->opd.contents;

      if (contents == NULL)
	{
	  if (!bfd_malloc_and_get_section (opd_bfd, opd_sec, &contents))
	    return (bfd_vma) -1;
	  ppc64_cgc_tdata (opd_bfd)->opd.contents = contents;
	}
  ...
  BFD_ASSERT (is_ppc64_cgc (opd_bfd));

  relocs = ppc64_cgc_tdata (opd_bfd)->opd.relocs;
  if (relocs == NULL)
    relocs = _bfd_cgc_link_read_relocs (opd_bfd, opd_sec, NULL, NULL, TRUE);
  ...
  while (lo < hi)
	...
	{
	  Cgc_Internal_Shdr *symtab_hdr = &cgc_symtab_hdr (opd_bfd);

	  if (CGC64_R_TYPE (look->r_info) == R_PPC64_ADDR64
	      && CGC64_R_TYPE ((look + 1)->r_info) == R_PPC64_TOC)
	    {
	      unsigned long symndx = CGC64_R_SYM (look->r_info);
	      asection *sec;

	      if (symndx < symtab_hdr->sh_info
		  || cgc_sym_hashes (opd_bfd) == NULL)
		{
		  Cgc_Internal_Sym *sym;

		  sym = (Cgc_Internal_Sym *) symtab_hdr->contents;
		  if (sym == NULL)
		    {
		      size_t symcnt = symtab_hdr->sh_info;
		      if (cgc_sym_hashes (opd_bfd) == NULL)
			symcnt = symtab_hdr->sh_size / symtab_hdr->sh_entsize;
		      sym = bfd_cgc_get_cgc_syms (opd_bfd, symtab_hdr, symcnt,
						  0, NULL, NULL, NULL);
		      if (sym == NULL)
			break;
		  ...
		  sym += symndx;
		  val = sym->st_value;
		  sec = bfd_section_from_cgc_index (opd_bfd, sym->st_shndx);
	      ...
	      else
		{
		  ...
		  sym_hashes = cgc_sym_hashes (opd_bfd);
		  rh = sym_hashes[symndx - symtab_hdr->sh_info];
		  if (rh != NULL)
		    {
		      rh = cgc_follow_link (rh);
		  ...
		  else
		    {
			 ...
			 during bfd_cgc_link_add_symbols before the
			 symbol hashes have been fully populated.  */
		      Cgc_Internal_Sym *sym;

		      sym = bfd_cgc_get_cgc_syms (opd_bfd, symtab_hdr, 1,
...
ppc64_cgc_maybe_function_sym (const asymbol *sym, asection *sec,
			      bfd_vma *code_off)
{
  bfd_size_type size;
  ...
  if (strcmp (sym->section->name, ".opd") == 0)
	...
	return 0;
	 ...
	 since cgc_find_function will look at the dot-sym anyway.
	 Now, cgc_find_function will keep the largest size of any
...
static bfd_boolean
is_static_defined (struct cgc_link_hash_entry *h)
{
  ...
  if (fdh->is_func_descriptor)
    {
      ...
      if (fh->cgc.root.type == bfd_link_hash_defined
	  || fh->cgc.root.type == bfd_link_hash_defweak)
	return fh;
    }
  return NULL;
}
...
static void
ppc64_cgc_gc_keep (struct bfd_link_info *info)
{
  struct ppc_link_hash_table *htab = ppc_hash_table (info);
  ...
  for (sym = info->gc_sym_list; sym != NULL; sym = sym->next)
	...
	cgc_link_hash_lookup (&htab->cgc, sym->name, FALSE, FALSE, TRUE);
      if (eh == NULL)
	continue;
      if (eh->cgc.root.type != bfd_link_hash_defined
	  && eh->cgc.root.type != bfd_link_hash_defweak)
	continue;

      fh = defined_code_entry (eh);
      if (fh != NULL)
	{
	  sec = fh->cgc.root.u.def.section;
	  sec->flags |= SEC_KEEP;
	}
      else if (get_opd_info (eh->cgc.root.u.def.section) != NULL
	       && opd_entry_value (eh->cgc.root.u.def.section,
				   eh->cgc.root.u.def.value,
				   &sec, NULL, FALSE) != (bfd_vma) -1)
	sec->flags |= SEC_KEEP;

      sec = eh->cgc.root.u.def.section;
      sec->flags |= SEC_KEEP;
    }
}
...
static bfd_boolean
ppc64_cgc_gc_mark_dynamic_ref (struct cgc_link_hash_entry *h, void *inf)
{
  ...
  if ((eh->cgc.root.type == bfd_link_hash_defined
	  ...
	  || (!info->executable
	      && eh->cgc.def_regular
	      && CGC_ST_VISIBILITY (eh->cgc.other) != STV_INTERNAL
	      && CGC_ST_VISIBILITY (eh->cgc.other) != STV_HIDDEN
	      && (strchr (eh->cgc.root.root.string, CGC_VER_CHR) != NULL
		  || !bfd_hide_sym_by_version (info->version_info,
					       eh->cgc.root.root.string)))))
    {
      asection *code_sec;
      struct ppc_link_hash_entry *fh;

      eh->cgc.root.u.def.section->flags |= SEC_KEEP;
	 ...
	 function code sym section to be marked.  */
      ...
      if (fh != NULL)
	{
	  code_sec = fh->cgc.root.u.def.section;
...
static asection *
ppc64_cgc_gc_mark_hook (asection *sec,
			struct bfd_link_info *info,
			...
			Cgc_Internal_Sym *sym)
{
  ...
  if (h != NULL)
	...
	default:
	  switch (h->root.type)
	      ...
	      if (fh != NULL)
		{
		  ...
		  eh->cgc.root.u.def.section->gc_mark = 1;

		  rsec = fh->cgc.root.u.def.section;
		}
	      else if (get_opd_info (eh->cgc.root.u.def.section) != NULL
		       && opd_entry_value (eh->cgc.root.u.def.section,
					   eh->cgc.root.u.def.value,
  ...
  else
    {
      ...
      rsec = bfd_section_from_cgc_index (sec->owner, sym->st_shndx);
...
static bfd_boolean
ppc64_cgc_gc_sweep_hook (bfd *abfd, struct bfd_link_info *info,
			 asection *sec, const Cgc_Internal_Rela *relocs)
{
  struct ppc_link_hash_table *htab;
  Cgc_Internal_Shdr *symtab_hdr;
  ...
  symtab_hdr = &cgc_symtab_hdr (abfd);
  sym_hashes = cgc_sym_hashes (abfd);
  local_got_ents = cgc_local_got_ents (abfd);
  ...
  for (i = parm->lo; i <= parm->hi; i++)
    {
      ...
      sym[len + 0] = i / 10 + '0';
      sym[len + 1] = i % 10 + '0';
      h = cgc_link_hash_lookup (&htab->cgc, sym, FALSE, FALSE, TRUE);
      if (h != NULL
	  && !h->def_regular)
	{
	  ...
	  if (htab->sfpr->contents == NULL)
	    {
	      htab->sfpr->contents = bfd_alloc (htab->cgc.dynobj, SFPR_MAX);
	      if (htab->sfpr->contents == NULL)
		return FALSE;
	    }
	}
      if (writing)
	{
	  ...
	  if (i != parm->hi)
	    p = (*parm->write_ent) (htab->cgc.dynobj, p, i);
	  else
	    p = (*parm->write_tail) (htab->cgc.dynobj, p, i);
...
/* Called via cgc_link_hash_traverse to transfer dynamic linking
   information on function code symbol entries to their corresponding
   function descriptor symbol entries.  */

static bfd_boolean
func_desc_adjust (struct cgc_link_hash_entry *h, void *inf)
{
  struct bfd_link_info *info;
  struct ppc_link_hash_table *htab;
  struct plt_entry *ent;
  ...
  if (fh->cgc.root.type == bfd_link_hash_indirect)
    return TRUE;
  ...
  if (fh->cgc.root.type == bfd_link_hash_undefweak
      && fh->was_undefined
      && (fdh = defined_func_desc (fh)) != NULL
      && get_opd_info (fdh->cgc.root.u.def.section) != NULL
      && opd_entry_value (fdh->cgc.root.u.def.section,
			  fdh->cgc.root.u.def.value,
			  &fh->cgc.root.u.def.section,
			  &fh->cgc.root.u.def.value, FALSE) != (bfd_vma) -1)
    {
      fh->cgc.root.type = fdh->cgc.root.type;
      fh->cgc.forced_local = 1;
      fh->cgc.def_regular = fdh->cgc.def_regular;
      fh->cgc.def_dynamic = fdh->cgc.def_dynamic;
    }
  ...
  for (ent = fh->cgc.plt.plist; ent != NULL; ent = ent->next)
    if (ent->plt.refcount > 0)
      break;
  if (ent == NULL
      || fh->cgc.root.root.string[0] != '.'
      || fh->cgc.root.root.string[1] == '\0')
    return TRUE;
  ...
  if (fdh == NULL
      && !info->executable
      && (fh->cgc.root.type == bfd_link_hash_undefined
	  || fh->cgc.root.type == bfd_link_hash_undefweak))
    {
  ...
  if (fdh != NULL
      && fdh->fake
      && fdh->cgc.root.type == bfd_link_hash_undefweak)
    {
      if (fh->cgc.root.type == bfd_link_hash_undefined)
	{
	  fdh->cgc.root.type = bfd_link_hash_undefined;
	  bfd_link_add_undef (&htab->cgc.root, &fdh->cgc.root);
	}
      else if (fh->cgc.root.type == bfd_link_hash_defined
	       || fh->cgc.root.type == bfd_link_hash_defweak)
	{
	  _bfd_cgc_link_hash_hide_symbol (info, &fdh->cgc, TRUE);
	}
    }

  if (fdh != NULL
      && !fdh->cgc.forced_local
      && (!info->executable
	  || fdh->cgc.def_dynamic
	  || fdh->cgc.ref_dynamic
	  || (fdh->cgc.root.type == bfd_link_hash_undefweak
	      && CGC_ST_VISIBILITY (fdh->cgc.other) == STV_DEFAULT)))
    {
      if (fdh->cgc.dynindx == -1)
	if (! bfd_cgc_link_record_dynamic_symbol (info, &fdh->cgc))
	  return FALSE;
      fdh->cgc.ref_regular |= fh->cgc.ref_regular;
      fdh->cgc.ref_dynamic |= fh->cgc.ref_dynamic;
      fdh->cgc.ref_regular_nonweak |= fh->cgc.ref_regular_nonweak;
      fdh->cgc.non_got_ref |= fh->cgc.non_got_ref;
      if (CGC_ST_VISIBILITY (fh->cgc.other) == STV_DEFAULT)
	{
  ...
  force_local = (!fh->cgc.def_regular
		 || fdh == NULL
		 || !fdh->cgc.def_regular
		 || fdh->cgc.forced_local);
  _bfd_cgc_link_hash_hide_symbol (info, &fh->cgc, force_local);

  return TRUE;
}

/* Called near the start of bfd_cgc_size_dynamic_sections.  We use
   this hook to a) provide some gcc support functions, and b) transfer
   dynamic linking information gathered so far on function code symbol
   entries, to their corresponding function descriptor symbol entries.  */

static bfd_boolean
ppc64_cgc_func_desc_adjust (bfd *obfd ATTRIBUTE_UNUSED,
			    struct bfd_link_info *info)
{
  struct ppc_link_hash_table *htab;
  unsigned int i;
  ...
  if (!info->relocatable
      && htab->cgc.hgot != NULL)
    {
      _bfd_cgc_link_hash_hide_symbol (info, htab->cgc.hgot, TRUE);
      /* Make .TOC. defined so as to prevent it being made dynamic.
	 The wrong value here is fixed later in ppc64_cgc_set_toc.  */
      htab->cgc.hgot->type = STT_OBJECT;
      htab->cgc.hgot->root.type = bfd_link_hash_defined;
      htab->cgc.hgot->root.u.def.value = 0;
      htab->cgc.hgot->root.u.def.section = bfd_abs_section_ptr;
      htab->cgc.hgot->def_regular = 1;
      htab->cgc.hgot->other = ((htab->cgc.hgot->other & ~CGC_ST_VISIBILITY (-1))
			       | STV_HIDDEN);
    }
  ...
  cgc_link_hash_traverse (&htab->cgc, func_desc_adjust, info);
...
static bfd_boolean
readonly_dynrelocs (struct cgc_link_hash_entry *h)
{
  struct ppc_link_hash_entry *eh;
  struct cgc_dyn_relocs *p;
...
static bfd_boolean
ppc64_cgc_adjust_dynamic_symbol (struct bfd_link_info *info,
				 struct cgc_link_hash_entry *h)
{
  struct ppc_link_hash_table *htab;
  asection *s;
  ...
  if ((h->root.u.def.section->flags & SEC_ALLOC) != 0 && h->size != 0)
    {
      htab->relbss->size += sizeof (Cgc64_External_Rela);
      h->needs_copy = 1;
    }
...
static void
ppc64_cgc_hide_symbol (struct bfd_link_info *info,
		       struct cgc_link_hash_entry *h,
		       bfd_boolean force_local)
{
  struct ppc_link_hash_entry *eh;
  _bfd_cgc_link_hash_hide_symbol (info, h, force_local);
  ...
  if (eh->is_func_descriptor)
      ...
      if (fh == NULL)
	{
	  ...
	  /* We aren't supposed to use alloca in BFD because on
	     ...
	     accessed;  It's either a string in an CGC string table,
	     or allocated in an objalloc structure.  */

	  p = eh->cgc.root.root.string - 1;
	  save = *p;
	  *(char *) p = '.';
	  htab = ppc_hash_table (info);
	  if (htab == NULL)
	  ...
	  fh = (struct ppc_link_hash_entry *)
	    cgc_link_hash_lookup (&htab->cgc, p, FALSE, FALSE, FALSE);
	  *(char *) p = save;
	  ...
	  if (fh == NULL)
	    {
	      q = eh->cgc.root.root.string + strlen (eh->cgc.root.root.string);
	      while (q >= eh->cgc.root.root.string && *q == *p)
		--q, --p;
	      if (q < eh->cgc.root.root.string && *p == '.')
		fh = (struct ppc_link_hash_entry *)
		  cgc_link_hash_lookup (&htab->cgc, p, FALSE, FALSE, FALSE);
	    }
	  if (fh != NULL)
...
static bfd_boolean
get_sym_h (struct cgc_link_hash_entry **hp,
	   Cgc_Internal_Sym **symp,
	   asection **symsecp,
	   unsigned char **tls_maskp,
	   Cgc_Internal_Sym **locsymsp,
	   unsigned long r_symndx,
	   bfd *ibfd)
{
  Cgc_Internal_Shdr *symtab_hdr = &cgc_symtab_hdr (ibfd);

  if (r_symndx >= symtab_hdr->sh_info)
    {
      struct cgc_link_hash_entry **sym_hashes = cgc_sym_hashes (ibfd);
      struct cgc_link_hash_entry *h;
	...
	*symp = NULL;
    ...
    {
      Cgc_Internal_Sym *sym;
      Cgc_Internal_Sym *locsyms = *locsymsp;

      if (locsyms == NULL)
	{
	  locsyms = (Cgc_Internal_Sym *) symtab_hdr->contents;
	  if (locsyms == NULL)
	    locsyms = bfd_cgc_get_cgc_syms (ibfd, symtab_hdr,
					    symtab_hdr->sh_info,
					    0, NULL, NULL, NULL);
	  if (locsyms == NULL)
	    return FALSE;
	...
	*symp = sym;
      ...
      if (symsecp != NULL)
	*symsecp = bfd_section_from_cgc_index (ibfd, sym->st_shndx);
      ...
      if (tls_maskp != NULL)
	{
	  ...
	  tls_mask = NULL;
	  lgot_ents = cgc_local_got_ents (ibfd);
	  if (lgot_ents != NULL)
	    {
	      struct plt_entry **local_plt = (struct plt_entry **)
	      ...
	      bfd *ibfd)
{
  ...
  if ((*tls_maskp != NULL && **tls_maskp != 0)
      || sec == NULL
      || ppc64_cgc_section_data (sec) == NULL
      || ppc64_cgc_section_data (sec)->sec_type != sec_toc)
    return 1;
  ...
  off += rel->r_addend;
  BFD_ASSERT (off % 8 == 0);
  r_symndx = ppc64_cgc_section_data (sec)->u.toc.symndx[off / 8];
  next_r = ppc64_cgc_section_data (sec)->u.toc.symndx[off / 8 + 1];
  if (toc_symndx != NULL)
    *toc_symndx = r_symndx;
  if (toc_addend != NULL)
    *toc_addend = ppc64_cgc_section_data (sec)->u.toc.add[off / 8];
  if (!get_sym_h (&h, &sym, &sec, tls_maskp, locsymsp, r_symndx, ibfd))
    return 0;
	      ...
	      bfd *ibfd)
{
  ...
  r_indx = CGC64_R_SYM (irela->r_info);
...
static bfd_boolean
adjust_opd_syms (struct cgc_link_hash_entry *h, void *inf ATTRIBUTE_UNUSED)
{
  struct ppc_link_hash_entry *eh;
  asection *sym_sec;
  struct _opd_sec_data *opd;
  ...
  sym_sec = eh->cgc.root.u.def.section;
  opd = get_opd_info (sym_sec);
  if (opd != NULL && opd->adjust != NULL)
    {
      long adjust = opd->adjust[eh->cgc.root.u.def.value / 8];
      if (adjust == -1)
	{
	  /* This entry has been deleted.  */
	  asection *dsec = ppc64_cgc_tdata (sym_sec->owner)->deleted_section;
	  if (dsec == NULL)
	    {
	      for (dsec = sym_sec->owner->sections; dsec; dsec = dsec->next)
		if (discarded_section (dsec))
		  {
		    ppc64_cgc_tdata (sym_sec->owner)->deleted_section = dsec;
		    break;
		  }
	    }
	  eh->cgc.root.u.def.value = 0;
	  eh->cgc.root.u.def.section = dsec;
	}
      else
	eh->cgc.root.u.def.value += adjust;
      eh->adjust_done = 1;
    }
  return TRUE;
}
  ...
  if (h != NULL)
    {
      ...
      /* cgc_gc_sweep may have already removed all dyn relocs associated
	 with local syms for a given section.  Also, symbol flags are
	 changed by cgc_gc_sweep_symbol, confusing the test above.  Don't
  ...
  else
    {
      ...
      if (local_syms == NULL)
	sym_sec = bfd_section_from_cgc_index (sec->owner, sym->st_shndx);
      if (sym_sec == NULL)
	sym_sec = sec;

      vpp = &cgc_section_data (sym_sec)->local_dynrel;
      pp = (struct ppc_dyn_relocs **) vpp;

      if (*pp == NULL && info->gc_sections)
	return TRUE;

      is_ifunc = CGC_ST_TYPE (sym->st_info) == STT_GNU_IFUNC;
      while ((p = *pp) != NULL)
	{
...
bfd_boolean
ppc64_cgc_edit_opd (struct bfd_link_info *info, bfd_boolean non_overlapping)
{
  bfd *ibfd;
  ...
  for (ibfd = info->input_bfds; ibfd != NULL; ibfd = ibfd->link_next)
    {
      asection *sec;
      Cgc_Internal_Rela *relstart, *rel, *relend;
      Cgc_Internal_Shdr *symtab_hdr;
      Cgc_Internal_Sym *local_syms;
      bfd_vma offset;
      struct _opd_sec_data *opd;
	...
	continue;
      ...
      relstart = _bfd_cgc_link_read_relocs (ibfd, sec, NULL, NULL,
					    info->keep_memory);
      if (relstart == NULL)
	return FALSE;
      ...
      for (rel = relstart; rel < relend; )
	{
	  ...
	  if ((r_type = CGC64_R_TYPE (rel->r_info)) != R_PPC64_ADDR64
	      || (r_type = CGC64_R_TYPE ((rel + 1)->r_info)) != R_PPC64_TOC)
	    {
	      (*_bfd_error_handler)
	  ...
	  if (sym_sec == NULL || sym_sec->owner == NULL)
		...
		sym_name = bfd_cgc_sym_name (ibfd, symtab_hdr, sym,
					     sym_sec);
	  ...
	  if (rel->r_offset == offset + 24)
	    ...
	    goto broken_opd;
		   ...
		   && CGC64_R_TYPE (rel[0].r_info) == R_PPC64_ADDR64
		   && CGC64_R_TYPE (rel[1].r_info) == R_PPC64_TOC)
	    {
	      offset += 16;
	      cnt_16b++;
		   ...
		   && CGC64_R_TYPE (rel[1].r_info) == R_PPC64_ADDR64
		   && CGC64_R_TYPE (rel[2].r_info) == R_PPC64_TOC)
	    {
	      offset += 24;
	      rel += 1;
	    }
      ...
      if (need_edit || add_aux_fields)
	{
	  ...
	  opd = &ppc64_cgc_section_data (sec)->u.opd;
	  ...
	  if ((sec->flags & SEC_IN_MEMORY) == 0)
		...
		error_ret:
		  if (local_syms != NULL
		    ...
		    free (local_syms);
		  if (cgc_section_data (sec)->relocs != relstart)
		    free (relstart);
		  return FALSE;
		}
	      sec->contents = loc;
	  ...
	  cgc_section_data (sec)->relocs = relstart;
	  ...
	  for (rel = relstart; rel < relend; rel++)
	      ...
	      if (rel->r_offset == offset)
		{
		  ...
		  if ((rel + 2 == relend && sec->size == offset + 16)
			  ...
			  && CGC64_R_TYPE (rel[2].r_info) == R_PPC64_ADDR64
			  && CGC64_R_TYPE (rel[3].r_info) == R_PPC64_TOC))
		    opd_ent_size = 16;
		  ...
		  if (h != NULL
			...
			fdh = lookup_fdh ((struct ppc_link_hash_entry *) h,
					  htab);
		      if (fdh != NULL
			  && fdh->cgc.root.type != bfd_link_hash_defined
			  && fdh->cgc.root.type != bfd_link_hash_defweak)
			fdh = NULL;
		    }
		  ...
		  if (skip)
		      ...
		      if (fdh != NULL && sym_sec->owner == ibfd)
			{
			  /* Arrange for the function descriptor sym
			     to be dropped.  */
			  fdh->cgc.root.u.def.value = 0;
			  fdh->cgc.root.u.def.section = sym_sec;
			}
		      ...
		      if (fdh != NULL)
			{
			  /* Redefine the function descriptor symbol to
			     ...
			     in the generic CGC code use the value
			     stored in u.def.value.  */
			  fdh->cgc.root.u.def.value = wptr - new_contents;
			  fdh->adjust_done = 1;
			}
	  ...
	  /* Fudge the header size too, as this is used later in
	     cgc_bfd_final_link if we are emitting relocs.  */
	  rel_hdr = _bfd_cgc_single_rel_hdr (sec);
	  rel_hdr->sh_size = sec->reloc_count * rel_hdr->sh_entsize;
	  some_edited = TRUE;
	}
      else if (cgc_section_data (sec)->relocs != relstart)
	free (relstart);
  ...
  if (some_edited)
    cgc_link_hash_traverse (cgc_hash_table (info), adjust_opd_syms, NULL);
...
/* Set htab->tls_get_addr and call the generic CGC tls_setup function.  */

asection *
ppc64_cgc_tls_setup (struct bfd_link_info *info,
		     ...
		     int *no_multi_toc)
{
  ...
  htab->tls_get_addr = ((struct ppc_link_hash_entry *)
			cgc_link_hash_lookup (&htab->cgc, ".__tls_get_addr",
					      FALSE, FALSE, TRUE));
  /* Move dynamic linking info to the function descriptor sym.  */
  if (htab->tls_get_addr != NULL)
    func_desc_adjust (&htab->tls_get_addr->cgc, info);
  htab->tls_get_addr_fd = ((struct ppc_link_hash_entry *)
			   cgc_link_hash_lookup (&htab->cgc, "__tls_get_addr",
						 FALSE, FALSE, TRUE));
  if (!no_tls_get_addr_opt)
    {
      struct cgc_link_hash_entry *opt, *opt_fd, *tga, *tga_fd;

      opt = cgc_link_hash_lookup (&htab->cgc, ".__tls_get_addr_opt",
				  FALSE, FALSE, TRUE);
      if (opt != NULL)
	func_desc_adjust (opt, info);
      opt_fd = cgc_link_hash_lookup (&htab->cgc, "__tls_get_addr_opt",
				     FALSE, FALSE, TRUE);
      if (opt_fd != NULL
	      ...
	      || opt_fd->root.type == bfd_link_hash_defweak))
	{
	  ...
	  if (htab->cgc.dynamic_sections_created
	      ...
	      if (ent != NULL)
		{
		  ...
		  ppc64_cgc_copy_indirect_symbol (info, opt_fd, tga_fd);
		  if (opt_fd->dynindx != -1)
		    {
		      ...
		      _bfd_cgc_strtab_delref (cgc_hash_table (info)->dynstr,
					      opt_fd->dynstr_index);
		      if (!bfd_cgc_link_record_dynamic_symbol (info, opt_fd))
			return NULL;
		    }
		  htab->tls_get_addr_fd = (struct ppc_link_hash_entry *) opt_fd;
		  tga = &htab->tls_get_addr->cgc;
		  if (opt != NULL && tga != NULL)
		    {
		      tga->root.type = bfd_link_hash_indirect;
		      tga->root.u.i.link = &opt->root;
		      ppc64_cgc_copy_indirect_symbol (info, opt, tga);
		      _bfd_cgc_link_hash_hide_symbol (info, opt,
						      tga->forced_local);
  ...
  return _bfd_cgc_tls_setup (info->output_bfd, info);
}
...
{
  Cgc_Internal_Shdr *symtab_hdr = &cgc_symtab_hdr (ibfd);
  enum cgc_ppc64_reloc_type r_type = CGC64_R_TYPE (rel->r_info);
  unsigned int r_symndx = CGC64_R_SYM (rel->r_info);
...
/* Run through all the TLS relocs looking for optimization
   opportunities.  The linker has been hacked (see ppc64cgc.em) to do
...
bfd_boolean
ppc64_cgc_tls_optimize (struct bfd_link_info *info)
{
  bfd *ibfd;
  asection *sec;
  struct ppc_link_hash_table *htab;
  ...
  for (pass = 0; pass < 2; ++pass)
	  ...
	  if (sec->has_tls_reloc && !bfd_is_abs_section (sec->output_section))
	      ...
	      for (rel = relstart; rel < relend; rel++)
		{
		  ...
		  if (pass == 0
		      ...
		      && h != NULL
		      && (h == &htab->tls_get_addr->cgc
			  || h == &htab->tls_get_addr_fd->cgc)
		  ...
		  switch (r_type)
			...
			continue;
		      if (rel + 1 < relend
			  && (rel[1].r_info
			      == CGC64_R_INFO (r_symndx, R_PPC64_DTPREL64))
			  && rel[1].r_offset == rel->r_offset + 8)
			{
			  if (ok_tprel)
			    /* GD -> LE */
		  ...
		  if (expecting_tls_get_addr && htab->tls_get_addr != NULL)
		    {
		      struct plt_entry *ent;
		      for (ent = htab->tls_get_addr->cgc.plt.plist;
			   ent != NULL;
			   ent = ent->next)
			if (ent->addend == 0)
			  {
		  ...
		  if (expecting_tls_get_addr && htab->tls_get_addr_fd != NULL)
		    {
		      struct plt_entry *ent;
		      for (ent = htab->tls_get_addr_fd->cgc.plt.plist;
			   ent != NULL;
			   ent = ent->next)
			if (ent->addend == 0)
			  {
		  ...
		  if ((tls_set & TLS_EXPLICIT) == 0)
			...
			ent = cgc_local_got_ents (ibfd)[r_symndx];
	...
	if (locsyms != NULL
	    && (cgc_symtab_hdr (ibfd).contents != (unsigned char *) locsyms))
	  {
	    if (!info->keep_memory)
	      free (locsyms);
	    else
...
/* Called via cgc_link_hash_traverse from ppc64_cgc_edit_toc to adjust
...
static bfd_boolean
adjust_toc_syms (struct cgc_link_hash_entry *h, void *inf)
{
  struct ppc_link_hash_entry *eh;
  ...
  if (eh->cgc.root.u.def.section == toc_inf->toc)
    {
      if (eh->cgc.root.u.def.value > toc_inf->toc->rawsize)
	i = toc_inf->toc->rawsize >> 3;
      else
	i = eh->cgc.root.u.def.value >> 3;

      if ((toc_inf->skip[i] & (ref_from_discarded | can_optimize)) != 0)
	{
	  (*_bfd_error_handler)
	    (_("%s defined on removed toc entry"), eh->cgc.root.root.string);
	  do
	    ++i;
	  while ((toc_inf->skip[i] & (ref_from_discarded | can_optimize)) != 0);
	  eh->cgc.root.u.def.value = (bfd_vma) i << 3;
	}

      eh->cgc.root.u.def.value -= toc_inf->skip[i];
      eh->adjust_done = 1;
    }
  else if (strcmp (eh->cgc.root.u.def.section->name, ".toc") == 0)
...
bfd_boolean
ppc64_cgc_edit_toc (struct bfd_link_info *info)
{
  bfd *ibfd;
  ...
  for (ibfd = info->input_bfds; ibfd != NULL; ibfd = ibfd->link_next)
    {
      ...
      Cgc_Internal_Shdr *symtab_hdr;
      Cgc_Internal_Sym *local_syms;
      Cgc_Internal_Rela *relstart, *rel, *toc_relocs;
      ...
      for (sec = ibfd->sections; sec != NULL; sec = sec->next)
	{
	  ...
	  relstart = _bfd_cgc_link_read_relocs (ibfd, sec, NULL, NULL, FALSE);
	  if (relstart == NULL)
	    goto error_ret;
	 ...
	 that the word storing "addr" in the toc is no longer needed.  */
      ...
      if (!ppc64_cgc_tdata (ibfd)->has_small_toc_reloc
	  && toc->output_section->rawsize < (bfd_vma) 1 << 31
	  && toc->reloc_count != 0)
	{
	  /* Read toc relocs.  */
	  toc_relocs = _bfd_cgc_link_read_relocs (ibfd, toc, NULL, NULL,
						  info->keep_memory);
	  if (toc_relocs == NULL)
	    goto error_ret;
	...
	error_ret:
	  ...
	  if (sec != NULL
	    ...
	    free (relstart);
	  if (toc_relocs != NULL
	      && cgc_section_data (toc)->relocs != toc_relocs)
	    free (toc_relocs);
	  if (skip != NULL)
	    free (skip);
	  return FALSE;
	      ...
	      for (rel = relstart; rel < relstart + sec->reloc_count; ++rel)
		{
		  ...
		  if (insn_check != no_check)
			     ...
			     != ((15u << 26) | (2 << 16)) /* addis rt,2,imm */))
			{
			  ...
			  ppc64_cgc_tdata (ibfd)->unexpected_toc_insn = 1;
      ...
      if (some_unused)
	{
	  ...
	  cgc_section_data (toc)->this_hdr.contents = contents;
	  ...
	  *drop = off;
	  ...
	  for (sec = ibfd->sections; sec != NULL; sec = sec->next)
	      ...
	      for (rel = relstart; rel < relstart + sec->reloc_count; ++rel)
		{
		  ...
		  if (val > toc->rawsize)
		    ...
		    {
		      Cgc_Internal_Rela *tocrel
			= toc_relocs + (skip[val >> 3] >> 2);
		      unsigned long tsym = CGC64_R_SYM (tocrel->r_info);

		      switch (r_type)
			{
			case R_PPC64_TOC16_HA:
			  rel->r_info = CGC64_R_INFO (tsym, R_PPC64_TOC16_HA);
			  break;

			case R_PPC64_TOC16_LO_DS:
			  rel->r_info = CGC64_R_INFO (tsym, R_PPC64_LO_DS_OPT);
			  break;
			...
			default:
			  ...
			  info->callbacks->einfo
			    (_("%P: %H: %s references "
			     ...
			     ibfd, sec, rel->r_offset,
			     ppc64_cgc_howto_table[r_type]->name);
			  bfd_set_error (bfd_error_bad_value);
			  goto error_ret;
			}
	  ...
	  if (local_syms != NULL)
	    for (sym = local_syms;
		 ...
		 ++sym)
	      if (sym->st_value != 0
		  && bfd_section_from_cgc_index (ibfd, sym->st_shndx) == toc)
		{
		  unsigned long i;
		  ...
		  if ((skip[i] & (ref_from_discarded | can_optimize)) != 0)
			...
			(*_bfd_error_handler)
			  (_("%s defined on removed toc entry"),
			   bfd_cgc_sym_name (ibfd, symtab_hdr, sym, NULL));
		      do
			++i;
	  ...
	  if (toc_inf.global_toc_syms)
	    {
	      ...
	      cgc_link_hash_traverse (cgc_hash_table (info), adjust_toc_syms,
				      &toc_inf);
	    }
	  ...
	  if (toc->reloc_count != 0)
		...
		if ((skip[rel->r_offset >> 3]
	      ...
	      rel_hdr = _bfd_cgc_single_rel_hdr (toc);
...
bfd_boolean
ppc64_cgc_has_small_toc_reloc (asection *i)
{
  return (is_ppc64_cgc (i->owner)
	  && ppc64_cgc_tdata (i->owner)->has_small_toc_reloc);
}

/* Allocate space for one GOT entry.  */

static void
allocate_got (struct cgc_link_hash_entry *h,
	      struct bfd_link_info *info,
	      struct got_entry *gent)
{
  ...
  int rentsize = (gent->tls_type & eh->tls_mask & TLS_GD
		  ? 2 : 1) * sizeof (Cgc64_External_Rela);
  asection *got = ppc64_cgc_tdata (gent->owner)->got;
  ...
  if (h->type == STT_GNU_IFUNC)
    {
      htab->cgc.irelplt->size += rentsize;
      htab->got_reli_size += rentsize;
	   ...
	   && (CGC_ST_VISIBILITY (h->other) == STV_DEFAULT
	       || h->root.type != bfd_link_hash_undefweak))
    {
      asection *relgot = ppc64_cgc_tdata (gent->owner)->relgot;
...
merge_got_entries (struct got_entry **pent)
{
  ...
  for (ent = *pent; ent != NULL; ent = ent->next)
	...
	if (!ent2->is_indirect
	    ...
	    && cgc_gp (ent2->owner) == cgc_gp (ent->owner))
	  {
	...
	if (pent->plt.refcount > 0)
	  {
	    ...
	    s->size += sizeof (Cgc64_External_Rela);
	    doneone = TRUE;
	  }
	else
  ...
  for (p = eh->dyn_relocs; p != NULL; p = p->next)
    {
      ...
      if (eh->cgc.type == STT_GNU_IFUNC)
	sreloc = htab->cgc.irelplt;
...
/* Called via cgc_link_hash_traverse from ppc64_cgc_size_dynamic_sections
   to set up space for global entry stubs.  These are put in glink,
   after the branch table.  */

static bfd_boolean
size_global_entry_stubs (struct cgc_link_hash_entry *h, void *inf)
{
  struct bfd_link_info *info;
  struct ppc_link_hash_table *htab;
  struct plt_entry *pent;
  ...
  for (pent = h->plt.plist; pent != NULL; pent = pent->next)
	...
	&& pent->addend == 0)
      {
	/* For CGCv2, if this symbol is not defined in a regular file
...
static bfd_boolean
maybe_set_textrel (struct cgc_link_hash_entry *h, void *info)
{
  if (h->root.type == bfd_link_hash_indirect)
    return TRUE;
...
static bfd_boolean
ppc64_cgc_size_dynamic_sections (bfd *output_bfd,
				 struct bfd_link_info *info)
{
  struct ppc_link_hash_table *htab;
  bfd *dynobj;
  ...
  for (ibfd = info->input_bfds; ibfd != NULL; ibfd = ibfd->link_next)
      ...
      for (s = ibfd->sections; s != NULL; s = s->next)
	{
	  ...
	  for (p = cgc_section_data (s)->local_dynrel; p != NULL; p = p->next)
		...
		{
		  asection *srel = cgc_section_data (p->sec)->sreloc;
		  if (p->ifunc)
		    srel = htab->cgc.irelplt;
		  srel->size += p->count * sizeof (Cgc64_External_Rela);
	  ...
	  while ((ent = *pent) != NULL)
		...
		if ((ent->tls_type & *lgot_masks & TLS_LD) != 0)
		...
		else
		  {
		    ...
		    unsigned int rel_size = sizeof (Cgc64_External_Rela);
		    ...
		    if ((*lgot_masks & PLT_IFUNC) != 0)
		      {
			htab->cgc.irelplt->size += rel_size;
			htab->got_reli_size += rel_size;
		      }
		    else if (info->shared)
		      {
			asection *srel = ppc64_cgc_tdata (ibfd)->relgot;
			srel->size += rel_size;
		      }
		    pent = &ent->next;
		  }
  ...
  if (!htab->opd_abi && !info->shared)
    cgc_link_hash_traverse (&htab->cgc, size_global_entry_stubs, info);
  ...
  for (ibfd = info->input_bfds; ibfd != NULL; ibfd = ibfd->link_next)
      ...
      if (ent->got.refcount > 0)
	{
	  if (!htab->do_multi_toc && first_tlsld != NULL)
		...
		{
		  asection *srel = ppc64_cgc_tdata (ibfd)->relgot;
		  srel->size += sizeof (Cgc64_External_Rela);
		}
	    }
	}
      else
  ...
  if (htab->cgc.dynamic_sections_created)
    {
	 ...
	 values later, in ppc64_cgc_finish_dynamic_sections, but we
...
#define add_dynamic_entry(TAG, VAL) \
  _bfd_cgc_add_dynamic_entry (info, TAG, VAL)
      ...
      if (info->executable)
	{
      ...
      if (htab->cgc.splt != NULL && htab->cgc.splt->size != 0)
	{
      ...
      if (NO_OPD_RELOCS && abiversion (output_bfd) <= 1)
	{
      ...
      tls_opt = (!htab->no_tls_get_addr_opt
		 ...
		 && htab->tls_get_addr_fd->cgc.plt.plist != NULL);
      ...
      if (relocs)
	{
	  ...
	  if ((info->flags & DF_TEXTREL) == 0)
	    cgc_link_hash_traverse (&htab->cgc, maybe_set_textrel, info);
...
static bfd_boolean
ppc64_cgc_hash_symbol (struct cgc_link_hash_entry *h)
{
  if (h->plt.plist != NULL
      && !h->def_regular
  ...
  if (h != NULL)
	  ...
	  && h->oh->is_func_descriptor)
	{
	  ...
	  *hash = fdh;
      ...
      for (ent = fdh->cgc.plt.plist; ent != NULL; ent = ent->next)
	if (ent->addend == rel->r_addend
	    && ent->plt.offset != (bfd_vma) -1)
	  {
	    *plt_ent = ent;
	 ...
	 any other type of stub.  */
      if (!is_static_defined (&fdh->cgc)
	  && !is_static_defined (&h->cgc))
	return ppc_stub_none;
    }
  else if (cgc_local_got_ents (input_sec->owner) != NULL)
    {
      Cgc_Internal_Shdr *symtab_hdr = &cgc_symtab_hdr (input_sec->owner);
      struct plt_entry **local_plt = (struct plt_entry **)
	cgc_local_got_ents (input_sec->owner) + symtab_hdr->sh_info;
      unsigned long r_symndx = CGC64_R_SYM (rel->r_info);
...
build_plt_stub (struct ppc_link_hash_table *htab,
		struct ppc_stub_hash_entry *stub_entry,
		bfd_byte *p, bfd_vma offset, Cgc_Internal_Rela *r)
{
  ...
  if (PPC_HA (offset) != 0)
      ...
      if (r != NULL)
	{
	  if (ALWAYS_EMIT_R2SAVE
	      || stub_entry->stub_type == ppc_stub_plt_call_r2save)
	    r[0].r_offset += 4;
	  r[0].r_info = CGC64_R_INFO (0, R_PPC64_TOC16_HA);
	  r[1].r_offset = r[0].r_offset + 4;
	  r[1].r_info = CGC64_R_INFO (0, R_PPC64_TOC16_LO_DS);
	  ...
	  if (plt_load_toc)
	      ...
	      if (PPC_HA (offset + 8 + 8 * plt_static_chain) != PPC_HA (offset))
		{
		  ...
		  r[2].r_info = CGC64_R_INFO (0, R_PPC64_TOC16_LO);
		  r[2].r_addend = r[0].r_addend;
		}
	      else
		{
		  r[2].r_offset = r[1].r_offset + 8 + 8 * use_fake_dep;
		  r[2].r_info = CGC64_R_INFO (0, R_PPC64_TOC16_LO_DS);
		  r[2].r_addend = r[0].r_addend + 8;
		  if (plt_static_chain)
		    {
		      r[3].r_offset = r[2].r_offset + 4;
		      r[3].r_info = CGC64_R_INFO (0, R_PPC64_TOC16_LO_DS);
      ...
      if (r != NULL)
	{
	  if (ALWAYS_EMIT_R2SAVE
	      || stub_entry->stub_type == ppc_stub_plt_call_r2save)
	    r[0].r_offset += 4;
	  r[0].r_info = CGC64_R_INFO (0, R_PPC64_TOC16_DS);
	  if (plt_load_toc)
	    {
	      if (PPC_HA (offset + 8 + 8 * plt_static_chain) != PPC_HA (offset))
		{
		  r[1].r_offset = r[0].r_offset + 4;
		  r[1].r_info = CGC64_R_INFO (0, R_PPC64_TOC16);
		  r[1].r_addend = r[0].r_addend;
		}
	      else
		{
		  r[1].r_offset = r[0].r_offset + 8 + 8 * use_fake_dep;
		  r[1].r_info = CGC64_R_INFO (0, R_PPC64_TOC16_DS);
		  r[1].r_addend = r[0].r_addend + 8 + 8 * plt_static_chain;
		  if (plt_static_chain)
		    {
		      r[2].r_offset = r[1].r_offset + 4;
		      r[2].r_info = CGC64_R_INFO (0, R_PPC64_TOC16_DS);
		      r[2].r_addend = r[0].r_addend + 8;
		    }
		}
	    }
...
static Cgc_Internal_Rela *
get_relocs (asection *sec, int count)
{
  Cgc_Internal_Rela *relocs;
  struct bfd_cgc_section_data *cgcsec_data;

  cgcsec_data = cgc_section_data (sec);
  relocs = cgcsec_data->relocs;
  if (relocs == NULL)
    {
      ...
      if (relocs == NULL)
	return NULL;
      cgcsec_data->relocs = relocs;
      cgcsec_data->rela.hdr = bfd_zalloc (sec->owner,
					  sizeof (Cgc_Internal_Shdr));
      if (cgcsec_data->rela.hdr == NULL)
	return NULL;
      cgcsec_data->rela.hdr->sh_size = (sec->reloc_count
					* sizeof (Cgc64_External_Rela));
      cgcsec_data->rela.hdr->sh_entsize = sizeof (Cgc64_External_Rela);
      sec->reloc_count = 0;
    }
  ...
  if (r2off == 0)
    {
	 ...
	 opd entry.  */
      ...
      if (!htab->opd_abi)
	return r2off;
      asection *opd = stub_entry->h->cgc.root.u.def.section;
      bfd_vma opd_off = stub_entry->h->cgc.root.u.def.value;

      if (strcmp (opd->name, ".opd") != 0
	  || opd->reloc_count != 0)
	{
	  info->callbacks->einfo (_("%P: cannot find opd entry toc for `%T'\n"),
				  stub_entry->h->cgc.root.root.string);
	  bfd_set_error (bfd_error_bad_value);
	  return 0;
	}
...
ppc_build_one_stub (struct bfd_hash_entry *gen_entry, void *in_arg)
{
  ...
  switch (stub_entry->stub_type)
      ...
      if (info->emitrelocations)
	{
	  ...
	  r->r_info = CGC64_R_INFO (0, R_PPC64_REL24);
	  r->r_addend = dest;
	  if (stub_entry->h != NULL)
	    {
	      struct cgc_link_hash_entry **hashes;
	      unsigned long symndx;
	      struct ppc_link_hash_entry *h;

	      hashes = cgc_sym_hashes (htab->stub_bfd);
	      if (hashes == NULL)
		{
		  bfd_size_type hsize;
		  ...
		  if (hashes == NULL)
		    return FALSE;
		  cgc_sym_hashes (htab->stub_bfd) = hashes;
		  htab->stub_globals = 1;
		}
	      symndx = htab->stub_globals++;
	      h = stub_entry->h;
	      hashes[symndx] = &h->cgc;
	      r->r_info = CGC64_R_INFO (symndx, R_PPC64_REL24);
	      if (h->oh != NULL && h->oh->is_func)
		h = ppc_follow_link (h->oh);
	      if (h->cgc.root.u.def.section != stub_entry->target_section)
		/* H is an opd symbol.  The addend must be zero.  */
		r->r_addend = 0;
	      else
		{
		  off = (h->cgc.root.u.def.value
			 + h->cgc.root.u.def.section->output_offset
			 + h->cgc.root.u.def.section->output_section->vma);
		  r->r_addend -= off;
		}
	    }
	}
      ...
      if (br_entry->iter == htab->stub_iteration)
	{
	  ...
	  if (htab->relbrlt != NULL)
	    {
	      ...
	      rela.r_info = CGC64_R_INFO (0, R_PPC64_RELATIVE);
	      rela.r_addend = dest;

	      rl = htab->relbrlt->contents;
	      rl += (htab->relbrlt->reloc_count++
		     * sizeof (Cgc64_External_Rela));
	      bfd_cgc64_swap_reloca_out (htab->relbrlt->owner, &rela, rl);
	    }
		...
		return FALSE;
		 ...
		 set up the offset per the output file.  */
	      r->r_offset = (br_entry->offset
			     + htab->brlt->output_offset
			     + htab->brlt->output_section->vma);
	      r->r_info = CGC64_R_INFO (0, R_PPC64_RELATIVE);
	      r->r_addend = dest;
	    }
	}
      ...
      off = (dest
	     - cgc_gp (htab->brlt->output_section->owner)
	  ...
	  && (stub_entry->plt_ent->plt.offset & 1) == 0)
	{
	  ...
	  rela.r_offset = dest;
	  if (htab->opd_abi)
	    rela.r_info = CGC64_R_INFO (0, R_PPC64_JMP_IREL);
	  else
	    rela.r_info = CGC64_R_INFO (0, R_PPC64_IRELATIVE);
	  rela.r_addend = (stub_entry->target_value
			   + stub_entry->target_section->output_offset
			   + stub_entry->target_section->output_section->vma);

	  rl = (htab->cgc.irelplt->contents
		+ (htab->cgc.irelplt->reloc_count++
		   * sizeof (Cgc64_External_Rela)));
	  bfd_cgc64_swap_reloca_out (info->output_bfd, &rela, rl);
	  stub_entry->plt_ent->plt.offset |= 1;
	}

      off = (dest
	     - cgc_gp (plt->output_section->owner)
	     - htab->stub_group[stub_entry->id_sec->id].toc_off);
  ...
  if (htab->emit_stub_syms)
	...
	return FALSE;
      ...
      h = cgc_link_hash_lookup (&htab->cgc, name, TRUE, FALSE, FALSE);
      if (h == NULL)
	return FALSE;
	  ...
	  if (br_entry->iter != htab->stub_iteration)
	    {
	      ...
	      if (htab->relbrlt != NULL)
		htab->relbrlt->size += sizeof (Cgc64_External_Rela);
	      else if (info->emitrelocations)
		{
...
void
ppc64_cgc_start_multitoc_partition (struct bfd_link_info *info)
{
  struct ppc_link_hash_table *htab = ppc_hash_table (info);

  htab->toc_curr = ppc64_cgc_set_toc (info, info->output_bfd);
  htab->toc_bfd = NULL;
...
bfd_boolean
ppc64_cgc_next_toc_section (struct bfd_link_info *info, asection *isec)
{
  struct ppc_link_hash_table *htab = ppc_hash_table (info);
  ...
  if (!htab->second_toc_pass)
      ...
      if (new_bfd)
	{
      ...
      limit = 0x80008000;
      if (ppc64_cgc_tdata (isec->owner)->has_small_toc_reloc)
	limit = 0x10000;
      if (off + isec->size > limit)
	{
      ...
      /* toc_curr is the base address of this toc group.  Set cgc_gp
	 for the input section to be the offset relative to the
	 output toc base plus 0x8000.  Making the input cgc_gp an
	 offset allows us to move the toc as a whole without
	 recalculating input cgc_gp.  */
      off = htab->toc_curr - cgc_gp (isec->output_section->owner);
      off += TOC_BASE_OFF;
  ...
  /* During the second pass toc_first_sec points to the start of
     a toc group, and toc_curr is used to track the old cgc_gp.
  ...
  if (htab->toc_first_sec == NULL
      || htab->toc_curr != cgc_gp (isec->owner))
    {
      htab->toc_curr = cgc_gp (isec->owner);
      htab->toc_first_sec = isec;
    }
  addr = (htab->toc_first_sec->output_offset
	  + htab->toc_first_sec->output_section->vma);
  off = addr - cgc_gp (isec->output_section->owner) + TOC_BASE_OFF;
  cgc_gp (isec->owner) = off;

  return TRUE;
}

/* Called via cgc_link_hash_traverse to merge GOT entries for global
   symbol H.  */

static bfd_boolean
merge_global_got (struct cgc_link_hash_entry *h, void *inf ATTRIBUTE_UNUSED)
{
  if (h->root.type == bfd_link_hash_indirect)
    return TRUE;
...
/* Called via cgc_link_hash_traverse to allocate GOT entries for global
   symbol H.  */

static bfd_boolean
reallocate_got (struct cgc_link_hash_entry *h, void *inf)
{
  struct got_entry *gent;
...
/* Called on the first multitoc pass after the last call to
   ppc64_cgc_next_toc_section.  This function removes duplicate GOT
   entries.  */

bfd_boolean
ppc64_cgc_layout_multitoc (struct bfd_link_info *info)
{
  struct ppc_link_hash_table *htab = ppc_hash_table (info);
  struct bfd *ibfd, *ibfd2;
  bfd_boolean done_something;

  htab->multi_toc_needed = htab->toc_curr != cgc_gp (info->output_bfd);

  if (!htab->do_multi_toc)
    return FALSE;

  /* Merge global sym got entries within a toc group.  */
  cgc_link_hash_traverse (&htab->cgc, merge_global_got, info);
  ...
  htab->cgc.irelplt->rawsize = htab->cgc.irelplt->size;
  htab->cgc.irelplt->size -= htab->got_reli_size;
  ...
  for (ibfd = info->input_bfds; ibfd != NULL; ibfd = ibfd->link_next)
	...
	continue;
      ...
      got = ppc64_cgc_tdata (ibfd)->got;
      if (got != NULL)
	{
	  got->rawsize = got->size;
	  got->size = 0;
	  relgot = ppc64_cgc_tdata (ibfd)->relgot;
  ...
  cgc_link_hash_traverse (&htab->cgc, reallocate_got, info);
  ...
  for (ibfd = info->input_bfds; ibfd != NULL; ibfd = ibfd->link_next)
	...
	continue;
	  ...
	  && ent->got.offset != (bfd_vma) -1)
	{
	  asection *s = ppc64_cgc_tdata (ibfd)->got;
	  ent->got.offset = s->size;
	  s->size += 16;
	  if (info->shared)
	    {
  ...
  done_something = htab->cgc.irelplt->rawsize != htab->cgc.irelplt->size;
  if (!done_something)
    for (ibfd = info->input_bfds; ibfd != NULL; ibfd = ibfd->link_next)
      {
	asection *got;
  ...
  /* Set up for second pass over toc sections to recalculate cgc_gp
     on input sections.  */
  htab->toc_bfd = NULL;
  htab->toc_first_sec = NULL;
...
void
ppc64_cgc_finish_multitoc_partition (struct bfd_link_info *info)
{
  struct ppc_link_hash_table *htab = ppc_hash_table (info);

  /* After the second pass, toc_curr tracks the TOC offset used
     for code sections below in ppc64_cgc_next_input_section.  */
...
toc_adjusting_stub_needed (struct bfd_link_info *info, asection *isec)
{
  ...
  if (isec->reloc_count != 0)
    {
      Cgc_Internal_Rela *relstart, *rel;
      Cgc_Internal_Sym *local_syms;
      struct ppc_link_hash_table *htab;

      relstart = _bfd_cgc_link_read_relocs (isec->owner, isec, NULL, NULL,
					    info->keep_memory);
      if (relstart == NULL)
	return -1;
      ...
      for (rel = relstart; rel < relstart + isec->reloc_count; ++rel)
	{
	  ...
	  eh = (struct ppc_link_hash_entry *) h;
	  if (eh != NULL
	      && (eh->cgc.plt.plist != NULL
		  || (eh->oh != NULL
		      && ppc_follow_link (eh->oh)->cgc.plt.plist != NULL)))
	    {
	      ret = 1;
	      break;
	    }
      ...
      if (local_syms != NULL
	  && (cgc_symtab_hdr (isec->owner).contents
	      != (unsigned char *) local_syms))
	free (local_syms);
      if (cgc_section_data (isec)->relocs != relstart)
	free (relstart);
    }
...
bfd_boolean
ppc64_cgc_next_input_section (struct bfd_link_info *info, asection *isec)
{
  struct ppc_link_hash_table *htab = ppc_hash_table (info);
...
bfd_boolean
ppc64_cgc_check_init_fini (struct bfd_link_info *info)
{
		...
		bfd_boolean stubs_always_before_branch)
{
  ...
  do
      ...
      while (tail != NULL)
	{
	  ...
	  curr = tail;
	  total = tail->size;
	  big_sec = total > (ppc64_cgc_section_data (tail) != NULL
			     && ppc64_cgc_section_data (tail)->has_14bit_branch
			     ? stub14_group_size : stub_group_size);
	  ...
	  while ((prev = PREV_SEC (curr)) != NULL
		 && ((total += curr->output_offset - prev->output_offset)
		     < (ppc64_cgc_section_data (prev) != NULL
			&& ppc64_cgc_section_data (prev)->has_14bit_branch
			? stub14_group_size : stub_group_size))
...
maybe_strip_output (struct bfd_link_info *info, asection *isec)
{
  if (isec->size == 0
      ...
      && !bfd_section_removed_from_list (info->output_bfd,
					 isec->output_section)
      && cgc_section_data (isec->output_section)->dynindx == 0)
    {
...
bfd_boolean
ppc64_cgc_size_stubs (struct bfd_link_info *info, bfd_signed_vma group_size,
		      ...
		      int plt_stub_align)
{
  ...
  if (!htab->opd_abi)
	...
	{
	  struct cgc_link_hash_entry *h;
	  h = cgc_link_hash_lookup (&htab->cgc, thread_starter[i],
				    FALSE, FALSE, TRUE);
	   ...
	   input_bfd = input_bfd->link_next, bfd_indx++)
	{
	  ...
	  for (section = input_bfd->sections;
		...
		continue;
	      ...
	      /* Get the relocs.  */
	      internal_relocs
		= _bfd_cgc_link_read_relocs (input_bfd, section, NULL, NULL,
					     info->keep_memory);
	      ...
	      for (; irela < irelaend; irela++)
		{
		  ...
		  r_type = CGC64_R_TYPE (irela->r_info);
		  r_indx = CGC64_R_SYM (irela->r_info);
		  ...
		  else if (hash->cgc.root.type == bfd_link_hash_defined
			   || hash->cgc.root.type == bfd_link_hash_defweak)
		    {
		      sym_value = hash->cgc.root.u.def.value;
		      if (sym_sec->output_section != NULL)
			ok_dest = TRUE;
		    }
		  else if (hash->cgc.root.type == bfd_link_hash_undefweak
			   || hash->cgc.root.type == bfd_link_hash_undefined)
		    {
		      /* Recognise an old ABI func code entry sym, and
			 use the func descriptor sym instead if it is
			 defined.  */
		      if (hash->cgc.root.root.string[0] == '.'
			  && (fdh = lookup_fdh (hash, htab)) != NULL)
			{
			  if (fdh->cgc.root.type == bfd_link_hash_defined
			      || fdh->cgc.root.type == bfd_link_hash_defweak)
			    {
			      sym_sec = fdh->cgc.root.u.def.section;
			      sym_value = fdh->cgc.root.u.def.value;
			      if (sym_sec->output_section != NULL)
				ok_dest = TRUE;
			    }
			  else
			  ...
			  if (fdh != NULL)
			    {
				 ...
				 entry.  */
			      hash->cgc.root.type = bfd_link_hash_defweak;
			      hash->cgc.root.u.def.section = code_sec;
			      hash->cgc.root.u.def.value = code_value;
			    }
			}
		    }
		  ...
		  if (stub_type == ppc_stub_plt_call
		      ...
		      && CGC64_R_TYPE (irela[1].r_info) == R_PPC64_TOCSAVE)
		    {
		  ...
		  stub_entry->other = hash ? hash->cgc.other : sym->st_other;
	      ...
	      if (cgc_section_data (section)->relocs != internal_relocs)
		free (internal_relocs);
	    }
...
bfd_vma
ppc64_cgc_set_toc (struct bfd_link_info *info, bfd *obfd)
{
  asection *s;
  bfd_vma TOCstart;
  ...
  if (info != NULL && s != NULL && is_ppc64_cgc (obfd))
    {
      struct ppc_link_hash_table *htab = ppc_hash_table (info);
	  ...
	  && htab->cgc.hgot != NULL)
	{
	  htab->cgc.hgot->root.u.def.value = TOC_BASE_OFF;
	  htab->cgc.hgot->root.u.def.section = s;
	}
    }
  return TOCstart;
}

/* Called via cgc_link_hash_traverse from ppc64_cgc_build_stubs to
   write out any global entry stubs.  */

static bfd_boolean
build_global_entry_stubs (struct cgc_link_hash_entry *h, void *inf)
{
  struct bfd_link_info *info;
  struct ppc_link_hash_table *htab;
  struct plt_entry *pent;
...
/* Build all the stubs associated with the current output file.
   ...
   hash table.  This function is called via gldcgc64ppc_finish.  */

bfd_boolean
ppc64_cgc_build_stubs (bfd_boolean emit_stub_syms,
		       struct bfd_link_info *info,
		       char **stats)
{
  struct ppc_link_hash_table *htab = ppc_hash_table (info);
  ...
  if (htab->glink != NULL && htab->glink->size != 0)
	...
	{
	  struct cgc_link_hash_entry *h;
	  h = cgc_link_hash_lookup (&htab->cgc, "__glink_PLTresolve",
				    TRUE, FALSE, FALSE);
	  if (h == NULL)
	    return FALSE;
	  if (h->root.type == bfd_link_hash_new)
      ...
      plt0 = (htab->cgc.splt->output_section->vma
	      + htab->cgc.splt->output_offset
	      - 16);
      if (info->emitrelocations)
	{
	  Cgc_Internal_Rela *r = get_relocs (htab->glink, 1);
	  if (r == NULL)
	    return FALSE;
	  r->r_offset = (htab->glink->output_offset
			 + htab->glink->output_section->vma);
	  r->r_info = CGC64_R_INFO (0, R_PPC64_REL64);
	  r->r_addend = plt0;
	}
	...
	cgc_link_hash_traverse (&htab->cgc, build_global_entry_stubs, info);
    }
  ...
  if (htab->glink_eh_frame != NULL
	...
	return FALSE;
      ...
      bfd_put_32 (htab->cgc.dynobj, last_fde_len, p);
	...
	if ((stub_sec->flags & SEC_LINKER_CREATED) == 0)
	  {
	    ...
	    last_fde_len = 16;
	    /* FDE length.  */
	    bfd_put_32 (htab->cgc.dynobj, 16, p);
	    p += 4;
	    /* CIE pointer.  */
	    val = p - htab->glink_eh_frame->contents;
	    bfd_put_32 (htab->cgc.dynobj, val, p);
	    p += 4;
	    ...
	    p += 4;
	    /* stub section size.  */
	    bfd_put_32 (htab->cgc.dynobj, stub_sec->rawsize, p);
	    p += 4;
	    /* Augmentation.  */
	    p += 1;
	    /* Pad.  */
      ...
      if (htab->glink != NULL && htab->glink->size != 0)
	{
	  ...
	  last_fde_len = 20;
	  /* FDE length.  */
	  bfd_put_32 (htab->cgc.dynobj, 20, p);
	  p += 4;
	  /* CIE pointer.  */
	  val = p - htab->glink_eh_frame->contents;
	  bfd_put_32 (htab->cgc.dynobj, val, p);
	  ...
	  p += 4;
	  /* .glink size.  */
	  bfd_put_32 (htab->cgc.dynobj, htab->glink->size - 8, p);
	  p += 4;
	  /* Augmentation.  */
	  p += 1;
	 ...
	 zero padding will be seen as a terminator.  */
      ...
      bfd_put_32 (htab->cgc.dynobj, last_fde_len + pad, last_fde);
    }
...
static bfd_boolean
undo_symbol_twiddle (struct cgc_link_hash_entry *h, void *inf ATTRIBUTE_UNUSED)
{
  struct ppc_link_hash_entry *eh;
  ...
  eh = (struct ppc_link_hash_entry *) h;
  if (eh->cgc.root.type != bfd_link_hash_undefweak || !eh->was_undefined)
    return TRUE;
...
void
ppc64_cgc_restore_symbols (struct bfd_link_info *info)
{
  struct ppc_link_hash_table *htab = ppc_hash_table (info);

  if (htab != NULL)
    cgc_link_hash_traverse (&htab->cgc, undo_symbol_twiddle, info);
}
...
static unsigned int
ppc64_cgc_action_discarded (asection *sec)
{
  ...
  return _bfd_cgc_default_action_discarded (sec);
}
...
static bfd_boolean
ppc64_cgc_relocate_section (bfd *output_bfd,
			    struct bfd_link_info *info,
			    bfd *input_bfd,
			    ...
			    asection **local_sections)
{
  ...
  BFD_ASSERT (is_ppc64_cgc (input_bfd));

  local_got_ents = cgc_local_got_ents (input_bfd);
  TOCstart = cgc_gp (output_bfd);
  symtab_hdr = &cgc_symtab_hdr (input_bfd);
  sym_hashes = cgc_sym_hashes (input_bfd);
  is_opd = ppc64_cgc_section_data (input_section)->sec_type == sec_opd;
  ...
  for (; rel < relend; rel++)
    {
      ...
      Cgc_Internal_Sym *sym;
      asection *sec;
      struct cgc_link_hash_entry *h_cgc;
      struct ppc_link_hash_entry *h;
      struct ppc_link_hash_entry *fdh;
      const char *sym_name;
      ...
      bfd_vma from;
      const Cgc_Internal_Rela orig_rel = *rel;
	 ...
	 proper TOC base to use.  */
      if (rel->r_info == CGC64_R_INFO (0, R_PPC64_TOC)
	  && rel != relocs
	  && CGC64_R_TYPE (rel[-1].r_info) == R_PPC64_ADDR64
	  && is_opd)
	r_symndx = CGC64_R_SYM (rel[-1].r_info);
      ...
      if (r_symndx < symtab_hdr->sh_info)
	{
	  ...
	  sym_name = bfd_cgc_sym_name (input_bfd, symtab_hdr, sym, sec);
	  sym_type = CGC64_ST_TYPE (sym->st_info);
      ...
      else
	{
	  RELOC_FOR_GLOBAL_SYMBOL (info, input_bfd, input_section, rel,
				   ...
				   h_cgc, sec, relocation,
				   unresolved_reloc, warned);
	  sym_name = h_cgc->root.root.string;
	  sym_type = h_cgc->type;
	  if (sec != NULL
		...
		if (lo->type == bfd_indirect_link_order)
		  {
		    ...
		    if (h_cgc->root.u.def.value >= isec->output_offset
			&& h_cgc->root.u.def.value < (isec->output_offset
						      + isec->size))
		      {
			h_cgc->root.u.def.value -= isec->output_offset;
			h_cgc->root.u.def.section = isec;
			sec = isec;
			break;
		      }
		  }
      ...
      h = (struct ppc_link_hash_entry *) h_cgc;

      if (sec != NULL && discarded_section (sec))
	RELOC_AGAINST_DISCARDED_SECTION (info, input_bfd, input_section,
					 rel, 1, relend,
					 ppc64_cgc_howto_table[r_type], 0,
					 contents);

      if (info->relocatable)
	continue;

      if (h != NULL && &h->cgc == htab->cgc.hgot)
	{
	  relocation = (TOCstart
	      ...
	      || r_type == R_PPC64_TLSLD))
	{
	 ...
	 relocs are used with non-tls syms.  */
	  ...
	  && r_type != R_PPC64_NONE
	  && (h == NULL
	      || h->cgc.root.type == bfd_link_hash_defined
	      || h->cgc.root.type == bfd_link_hash_defweak)
	...
	case R_PPC64_LO_DS_OPT:
	  ...
	  rel->r_info = CGC64_R_INFO (r_symndx, r_type);
	  break;
	...
	case R_PPC64_GOT_TPREL16_LO_DS:
	  if (tls_mask != 0
	    ...
	    toctprel:
	      ...
	      if (toc_symndx != 0)
		{
		  rel->r_info = CGC64_R_INFO (toc_symndx, r_type);
	...
	case R_PPC64_TLS:
	  if (tls_mask != 0
	      && (tls_mask & TLS_TPREL) == 0)
	    {
	      ...
	      insn = _bfd_cgc_ppc_at_tls_transform (insn, 13);
	      if (insn == 0)
		abort ();
	...
	case R_PPC64_GOT_TLSLD16_LO:
	  if (tls_mask != 0 && (tls_mask & TLS_LD) == 0)
	      ...
	      if ((tls_mask & tls_gd) != 0)
		{
		  ...
		  if (offset != (bfd_vma) -1)
		    rel[1].r_info = CGC64_R_INFO (STN_UNDEF, R_PPC64_NONE);
	      ...
	      else
		{
		  ...
		  if (tls_gd == 0)
			...
			if (local_sections[r_symndx] == sec)
		      ...
		      if (r_symndx >= symtab_hdr->sh_info)
			r_symndx = STN_UNDEF;
		      rel->r_addend = htab->cgc.tls_sec->vma + DTP_OFFSET;
		      if (r_symndx != STN_UNDEF)
		  ...
		  if (offset != (bfd_vma) -1)
		    {
		      rel[1].r_info = CGC64_R_INFO (r_symndx,
						    R_PPC64_TPREL16_LO);
	...
	case R_PPC64_DTPMOD64:
	  if (rel + 1 < relend
	      ...
	      && rel[1].r_offset == rel->r_offset + 8)
	    {
	      if ((tls_mask & TLS_GD) == 0)
		{
		  rel[1].r_info = CGC64_R_INFO (r_symndx, R_PPC64_NONE);
		  if ((tls_mask & TLS_TPRELGD) != 0)
	...
	case R_PPC64_REL16_HA:
	  /* If we are generating a non-PIC executable, edit
	     ...
	     .		addi 2,2,.TOC.-0b@l
	     used by CGCv2 global entry points to set up r2, to
	     .		lis 2,.TOC.@ha
	     .		addi 2,2,.TOC.@l
	     if .TOC. is in range.  */
	  if (!info->shared
	      && h != NULL && &h->cgc == htab->cgc.hgot
	      && rel + 1 < relend
	      && rel[1].r_info == CGC64_R_INFO (r_symndx, R_PPC64_REL16_LO)
		  ...
		  && (insn2 & 0xffff0000) == 0x38420000 /* addi 2,2 */)
		{
		  ...
		  rel[1].r_info = CGC64_R_INFO (r_symndx, R_PPC64_ADDR16_LO);
	...
	case R_PPC64_REL24:
	  ...
	  if (stub_entry != NULL
		...
		{
		  const char *name = h->cgc.root.root.string;
	  ...
	  if (stub_entry != NULL)
	    {
		 ...
		 rather than the procedure directly.  */
		  ...
		  && rel + 1 < relend
		  && rel[1].r_offset == rel->r_offset + 4
		  && CGC64_R_TYPE (rel[1].r_info) == R_PPC64_TOCSAVE)
		relocation += 4;
	    }
	  ...
	  /* NOP out calls to undefined weak functions.
	     ...
	     checking whether the function is defined.  */
		   ...
		   && h->cgc.root.type == bfd_link_hash_undefweak
		   && h->cgc.dynindx == -1
	...
	dogot:
	  {
		...
		if (h != NULL)
		  {
		    bfd_boolean dyn = htab->cgc.dynamic_sections_created;
		    if (!WILL_CALL_FINISH_DYNAMIC_SYMBOL (dyn, info->shared,
							  &h->cgc)
			|| (info->shared
			    && SYMBOL_REFERENCES_LOCAL (info, &h->cgc)))
	    ...
	    if (ent->is_indirect)
	      ent = ent->got.ent;
	    offp = &ent->got.offset;
	    got = ppc64_cgc_tdata (ent->owner)->got;
	    if (got == NULL)
	      abort ();
		...
		*offp = off | 1;
		relgot = NULL;
		ifunc = (h != NULL
			 ? h->cgc.type == STT_GNU_IFUNC
			 : CGC_ST_TYPE (sym->st_info) == STT_GNU_IFUNC);
		if (ifunc)
		  relgot = htab->cgc.irelplt;
		else if ((info->shared || indx != 0)
			 && (h == NULL
			     || (tls_type == (TLS_TLS | TLS_LD)
				 && !h->cgc.def_dynamic)
			     || CGC_ST_VISIBILITY (h->cgc.other) == STV_DEFAULT
			     || h->cgc.root.type != bfd_link_hash_undefweak))
		  relgot = ppc64_cgc_tdata (ent->owner)->relgot;
		if (relgot != NULL)
		  {
		    ...
		    if (tls_type & (TLS_LD | TLS_GD))
		      {
			outrel.r_addend = 0;
			outrel.r_info = CGC64_R_INFO (indx, R_PPC64_DTPMOD64);
			if (tls_type == (TLS_TLS | TLS_GD))
			  {
			    loc = relgot->contents;
			    loc += (relgot->reloc_count++
				    * sizeof (Cgc64_External_Rela));
			    bfd_cgc64_swap_reloca_out (output_bfd,
						       &outrel, loc);
			    outrel.r_offset += 8;
			    outrel.r_addend = addend;
			    outrel.r_info
			      = CGC64_R_INFO (indx, R_PPC64_DTPREL64);
			  }
		      }
		    else if (tls_type == (TLS_TLS | TLS_DTPREL))
		      outrel.r_info = CGC64_R_INFO (indx, R_PPC64_DTPREL64);
		    else if (tls_type == (TLS_TLS | TLS_TPREL))
		      outrel.r_info = CGC64_R_INFO (indx, R_PPC64_TPREL64);
		    else if (indx != 0)
		      outrel.r_info = CGC64_R_INFO (indx, R_PPC64_GLOB_DAT);
		    else
		      {
			if (ifunc)
			  outrel.r_info = CGC64_R_INFO (0, R_PPC64_IRELATIVE);
			else
			  outrel.r_info = CGC64_R_INFO (0, R_PPC64_RELATIVE);
			...
			if (tls_type & (TLS_GD | TLS_DTPREL | TLS_TPREL))
			  outrel.r_addend -= htab->cgc.tls_sec->vma;
		      }
		    loc = relgot->contents;
		    loc += (relgot->reloc_count++
			    * sizeof (Cgc64_External_Rela));
		...
		/* Init the .got section contents here if we're not
		...
		else
		  {
		    ...
		    if (tls_type == (TLS_TLS | TLS_LD))
		      ...
		      {
			relocation -= htab->cgc.tls_sec->vma + DTP_OFFSET;
	...
	case R_PPC64_PLT64:
	  ...
	  /* It's possible that we didn't make a PLT entry for this
	     ...
	     PLT entry.  */
	  if (htab->cgc.splt != NULL)
	    {
	      struct plt_entry *ent;
	      for (ent = h->cgc.plt.plist; ent != NULL; ent = ent->next)
	  ...
	  if (h != NULL
	      ...
	      && h->cgc.dynindx == -1)
	    {
		 ...
		 defined before using them.  */
	      ...
	      insn = _bfd_cgc_ppc_at_tprel_transform (insn, 13);
	      if (insn != 0)
		bfd_put_32 (output_bfd, insn, p);
	      break;
	    }
	  addend -= htab->cgc.tls_sec->vma + TP_OFFSET;
	  if (info->shared)
	...
	case R_PPC64_DTPREL16_HIGHEST:
	case R_PPC64_DTPREL16_HIGHESTA:
	  addend -= htab->cgc.tls_sec->vma + DTP_OFFSET;
	  break;
	  ...
	  if ((info->shared
		      ...
		      : CGC_ST_TYPE (sym->st_info) == STT_GNU_IFUNC)))
	    {
		 ...
		 time.  */
	      ...
	      out_off = _bfd_cgc_section_offset (output_bfd, info,
		...
		memset (&outrel, 0, sizeof outrel);
	      else if (!SYMBOL_REFERENCES_LOCAL (info, &h->cgc)
		       && !is_opd
		       && r_type != R_PPC64_TOC)
		{
		  BFD_ASSERT (h->cgc.dynindx != -1);
		  outrel.r_info = CGC64_R_INFO (h->cgc.dynindx, r_type);
		}
	      else
		{
		  ...
		  if (r_type == R_PPC64_ADDR64 || r_type == R_PPC64_TOC)
		      ...
		      else
			{
			  ...
			  if (indx == 0)
			    {
				  ...
				  && htab->cgc.data_index_section != NULL)
				osec = htab->cgc.data_index_section;
			      else
		      ...
		      outrel.r_info = CGC64_R_INFO (indx, r_type);
		    }
		}
		...
		abort ();
	      ...
	      if (sreloc->reloc_count * sizeof (Cgc64_External_Rela)
		  >= sreloc->size)
		abort ();
	      loc = sreloc->contents;
	      ...
	      if (! relocate)
		{
		  ...
		  else if (ppc64_cgc_howto_table[r_type]->pc_relative)
	...
	case R_PPC64_PLTREL64:
	  ...
	  info->callbacks->einfo
	    (_("%P: %B: %s is not supported for `%T'\n"),
	     input_bfd,
	     ppc64_cgc_howto_table[r_type]->name, sym_name);
	...
	case R_PPC64_TOC16_HA:
	  if (htab->do_toc_opt && relocation + addend + 0x8000 < 0x10000
	      && !ppc64_cgc_tdata (input_bfd)->unexpected_toc_insn)
	    {
				      ...
				      rel->r_offset) != (bfd_vma) -1)
	{
	  info->callbacks->einfo
	    (_("%P: %H: unresolvable %s against `%T'\n"),
	     input_bfd, input_section, rel->r_offset,
	     ppc64_cgc_howto_table[(int) r_type]->name,
	     h->cgc.root.root.string);
	  ret = FALSE;
	}

      r = _bfd_final_link_relocate (ppc64_cgc_howto_table[(int) r_type],
				    input_bfd,
				    input_section,
				    contents,
				    rel->r_offset,
	...
	{
	  char *more_info = NULL;
	  const char *reloc_name = ppc64_cgc_howto_table[r_type]->name;
	  ...
	  if (r == bfd_reloc_overflow)
		...
		continue;
	      if (h != NULL
		  && h->cgc.root.type == bfd_link_hash_undefweak
		  && ppc64_cgc_howto_table[r_type]->pc_relative)
		{
  ...
  if (is_opd && (info->emitrelocations || info->relocatable))
    {
      bfd_size_type amt;
      amt = input_section->reloc_count * sizeof (Cgc_Internal_Rela);
      rel = bfd_alloc (input_bfd, amt);
      BFD_ASSERT (ppc64_cgc_tdata (input_bfd)->opd.relocs == NULL);
      ppc64_cgc_tdata (input_bfd)->opd.relocs = rel;
      if (rel == NULL)
	return FALSE;
...
static int
ppc64_cgc_output_symbol_hook (struct bfd_link_info *info,
			      ...
			      struct cgc_link_hash_entry *h)
{
  ...
  value = cgcsym->st_value - input_sec->output_offset;
  if (!info->relocatable)
...
static bfd_boolean
ppc64_cgc_finish_dynamic_symbol (bfd *output_bfd,
				 struct bfd_link_info *info,
				 struct cgc_link_hash_entry *h,
				 Cgc_Internal_Sym *sym ATTRIBUTE_UNUSED)
{
  struct ppc_link_hash_table *htab;
  struct plt_entry *ent;
  Cgc_Internal_Rela rela;
	...
	if (!htab->cgc.dynamic_sections_created
	    || h->dynindx == -1)
	  {
	    BFD_ASSERT (h->type == STT_GNU_IFUNC
			...
			&& (h->root.type == bfd_link_hash_defined
			    || h->root.type == bfd_link_hash_defweak));
	    rela.r_offset = (htab->cgc.iplt->output_section->vma
	    ...
	    rela.r_addend = (h->root.u.def.value
			     ...
			     + ent->addend);
	    loc = (htab->cgc.irelplt->contents
		   + (htab->cgc.irelplt->reloc_count++
		      * sizeof (Cgc64_External_Rela)));
	  }
	else
	  {
	    rela.r_offset = (htab->cgc.splt->output_section->vma
			     + htab->cgc.splt->output_offset
			     + ent->plt.offset);
	    rela.r_info = CGC64_R_INFO (h->dynindx, R_PPC64_JMP_SLOT);
	    rela.r_addend = ent->addend;
	    loc = (htab->cgc.srelplt->contents
		   + ((ent->plt.offset - PLT_INITIAL_ENTRY_SIZE (htab))
		      / PLT_ENTRY_SIZE (htab) * sizeof (Cgc64_External_Rela)));
	  }
  ...
  if (h->needs_copy)
	...
	abort ();
      ...
      rela.r_offset = (h->root.u.def.value
		       + h->root.u.def.section->output_section->vma
		       + h->root.u.def.section->output_offset);
      rela.r_info = CGC64_R_INFO (h->dynindx, R_PPC64_COPY);
      rela.r_addend = 0;
      loc = htab->relbss->contents;
      loc += htab->relbss->reloc_count++ * sizeof (Cgc64_External_Rela);
      bfd_cgc64_swap_reloca_out (output_bfd, &rela, loc);
    }
...
ppc64_cgc_reloc_type_class (const struct bfd_link_info *info,
			    ...
			    const Cgc_Internal_Rela *rela)
{
  ...
  if (rel_sec == htab->cgc.irelplt)
    return reloc_class_ifunc;

  r_type = CGC64_R_TYPE (rela->r_info);
  switch (r_type)
    {
    case R_PPC64_RELATIVE:
...
static bfd_boolean
ppc64_cgc_finish_dynamic_sections (bfd *output_bfd,
				   struct bfd_link_info *info)
{
  struct ppc_link_hash_table *htab;
  bfd *dynobj;
  ...
  if (htab->cgc.dynamic_sections_created)
      ...
      for (; dyncon < dynconend; dyncon++)
	{
	  ...
	  switch (dyn.d_tag)
	    ...
	    case DT_PLTRELSZ:
	      dyn.d_un.d_val = htab->cgc.srelplt->size;
	      break;
	    ...
	    case DT_RELA:
	      /* We may not be using the standard CGC linker script.
  ...
  if (htab->cgc.sgot != NULL && htab->cgc.sgot->size != 0)
    {
      /* Fill in the first entry in the global offset table.
	 We use it to hold the link-time TOCbase.  */
      bfd_put_64 (output_bfd,
		  cgc_gp (output_bfd) + TOC_BASE_OFF,
		  htab->cgc.sgot->contents);

      /* Set .got entry size.  */
      cgc_section_data (htab->cgc.sgot->output_section)->this_hdr.sh_entsize = 8;
    }
  ...
  if (htab->brlt != NULL
      && htab->brlt->reloc_count != 0
      && !_bfd_cgc_link_output_relocs (output_bfd,
				       htab->brlt,
				       cgc_section_data (htab->brlt)->rela.hdr,
				       cgc_section_data (htab->brlt)->relocs,
				       NULL))
    return FALSE;
  ...
  if (htab->glink != NULL
      ...
      && !_bfd_cgc_link_output_relocs (output_bfd,
				       htab->glink,
				       cgc_section_data (htab->glink)->rela.hdr,
				       cgc_section_data (htab->glink)->relocs,
				       NULL))
    return FALSE;
  ...
  if (htab->glink_eh_frame != NULL
      ...
      && !_bfd_cgc_write_section_eh_frame (output_bfd, info,
					   htab->glink_eh_frame,
  ...
  while ((dynobj = dynobj->link_next) != NULL)
    {
      ...
      if (!is_ppc64_cgc (dynobj))
	continue;

      s = ppc64_cgc_tdata (dynobj)->got;
      if (s != NULL
	  && s->size != 0
	  ...
	  && !bfd_set_section_contents (output_bfd, s->output_section,
					...
					s->size))
	return FALSE;
      s = ppc64_cgc_tdata (dynobj)->relgot;
      if (s != NULL
	  && s->size != 0
	  && s->output_section != bfd_abs_section_ptr
	  && !bfd_set_section_contents (output_bfd, s->output_section,
...
#define TARGET_BIG_SYM	bfd_cgc64_powerpc_freebsd_vec
#undef  TARGET_BIG_NAME
#define TARGET_BIG_NAME "cgc64-powerpc-freebsd"

#undef  CGC_OSABI
#define	CGC_OSABI       CGCOSABI_FREEBSD

#undef  cgc64_bed
#define cgc64_bed	cgc64_powerpc_fbsd_bed
