/* Generic support for 64-bit CGC
...
static bfd_boolean
cgc64_generic_link_add_symbols (bfd *abfd, struct bfd_link_info *info)
{
...
#define TARGET_LITTLE_SYM		bfd_cgc64_little_generic_vec
#define TARGET_LITTLE_NAME		"cgc64-little"
#define TARGET_BIG_SYM			bfd_cgc64_big_generic_vec
#define TARGET_BIG_NAME			"cgc64-big"
#define CGC_ARCH			bfd_arch_unknown
#define CGC_MACHINE_CODE		EM_NONE
#define CGC_MAXPAGESIZE			0x1
#define bfd_cgc64_bfd_reloc_type_lookup bfd_default_reloc_type_lookup
#define bfd_cgc64_bfd_reloc_name_lookup _bfd_norelocs_bfd_reloc_name_lookup
#define bfd_cgc64_bfd_link_add_symbols	cgc64_generic_link_add_symbols
