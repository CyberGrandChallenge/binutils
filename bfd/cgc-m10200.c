/* Matsushita 10200 specific support for 32-bit CGC
...
static bfd_boolean
mn10200_cgc_relax_delete_bytes (bfd *, asection *, bfd_vma, int);
static bfd_boolean
mn10200_cgc_symbol_address_p (bfd *, asection *, Cgc_Internal_Sym *, bfd_vma);
...
static reloc_howto_type cgc_mn10200_howto_table[] =
{
				 ...
				 bfd_reloc_code_real_type code)
{
  ...
  for (i = 0;
	...
	return &cgc_mn10200_howto_table[mn10200_reloc_map[i].cgc_reloc_val];
    }
				 ...
				 const char *r_name)
{
  ...
  for (i = 0;
       i < (sizeof (cgc_mn10200_howto_table)
	    / sizeof (cgc_mn10200_howto_table[0]));
       i++)
    if (cgc_mn10200_howto_table[i].name != NULL
	&& strcasecmp (cgc_mn10200_howto_table[i].name, r_name) == 0)
      return &cgc_mn10200_howto_table[i];

  return NULL;
}

/* Set the howto pointer for an MN10200 CGC reloc.  */
		       ...
		       Cgc_Internal_Rela *dst)
{
  ...
  cache_ptr->howto = &cgc_mn10200_howto_table[r_type];
}

/* Perform a relocation as part of a final link.  */

static bfd_reloc_status_type
mn10200_cgc_final_link_relocate (reloc_howto_type *howto,
				 bfd *input_bfd,
...

/* Relocate an MN10200 CGC section.  */
static bfd_boolean
mn10200_cgc_relocate_section (bfd *output_bfd,
  ...
  for (; rel < relend; rel++)
    {
      ...
      howto = cgc_mn10200_howto_table + r_type;
	...
	continue;
      ...
      r = mn10200_cgc_final_link_relocate (howto, input_bfd, output_bfd,
					   input_section,
...
static bfd_boolean
mn10200_cgc_relax_delete_bytes (bfd *abfd, asection *sec,
...
static bfd_boolean
mn10200_cgc_relax_section (bfd *abfd,
			   asection *sec,
  ...
  for (irel = internal_relocs; irel < irelend; irel++)
    {
	 ...
	 this reloc.  */
      if (CGC32_R_TYPE (irel->r_info) == (int) R_MN10200_NONE
	  || CGC32_R_TYPE (irel->r_info) == (int) R_MN10200_8
	  || CGC32_R_TYPE (irel->r_info) == (int) R_MN10200_MAX)
	continue;
      ...
      else
	{
	 ...
	 branch/call.  */
      if (CGC32_R_TYPE (irel->r_info) == (int) R_MN10200_PCREL24)
	{
	  ...
	  if ((long) value < 0x8001 && (long) value > -0x8000)
		...
		bfd_put_8 (abfd, 0xfd, contents + irel->r_offset - 2);
	      ...
	      if (!mn10200_cgc_relax_delete_bytes (abfd, sec,
						   irel->r_offset + 1, 2))
		goto error_return;
	 ...
	 branch.  */
      if (CGC32_R_TYPE (irel->r_info) == (int) R_MN10200_PCREL16)
	{
	  bfd_vma value = symval;
	 ...
	 but due to other relaxations it can reach at link time.  */
      if (CGC32_R_TYPE (irel->r_info) == (int) R_MN10200_PCREL8)
	{
	  ...
	  if (nrel == irelend
	      ...
	      || CGC32_R_TYPE (nrel->r_info) != (int) R_MN10200_PCREL8)
	    continue;
	  ...
	  if (mn10200_cgc_symbol_address_p (abfd, sec, isymbuf,
					    irel->r_offset + 1))
	    continue;
	 ...
	 into a 16bit immediate, displacement or absolute address.  */
      if (CGC32_R_TYPE (irel->r_info) == (int) R_MN10200_24)
	{
	  bfd_vma value = symval;
...
/* Return TRUE if a symbol exists at the given address, else return
   FALSE.  */
static bfd_boolean
mn10200_cgc_symbol_address_p (bfd *abfd,
			      asection *sec,
			      Cgc_Internal_Sym *isym,
			      bfd_vma addr)
{
...
/* This is a version of bfd_generic_get_relocated_section_contents
   which uses mn10200_cgc_relocate_section.  */

static bfd_byte *
mn10200_cgc_get_relocated_section_contents (bfd *output_bfd,
					    struct bfd_link_info *link_info,
  ...
  if ((input_section->flags & SEC_RELOC) != 0
      ...
      for (isym = isymbuf, secpp = sections; isym < isymend; ++isym, ++secpp)
	{
	  ...
	  *secpp = isec;
      ...
      if (! mn10200_cgc_relocate_section (output_bfd, link_info, input_bfd,
...
#define TARGET_LITTLE_SYM	bfd_cgc32_mn10200_vec
#define TARGET_LITTLE_NAME	"cgc32-mn10200"
#define CGC_ARCH		bfd_arch_mn10200
#define CGC_MACHINE_CODE	EM_MN10200
#define CGC_MACHINE_ALT1	EM_CYGNUS_MN10200
#define CGC_MAXPAGESIZE		0x1000

#define cgc_backend_rela_normal 1
#define cgc_info_to_howto	mn10200_info_to_howto
#define cgc_info_to_howto_rel	0
#define cgc_backend_relocate_section mn10200_cgc_relocate_section
#define bfd_cgc32_bfd_relax_section	mn10200_cgc_relax_section
#define bfd_cgc32_bfd_get_relocated_section_contents \
				mn10200_cgc_get_relocated_section_contents
