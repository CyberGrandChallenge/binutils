...
extern enum sh64_cgc_cr_type sh64_get_contents_type
  (asection *, bfd_vma, sh64_cgc_crange *);
...
struct _sh64_cgc_section_data
{
  struct bfd_cgc_section_data cgc;
  struct sh64_section_data *sh64_info;
};

#define sh64_cgc_section_data(sec) \
  ((struct _sh64_cgc_section_data *) cgc_section_data (sec))
