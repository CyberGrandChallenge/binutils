/* DO NOT EDIT!  -*- buffer-read-only: t -*-  This file is automatically 
   ...
   "bfdwin.c", "cache.c", "reloc.c", "archures.c" and "cgc.c".
...
/* Functions shared by the ECOFF and MIPS CGC backends, which have no
...
/* Function shared by the COFF and CGC SH backends, which have no
   other common header files.  */
