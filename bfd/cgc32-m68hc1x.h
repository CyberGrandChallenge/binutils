/* Motorola 68HC11/68HC12-specific support for 32-bit CGC
...
#ifndef _CGC32_M68HC1X_H
#define _CGC32_M68HC1X_H
...
extern bfd_boolean _bfd_m68hc11_cgc_merge_private_bfd_data (bfd*,bfd*);
extern bfd_boolean _bfd_m68hc11_cgc_set_private_flags (bfd*,flagword);
extern bfd_boolean _bfd_m68hc11_cgc_print_private_bfd_data (bfd*, void*);
...
struct m68hc11_cgc_link_hash_table
{
  ...
  /* Assorted information used by cgc32_hppa_size_stubs.  */
...
/* Get the Sparc64 CGC linker hash table from a link_info structure.  */

#define m68hc11_cgc_hash_table(p) \
  (cgc_hash_table_id ((struct cgc_link_hash_table *) ((p)->hash)) \
  == M68HC11_CGC_DATA ? ((struct m68hc11_cgc_link_hash_table *) ((p)->hash)) : NULL)

/* Create a 68HC11/68HC12 CGC linker hash table.  */

extern struct m68hc11_cgc_link_hash_table* m68hc11_cgc_hash_table_create
  (bfd*);
extern void m68hc11_cgc_bfd_link_hash_table_free (struct bfd_link_hash_table*);

extern void m68hc11_cgc_get_bank_parameters (struct bfd_link_info*);
...
bfd_reloc_status_type m68hc11_cgc_ignore_reloc
  (bfd *abfd, arelent *reloc_entry,
   asymbol *symbol, void *data, asection *input_section,
   bfd *output_bfd, char **error_message);
bfd_reloc_status_type m68hc11_cgc_special_reloc
  (bfd *abfd, arelent *reloc_entry,
    asymbol *symbol, void *data, asection *input_section,
    bfd *output_bfd, char **error_message);

bfd_boolean cgc32_m68hc11_check_relocs
  (bfd * abfd, struct bfd_link_info * info,
   asection * sec, const Cgc_Internal_Rela * relocs);
bfd_boolean cgc32_m68hc11_relocate_section
  (bfd *output_bfd, struct bfd_link_info *info,
   bfd *input_bfd, asection *input_section,
   bfd_byte *contents, Cgc_Internal_Rela *relocs,
   Cgc_Internal_Sym *local_syms, asection **local_sections);

bfd_boolean cgc32_m68hc11_add_symbol_hook
  (bfd *abfd, struct bfd_link_info *info,
   Cgc_Internal_Sym *sym, const char **namep,
   flagword *flagsp, asection **secp,
   bfd_vma *valp);

void cgc32_m68hc11_merge_symbol_attribute
  (struct cgc_link_hash_entry *, const Cgc_Internal_Sym *,
   bfd_boolean, bfd_boolean);

/* Tweak the OSABI field of the cgc header.  */

extern void cgc32_m68hc11_post_process_headers (bfd*, struct bfd_link_info*);

int cgc32_m68hc11_setup_section_lists (bfd *, struct bfd_link_info *);

bfd_boolean cgc32_m68hc11_size_stubs
  (bfd *, bfd *, struct bfd_link_info *,
   asection * (*) (const char *, asection *));

bfd_boolean cgc32_m68hc11_build_stubs (bfd* abfd, struct bfd_link_info *);
#endif
