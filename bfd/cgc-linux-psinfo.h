/* Definitions for PRPSINFO structures under CGC on GNU/Linux.
...
#ifndef CGC_LINUX_PSINFO_H
#define CGC_LINUX_PSINFO_H
...
struct cgc_external_linux_prpsinfo32
  {
...
/* Helper macro to swap (properly handling endianess) things from the
   `cgc_internal_linux_prpsinfo' structure to the
   `cgc_external_linux_prpsinfo32' structure.
...
struct cgc_external_linux_prpsinfo64
  {
    char pr_state;			/* Numeric process state.  */
    char pr_sname;			/* Char for pr_state.  */
    char pr_zomb;			/* Zombie.  */
...
/* Helper macro to swap (properly handling endianess) things from the
   `cgc_internal_linux_prpsinfo' structure to the
   `cgc_external_linux_prpsinfo64' structure.
