/* BFD back-end for National Semiconductor's CR16C CGC
...
/* reloc_map_index array maps CRASM relocation type into a BFD
   ...
   RINDEX_16C_* indices, created in include/cgc/cr16c.h.
   The array is used in:
   1. cgc32-cr16c.c : cgc_cr16c_reloc_type_lookup().
...
cgc_cr16c_reloc_type_lookup (bfd *abfd ATTRIBUTE_UNUSED,
...
static reloc_howto_type *
cgc_cr16c_reloc_name_lookup (bfd *abfd ATTRIBUTE_UNUSED,
			     const char *r_name)
{
  unsigned int i;
...
static void
cgc_cr16c_info_to_howto (bfd *abfd ATTRIBUTE_UNUSED,
...
static void
cgc_cr16c_info_to_howto_rel (bfd *abfd ATTRIBUTE_UNUSED,
			     arelent *cache_ptr,
...
cr16c_cgc_final_link_relocate (reloc_howto_type *howto,
			       bfd *abfd,
...
/* Relocate a CR16C CGC section.  */

static bfd_boolean
cgc32_cr16c_relocate_section (bfd *output_bfd,
			      ...
			      asection **local_sections)
{
  ...
  for (; rel < relend; rel++)
      ...
      if (info->relocatable)
	{
      ...
      r = cr16c_cgc_final_link_relocate (howto, input_bfd, output_bfd,
					 input_section,
...
/* CR16C CGC uses three common sections:
   ...
   The following implementation is based on cgc32-mips architecture */

static asection  cr16c_cgc_fcom_section;
static asymbol   cr16c_cgc_fcom_symbol;
static asymbol * cr16c_cgc_fcom_symbol_ptr;
static asection  cr16c_cgc_ncom_section;
static asymbol   cr16c_cgc_ncom_symbol;
static asymbol * cr16c_cgc_ncom_symbol_ptr;

/* Given a BFD section, try to locate the
   corresponding CGC section index.  */

static bfd_boolean
cgc32_cr16c_section_from_bfd_section (bfd *abfd ATTRIBUTE_UNUSED,
				      asection *sec,
				      int *retval)
{
...
static void
cgc32_cr16c_symbol_processing (bfd *abfd ATTRIBUTE_UNUSED,
			       asymbol *asym)
{
  ...
  switch (indx)
    ...
    case SHN_CR16C_FCOMMON:
      if (cr16c_cgc_fcom_section.name == NULL)
	{
	  /* Initialize the far common section.  */
	  cr16c_cgc_fcom_section.name = ".fcommon";
	  cr16c_cgc_fcom_section.flags = SEC_IS_COMMON | SEC_ALLOC;
	  cr16c_cgc_fcom_section.output_section = &cr16c_cgc_fcom_section;
	  cr16c_cgc_fcom_section.symbol = &cr16c_cgc_fcom_symbol;
	  cr16c_cgc_fcom_section.symbol_ptr_ptr = &cr16c_cgc_fcom_symbol_ptr;
	  cr16c_cgc_fcom_symbol.name = ".fcommon";
	  cr16c_cgc_fcom_symbol.flags = BSF_SECTION_SYM;
	  cr16c_cgc_fcom_symbol.section = &cr16c_cgc_fcom_section;
	  cr16c_cgc_fcom_symbol_ptr = &cr16c_cgc_fcom_symbol;
	}
      asym->section = &cr16c_cgc_fcom_section;
      asym->value = cgcsym->internal_cgc_sym.st_size;
      break;
    case SHN_CR16C_NCOMMON:
      if (cr16c_cgc_ncom_section.name == NULL)
	{
	  /* Initialize the far common section.  */
	  cr16c_cgc_ncom_section.name = ".ncommon";
	  cr16c_cgc_ncom_section.flags = SEC_IS_COMMON | SEC_ALLOC;
	  cr16c_cgc_ncom_section.output_section = &cr16c_cgc_ncom_section;
	  cr16c_cgc_ncom_section.symbol = &cr16c_cgc_ncom_symbol;
	  cr16c_cgc_ncom_section.symbol_ptr_ptr = &cr16c_cgc_ncom_symbol_ptr;
	  cr16c_cgc_ncom_symbol.name = ".ncommon";
	  cr16c_cgc_ncom_symbol.flags = BSF_SECTION_SYM;
	  cr16c_cgc_ncom_symbol.section = &cr16c_cgc_ncom_section;
	  cr16c_cgc_ncom_symbol_ptr = &cr16c_cgc_ncom_symbol;
	}
      asym->section = &cr16c_cgc_ncom_section;
      asym->value = cgcsym->internal_cgc_sym.st_size;
      break;
    }
}
...
static bfd_boolean
cgc32_cr16c_add_symbol_hook (bfd *abfd,
			     struct bfd_link_info *info ATTRIBUTE_UNUSED,
			     Cgc_Internal_Sym *sym,
...
static int
cgc32_cr16c_link_output_symbol_hook (struct bfd_link_info *info ATTRIBUTE_UNUSED,
...
#define TARGET_LITTLE_SYM		bfd_cgc32_cr16c_vec
#define TARGET_LITTLE_NAME		"cgc32-cr16c"
#define CGC_ARCH			bfd_arch_cr16c
#define CGC_MACHINE_CODE		EM_CR
#define CGC_MAXPAGESIZE			0x1
#define cgc_symbol_leading_char		'_'

#define bfd_cgc32_bfd_reloc_type_lookup		cgc_cr16c_reloc_type_lookup
#define bfd_cgc32_bfd_reloc_name_lookup	cgc_cr16c_reloc_name_lookup
#define cgc_info_to_howto			cgc_cr16c_info_to_howto
#define cgc_info_to_howto_rel			cgc_cr16c_info_to_howto_rel
#define cgc_backend_relocate_section		cgc32_cr16c_relocate_section
#define cgc_backend_symbol_processing		cgc32_cr16c_symbol_processing
#define cgc_backend_section_from_bfd_section 	cgc32_cr16c_section_from_bfd_section
#define cgc_backend_add_symbol_hook		cgc32_cr16c_add_symbol_hook
#define cgc_backend_link_output_symbol_hook 	cgc32_cr16c_link_output_symbol_hook
