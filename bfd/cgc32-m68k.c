/* Motorola 68k series support for 32-bit CGC
...
static bfd_boolean
cgc_m68k_discard_copies (struct cgc_link_hash_entry *, void *);

static reloc_howto_type howto_table[] =
{
  HOWTO(R_68K_NONE,       0, 0, 0, FALSE,0, complain_overflow_dont,     bfd_cgc_generic_reloc, "R_68K_NONE",      FALSE, 0, 0x00000000,FALSE),
  HOWTO(R_68K_32,         0, 2,32, FALSE,0, complain_overflow_bitfield, bfd_cgc_generic_reloc, "R_68K_32",        FALSE, 0, 0xffffffff,FALSE),
  HOWTO(R_68K_16,         0, 1,16, FALSE,0, complain_overflow_bitfield, bfd_cgc_generic_reloc, "R_68K_16",        FALSE, 0, 0x0000ffff,FALSE),
  HOWTO(R_68K_8,          0, 0, 8, FALSE,0, complain_overflow_bitfield, bfd_cgc_generic_reloc, "R_68K_8",         FALSE, 0, 0x000000ff,FALSE),
  HOWTO(R_68K_PC32,       0, 2,32, TRUE, 0, complain_overflow_bitfield, bfd_cgc_generic_reloc, "R_68K_PC32",      FALSE, 0, 0xffffffff,TRUE),
  HOWTO(R_68K_PC16,       0, 1,16, TRUE, 0, complain_overflow_signed,   bfd_cgc_generic_reloc, "R_68K_PC16",      FALSE, 0, 0x0000ffff,TRUE),
  HOWTO(R_68K_PC8,        0, 0, 8, TRUE, 0, complain_overflow_signed,   bfd_cgc_generic_reloc, "R_68K_PC8",       FALSE, 0, 0x000000ff,TRUE),
  HOWTO(R_68K_GOT32,      0, 2,32, TRUE, 0, complain_overflow_bitfield, bfd_cgc_generic_reloc, "R_68K_GOT32",     FALSE, 0, 0xffffffff,TRUE),
  HOWTO(R_68K_GOT16,      0, 1,16, TRUE, 0, complain_overflow_signed,   bfd_cgc_generic_reloc, "R_68K_GOT16",     FALSE, 0, 0x0000ffff,TRUE),
  HOWTO(R_68K_GOT8,       0, 0, 8, TRUE, 0, complain_overflow_signed,   bfd_cgc_generic_reloc, "R_68K_GOT8",      FALSE, 0, 0x000000ff,TRUE),
  HOWTO(R_68K_GOT32O,     0, 2,32, FALSE,0, complain_overflow_bitfield, bfd_cgc_generic_reloc, "R_68K_GOT32O",    FALSE, 0, 0xffffffff,FALSE),
  HOWTO(R_68K_GOT16O,     0, 1,16, FALSE,0, complain_overflow_signed,   bfd_cgc_generic_reloc, "R_68K_GOT16O",    FALSE, 0, 0x0000ffff,FALSE),
  HOWTO(R_68K_GOT8O,      0, 0, 8, FALSE,0, complain_overflow_signed,   bfd_cgc_generic_reloc, "R_68K_GOT8O",     FALSE, 0, 0x000000ff,FALSE),
  HOWTO(R_68K_PLT32,      0, 2,32, TRUE, 0, complain_overflow_bitfield, bfd_cgc_generic_reloc, "R_68K_PLT32",     FALSE, 0, 0xffffffff,TRUE),
  HOWTO(R_68K_PLT16,      0, 1,16, TRUE, 0, complain_overflow_signed,   bfd_cgc_generic_reloc, "R_68K_PLT16",     FALSE, 0, 0x0000ffff,TRUE),
  HOWTO(R_68K_PLT8,       0, 0, 8, TRUE, 0, complain_overflow_signed,   bfd_cgc_generic_reloc, "R_68K_PLT8",      FALSE, 0, 0x000000ff,TRUE),
  HOWTO(R_68K_PLT32O,     0, 2,32, FALSE,0, complain_overflow_bitfield, bfd_cgc_generic_reloc, "R_68K_PLT32O",    FALSE, 0, 0xffffffff,FALSE),
  HOWTO(R_68K_PLT16O,     0, 1,16, FALSE,0, complain_overflow_signed,   bfd_cgc_generic_reloc, "R_68K_PLT16O",    FALSE, 0, 0x0000ffff,FALSE),
  HOWTO(R_68K_PLT8O,      0, 0, 8, FALSE,0, complain_overflow_signed,   bfd_cgc_generic_reloc, "R_68K_PLT8O",     FALSE, 0, 0x000000ff,FALSE),
  HOWTO(R_68K_COPY,       0, 0, 0, FALSE,0, complain_overflow_dont,     bfd_cgc_generic_reloc, "R_68K_COPY",      FALSE, 0, 0xffffffff,FALSE),
  HOWTO(R_68K_GLOB_DAT,   0, 2,32, FALSE,0, complain_overflow_dont,     bfd_cgc_generic_reloc, "R_68K_GLOB_DAT",  FALSE, 0, 0xffffffff,FALSE),
  HOWTO(R_68K_JMP_SLOT,   0, 2,32, FALSE,0, complain_overflow_dont,     bfd_cgc_generic_reloc, "R_68K_JMP_SLOT",  FALSE, 0, 0xffffffff,FALSE),
  HOWTO(R_68K_RELATIVE,   0, 2,32, FALSE,0, complain_overflow_dont,     bfd_cgc_generic_reloc, "R_68K_RELATIVE",  FALSE, 0, 0xffffffff,FALSE),
...
static void
rtype_to_howto (bfd *abfd, arelent *cache_ptr, Cgc_Internal_Rela *dst)
{
  unsigned int indx = CGC32_R_TYPE (dst->r_info);
...
#define cgc_info_to_howto rtype_to_howto
		   ...
		   bfd_reloc_code_real_type code)
{
  ...
  for (i = 0; i < sizeof (reloc_map) / sizeof (reloc_map[0]); i++)
	...
	return &howto_table[reloc_map[i].cgc_val];
    }
  return 0;
}
...
#define bfd_cgc32_bfd_reloc_type_lookup reloc_type_lookup
#define bfd_cgc32_bfd_reloc_name_lookup reloc_name_lookup
#define CGC_ARCH bfd_arch_m68k
#define CGC_TARGET_ID M68K_CGC_DATA

/* Functions for the m68k CGC linker.  */
...
static const bfd_byte cgc_m68k_plt0_entry[PLT_ENTRY_SIZE] =
{
...
static const bfd_byte cgc_m68k_plt_entry[PLT_ENTRY_SIZE] =
{
...
static const struct cgc_m68k_plt_info cgc_m68k_plt_info = {
  PLT_ENTRY_SIZE,
  cgc_m68k_plt0_entry, { 4, 12 },
  cgc_m68k_plt_entry, { 4, 16 }, 8
};

#define ISAB_PLT_ENTRY_SIZE 24

static const bfd_byte cgc_isab_plt0_entry[ISAB_PLT_ENTRY_SIZE] =
{
...
static const bfd_byte cgc_isab_plt_entry[ISAB_PLT_ENTRY_SIZE] =
{
  0x20, 0x3c,             /* move.l #offset,%d0 */
...
static const struct cgc_m68k_plt_info cgc_isab_plt_info = {
  ISAB_PLT_ENTRY_SIZE,
  cgc_isab_plt0_entry, { 2, 12 },
  cgc_isab_plt_entry, { 2, 20 }, 12
};

#define ISAC_PLT_ENTRY_SIZE 24

static const bfd_byte cgc_isac_plt0_entry[ISAC_PLT_ENTRY_SIZE] =
{
  0x20, 0x3c,		  /* move.l #offset,%d0 */
...
static const bfd_byte cgc_isac_plt_entry[ISAC_PLT_ENTRY_SIZE] =
{
  0x20, 0x3c,		  /* move.l #offset,%d0 */
...
static const struct cgc_m68k_plt_info cgc_isac_plt_info = {
  ISAC_PLT_ENTRY_SIZE,
  cgc_isac_plt0_entry, { 2, 12},
  cgc_isac_plt_entry, { 2, 20 }, 12
};

#define CPU32_PLT_ENTRY_SIZE 24
/* Procedure linkage table entries for the cpu32 */
static const bfd_byte cgc_cpu32_plt0_entry[CPU32_PLT_ENTRY_SIZE] =
{
  0x2f, 0x3b, 0x01, 0x70, /* move.l (%pc,addr),-(%sp) */
  0, 0, 0, 2,             /* + (.got + 4) - . */
...
static const bfd_byte cgc_cpu32_plt_entry[CPU32_PLT_ENTRY_SIZE] =
{
  0x22, 0x7b, 0x01, 0x70,  /* moveal %pc@(0xc), %a1 */
  0, 0, 0, 2,              /* + (.got.plt entry) - . */
  0x4e, 0xd1,              /* jmp %a1@ */
...
static const struct cgc_m68k_plt_info cgc_cpu32_plt_info = {
  CPU32_PLT_ENTRY_SIZE,
  cgc_cpu32_plt0_entry, { 4, 12 },
  cgc_cpu32_plt_entry, { 4, 18 }, 10
};
...
struct cgc_m68k_pcrel_relocs_copied
{
  /* Next section.  */
  struct cgc_m68k_pcrel_relocs_copied *next;
  /* A section in dynobj.  */
  asection *section;
...
/* Forward declaration.  */
struct cgc_m68k_got_entry;

/* m68k CGC linker hash entry.  */

struct cgc_m68k_link_hash_entry
{
  struct cgc_link_hash_entry root;

  /* Number of PC relative relocs copied for this symbol.  */
  struct cgc_m68k_pcrel_relocs_copied *pcrel_relocs_copied;

  /* Key to got_entries.  */
  unsigned long got_entry_key;

  /* List of GOT entries for this symbol.  This list is build during
     offset finalization and is used within cgc_m68k_finish_dynamic_symbol
  ...
  struct cgc_m68k_got_entry *glist;
};

#define cgc_m68k_hash_entry(ent) ((struct cgc_m68k_link_hash_entry *) (ent))

/* Key part of GOT entry in hashtable.  */
struct cgc_m68k_got_entry_key
{
  ...
  /* Type is one of R_68K_GOT{8, 16, 32}O, R_68K_TLS_GD{8, 16, 32},
     ...
     From perspective of hashtable key, only cgc_m68k_got_reloc_type (type)
  ...
  enum cgc_m68k_reloc_type type;
};

/* Size of the GOT offset suitable for relocation.  */
enum cgc_m68k_got_offset_size { R_8, R_16, R_32, R_LAST };

/* Entry of the GOT.  */
struct cgc_m68k_got_entry
{
  /* GOT entries are put into a got->entries hashtable.  This is the key.  */
  struct cgc_m68k_got_entry_key key_;
  ...
  union
  {
    struct
    {
	 ...
	 filter out unnecessary GOT slots in cgc_m68k_gc_sweep_hook.  */
      bfd_vma refcount;
    } s1;
    ...
    struct
    {
	 ...
	 NULL for local symbols.  */
      struct cgc_m68k_got_entry *next;
    } s2;
  } u;
};
...
static enum cgc_m68k_reloc_type
cgc_m68k_reloc_got_type (enum cgc_m68k_reloc_type r_type)
{
  switch (r_type)
    {
...
static enum cgc_m68k_got_offset_size
cgc_m68k_reloc_got_offset_size (enum cgc_m68k_reloc_type r_type)
{
  switch (r_type)
    {
...
static bfd_vma
cgc_m68k_reloc_got_n_slots (enum cgc_m68k_reloc_type r_type)
{
  switch (cgc_m68k_reloc_got_type (r_type))
    {
    case R_68K_GOT32O:
    case R_68K_TLS_IE32:
      return 1;
...
static bfd_boolean
cgc_m68k_reloc_tls_p (enum cgc_m68k_reloc_type r_type)
{
  switch (r_type)
    {
...
struct cgc_m68k_got
{
  /* Hashtable of 'struct cgc_m68k_got_entry's.
  ...
  /* Number of local (entry->key_.h == NULL) slots in this GOT.
     ...
     see cgc_m68k_partition_multi_got.  */
...
struct cgc_m68k_bfd2got_entry
{
  ...
  /* Assigned GOT.  Before partitioning multi-GOT each BFD has its own
     ...
     share a single GOT.  */
  struct cgc_m68k_got *got;
};

/* The main data structure holding all the pieces.  */
struct cgc_m68k_multi_got
{
...
/* m68k CGC linker hash table.  */

struct cgc_m68k_link_hash_table
{
  ...
  /* The PLT format used by this link, or NULL if the format has not
     yet been chosen.  */
  const struct cgc_m68k_plt_info *plt_info;
  ...
  struct cgc_m68k_multi_got multi_got_;
};

/* Get the m68k CGC linker hash table from a link_info structure.  */

#define cgc_m68k_hash_table(p) \
  (cgc_hash_table_id ((struct cgc_link_hash_table *) ((p)->hash)) \
  == M68K_CGC_DATA ? ((struct cgc_m68k_link_hash_table *) ((p)->hash)) : NULL)

/* Shortcut to multi-GOT data.  */
#define cgc_m68k_multi_got(INFO) (&cgc_m68k_hash_table (INFO)->multi_got_)

/* Create an entry in an m68k CGC linker hash table.  */

static struct bfd_hash_entry *
cgc_m68k_link_hash_newfunc (struct bfd_hash_entry *entry,
			    ...
			    const char *string)
{
  ...
  if (ret == NULL)
    ret = bfd_hash_allocate (table,
			     sizeof (struct cgc_m68k_link_hash_entry));
  if (ret == NULL)
    return ret;

  /* Call the allocation method of the superclass.  */
  ret = _bfd_cgc_link_hash_newfunc (ret, table, string);
  if (ret != NULL)
    {
      cgc_m68k_hash_entry (ret)->pcrel_relocs_copied = NULL;
      cgc_m68k_hash_entry (ret)->got_entry_key = 0;
      cgc_m68k_hash_entry (ret)->glist = NULL;
    }

  return ret;
}

/* Create an m68k CGC linker hash table.  */

static struct bfd_link_hash_table *
cgc_m68k_link_hash_table_create (bfd *abfd)
{
  struct cgc_m68k_link_hash_table *ret;
  bfd_size_type amt = sizeof (struct cgc_m68k_link_hash_table);

  ret = (struct cgc_m68k_link_hash_table *) bfd_zmalloc (amt);
  if (ret == (struct cgc_m68k_link_hash_table *) NULL)
    return NULL;

  if (!_bfd_cgc_link_hash_table_init (&ret->root, abfd,
				      cgc_m68k_link_hash_newfunc,
				      sizeof (struct cgc_m68k_link_hash_entry),
				      M68K_CGC_DATA))
    {
      free (ret);
...
static void
cgc_m68k_link_hash_table_free (struct bfd_link_hash_table *_htab)
{
  struct cgc_m68k_link_hash_table *htab;

  htab = (struct cgc_m68k_link_hash_table *) _htab;
  ...
  _bfd_cgc_link_hash_table_free (_htab);
}

/* Set the right machine number.  */

static bfd_boolean
cgc32_m68k_object_p (bfd *abfd)
{
  unsigned int mach = 0;
  unsigned features = 0;
  flagword eflags = cgc_cgcheader (abfd)->e_flags;
...
/* Somewhat reverse of cgc32_m68k_object_p, this sets the e_flag
   field based on the machine number.  */

static void
cgc_m68k_final_write_processing (bfd *abfd,
				 bfd_boolean linker ATTRIBUTE_UNUSED)
{
  int mach = bfd_get_mach (abfd);
  unsigned long e_flags = cgc_cgcheader (abfd)->e_flags;
  ...
  if (!e_flags)
      ...
      else
	{
      ...
      cgc_cgcheader (abfd)->e_flags = e_flags;
    }
}

/* Keep m68k-specific flags in the CGC header.  */

static bfd_boolean
cgc32_m68k_set_private_flags (bfd *abfd, flagword flags)
{
...
static bfd_boolean
cgc32_m68k_merge_private_bfd_data (bfd *ibfd, bfd *obfd)
{
  flagword out_flags;
  flagword in_flags;
  flagword out_isa;
  ...
  cgc_cgcheader (obfd)->e_flags = out_flags;
...
static bfd_boolean
cgc32_m68k_print_private_bfd_data (bfd *abfd, void * ptr)
{
  FILE *file = (FILE *) ptr;
  flagword eflags = cgc_cgcheader (abfd)->e_flags;
...
/* Multi-GOT support implementation design:
   ...
   relocations of a BFD and build a local GOT (struct cgc_m68k_got)
   ...
   Partitioning is done in cgc_m68k_partition_multi_got.  We start with
   ...
   After that we get to cgc_m68k_relocate_section.  There we
   ...
   * R_32 type is used in all other cases.  We can have as many
   ...
   cgc_hash_table (info)->dynobj bfd (for this reason we pass 'info'
   ...
   cgc_m68k_multi_got (info).  We deallocate them in
   cgc_m68k_link_hash_table_free.  */

/* Initialize GOT.  */

static void
cgc_m68k_init_got (struct cgc_m68k_got *got)
{
  got->entries = NULL;
  got->n_slots[R_8] = 0;
  got->n_slots[R_16] = 0;
...
static void
cgc_m68k_clear_got (struct cgc_m68k_got *got)
{
  if (got->entries != NULL)
    {
...
static struct cgc_m68k_got *
cgc_m68k_create_empty_got (struct bfd_link_info *info)
{
  struct cgc_m68k_got *got;

  got = bfd_alloc (cgc_hash_table (info)->dynobj, sizeof (*got));
  if (got == NULL)
    return NULL;

  cgc_m68k_init_got (got);
...
static void
cgc_m68k_init_got_entry_key (struct cgc_m68k_got_entry_key *key,
			     struct cgc_link_hash_entry *h,
			     const bfd *abfd, unsigned long symndx,
			     enum cgc_m68k_reloc_type reloc_type)
{
  if (cgc_m68k_reloc_got_type (reloc_type) == R_68K_TLS_LDM32)
    ...
    {
      key->bfd = NULL;
      key->symndx = cgc_m68k_hash_entry (h)->got_entry_key;
...
static hashval_t
cgc_m68k_got_entry_hash (const void *_entry)
{
  const struct cgc_m68k_got_entry_key *key;

  key = &((const struct cgc_m68k_got_entry *) _entry)->key_;

  return (key->symndx
	  + (key->bfd != NULL ? (int) key->bfd->id : -1)
	  + cgc_m68k_reloc_got_type (key->type));
}

/* Check if two got entries are equal.  */

static int
cgc_m68k_got_entry_eq (const void *_entry1, const void *_entry2)
{
  const struct cgc_m68k_got_entry_key *key1;
  const struct cgc_m68k_got_entry_key *key2;

  key1 = &((const struct cgc_m68k_got_entry *) _entry1)->key_;
  key2 = &((const struct cgc_m68k_got_entry *) _entry2)->key_;

  return (key1->bfd == key2->bfd
	  && key1->symndx == key2->symndx
	  && (cgc_m68k_reloc_got_type (key1->type)
	      == cgc_m68k_reloc_got_type (key2->type)));
}
...
#define CGC_M68K_R_8_MAX_N_SLOTS_IN_GOT(INFO)		\
  (cgc_m68k_hash_table (INFO)->use_neg_got_offsets_p		\
   ? (0x40 - 1)							\
   : 0x20)

/* Maximal number of R_8 and R_16 slots in a single GOT.  */
#define CGC_M68K_R_8_16_MAX_N_SLOTS_IN_GOT(INFO)		\
  (cgc_m68k_hash_table (INFO)->use_neg_got_offsets_p		\
   ? (0x4000 - 2)						\
   : 0x2000)
...
static struct cgc_m68k_got_entry *
cgc_m68k_get_got_entry (struct cgc_m68k_got *got,
			const struct cgc_m68k_got_entry_key *key,
			enum cgc_m68k_get_entry_howto howto,
			struct bfd_link_info *info)
{
  struct cgc_m68k_got_entry entry_;
  struct cgc_m68k_got_entry *entry;
  void **ptr;
  ...
  if (got->entries == NULL)
	...
	return NULL;
      ...
      got->entries = htab_try_create (CGC_M68K_R_8_MAX_N_SLOTS_IN_GOT
				      (info),
				      cgc_m68k_got_entry_hash,
				      cgc_m68k_got_entry_eq, NULL);
      if (got->entries == NULL)
	{
  ...
  if (*ptr == NULL)
    /* We didn't find the entry and we're asked to create a new one.  */
    {
      ...
      entry = bfd_alloc (cgc_hash_table (info)->dynobj, sizeof (*entry));
      if (entry == NULL)
	return NULL;
...
static enum cgc_m68k_reloc_type
cgc_m68k_update_got_entry_type (struct cgc_m68k_got *got,
				enum cgc_m68k_reloc_type was,
				enum cgc_m68k_reloc_type new_reloc)
{
  enum cgc_m68k_got_offset_size was_size;
  enum cgc_m68k_got_offset_size new_size;
  bfd_vma n_slots;
  ...
  if (was == R_68K_max)
  ...
  else
    {
	 ...
	 in such a case.  */
      BFD_ASSERT (cgc_m68k_reloc_got_type (was)
		  == cgc_m68k_reloc_got_type (new_reloc));

      was_size = cgc_m68k_reloc_got_offset_size (was);
    }

  new_size = cgc_m68k_reloc_got_offset_size (new_reloc);
  n_slots = cgc_m68k_reloc_got_n_slots (new_reloc);
...
static void
cgc_m68k_remove_got_entry_type (struct cgc_m68k_got *got,
				enum cgc_m68k_reloc_type type)
{
  enum cgc_m68k_got_offset_size os;
  bfd_vma n_slots;

  n_slots = cgc_m68k_reloc_got_n_slots (type);

  /* Decrese counter of slots with offset size corresponding to TYPE
     and all greater offset sizes.  */
  for (os = cgc_m68k_reloc_got_offset_size (type); os <= R_32; ++os)
    {
...
static struct cgc_m68k_got_entry *
cgc_m68k_add_entry_to_got (struct cgc_m68k_got *got,
			   struct cgc_link_hash_entry *h,
			   const bfd *abfd,
			   enum cgc_m68k_reloc_type reloc_type,
			   unsigned long symndx,
			   struct bfd_link_info *info)
{
  ...
  if (h != NULL && cgc_m68k_hash_entry (h)->got_entry_key == 0)
    cgc_m68k_hash_entry (h)->got_entry_key
      = cgc_m68k_multi_got (info)->global_symndx++;

  cgc_m68k_init_got_entry_key (&key_, h, abfd, symndx, reloc_type);

  entry = cgc_m68k_get_got_entry (got, &key_, FIND_OR_CREATE, info);
  if (entry == NULL)
    return NULL;

  /* Determine entry's type and update got->n_slots counters.  */
  entry->key_.type = cgc_m68k_update_got_entry_type (got,
						     entry->key_.type,
						     reloc_type);
  ...
  if (entry->u.s1.refcount == 1)
	...
	got->local_n_slots += cgc_m68k_reloc_got_n_slots (entry->key_.type);
    }

  BFD_ASSERT (got->n_slots[R_32] >= got->local_n_slots);

  if ((got->n_slots[R_8]
       > CGC_M68K_R_8_MAX_N_SLOTS_IN_GOT (info))
      || (got->n_slots[R_16]
	  > CGC_M68K_R_8_16_MAX_N_SLOTS_IN_GOT (info)))
    /* This BFD has too many relocation.  */
    {
      if (got->n_slots[R_8] > CGC_M68K_R_8_MAX_N_SLOTS_IN_GOT (info))
...
static hashval_t
cgc_m68k_bfd2got_entry_hash (const void *entry)
{
  const struct cgc_m68k_bfd2got_entry *e;

  e = (const struct cgc_m68k_bfd2got_entry *) entry;
...
static int
cgc_m68k_bfd2got_entry_eq (const void *entry1, const void *entry2)
{
  const struct cgc_m68k_bfd2got_entry *e1;
  const struct cgc_m68k_bfd2got_entry *e2;

  e1 = (const struct cgc_m68k_bfd2got_entry *) entry1;
  e2 = (const struct cgc_m68k_bfd2got_entry *) entry2;
...
static void
cgc_m68k_bfd2got_entry_del (void *_entry)
{
  struct cgc_m68k_bfd2got_entry *entry;

  entry = (struct cgc_m68k_bfd2got_entry *) _entry;

  BFD_ASSERT (entry->got != NULL);
  cgc_m68k_clear_got (entry->got);
}
...
static struct cgc_m68k_bfd2got_entry *
cgc_m68k_get_bfd2got_entry (struct cgc_m68k_multi_got *multi_got,
			    const bfd *abfd,
			    enum cgc_m68k_get_entry_howto howto,
			    struct bfd_link_info *info)
{
  struct cgc_m68k_bfd2got_entry entry_;
  void **ptr;
  struct cgc_m68k_bfd2got_entry *entry;
  ...
  if (multi_got->bfd2got == NULL)
	...
	return NULL;
      ...
      multi_got->bfd2got = htab_try_create (1, cgc_m68k_bfd2got_entry_hash,
					    cgc_m68k_bfd2got_entry_eq,
					    cgc_m68k_bfd2got_entry_del);
      if (multi_got->bfd2got == NULL)
	{
	  bfd_set_error (bfd_error_no_memory);
	  return NULL;
  ...
  if (*ptr == NULL)
    /* Entry was not found.  Create new one.  */
    {
      ...
      entry = ((struct cgc_m68k_bfd2got_entry *)
	       bfd_alloc (cgc_hash_table (info)->dynobj, sizeof (*entry)));
      if (entry == NULL)
	return NULL;

      entry->bfd = abfd;

      entry->got = cgc_m68k_create_empty_got (info);
      if (entry->got == NULL)
	return NULL;
...
static int
cgc_m68k_can_merge_gots_1 (void **_entry_ptr, void *_arg)
{
  const struct cgc_m68k_got_entry *entry1;
  struct cgc_m68k_can_merge_gots_arg *arg;
  const struct cgc_m68k_got_entry *entry2;
  enum cgc_m68k_reloc_type type;

  entry1 = (const struct cgc_m68k_got_entry *) *_entry_ptr;
  arg = (struct cgc_m68k_can_merge_gots_arg *) _arg;

  entry2 = cgc_m68k_get_got_entry (arg->big, &entry1->key_, SEARCH, NULL);

  if (entry2 != NULL)
    /* We found an existing entry.  Check if we should update it.  */
    {
      type = cgc_m68k_update_got_entry_type (arg->diff,
					     entry2->key_.type,
					     entry1->key_.type);
	...
	arg->diff->local_n_slots += cgc_m68k_reloc_got_n_slots (type);
    }
  ...
  if (type != R_68K_max)
    /* Create an entry in DIFF.  */
    {
      ...
      entry = cgc_m68k_get_got_entry (arg->diff, &entry1->key_, MUST_CREATE,
				      arg->info);
      if (entry == NULL)
	{
	  arg->error_p = TRUE;
...
static bfd_boolean
cgc_m68k_can_merge_gots (struct cgc_m68k_got *big,
			 const struct cgc_m68k_got *small,
			 struct bfd_link_info *info,
			 struct cgc_m68k_got *diff)
{
  struct cgc_m68k_can_merge_gots_arg arg_;
  ...
  arg_.info = info;
  arg_.error_p = FALSE;
  htab_traverse_noresize (small->entries, cgc_m68k_can_merge_gots_1, &arg_);
  if (arg_.error_p)
    {
      diff->offset = 0;
      return FALSE;
...
struct cgc_m68k_merge_gots_arg
{
  /* The BIG got.  */
  struct cgc_m68k_got *big;
...
static int
cgc_m68k_merge_gots_1 (void **entry_ptr, void *_arg)
{
  const struct cgc_m68k_got_entry *from;
  struct cgc_m68k_merge_gots_arg *arg;
  struct cgc_m68k_got_entry *to;

  from = (const struct cgc_m68k_got_entry *) *entry_ptr;
  arg = (struct cgc_m68k_merge_gots_arg *) _arg;

  to = cgc_m68k_get_got_entry (arg->big, &from->key_, FIND_OR_CREATE,
			       arg->info);
  if (to == NULL)
    {
      arg->error_p = TRUE;
...
static bfd_boolean
cgc_m68k_merge_gots (struct cgc_m68k_got *big,
		     struct cgc_m68k_got *diff,
		     struct bfd_link_info *info)
{
  if (diff->entries != NULL)
    ...
    {
      struct cgc_m68k_merge_gots_arg arg_;

      /* Merge entries.  */
      arg_.big = big;
      arg_.info = info;
      arg_.error_p = FALSE;
      htab_traverse_noresize (diff->entries, cgc_m68k_merge_gots_1, &arg_);
      if (arg_.error_p)
	return FALSE;
  ...
  BFD_ASSERT (!cgc_m68k_hash_table (info)->allow_multigot_p
	      || ((big->n_slots[R_8]
		   <= CGC_M68K_R_8_MAX_N_SLOTS_IN_GOT (info))
		  && (big->n_slots[R_16]
		      <= CGC_M68K_R_8_16_MAX_N_SLOTS_IN_GOT (info))));
...
struct cgc_m68k_finalize_got_offsets_arg
{
  ...
  struct cgc_m68k_link_hash_entry **symndx2h;
...
static int
cgc_m68k_finalize_got_offsets_1 (void **entry_ptr, void *_arg)
{
  struct cgc_m68k_got_entry *entry;
  struct cgc_m68k_finalize_got_offsets_arg *arg;

  enum cgc_m68k_got_offset_size got_offset_size;
  bfd_vma entry_size;

  entry = (struct cgc_m68k_got_entry *) *entry_ptr;
  arg = (struct cgc_m68k_finalize_got_offsets_arg *) _arg;

  /* This should be a fresh entry created in cgc_m68k_can_merge_gots.  */
  BFD_ASSERT (entry->u.s1.refcount == 0);

  /* Get GOT offset size for the entry .  */
  got_offset_size = cgc_m68k_reloc_got_offset_size (entry->key_.type);

  /* Calculate entry size in bytes.  */
  entry_size = 4 * cgc_m68k_reloc_got_n_slots (entry->key_.type);
  ...
  if (entry->key_.bfd == NULL)
    ...
    {
      struct cgc_m68k_link_hash_entry *h;
	...
	{
	  BFD_ASSERT ((cgc_m68k_reloc_got_type (entry->key_.type)
		       == R_68K_TLS_LDM32)
		      && entry->key_.symndx == 0);
...
static void
cgc_m68k_finalize_got_offsets (struct cgc_m68k_got *got,
			       bfd_boolean use_neg_got_offsets_p,
			       struct cgc_m68k_link_hash_entry **symndx2h,
			       bfd_vma *final_offset, bfd_vma *n_ldm_entries)
{
  struct cgc_m68k_finalize_got_offsets_arg arg_;
  ...
  if (!use_neg_got_offsets_p)
    /* Make sure that if we try to switch to negative offsets in
       cgc_m68k_finalize_got_offsets_1, the assert therein will catch
       the bug.  */
    for (i = R_8; i <= R_32; ++i)
  ...
  /* Assign offsets.  */
  htab_traverse (got->entries, cgc_m68k_finalize_got_offsets_1, &arg_);
...
struct cgc_m68k_partition_multi_got_arg
{
  /* The GOT we are adding entries to.  Aka big got.  */
  struct cgc_m68k_got *current_got;
...
static void
cgc_m68k_partition_multi_got_2 (struct cgc_m68k_partition_multi_got_arg *arg)
{
  bfd_vma n_ldm_entries;

  cgc_m68k_finalize_got_offsets (arg->current_got,
				 (cgc_m68k_hash_table (arg->info)
...
static int
cgc_m68k_partition_multi_got_1 (void **_entry, void *_arg)
{
  struct cgc_m68k_bfd2got_entry *entry;
  struct cgc_m68k_partition_multi_got_arg *arg;
  struct cgc_m68k_got *got;
  struct cgc_m68k_got diff_;
  struct cgc_m68k_got *diff;

  entry = (struct cgc_m68k_bfd2got_entry *) *_entry;
  arg = (struct cgc_m68k_partition_multi_got_arg *) _arg;
  ...
  if (arg->current_got != NULL)
    ...
    {
      diff = &diff_;
      cgc_m68k_init_got (diff);

      if (!cgc_m68k_can_merge_gots (arg->current_got, got, arg->info, diff))
	{
	  if (diff->offset == 0)
	  ...
	  if (cgc_m68k_hash_table (arg->info)->allow_multigot_p)
	    {
	      cgc_m68k_clear_got (diff);
    ...
    /* Diff of got against empty current_got is got itself.  */
    {
      ...
      arg->current_got = cgc_m68k_create_empty_got (arg->info);
      if (arg->current_got == NULL)
	{
	  arg->error_p = TRUE;
	  goto final_return;
  ...
  if (diff != NULL)
    {
      if (!cgc_m68k_merge_gots (arg->current_got, diff, arg->info))
	{
	  arg->error_p = TRUE;
	  goto final_return;
	}
  ...
  else
    {
      ...
      cgc_m68k_partition_multi_got_2 (arg);

      /* Schedule to start a new current_got.  */
      arg->current_got = NULL;

      /* Retry.  */
      if (!cgc_m68k_partition_multi_got_1 (_entry, _arg))
	{
...
static bfd_boolean
cgc_m68k_init_symndx2h_1 (struct cgc_link_hash_entry *_h,
			  void *_arg)
{
  struct cgc_m68k_link_hash_entry *h;

  h = cgc_m68k_hash_entry (_h);
...
static bfd_boolean
cgc_m68k_partition_multi_got (struct bfd_link_info *info)
{
  struct cgc_m68k_multi_got *multi_got;
  struct cgc_m68k_partition_multi_got_arg arg_;

  multi_got = cgc_m68k_multi_got (info);
  ...
  if (multi_got->bfd2got != NULL)
	...
	cgc_link_hash_traverse (cgc_hash_table (info),
				cgc_m68k_init_symndx2h_1, &arg_);
      }

      /* Partition.  */
      htab_traverse (multi_got->bfd2got, cgc_m68k_partition_multi_got_1,
		     &arg_);
      if (arg_.error_p)
	{
	  free (arg_.symndx2h);
      ...
      cgc_m68k_partition_multi_got_2 (&arg_);

      free (arg_.symndx2h);
    }

  if (cgc_hash_table (info)->dynobj != NULL)
    /* Set sizes of .got and .rela.got sections.  */
    {
      asection *s;

      s = bfd_get_linker_section (cgc_hash_table (info)->dynobj, ".got");
      if (s != NULL)
	s->size = arg_.offset;
      else
	BFD_ASSERT (arg_.offset == 0);
      ...
      s = bfd_get_linker_section (cgc_hash_table (info)->dynobj, ".rela.got");
      if (s != NULL)
	s->size = arg_.n_slots * sizeof (Cgc32_External_Rela);
      else
...
/* Specialized version of cgc_m68k_get_got_entry that returns pointer
   to hashtable slot, thus allowing removal of entry via
   cgc_m68k_remove_got_entry.  */

static struct cgc_m68k_got_entry **
cgc_m68k_find_got_entry_ptr (struct cgc_m68k_got *got,
			     struct cgc_m68k_got_entry_key *key)
{
  void **ptr;
  struct cgc_m68k_got_entry entry_;
  struct cgc_m68k_got_entry **entry_ptr;

  entry_.key_ = *key;
  ptr = htab_find_slot (got->entries, &entry_, NO_INSERT);
  BFD_ASSERT (ptr != NULL);

  entry_ptr = (struct cgc_m68k_got_entry **) ptr;
...
static void
cgc_m68k_remove_got_entry (struct cgc_m68k_got *got,
			   struct cgc_m68k_got_entry **entry_ptr)
{
  struct cgc_m68k_got_entry *entry;
  ...
  cgc_m68k_remove_got_entry_type (got, entry->key_.type);
...
static void
cgc_m68k_copy_indirect_symbol (struct bfd_link_info *info,
			       struct cgc_link_hash_entry *_dir,
			       struct cgc_link_hash_entry *_ind)
{
  struct cgc_m68k_link_hash_entry *dir;
  struct cgc_m68k_link_hash_entry *ind;

  _bfd_cgc_link_hash_copy_indirect (info, _dir, _ind);

  if (_ind->root.type != bfd_link_hash_indirect)
    return;

  dir = cgc_m68k_hash_entry (_dir);
  ind = cgc_m68k_hash_entry (_ind);
...
static bfd_boolean
cgc_m68k_check_relocs (bfd *abfd,
		       struct bfd_link_info *info,
		       asection *sec,
		       const Cgc_Internal_Rela *relocs)
{
  ...
  for (rel = relocs; rel < rel_end; rel++)
	...
	case R_68K_TLS_DTPREL32:
	  ...
	  if (CGC32_R_TYPE (rel->r_info) == R_68K_TLS_TPREL32
	      && info->shared)
	  ...
	  if (got == NULL)
	    {
	      struct cgc_m68k_bfd2got_entry *bfd2got_entry;

	      bfd2got_entry
		= cgc_m68k_get_bfd2got_entry (cgc_m68k_multi_got (info),
	  ...
	  {
	    struct cgc_m68k_got_entry *got_entry;

	    /* Add entry to got.  */
	    got_entry = cgc_m68k_add_entry_to_got (got, h, abfd,
						   CGC32_R_TYPE (rel->r_info),
						   r_symndx, info);
	    if (got_entry == NULL)
	      return FALSE;
	...
	case R_68K_32:
	  ...
	  if (info->shared)
	      ...
	      if (sreloc == NULL)
		{
		  ...
		  && !(CGC32_R_TYPE (rel->r_info) == R_68K_PC8
		       || CGC32_R_TYPE (rel->r_info) == R_68K_PC16
		       || CGC32_R_TYPE (rel->r_info) == R_68K_PC32))
		    info->flags |= DF_TEXTREL;

	      sreloc->size += sizeof (Cgc32_External_Rela);
		 ...
		 function is only called if we are using an m68kcgc linker
		 hash table, which means that h is really a pointer to an
		 cgc_m68k_link_hash_entry.  */
	      if (CGC32_R_TYPE (rel->r_info) == R_68K_PC8
		  || CGC32_R_TYPE (rel->r_info) == R_68K_PC16
		  || CGC32_R_TYPE (rel->r_info) == R_68K_PC32)
		{
		  struct cgc_m68k_pcrel_relocs_copied *p;
		  struct cgc_m68k_pcrel_relocs_copied **head;

		  if (h != NULL)
		    {
		      struct cgc_m68k_link_hash_entry *eh
			= cgc_m68k_hash_entry (h);
		  ...
		  else
		    {
		      ...
		      isym = bfd_sym_from_r_symndx (&cgc_m68k_hash_table (info)->sym_cache,
						    abfd, r_symndx);
		      if (isym == NULL)
			return FALSE;
			...
			s = sec;
		      ...
		      head = (struct cgc_m68k_pcrel_relocs_copied **) vpp;
		    }
		  ...
		  if (p == NULL)
		    {
		      p = ((struct cgc_m68k_pcrel_relocs_copied *)
...
static asection *
cgc_m68k_gc_mark_hook (asection *sec,
		       struct bfd_link_info *info,
...
static bfd_boolean
cgc_m68k_gc_sweep_hook (bfd *abfd,
			struct bfd_link_info *info,
			asection *sec,
			const Cgc_Internal_Rela *relocs)
{
  ...
  for (rel = relocs; rel < relend; rel++)
	...
	case R_68K_TLS_DTPREL32:
	  ...
	  if (got == NULL)
	    {
	      got = cgc_m68k_get_bfd2got_entry (cgc_m68k_multi_got (info),
	  ...
	  {
	    struct cgc_m68k_got_entry_key key_;
	    struct cgc_m68k_got_entry **got_entry_ptr;
	    struct cgc_m68k_got_entry *got_entry;

	    cgc_m68k_init_got_entry_key (&key_, h, abfd, r_symndx,
					 CGC32_R_TYPE (rel->r_info));
	    got_entry_ptr = cgc_m68k_find_got_entry_ptr (got, &key_);
		...
		if (got_entry->u.s1.refcount == 0)
		  ...
		  cgc_m68k_remove_got_entry (got, got_entry_ptr);
	      }
	  }
	  break;
...
static const struct cgc_m68k_plt_info *
cgc_m68k_get_plt_info (bfd *output_bfd)
{
  unsigned int features;

  features = bfd_m68k_mach_to_features (bfd_get_mach (output_bfd));
  if (features & cpu32)
    return &cgc_cpu32_plt_info;
  if (features & mcfisa_b)
    return &cgc_isab_plt_info;
  if (features & mcfisa_c)
    return &cgc_isac_plt_info;
  return &cgc_m68k_plt_info;
}
...
static bfd_boolean
cgc_m68k_always_size_sections (bfd *output_bfd, struct bfd_link_info *info)
{
  /* Bind input BFDs to GOTs and calculate sizes of .got and .rela.got
     sections.  */
  if (!cgc_m68k_partition_multi_got (info))
    return FALSE;

  cgc_m68k_hash_table (info)->plt_info = cgc_m68k_get_plt_info (output_bfd);
  return TRUE;
}
...
static bfd_boolean
cgc_m68k_adjust_dynamic_symbol (struct bfd_link_info *info,
				struct cgc_link_hash_entry *h)
{
  struct cgc_m68k_link_hash_table *htab;
  bfd *dynobj;
  ...
  if (h->type == STT_FUNC
	  ...
	  && !h->def_regular)
	{
	 ...
	 will be placed in the .got section by the linker script.  */
      ...
      BFD_ASSERT (s != NULL);
      s->size += sizeof (Cgc32_External_Rela);
...
static bfd_boolean
cgc_m68k_size_dynamic_sections (bfd *output_bfd ATTRIBUTE_UNUSED,
				struct bfd_link_info *info)
{
  bfd *dynobj;
  asection *s;
  ...
  if (cgc_hash_table (info)->dynamic_sections_created)
    {
	 ...
	 values later, in cgc_m68k_finish_dynamic_sections, but we
...
/* This function is called via cgc_link_hash_traverse if we are
...
static bfd_boolean
cgc_m68k_discard_copies (struct cgc_link_hash_entry *h,
			 void * inf)
{
  struct bfd_link_info *info = (struct bfd_link_info *) inf;
  struct cgc_m68k_pcrel_relocs_copied *s;
  ...
  if (!SYMBOL_CALLS_LOCAL (info, h))
      ...
      if ((info->flags & DF_TEXTREL) == 0)
	{
	  ...
	  for (s = cgc_m68k_hash_entry (h)->pcrel_relocs_copied;
	       s != NULL;
	       s = s->next)
  ...
  for (s = cgc_m68k_hash_entry (h)->pcrel_relocs_copied;
       s != NULL;
       s = s->next)
    s->section->size -= s->count * sizeof (Cgc32_External_Rela);
...
static void
cgc_m68k_install_rela (bfd *output_bfd,
		       asection *srela,
		       Cgc_Internal_Rela *rela)
{
  ...
  loc = srela->contents;
  loc += srela->reloc_count++ * sizeof (Cgc32_External_Rela);
...
/* Output necessary relocation to handle a symbol during static link.
   This function is called from cgc_m68k_relocate_section.  */

static void
cgc_m68k_init_got_entry_static (struct bfd_link_info *info,
				bfd *output_bfd,
				enum cgc_m68k_reloc_type r_type,
				asection *sgot,
...
/* Output necessary relocation to handle a local symbol
   during dynamic link.
   This function is called either from cgc_m68k_relocate_section
   or from cgc_m68k_finish_dynamic_symbol.  */

static void
cgc_m68k_init_got_entry_local_shared (struct bfd_link_info *info,
				      bfd *output_bfd,
				      enum cgc_m68k_reloc_type r_type,
				      asection *sgot,
				      bfd_vma got_entry_offset,
				      ...
				      asection *srela)
{
  ...
  switch (cgc_m68k_reloc_got_type (r_type))
    ...
    case R_68K_GOT32O:
	 ...
	 at run-time.  */
      outrel.r_info = CGC32_R_INFO (0, R_68K_RELATIVE);
    ...
    case R_68K_TLS_LDM32:
	 ...
	 create a relocation for it.  */
      outrel.r_info = CGC32_R_INFO (0, R_68K_TLS_DTPMOD32);
      outrel.r_addend = 0;
      break;
    ...
    case R_68K_TLS_IE32:
	 ...
	 at run-time.  */
      outrel.r_info = CGC32_R_INFO (0, R_68K_TLS_TPREL32);
      outrel.r_addend = relocation - cgc_hash_table (info)->tls_sec->vma;
      break;
  ...
  cgc_m68k_install_rela (output_bfd, srela, &outrel);

  bfd_put_32 (output_bfd, outrel.r_addend, sgot->contents + got_entry_offset);
}

/* Relocate an M68K CGC section.  */

static bfd_boolean
cgc_m68k_relocate_section (bfd *output_bfd,
			   struct bfd_link_info *info,
			   bfd *input_bfd,
  ...
  for (; rel < relend; rel++)
	...
	case R_68K_GOT32:
	  ...
	  if (h != NULL
	      && strcmp (h->root.root.string, "_GLOBAL_OFFSET_TABLE_") == 0)
	    {
	      if (cgc_m68k_hash_table (info)->local_gp_p)
		{
	...
	case R_68K_TLS_IE32:
...

	  {
	    ...
	    cgc_m68k_init_got_entry_key (&key_, h, input_bfd, r_symndx,
					 r_type);
	    off_ptr = &cgc_m68k_get_got_entry (got, &key_, MUST_FIND,
					       NULL)->u.s2.offset;
	    off = *off_ptr;
		...
		if (h != NULL
		    /* @TLSLDM relocations are bounded to the module, in
		       ...
		       itself.  */
		    && cgc_m68k_reloc_got_type (r_type) != R_68K_TLS_LDM32)
		  {
		    bfd_boolean dyn;
			...
			cgc_m68k_init_got_entry_static (info,
							output_bfd,
							r_type,
							sgot,
							off,
		  ...
		  /* Process local symbol during dynamic link.  */
		  {
		    ...
		    cgc_m68k_init_got_entry_local_shared (info,
							  output_bfd,
							  r_type,
							  sgot,
							  off,
	    ...
	    /* We don't use cgc_m68k_reloc_got_type in the condition below
		...
		|| r_type == R_68K_GOT16O
		|| r_type == R_68K_GOT8O
		|| cgc_m68k_reloc_got_type (r_type) == R_68K_TLS_GD32
		|| cgc_m68k_reloc_got_type (r_type) == R_68K_TLS_LDM32
		|| cgc_m68k_reloc_got_type (r_type) == R_68K_TLS_IE32)
	      {
		/* GOT pointer is adjusted to point to the start/middle
		   of local GOT.  Adjust the offset accordingly.  */
		BFD_ASSERT (cgc_m68k_hash_table (info)->use_neg_got_offsets_p
			    || off >= got->offset);
	      ...
	      || h->root.type == bfd_link_hash_defweak))
	{
	  ...
	  sym_type = (sym != NULL) ? CGC32_ST_TYPE (sym->st_info) : h->type;

	  if (cgc_m68k_reloc_tls_p (r_type) != (sym_type == STT_TLS))
	    {
	      const char *name;
...
static void
cgc_m68k_install_pc32 (asection *sec, bfd_vma offset, bfd_vma value)
{
...
static bfd_boolean
cgc_m68k_finish_dynamic_symbol (bfd *output_bfd,
				struct bfd_link_info *info,
				struct cgc_link_hash_entry *h,
				Cgc_Internal_Sym *sym)
{
  ...
  if (h->plt.offset != (bfd_vma) -1)
    {
	 ...
	 it up.  */
      ...
      plt_info = cgc_m68k_hash_table (info)->plt_info;
      splt = bfd_get_linker_section (dynobj, ".plt");
	 ...
	 The first three are reserved.  */
      ...
      cgc_m68k_install_pc32 (splt, h->plt.offset + plt_info->symbol_relocs.got,
			     (sgot->output_section->vma
			      + sgot->output_offset
			      + got_offset));

      bfd_put_32 (output_bfd, plt_index * sizeof (Cgc32_External_Rela),
		  splt->contents
		  + h->plt.offset
		  + plt_info->symbol_resolve_entry + 2);

      cgc_m68k_install_pc32 (splt, h->plt.offset + plt_info->symbol_relocs.plt,
      ...
      rela.r_offset = (sgot->output_section->vma
		       + sgot->output_offset
		       + got_offset);
      rela.r_info = CGC32_R_INFO (h->dynindx, R_68K_JMP_SLOT);
      rela.r_addend = 0;
      loc = srela->contents + plt_index * sizeof (Cgc32_External_Rela);
      bfd_cgc32_swap_reloca_out (output_bfd, &rela, loc);
  ...
  if (cgc_m68k_hash_entry (h)->glist != NULL)
    {
      asection *sgot;
      asection *srela;
      struct cgc_m68k_got_entry *got_entry;
	 ...
	 up.  */
      ...
      got_entry = cgc_m68k_hash_entry (h)->glist;
      ...
      while (got_entry != NULL)
	{
	  ...
	  if (info->shared
		...
		n_slots = cgc_m68k_reloc_got_n_slots (got_entry->key_.type);
		while (n_slots--)
		...
		{
		case R_68K_GOT32O:
		  rela.r_info = CGC32_R_INFO (h->dynindx, R_68K_GLOB_DAT);
		  cgc_m68k_install_rela (output_bfd, srela, &rela);
		  break;

		case R_68K_TLS_GD32:
		  rela.r_info = CGC32_R_INFO (h->dynindx, R_68K_TLS_DTPMOD32);
		  cgc_m68k_install_rela (output_bfd, srela, &rela);

		  rela.r_offset += 4;
		  rela.r_info = CGC32_R_INFO (h->dynindx, R_68K_TLS_DTPREL32);
		  cgc_m68k_install_rela (output_bfd, srela, &rela);
		  break;

		case R_68K_TLS_IE32:
		  rela.r_info = CGC32_R_INFO (h->dynindx, R_68K_TLS_TPREL32);
		  cgc_m68k_install_rela (output_bfd, srela, &rela);
		  break;
  ...
  if (h->needs_copy)
    {
      ...
      rela.r_info = CGC32_R_INFO (h->dynindx, R_68K_COPY);
      rela.r_addend = 0;
...
static bfd_boolean
cgc_m68k_finish_dynamic_sections (bfd *output_bfd, struct bfd_link_info *info)
{
  bfd *dynobj;
  asection *sgot;
  asection *sdyn;
  ...
  if (cgc_hash_table (info)->dynamic_sections_created)
      ...
      if (splt->size > 0)
	{
	  ...
	  cgc_m68k_install_pc32 (splt, plt_info->plt0_relocs.got4,
				 (sgot->output_section->vma
				  + sgot->output_offset
				  + 4));

	  cgc_m68k_install_pc32 (splt, plt_info->plt0_relocs.got8,
				 (sgot->output_section->vma
				  + sgot->output_offset
				  + 8));
...
bfd_boolean
bfd_m68k_cgc32_create_embedded_relocs (abfd, info, datasec, relsec, errmsg)
     bfd *abfd;
     struct bfd_link_info *info;
     asection *datasec;
     asection *relsec;
     char **errmsg;
{
  ...
  *errmsg = NULL;
  ...
  internal_relocs = (_bfd_cgc_link_read_relocs
		     (abfd, datasec, NULL, (Cgc_Internal_Rela *) NULL,
		      info->keep_memory));
  ...
  for (irel = internal_relocs; irel < irelend; irel++, p += 12)
    {
      ...
      if (CGC32_R_TYPE (irel->r_info) != (int) R_68K_32)
	{
      ...
      if (CGC32_R_SYM (irel->r_info) < symtab_hdr->sh_info)
	{
	  ...
	  targetsec = bfd_section_from_cgc_index (abfd, isym->st_shndx);
	}
      else
	{
	  unsigned long indx;
  ...
  if (isymbuf != NULL && symtab_hdr->contents != (unsigned char *) isymbuf)
    free (isymbuf);
  if (internal_relocs != NULL
      && cgc_section_data (datasec)->relocs != internal_relocs)
...
void
bfd_cgc_m68k_set_target_options (struct bfd_link_info *info, int got_handling)
{
  struct cgc_m68k_link_hash_table *htab;
  bfd_boolean use_neg_got_offsets_p;
  bfd_boolean allow_multigot_p;
...
cgc32_m68k_reloc_type_class (const struct bfd_link_info *info ATTRIBUTE_UNUSED,
...
static bfd_vma
cgc_m68k_plt_sym_val (bfd_vma i, const asection *plt,
		      const arelent *rel ATTRIBUTE_UNUSED)
{
  return plt->vma + (i + 1) * cgc_m68k_get_plt_info (plt->owner)->size;
}

/* Support for core dump NOTE sections.  */

static bfd_boolean
cgc_m68k_grok_prstatus (bfd *abfd, Cgc_Internal_Note *note)
{
  int offset;
  size_t size;
  ...
  switch (note->descsz)
    ...
    case 154:		/* Linux/m68k */
      ...
      /* pr_pid */
      cgc_tdata (abfd)->core->lwpid = bfd_get_32 (abfd, note->descdata + 22);
...
static bfd_boolean
cgc_m68k_grok_psinfo (bfd *abfd, Cgc_Internal_Note *note)
{
  switch (note->descsz)
    {
    default:
    ...
    case 124:		/* Linux/m68k cgc_prpsinfo.  */
...
#define TARGET_BIG_SYM			bfd_cgc32_m68k_vec
#define TARGET_BIG_NAME			"cgc32-m68k"
#define CGC_MACHINE_CODE		EM_68K
#define CGC_MAXPAGESIZE			0x2000
#define cgc_backend_create_dynamic_sections \
					_bfd_cgc_create_dynamic_sections
#define bfd_cgc32_bfd_link_hash_table_create \
					cgc_m68k_link_hash_table_create
/* ??? Should it be this macro or bfd_cgcNN_bfd_link_hash_table_create?  */
#define bfd_cgc32_bfd_link_hash_table_free \
					cgc_m68k_link_hash_table_free
#define bfd_cgc32_bfd_final_link	bfd_cgc_final_link

#define cgc_backend_check_relocs	cgc_m68k_check_relocs
#define cgc_backend_always_size_sections \
					cgc_m68k_always_size_sections
#define cgc_backend_adjust_dynamic_symbol \
					cgc_m68k_adjust_dynamic_symbol
#define cgc_backend_size_dynamic_sections \
					cgc_m68k_size_dynamic_sections
#define cgc_backend_final_write_processing	cgc_m68k_final_write_processing
#define cgc_backend_init_index_section	_bfd_cgc_init_1_index_section
#define cgc_backend_relocate_section	cgc_m68k_relocate_section
#define cgc_backend_finish_dynamic_symbol \
					cgc_m68k_finish_dynamic_symbol
#define cgc_backend_finish_dynamic_sections \
					cgc_m68k_finish_dynamic_sections
#define cgc_backend_gc_mark_hook	cgc_m68k_gc_mark_hook
#define cgc_backend_gc_sweep_hook	cgc_m68k_gc_sweep_hook
#define cgc_backend_copy_indirect_symbol cgc_m68k_copy_indirect_symbol
#define bfd_cgc32_bfd_merge_private_bfd_data \
                                        cgc32_m68k_merge_private_bfd_data
#define bfd_cgc32_bfd_set_private_flags \
                                        cgc32_m68k_set_private_flags
#define bfd_cgc32_bfd_print_private_bfd_data \
                                        cgc32_m68k_print_private_bfd_data
#define cgc_backend_reloc_type_class	cgc32_m68k_reloc_type_class
#define cgc_backend_plt_sym_val		cgc_m68k_plt_sym_val
#define cgc_backend_object_p		cgc32_m68k_object_p
#define cgc_backend_grok_prstatus	cgc_m68k_grok_prstatus
#define cgc_backend_grok_psinfo		cgc_m68k_grok_psinfo
