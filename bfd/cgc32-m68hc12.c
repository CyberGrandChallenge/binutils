/* Motorola 68HC12-specific support for 32-bit CGC
...
static reloc_howto_type cgc_m68hc11_howto_table[] = {
  ...
  HOWTO (R_M68HC11_24,	        /* type */
	 ...
	 0,			/* bitpos */
	 complain_overflow_dont,	/* complain_on_overflow */
	 m68hc11_cgc_special_reloc,	/* special_function */
	 "R_M68HC12_24",	/* name */
	 FALSE,			/* partial_inplace */
	 0xffffff,		/* src_mask */
	 0xffffff,		/* dst_mask */
...
static bfd_boolean
m68hc12_cgc_build_one_stub (struct bfd_hash_entry *gen_entry, void *in_arg)
{
...
static bfd_boolean
m68hc12_cgc_size_one_stub (struct bfd_hash_entry *gen_entry,
...
/* Create a 68HC12 CGC linker hash table.  */

static struct bfd_link_hash_table *
m68hc12_cgc_bfd_link_hash_table_create (bfd *abfd)
{
  ...
  ret->size_one_stub = m68hc12_cgc_size_one_stub;
  ret->build_one_stub = m68hc12_cgc_build_one_stub;

  return &ret->root.root;
}

static bfd_boolean
m68hc12_cgc_set_mach_from_flags (bfd *abfd)
{
...
/* Specific sections:
   ...
   - The .vectors is the section that represents the interrupt
     vectors.  */
static const struct bfd_cgc_special_section cgc32_m68hc12_special_sections[] =
{
...

#define CGC_ARCH		bfd_arch_m68hc12
#define CGC_TARGET_ID		M68HC11_CGC_DATA
#define CGC_MACHINE_CODE	EM_68HC12
#define CGC_MAXPAGESIZE		0x1000

#define TARGET_BIG_SYM          bfd_cgc32_m68hc12_vec
#define TARGET_BIG_NAME		"cgc32-m68hc12"
...
#define cgc_backend_object_p		m68hc12_cgc_set_mach_from_flags
#define cgc_backend_final_write_processing	0
#define cgc_backend_can_gc_sections		1
#define cgc_backend_special_sections cgc32_m68hc12_special_sections
#define cgc_backend_post_process_headers     cgc32_m68hc11_post_process_headers
...
#define bfd_cgc32_bfd_link_hash_table_create \
                                m68hc12_cgc_bfd_link_hash_table_create
