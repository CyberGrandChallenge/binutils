  ...
  if (eiaf_vbn != 0)
    {
      ...
      unsigned int qrcgcixoff;
      unsigned int lrcgcixoff;
      ...
      qrcgcixoff = bfd_getl32 (eiaf->qrcgcixoff);
      lrcgcixoff = bfd_getl32 (eiaf->lrcgcixoff);
      fprintf (file, _("  qrcgcixoff: %5u, lrcgcixoff: %5u\n"),
               qrcgcixoff, lrcgcixoff);
      ...
      if (qrcgcixoff != 0)
        {
          ...
          evax_bfd_print_relocation_records (file, buf + qrcgcixoff, 8);
        }
      if (lrcgcixoff != 0)
        {
          fprintf (file, _(" long-word relocation fixups:\n"));
          evax_bfd_print_relocation_records (file, buf + lrcgcixoff, 4);
        }
      if (qdotadroff != 0)
        {
  ...
  if (abfd->flags & DYNAMIC)
    {
      ...
      /* We do not want to include any of the sections in a dynamic
         object in the output file.  See comment in cgclink.c.  */
...
alpha_vms_build_fixups (struct bfd_link_info *info)
{
  ...
  bfd_putl32 (0, eiaf->qrcgcixoff);
  bfd_putl32 (0, eiaf->lrcgcixoff);
