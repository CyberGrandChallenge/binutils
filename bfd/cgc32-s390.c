/* IBM S/390-specific support for 32-bit CGC
...
static reloc_howto_type cgc_howto_table[] =
{
  ...
  HOWTO(R_390_COPY,      0, 2, 32, FALSE, 0, complain_overflow_bitfield,
	bfd_cgc_generic_reloc, "R_390_COPY",     FALSE, 0,0xffffffff, FALSE),
  HOWTO(R_390_GLOB_DAT,  0, 2, 32, FALSE, 0, complain_overflow_bitfield,
	bfd_cgc_generic_reloc, "R_390_GLOB_DAT", FALSE, 0,0xffffffff, FALSE),
  HOWTO(R_390_JMP_SLOT,  0, 2, 32, FALSE, 0, complain_overflow_bitfield,
	bfd_cgc_generic_reloc, "R_390_JMP_SLOT", FALSE, 0,0xffffffff, FALSE),
  HOWTO(R_390_RELATIVE,  0, 2, 32,  TRUE, 0, complain_overflow_bitfield,
	bfd_cgc_generic_reloc, "R_390_RELATIVE", FALSE, 0,0xffffffff, FALSE),
  HOWTO(R_390_GOTOFF32,  0, 2, 32, FALSE, 0, complain_overflow_bitfield,
	bfd_cgc_generic_reloc, "R_390_GOTOFF32", FALSE, 0,0xffffffff, FALSE),
  HOWTO(R_390_GOTPC,     0, 2, 32,  TRUE, 0, complain_overflow_bitfield,
	bfd_cgc_generic_reloc, "R_390_GOTPC",    FALSE, 0,0xffffffff, TRUE),
  ...
  HOWTO(R_390_GOTPCDBL,  1, 2, 32,  TRUE, 0, complain_overflow_bitfield,
	bfd_cgc_generic_reloc, "R_390_GOTPCDBL", FALSE, 0,0xffffffff, TRUE),
  ...
  HOWTO(R_390_GOTENT,	 1, 2, 32,  TRUE, 0, complain_overflow_bitfield,
	bfd_cgc_generic_reloc, "R_390_GOTENT",   FALSE, 0,0xffffffff, TRUE),
  ...
  HOWTO(R_390_GOTPLTENT, 1, 2, 32,  TRUE, 0, complain_overflow_bitfield,
	bfd_cgc_generic_reloc, "R_390_GOTPLTENT",FALSE, 0,0xffffffff, TRUE),
  ...
  HOWTO(R_390_TLS_GD32, 0, 2, 32, FALSE, 0, complain_overflow_bitfield,
	bfd_cgc_generic_reloc, "R_390_TLS_GD32", FALSE, 0, 0xffffffff, FALSE),
  ...
  HOWTO(R_390_TLS_GOTIE32, 0, 2, 32, FALSE, 0, complain_overflow_bitfield,
	bfd_cgc_generic_reloc, "R_390_TLS_GOTIE32", FALSE, 0, 0xffffffff, FALSE),
  ...
  HOWTO(R_390_TLS_LDM32, 0, 2, 32, FALSE, 0, complain_overflow_bitfield,
	bfd_cgc_generic_reloc, "R_390_TLS_LDM32", FALSE, 0, 0xffffffff, FALSE),
  ...
  HOWTO(R_390_TLS_DTPMOD, 0, 2, 32, FALSE, 0, complain_overflow_bitfield,
	bfd_cgc_generic_reloc, "R_390_TLS_DTPMOD", FALSE, 0, 0xffffffff, FALSE),
  HOWTO(R_390_TLS_DTPOFF, 0, 2, 32, FALSE, 0, complain_overflow_bitfield,
	bfd_cgc_generic_reloc, "R_390_TLS_DTPOFF", FALSE, 0, 0xffffffff, FALSE),
  HOWTO(R_390_TLS_TPOFF, 0, 2, 32, FALSE, 0, complain_overflow_bitfield,
	bfd_cgc_generic_reloc, "R_390_TLS_TPOFF", FALSE, 0, 0xffffffff, FALSE),
  ...
  HOWTO(R_390_IRELATIVE, 0, 2, 32, TRUE, 0, complain_overflow_bitfield,
	bfd_cgc_generic_reloc, "R_390_IRELATIVE", FALSE, 0, 0xffffffff, FALSE),
...
static reloc_howto_type cgc32_s390_vtinherit_howto =
  HOWTO (R_390_GNU_VTINHERIT, 0,2,0,FALSE,0,complain_overflow_dont, NULL, "R_390_GNU_VTINHERIT", FALSE,0, 0, FALSE);
static reloc_howto_type cgc32_s390_vtentry_howto =
  HOWTO (R_390_GNU_VTENTRY, 0,2,0,FALSE,0,complain_overflow_dont, _bfd_cgc_rel_vtable_reloc_fn,"R_390_GNU_VTENTRY", FALSE,0,0, FALSE);
			    ...
			    bfd_reloc_code_real_type code)
{
  switch (code)
    ...
    case BFD_RELOC_390_TLS_GD32:
      return &cgc_howto_table[(int) R_390_TLS_GD32];
    case BFD_RELOC_390_TLS_GOTIE12:
      return &cgc_howto_table[(int) R_390_TLS_GOTIE12];
    case BFD_RELOC_390_TLS_GOTIE32:
      return &cgc_howto_table[(int) R_390_TLS_GOTIE32];
    case BFD_RELOC_390_TLS_LDM32:
      return &cgc_howto_table[(int) R_390_TLS_LDM32];
    case BFD_RELOC_390_TLS_IE32:
      return &cgc_howto_table[(int) R_390_TLS_IE32];
    case BFD_RELOC_390_TLS_IEENT:
      return &cgc_howto_table[(int) R_390_TLS_IEENT];
    case BFD_RELOC_390_TLS_LE32:
      return &cgc_howto_table[(int) R_390_TLS_LE32];
    case BFD_RELOC_390_TLS_LDO32:
      return &cgc_howto_table[(int) R_390_TLS_LDO32];
    ...
    case BFD_RELOC_VTABLE_INHERIT:
      return &cgc32_s390_vtinherit_howto;
    case BFD_RELOC_VTABLE_ENTRY:
      return &cgc32_s390_vtentry_howto;
    default:
      break;
    }
  return 0;
			    ...
			    const char *r_name)
{
  ...
  if (strcasecmp (cgc32_s390_vtinherit_howto.name, r_name) == 0)
    return &cgc32_s390_vtinherit_howto;
  if (strcasecmp (cgc32_s390_vtentry_howto.name, r_name) == 0)
    return &cgc32_s390_vtentry_howto;

  return NULL;
}

/* We need to use CGC32_R_TYPE so we have our own copy of this function,
   and cgc32-s390.c has its own copy.  */
			...
			Cgc_Internal_Rela *dst)
{
  ...
  switch (r_type)
    ...
    case R_390_GNU_VTINHERIT:
      cache_ptr->howto = &cgc32_s390_vtinherit_howto;
      break;

    case R_390_GNU_VTENTRY:
      cache_ptr->howto = &cgc32_s390_vtentry_howto;
      break;
...
static bfd_reloc_status_type
s390_cgc_ldisp_reloc (bfd *abfd ATTRIBUTE_UNUSED,
		      arelent *reloc_entry,
		      asymbol *symbol,
		      void * data ATTRIBUTE_UNUSED,
		      asection *input_section,
...
#define RELA_ENTRY_SIZE sizeof (Cgc32_External_Rela)
...
static const bfd_byte cgc_s390_plt_entry[PLT_ENTRY_SIZE] =
  {
...
static const bfd_byte cgc_s390_plt_pic_entry[PLT_ENTRY_SIZE] =
  {
    0x0d, 0x10,                             /* basr    %r1,%r0         */
    0x58, 0x10, 0x10, 0x16,                 /* l       %r1,22(%r1)     */
...
static const bfd_byte cgc_s390_plt_pic12_entry[PLT_ENTRY_SIZE] =
  {
...
/* Optimized PLT pic entry for GOT offset < 32k.  xx will be replaced
   when generating the PLT slot with the GOT offset.  */
static const bfd_byte cgc_s390_plt_pic16_entry[PLT_ENTRY_SIZE] =
  {
...
static const bfd_byte cgc_s390_plt_first_entry[PLT_FIRST_ENTRY_SIZE] =
  {
...
static const bfd_byte cgc_s390_plt_pic_first_entry[PLT_FIRST_ENTRY_SIZE] =
  {
    0x50, 0x10, 0xf0, 0x1c,                     /* st      %r1,28(%r15)  */
...
/* NOTE: Keep this structure in sync with
   the one declared in cgc64-s390.c.  */
...
static bfd_boolean
cgc_s390_create_dynamic_sections (bfd *dynobj, struct bfd_link_info *info)
{
  struct cgc_s390_link_hash_table *htab;
  ...
  for (rel = relocs; rel < rel_end; rel++)
	...
	case R_390_PC32:
	  ...
	  if ((info->shared
	       ...
	       && ((CGC32_R_TYPE (rel->r_info) != R_390_PC16
		    && CGC32_R_TYPE (rel->r_info) != R_390_PC12DBL
		    && CGC32_R_TYPE (rel->r_info) != R_390_PC16DBL
		    && CGC32_R_TYPE (rel->r_info) != R_390_PC24DBL
		    && CGC32_R_TYPE (rel->r_info) != R_390_PC32DBL
		    && CGC32_R_TYPE (rel->r_info) != R_390_PC32)
		   || (h != NULL
	      ...
	      if (p == NULL || p->sec != sec)
		{
		  ...
		  *head = p;
	      ...
	      p->count += 1;
	      if (CGC32_R_TYPE (rel->r_info) == R_390_PC16
		  || CGC32_R_TYPE (rel->r_info) == R_390_PC12DBL
		  || CGC32_R_TYPE (rel->r_info) == R_390_PC16DBL
		  || CGC32_R_TYPE (rel->r_info) == R_390_PC24DBL
		  || CGC32_R_TYPE (rel->r_info) == R_390_PC32DBL
			...
			const Cgc_Internal_Rela *relocs)
{
  ...
  for (rel = relocs; rel < relend; rel++)
	...
	{
	case R_390_TLS_LDM32:
	  if (cgc_s390_hash_table (info)->tls_ldm_got.refcount > 0)
	    cgc_s390_hash_table (info)->tls_ldm_got.refcount -= 1;
	  break;
...
allocate_dynrelocs (struct cgc_link_hash_entry *h, void * inf)
{
  ...
  if (h->got.refcount > 0
  ...
  else if (h->got.refcount > 0)
   {
	...
	htab->cgc.srelgot->size += 2 * sizeof (Cgc32_External_Rela);
  ...
  for (ibfd = info->input_bfds; ibfd != NULL; ibfd = ibfd->link_next)
      ...
      for (s = ibfd->sections; s != NULL; s = s->next)
	{
	  ...
	  for (p = cgc_section_data (s)->local_dynrel; p != NULL; p = p->next)
	      ...
	      else if (p->count != 0)
		{
		  ...
		  srela->size += p->count * sizeof (Cgc32_External_Rela);
      ...
      for (; local_got < end_local_got; ++local_got, ++local_tls_type)
	{
	  if (*local_got > 0)
		...
		s->size += GOT_ENTRY_SIZE;
	      if (info->shared)
		srela->size += sizeof (Cgc32_External_Rela);
	    }
	  else
	    *local_got = (bfd_vma) -1;
	}
	  ...
	  if (local_plt[i].plt.refcount > 0)
	    {
	      ...
	      htab->cgc.irelplt->size += RELA_ENTRY_SIZE;
	    }
	  else
		  ...
		  Cgc_Internal_Rela *rel)
{
  ...
  howto = cgc_howto_table + CGC32_R_TYPE (rel->r_info);
  (*_bfd_error_handler)
  ...
  for (; rel < relend; rel++)
		  ...
		  if (info->shared)
			...
			abort ();
		      ...
		      outrel.r_offset = (htab->cgc.sgot->output_section->vma
					 + htab->cgc.sgot->output_offset
					 + off);
		      outrel.r_info = CGC32_R_INFO (0, R_390_RELATIVE);
	...
	case R_390_PLT32:
	  ...
	  if (h->plt.offset == (bfd_vma) -1
	      || (htab->cgc.splt == NULL && htab->cgc.iplt == NULL))
	    {
	      ...
	      else
		{
		  ...
		  if (h->dynindx == -1
		      ...
		      || info->executable)
		    {
		      ...
		      outrel.r_info = CGC32_R_INFO (0, R_390_IRELATIVE);
	      ...
	      else
		{
		  ...
		  if (r_type == R_390_32)
		      ...
		      else
			{
		      ...
		      outrel.r_info = CGC32_R_INFO (sindx, r_type);
		    }
		}
	...
	emit_tls_relocs:
		...
		* sizeof (Cgc32_External_Rela);
	      ...
	      if (r_type == R_390_TLS_GD32)
		{
		  if (indx == 0)
		    ...
		    {
		      outrel.r_info = CGC32_R_INFO (indx, R_390_TLS_DTPOFF);
	  ...
	  if (r_type == CGC32_R_TYPE (rel->r_info))
	    ...
	    {
	      bfd_put_32 (output_bfd, htab->cgc.sgot->output_offset + off,
			  contents + rel->r_offset);
	      continue;
	    }
	  break;
	  ...
	  if (off & 1)
		...
		abort ();
	      ...
	      bfd_put_32 (output_bfd, 0,
			  htab->cgc.sgot->contents + off + GOT_ENTRY_SIZE);
	      outrel.r_info = CGC32_R_INFO (0, R_390_TLS_DTPMOD);
	      outrel.r_addend = 0;
	      loc = htab->cgc.srelgot->contents;
	      loc += htab->cgc.srelgot->reloc_count++
		* sizeof (Cgc32_External_Rela);
	...
	case R_390_TLS_LE32:
	  if (info->shared)
		...
		indx = 0;
	      outrel.r_info = CGC32_R_INFO (indx, R_390_TLS_TPOFF);
	      if (indx == 0)
		outrel.r_addend = relocation - dtpoff_base (info);
	      else
		outrel.r_addend = 0;
...
/* If offset is > 32768, branch to a previous branch
  ...
  if (!info->shared)
    {
      memcpy (plt->contents + iplt_offset, cgc_s390_plt_entry,
	      PLT_ENTRY_SIZE);
  ...
  if (!h
	  ...
	  && h->def_regular))
    {
      ...
      rela.r_info = CGC32_R_INFO (0, R_390_IRELATIVE);
      rela.r_addend = resolver_address;
    }
  else
    {
      rela.r_info = CGC32_R_INFO (h->dynindx, R_390_JMP_SLOT);
      rela.r_addend = 0;
    }
				...
				Cgc_Internal_Sym *sym)
{
  ...
  if (h->plt.offset != (bfd_vma) -1)
      ...
      else
	{
	  ...
	  if (!info->shared)
	    {
	      memcpy (htab->cgc.splt->contents + h->plt.offset, cgc_s390_plt_entry,
		      PLT_ENTRY_SIZE);

	      /* Adjust jump to the first plt entry.  */
	      bfd_put_32 (output_bfd, (bfd_vma) 0+(relative_offset << 16),
			  htab->cgc.splt->contents + h->plt.offset + 20);
	  ...
	  else if (got_offset < 4096)
	    {
	      /* The GOT offset is small enough to be used directly as
		 displacement.  */
	      memcpy (htab->cgc.splt->contents + h->plt.offset,
		      cgc_s390_plt_pic12_entry,
		      PLT_ENTRY_SIZE);
	  ...
	  rela.r_info = CGC32_R_INFO (h->dynindx, R_390_JMP_SLOT);
	  rela.r_addend = 0;
	  loc = htab->cgc.srelplt->contents + plt_index * sizeof (Cgc32_External_Rela);
	  bfd_cgc32_swap_reloca_out (output_bfd, &rela, loc);
  ...
  if (h->got.offset != (bfd_vma) -1
      ...
      if (h->def_regular && s390_is_ifunc_symbol_p (h))
	{
	  if (info->shared)
	  ...
	  else
	    {
		 ...
		 equality reasons.  */
	      bfd_put_32 (output_bfd, (htab->cgc.iplt->output_section->vma
				       + htab->cgc.iplt->output_offset
				       + h->plt.offset),
	  ...
	  && SYMBOL_REFERENCES_LOCAL (info, h))
	{
	  ...
	  rela.r_info = CGC32_R_INFO (0, R_390_RELATIVE);
      ...
      else
	{
	  BFD_ASSERT((h->got.offset & 1) == 0);
	do_glob_dat:
	  bfd_put_32 (output_bfd, (bfd_vma) 0, htab->cgc.sgot->contents + h->got.offset);
	  rela.r_info = CGC32_R_INFO (h->dynindx, R_390_GLOB_DAT);
	  rela.r_addend = 0;
	}

      loc = htab->cgc.srelgot->contents;
      loc += htab->cgc.srelgot->reloc_count++ * sizeof (Cgc32_External_Rela);
      bfd_cgc32_swap_reloca_out (output_bfd, &rela, loc);
    }
  ...
  if (h->needs_copy)
	...
	abort ();
      ...
      rela.r_offset = (h->root.u.def.value
		       + h->root.u.def.section->output_section->vma
		       + h->root.u.def.section->output_offset);
      rela.r_info = CGC32_R_INFO (h->dynindx, R_390_COPY);
      rela.r_addend = 0;
      loc = htab->srelbss->contents;
      loc += htab->srelbss->reloc_count++ * sizeof (Cgc32_External_Rela);
      bfd_cgc32_swap_reloca_out (output_bfd, &rela, loc);
    }
				  ...
				  struct bfd_link_info *info)
{
  ...
  if (htab->cgc.dynamic_sections_created)
	...
	{
	  memset (htab->cgc.splt->contents, 0, PLT_FIRST_ENTRY_SIZE);
	  if (info->shared)
	    {
	      memcpy (htab->cgc.splt->contents, cgc_s390_plt_pic_first_entry,
		      PLT_FIRST_ENTRY_SIZE);
	    }
	  else
	    {
	      memcpy (htab->cgc.splt->contents, cgc_s390_plt_first_entry,
		      PLT_FIRST_ENTRY_SIZE);
	      bfd_put_32 (output_bfd,
			  htab->cgc.sgotplt->output_section->vma
			  + htab->cgc.sgotplt->output_offset,
			  htab->cgc.splt->contents + 24);
	   }
  ...
  if (htab->cgc.sgotplt)
      ...
      if (htab->cgc.sgotplt->size > 0)
	{
	  ...
	  bfd_put_32 (output_bfd, (bfd_vma) 0, htab->cgc.sgotplt->contents + 4);
	  /* One entry for _dl_runtime_resolve.  */
	  bfd_put_32 (output_bfd, (bfd_vma) 0, htab->cgc.sgotplt->contents + 8);
	}

      cgc_section_data (htab->cgc.sgotplt->output_section)
	->this_hdr.sh_entsize = 4;
    }
...
static bfd_boolean
cgc_s390_grok_prstatus (bfd * abfd, Cgc_Internal_Note * note)
{
  int offset;
  unsigned int size;
...
static bfd_boolean
cgc32_s390_merge_private_bfd_data (bfd *ibfd, bfd *obfd)
{
...
#define TARGET_BIG_SYM	bfd_cgc32_s390_vec
#define TARGET_BIG_NAME	"cgc32-s390"
...
#define bfd_cgc32_bfd_is_local_label_name     cgc_s390_is_local_label_name
#define bfd_cgc32_bfd_link_hash_table_create  cgc_s390_link_hash_table_create
#define bfd_cgc32_bfd_reloc_type_lookup	      cgc_s390_reloc_type_lookup
#define bfd_cgc32_bfd_reloc_name_lookup cgc_s390_reloc_name_lookup

#define bfd_cgc32_bfd_merge_private_bfd_data  cgc32_s390_merge_private_bfd_data
