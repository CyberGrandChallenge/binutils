...
$   create build.com
$DECK
$ DEFS="""SELECT_VECS=&bfd_cgc64_ia64_vms_vec"","+-
  """SELECT_ARCHITECTURES=&bfd_ia64_arch"""
$ FILES="cpu-ia64,cgc64-ia64,cgc-strtab,corefile,stabs,merge,cgc-eh-frame,"+-
  "cgclink,cgc-attrs,dwarf1,cgc64,"
$EOD
$ create substxx.tpu
$DECK
   set (success,off);
   ...
   QUIT
$  EOD
$ write sys$output "Generate cgc64-target.h from cgcxx-target.h"
$ edit/tpu/nojournal/nosection/nodisplay/command=substxx.tpu -
        []cgcXX-target.h /output=[]cgc64-target.h
$ del substxx.tpu;*
$ endif
...
$ FILES=FILES + "archive,archive64,archures,bfd,bfdio,binary,cache,coffgen,"+-
  "compress,corefile,dwarf2,cgc,format,hash,ihex,init,libbfd,linker,"+-
