/* TILE-Gx-specific support for 32-bit CGC.
...
#define TARGET_BIG_SYM          bfd_cgc32_tilegx_be_vec
#define TARGET_BIG_NAME         "cgc32-tilegx-be"
#define TARGET_LITTLE_SYM       bfd_cgc32_tilegx_le_vec
#define TARGET_LITTLE_NAME      "cgc32-tilegx-le"

#define cgc_backend_reloc_type_class	     tilegx_reloc_type_class

#define bfd_cgc32_bfd_reloc_name_lookup      tilegx_reloc_name_lookup
#define bfd_cgc32_bfd_link_hash_table_create tilegx_cgc_link_hash_table_create
#define bfd_cgc32_bfd_reloc_type_lookup	     tilegx_reloc_type_lookup
