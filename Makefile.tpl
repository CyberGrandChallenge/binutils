...
HOST_EXPORTS = \
	...
	READCGC="$(READCGC)"; export READCGC; \
	...
	READCGC_FOR_TARGET="$(READCGC_FOR_TARGET)"; export READCGC_FOR_TARGET; \
	...
	LIBCGCLIBS="$(HOST_LIBCGCLIBS)" ; export LIBCGCLIBS; \
	LIBCGCINC="$(HOST_LIBCGCINC)" ; export LIBCGCINC; \
@if gcc-bootstrap
...
BASE_TARGET_EXPORTS = \
	...
	READCGC="$(READCGC_FOR_TARGET)"; export READCGC; \
...
# Where to find libcgc
HOST_LIBCGCLIBS = @libcgclibs@
HOST_LIBCGCINC = @libcgcinc@
...
READCGC_FOR_TARGET=@READCGC_FOR_TARGET@
