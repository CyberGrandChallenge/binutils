...
#define LBR_CGCMAJORID 6	/* Cgc libraries (new index, new data).  */
...
struct vms_indexdef
{
  ...
  /* The key field contains vms_idx/vms_cgcidx structures, which are
...
#define CGCIDX__WEAK 0x01	/* Weak symbol.  */
#define CGCIDX__GROUP 0x02	/* Group symbol.  */
#define CGCIDX__LISTRFA 0x04	/* RFA field points to an LHS.  */
#define CGCIDX__SYMESC 0x08	/* Long symbol.  */
