...
/* Other constants defined in the ARM CGC spec. version B-01.  */
#define EF_ARM_SYMSARESORTED 0x04	/* NB conflicts with EF_INTERWORK.  */
#define EF_ARM_DYNSYMSUSESEGIDX 0x08	/* NB conflicts with EF_APCS26.  */
#define EF_ARM_MAPSYMSFIRST 0x10	/* NB conflicts with EF_APCS_FLOAT.  */
#define EF_ARM_EABIMASK      0xFF000000

/* New constants defined in the ARM CGC spec. version XXX.
   Only valid in conjunction with EF_ARM_EABI_VER5. */
#define EF_ARM_ABI_FLOAT_SOFT 0x200	/* NB conflicts with EF_ARM_SOFT_FLOAT.  */
#define EF_ARM_ABI_FLOAT_HARD 0x400	/* NB conflicts with EF_ARM_VFP_FLOAT.  */

/* Constants defined in AACGC.  */
...
START_RELOC_NUMBERS (cgc_arm_reloc_type)
/* AACGC official names and numbers.  */
...
#define CGC_STRING_ARM_unwind           ".ARM.exidx"
#define CGC_STRING_ARM_unwind_info      ".ARM.extab"
#define CGC_STRING_ARM_unwind_once      ".gnu.linkonce.armexidx."
#define CGC_STRING_ARM_unwind_info_once ".gnu.linkonce.armextab."
