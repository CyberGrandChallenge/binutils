...
/* This file holds definitions specific to the MIPS CGC ABI.  Note
   that most of this is not actually implemented by BFD.  */

#ifndef _CGC_MIPS_H
#define _CGC_MIPS_H

#include "cgc/reloc-macros.h"

/* Relocation types.  */
START_RELOC_NUMBERS (cgc_mips_reloc_type)
  RELOC_NUMBER (R_MIPS_NONE, 0)
  RELOC_NUMBER (R_MIPS_16, 1)
  RELOC_NUMBER (R_MIPS_32, 2)		/* In Cgc 64: alias R_MIPS_ADD */
  RELOC_NUMBER (R_MIPS_REL32, 3)	/* In Cgc 64: alias R_MIPS_REL */
  RELOC_NUMBER (R_MIPS_26, 4)
  RELOC_NUMBER (R_MIPS_HI16, 5)
  RELOC_NUMBER (R_MIPS_LO16, 6)
  RELOC_NUMBER (R_MIPS_GPREL16, 7)	/* In Cgc 64: alias R_MIPS_GPREL */
  RELOC_NUMBER (R_MIPS_LITERAL, 8)
  RELOC_NUMBER (R_MIPS_GOT16, 9)	/* In Cgc 64: alias R_MIPS_GOT */
  RELOC_NUMBER (R_MIPS_PC16, 10)
  RELOC_NUMBER (R_MIPS_CALL16, 11)	/* In Cgc 64: alias R_MIPS_CALL */
  ...
  RELOC_NUMBER (R_MICROMIPS_GPREL16, 136)	/* In Cgc 64:
						   alias R_MICROMIPS_GPREL */
  RELOC_NUMBER (R_MICROMIPS_LITERAL, 137)
  RELOC_NUMBER (R_MICROMIPS_GOT16, 138)		/* In Cgc 64:
  ...
  RELOC_NUMBER (R_MICROMIPS_CALL16, 142)	/* In Cgc 64:
...
/* Processor specific flags for the CGC header e_flags field.  */
...
/* The external version of Cgc32_Lib.  */
typedef struct
{
...
/* The l_flags field of an Cgc32_Lib structure may contain the
   following flags.  */
...
typedef unsigned long Cgc32_Conflict;
typedef unsigned char Cgc32_External_Conflict[4];

typedef unsigned long Cgc64_Conflict;
typedef unsigned char Cgc64_External_Conflict[8];
...
/* The external version of Cgc32_gptab.  */
...
/* The external version of the Cgc_RegInfo structure.  */
typedef struct
{
...
/* MIPS CGC .reginfo swapping routines.  */
extern void bfd_mips_cgc32_swap_reginfo_in
  (bfd *, const Cgc32_External_RegInfo *, Cgc32_RegInfo *);
extern void bfd_mips_cgc32_swap_reginfo_out
  (bfd *, const Cgc32_RegInfo *, Cgc32_External_RegInfo *);

...
#define STO_MIPS_FLAGS		(~(STO_MIPS_ISA | CGC_ST_VISIBILITY (-1)))
...
#define CGC_ST_IS_MIPS_PLT(other)					\
  ((CGC_ST_IS_MIPS16 (other)						\
    ? ((other) & (~STO_MIPS16 & STO_MIPS_FLAGS))			\
    : ((other) & STO_MIPS_FLAGS)) == STO_MIPS_PLT)
#define CGC_ST_SET_MIPS_PLT(other)					\
  ((CGC_ST_IS_MIPS16 (other)						\
    ? ((other) & (STO_MIPS16 | ~STO_MIPS_FLAGS))			\
    : ((other) & ~STO_MIPS_FLAGS)) | STO_MIPS_PLT)
...
#define CGC_ST_IS_MIPS_PIC(other) (((other) & STO_MIPS_FLAGS) == STO_MIPS_PIC)
#define CGC_ST_SET_MIPS_PIC(other)					\
  ((CGC_ST_IS_MIPS16 (other)						\
    ? ((other) & ~(STO_MIPS16 | STO_MIPS_FLAGS))			\
...
#define CGC_ST_IS_MIPS16(other) (((other) & STO_MIPS16) == STO_MIPS16)
#define CGC_ST_SET_MIPS16(other) ((other) | STO_MIPS16)
...
#define CGC_ST_IS_MICROMIPS(other) (((other) & STO_MIPS_ISA) == STO_MICROMIPS)
#define CGC_ST_SET_MICROMIPS(other) (((other) & ~STO_MIPS_ISA) | STO_MICROMIPS)

/* Whether code compression (either of the MIPS16 or the microMIPS ASEs)
   has been indicated for a .text symbol.  */
#define CGC_ST_IS_COMPRESSED(other) \
  (CGC_ST_IS_MIPS16 (other) || CGC_ST_IS_MICROMIPS (other))
...
#define CGC_MIPS_IS_OPTIONAL(other)	((other) & STO_OPTIONAL)

/* The 64-bit MIPS CGC ABI uses an unusual reloc format.  Each
...
} Cgc64_Mips_Internal_Rela;

/* MIPS CGC 64 relocation info access macros.  */
#define CGC64_MIPS_R_SSYM(i) (((i) >> 24) & 0xff)
#define CGC64_MIPS_R_TYPE3(i) (((i) >> 16) & 0xff)
#define CGC64_MIPS_R_TYPE2(i) (((i) >> 8) & 0xff)
#define CGC64_MIPS_R_TYPE(i) ((i) & 0xff)
...
typedef struct
{
  ...
  /* Information specific to this kind of option.  */
  unsigned long info;
} Cgc_Internal_Options;

/* MIPS CGC option header swapping routines.  */
extern void bfd_mips_cgc_swap_options_in
  (bfd *, const Cgc_External_Options *, Cgc_Internal_Options *);
extern void bfd_mips_cgc_swap_options_out
  (bfd *, const Cgc_Internal_Options *, Cgc_External_Options *);

/* Values which may appear in the kind field of an Cgc_Options
   structure.  */
...
/* In the 32 bit ABI, an ODK_REGINFO option is just a Cgc32_RegInfo
...
typedef struct
{
  ...
  /* Contains both the dynamic relocation index and the symbol flags
     field.  The macros CGC32_MS_REL_INDEX and CGC32_MS_FLAGS are used
...
#define CGC32_MS_REL_INDEX(i) ((i) >> 8)
#define CGC32_MS_FLAGS(i)     (i) & 0xff)
#define CGC32_MS_INFO(r, f)   (((r) << 8) + ((f) & 0xff))

/* MIPS CGC reginfo swapping routines.  */
extern void bfd_mips_cgc64_swap_reginfo_in
  (bfd *, const Cgc64_External_RegInfo *, Cgc64_Internal_RegInfo *);
extern void bfd_mips_cgc64_swap_reginfo_out
  (bfd *, const Cgc64_Internal_RegInfo *, Cgc64_External_RegInfo *);
...
#define OGP_SELF	0xffff0000	/* Scgc-contained GP groups.  */
