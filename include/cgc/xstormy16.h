...
#ifndef _CGC_XSTORMY16_H
#define _CGC_XSTORMY16_H

#include "cgc/reloc-macros.h"

/* Relocations.  */
START_RELOC_NUMBERS (cgc_xstormy16_reloc_type)
...
/* Define the data & instruction memory discriminator.  In a linked
   ...
   for the data space.  See also `ld/emulparams/cgc32xstormy16.sh'.  */
