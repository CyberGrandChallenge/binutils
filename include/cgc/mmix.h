...
/* This file holds definitions specific to the MMIX CGC ABI.  */
...
/* Relocations.  See the reloc table in bfd/cgc64-mmix.c for details.  */
START_RELOC_NUMBERS (cgc_mmix_reloc_type)
...
/* Appended with a number N=0..65535, this is a representation of the
   ...
   CGC section by name ".MMIX.spec_data.N".  */
...
/* We smuggle in a few MMO specifics here.  We don't make a specific MMO
   file, since we can't reasonably support MMO without CGC; we have to
