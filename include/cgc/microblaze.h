...
/* This file holds definitions specific to the MICROBLAZE CGC ABI.  */

#ifndef _CGC_MICROBLAZE_H
#define _CGC_MICROBLAZE_H

#include "cgc/reloc-macros.h"

/* Relocations.  */
START_RELOC_NUMBERS (cgc_microblaze_reloc_type)
