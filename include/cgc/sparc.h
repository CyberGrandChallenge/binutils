...
/* Relocation types.  */
START_RELOC_NUMBERS (cgc_sparc_reloc_type)
  ...
  /* ??? These 6 relocs are new but not currently used.  For binary
     compatibility in the sparc64-cgc toolchain, we leave them out.
     A non-binary upward compatible change is expected for sparc64-cgc.  */
...
#define CGC64_R_TYPE_DATA(info) \
  (((bfd_signed_vma)(CGC64_R_TYPE(info) >> 8) ^ 0x800000) - 0x800000)
#define CGC64_R_TYPE_ID(info) \
  ((info) & 0xff)
#define CGC64_R_TYPE_INFO(data, type) \
  (((bfd_vma) ((data) & 0xffffff) << 8) | (bfd_vma) (type))

/* Values for Cgc64_Dyn.d_tag.  */
...
#define CGC_SPARC_HWCAP_MUL32	0x00000001 /* umul/umulcc/smul/smulcc insns */
#define CGC_SPARC_HWCAP_DIV32	0x00000002 /* udiv/udivcc/sdiv/sdivcc insns */
#define CGC_SPARC_HWCAP_FSMULD	0x00000004 /* 'fsmuld' insn */
#define CGC_SPARC_HWCAP_V8PLUS	0x00000008 /* v9 insns available to 32bit */
#define CGC_SPARC_HWCAP_POPC	0x00000010 /* 'popc' insn */
#define CGC_SPARC_HWCAP_VIS	0x00000020 /* VIS insns */
#define CGC_SPARC_HWCAP_VIS2	0x00000040 /* VIS2 insns */
#define CGC_SPARC_HWCAP_ASI_BLK_INIT	\
				0x00000080 /* block init ASIs */
#define CGC_SPARC_HWCAP_FMAF	0x00000100 /* fused multiply-add */
#define CGC_SPARC_HWCAP_VIS3	0x00000400 /* VIS3 insns */
#define CGC_SPARC_HWCAP_HPC	0x00000800 /* HPC insns */
#define CGC_SPARC_HWCAP_RANDOM	0x00001000 /* 'random' insn */
#define CGC_SPARC_HWCAP_TRANS	0x00002000 /* transaction insns */
#define CGC_SPARC_HWCAP_FJFMAU	0x00004000 /* unfused multiply-add */
#define CGC_SPARC_HWCAP_IMA	0x00008000 /* integer multiply-add */
#define CGC_SPARC_HWCAP_ASI_CACHE_SPARING \
				0x00010000 /* cache sparing ASIs */
#define CGC_SPARC_HWCAP_AES	0x00020000 /* AES crypto insns */
#define CGC_SPARC_HWCAP_DES	0x00040000 /* DES crypto insns */
#define CGC_SPARC_HWCAP_KASUMI	0x00080000 /* KASUMI crypto insns */
#define CGC_SPARC_HWCAP_CAMELLIA \
				0x00100000 /* CAMELLIA crypto insns */
#define CGC_SPARC_HWCAP_MD5	0x00200000 /* MD5 hashing insns */
#define CGC_SPARC_HWCAP_SHA1	0x00400000 /* SHA1 hashing insns */
#define CGC_SPARC_HWCAP_SHA256	0x00800000 /* SHA256 hashing insns */
#define CGC_SPARC_HWCAP_SHA512	0x01000000 /* SHA512 hashing insns */
#define CGC_SPARC_HWCAP_MPMUL	0x02000000 /* Multiple Precision Multiply */
#define CGC_SPARC_HWCAP_MONT	0x04000000 /* Montgomery Mult/Sqrt */
#define CGC_SPARC_HWCAP_PAUSE	0x08000000 /* Pause insn */
#define CGC_SPARC_HWCAP_CBCOND	0x10000000 /* Compare and Branch insns */
#define CGC_SPARC_HWCAP_CRC32C	0x20000000 /* CRC32C insn */
