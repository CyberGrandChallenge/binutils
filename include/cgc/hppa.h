...
/* This file holds definitions specific to the HPPA CGC ABI.  Note
...
/* These are strictly for compatibility with the older cgc32-hppa
...
/* CGC/HPPA relocation types */

/* Note: PA-CGC is defined to use only RELA relocations.  */
#include "cgc/reloc-macros.h"

START_RELOC_NUMBERS (cgc_hppa_reloc_type)
...
typedef enum cgc_hppa_reloc_type cgc_hppa_reloc_type;
#endif
...
/* Flag bits in sh_flags of CgcXX_Shdr.  */
...
/* Values of sh_type in CgcXX_Shdr.  */
...
/* Flag bits in p_flags of CgcXX_Phdr.  */
