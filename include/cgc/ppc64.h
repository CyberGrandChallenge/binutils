...
/* Relocations.  */
START_RELOC_NUMBERS (cgc_ppc64_reloc_type)
  ...
  /* The following relocs were added in the 64-bit PowerPC CGC ABI
     revision 1.2. */
  ...
  /* Relocs added to support TLS.  PowerPC64 CGC ABI revision 1.5.  */
...
/* The CGCv2 ABI uses three bits in the symbol st_other field of a
