...
/* This file holds definitions specific to the ALPHA CGC ABI.  Note
...
/* Special values for Cgc64_Dyn tag.  */
#define DT_ALPHA_PLTRO		DT_LOPROC

#include "cgc/reloc-macros.h"

/* Alpha relocs.  */
START_RELOC_NUMBERS (cgc_alpha_reloc_type)
