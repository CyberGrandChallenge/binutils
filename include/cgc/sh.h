...
/* Define the mapping from CGC to bfd mach numbers.
...
int sh_find_cgc_flags (unsigned int arch_set);

/* Convert bfd_mach_* into EF_SH*.  */
int sh_cgc_get_flags_from_mach (unsigned long mach);
...
START_RELOC_NUMBERS (cgc_sh_reloc_type)
