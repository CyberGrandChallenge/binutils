...
/* Note that there are a few internal relocation types used by the
   ...
   check cgc32-rl78.c to see if any of the internal relocations need to
   be, er, relocated.  */

/* Preliminary relocations.  */
START_RELOC_NUMBERS (cgc_rl78_reloc_type)
...
/* Values for the e_flags field in the CGC header.  */
