...
/* Bits in the e_flags field of the Cgc64_Ehdr:  */
...
#define CGC_STRING_ia64_archext		".IA_64.archext"
#define CGC_STRING_ia64_pltoff		".IA_64.pltoff"
#define CGC_STRING_ia64_unwind		".IA_64.unwind"
#define CGC_STRING_ia64_unwind_info	".IA_64.unwind_info"
#define CGC_STRING_ia64_unwind_once	".gnu.linkonce.ia64unw."
#define CGC_STRING_ia64_unwind_info_once ".gnu.linkonce.ia64unwi."
/* .IA_64.unwind_hdr is only used by HP-UX.  */
#define CGC_STRING_ia64_unwind_hdr	".IA_64.unwind_hdr"

/* Bits in the sh_flags field of Cgc64_Shdr:  */
...
/* Possible values for sh_type in Cgc64_Shdr: */
...
/* SHT_IA_64_HP_OPT_ANOT is only generated by HPUX compilers for its
   ...
   want readcgc to know what they are.  Do not use two capital Ns in
...
/* Bits in the p_flags field of Cgc64_Phdr:  */

#define PF_IA_64_NORECOV	0x80000000

/* Possible values for p_type in Cgc64_Phdr:  */

#define PT_IA_64_ARCHEXT	(PT_LOPROC + 0)	/* Arch extension bits,  */
#define PT_IA_64_UNWIND 	(PT_LOPROC + 1)	/* IA64 unwind bits.  */

/* HP-UX specific values for p_type in Cgc64_Phdr.
   These values are currently just used to make
   readcgc more usable on HP-UX.  */

#define PT_IA_64_HP_OPT_ANOT	(PT_LOOS + 0x12)
#define PT_IA_64_HP_HSL_ANOT	(PT_LOOS + 0x13)
#define PT_IA_64_HP_STACK	(PT_LOOS + 0x14)

/* Possible values for d_tag in Cgc64_Dyn:  */

#define DT_IA_64_PLT_RESERVE	(DT_LOPROC + 0)

/* VMS specific values for d_tag in Cgc64_Dyn:  */
...
} Cgc64_External_VMS_IMAGE_FIXUP;
...
typedef struct  {
  ...
  unsigned char cgc_flags[4];		/* Original ehdr flags.  */
  unsigned char _pad[4];
  unsigned char imgid[1];		/* Original NT_VMS_IMGID.  */
} Cgc64_External_VMS_ORIG_DYN_Note;
...
START_RELOC_NUMBERS (cgc_ia64_reloc_type)
