...
#ifndef _CGC_AARCH64_H
#define _CGC_AARCH64_H
...
START_RELOC_NUMBERS (cgc_aarch64_reloc_type)
...
/* Aliasing relocs are guarded by RELOC_MACROS_GEN_FUNC
   so that readcgc.c won't generate duplicated case
   statements.  */
