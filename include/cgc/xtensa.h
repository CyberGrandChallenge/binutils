...
/* This file holds definitions specific to the Xtensa CGC ABI.  */

#ifndef _CGC_XTENSA_H
#define _CGC_XTENSA_H

#include "cgc/reloc-macros.h"

/* Relocations.  */
START_RELOC_NUMBERS (cgc_xtensa_reloc_type)
