/* Altera Nios II CGC support for BFD.
...
/* This file holds definitions specific to the Altera Nios II CGC ABI.  Note
...
/* The order of these numbers must match the order in
   the cgc_nios2_howto_table_rel table for the lookup
   function to work properly.  */

START_RELOC_NUMBERS (cgc_nios2_reloc_type)
