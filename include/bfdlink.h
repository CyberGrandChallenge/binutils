...
struct bfd_link_info
{
  ...
  /* TRUE if .eh_frame_hdr section and PT_GNU_EH_FRAME CGC segment
     should be created.  */
  ...
  /* TRUE if the new CGC dynamic tags are enabled. */
  ...
  /* TRUE if we should warn alternate CGC machine code.  */
  ...
  /* May be used to set DT_FLAGS for CGC. */
  bfd_vma flags;

  /* May be used to set DT_FLAGS_1 for CGC. */
  bfd_vma flags_1;
  ...
  struct bfd_cgc_dynamic_list *dynamic_list;

  /* The version information.  */
  struct bfd_cgc_version_tree *version_info;
};
...
/* These structures are used to describe version information for the
   CGC linker.  These structures could be manipulated entirely inside
...
struct bfd_cgc_version_expr
{
  ...
  struct bfd_cgc_version_expr *next;
  /* Glob pattern.  */
  const char *pattern;
  ...
  /* Pattern type.  */
#define BFD_CGC_VERSION_C_TYPE		1
#define BFD_CGC_VERSION_CXX_TYPE	2
#define BFD_CGC_VERSION_JAVA_TYPE	4
  unsigned int mask : 3;
};
...
struct bfd_cgc_version_expr_head
{
  ...
  struct bfd_cgc_version_expr *list;
  /* Hash table for non-wildcards.  */
  void *htab;
  /* Remaining patterns.  */
  struct bfd_cgc_version_expr *remaining;
...
struct bfd_cgc_version_deps
{
  ...
  struct bfd_cgc_version_deps *next;
  /* The version which this version depends upon.  */
  struct bfd_cgc_version_tree *version_needed;
};
...
{
  /* Next version.  */
  struct bfd_cgc_version_tree *next;
  /* Name of this version.  */
  const char *name;
  /* Version number.  */
  unsigned int vernum;
  /* Regular expressions for global symbols in this version.  */
  struct bfd_cgc_version_expr_head globals;
  /* Regular expressions for local symbols in this version.  */
  struct bfd_cgc_version_expr_head locals;
  ...
  int used;
  /* Matching hook.  */
  struct bfd_cgc_version_expr *(*match)
    (struct bfd_cgc_version_expr_head *head,
     struct bfd_cgc_version_expr *prev, const char *sym);
};
