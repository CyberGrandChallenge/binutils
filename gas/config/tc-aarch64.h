...
# define TARGET_FORMAT	cgc64_aarch64_target_format ()
#endif
...
#ifdef OBJ_CGC
# define obj_frob_symbol(sym, punt)	aarch64cgc_frob_symbol ((sym), & (punt))
...
extern const char * cgc64_aarch64_target_format (void);
...
extern void aarch64cgc_frob_symbol (symbolS *, int *);
