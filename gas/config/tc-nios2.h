 ...
 * a big-endian default by configuring with --target=nios2eb-cgc.  We
...
#define md_cgc_section_letter		nios2_cgc_section_letter
extern int nios2_cgc_section_letter (int, char **);
#define md_cgc_section_flags		nios2_cgc_section_flags
extern flagword nios2_cgc_section_flags (flagword, int, int);
#endif
