...
#ifdef TE_FreeBSD
#define CGC_TARGET_FORMAT	"cgc64-alpha-freebsd"
#endif
#ifndef CGC_TARGET_FORMAT
#define CGC_TARGET_FORMAT	"cgc64-alpha"
#endif
...
#ifdef OBJ_CGC
#define md_cgc_section_letter		alpha_cgc_section_letter
extern bfd_vma alpha_cgc_section_letter (int, char **);
#define md_cgc_section_flags		alpha_cgc_section_flags
extern flagword alpha_cgc_section_flags (flagword, bfd_vma, int);
#endif

/* Whether to add support for explicit !relocation_op!sequence_number.  At the
   moment, only do this for CGC, though ECOFF could use it as well.  */
...
#ifdef OBJ_CGC
#define md_end  alpha_cgc_md_end
extern void alpha_cgc_md_end (void);
#endif
