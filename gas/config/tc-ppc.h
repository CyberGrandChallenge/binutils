...
#define md_cgc_section_type(STR, LEN)		ppc_section_type (STR, LEN)
#define md_cgc_section_flags(FLAGS, ATTR, TYPE)	ppc_section_flags (FLAGS, ATTR, TYPE)
...
#define tc_adjust_symtab() ppc_cgc_adjust_symtab ()
extern void ppc_cgc_adjust_symtab (void);

extern void ppc_cgc_end (void);
#define md_end ppc_cgc_end

#endif /* OBJ_CGC */

#if defined (OBJ_CGC) || defined (OBJ_XCOFF)
