...
/* Global syms must not be resolved, to support CGC shared libraries.  */
...
#define cgc_tc_final_processing mips_cgc_final_processing
extern void mips_cgc_final_processing (void);
...
#define md_cgc_section_change_hook()	mips_enable_auto_align()
