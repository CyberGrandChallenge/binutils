...
#ifndef OBJ_CGC
#error Xtensa support requires CGC object format
#endif
...
extern void xtensa_cgc_section_change_hook (void);
...
#define md_cgc_section_change_hook	xtensa_cgc_section_change_hook
