 ...
 * "cgc32-bfin", not "cgc32-little-bfin".  Since the BFD source file
 * cgc32-bfin.c defines TARGET_LITTLE_NAME to be "cgc32-little-bfin",
 * we must use this value, until this is corrected and BFD is rebuilt.  */
#ifdef OBJ_CGC
#define TARGET_FORMAT		"cgc32-bfin"
#endif
