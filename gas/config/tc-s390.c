...
/* Set to TRUE if the highgprs flag in the CGC header needs to be set
   for the output file.  */
...
const pseudo_typeS md_pseudo_table[] =
{
  ...
  { "byte",	    s390_byte,	        0 },
  { "short",        s390_cgc_cons,      2 },
  { "long",	    s390_cgc_cons,	4 },
  { "quad",         s390_cgc_cons,      8 },
...
/* Flags to set in the cgc header */
...
s390_target_format (void)
{
  ...
  return s390_arch_size == 64 ? "cgc64-s390" : "cgc32-s390";
}
...
struct map_bfd
  {
    char *string;
    int length;
    cgc_suffix_type suffix;
  };


/* Parse @got/@plt/@gotoff. and return the desired relocation.  */
static cgc_suffix_type
s390_cgc_suffix (char **str_p, expressionS *exp_p)
{
  static struct map_bfd mapping[] =
  {
    { "got", 3, CGC_SUFFIX_GOT  },
    { "got12", 5, CGC_SUFFIX_GOT  },
    { "plt", 3, CGC_SUFFIX_PLT  },
    { "gotent", 6, CGC_SUFFIX_GOTENT },
    { "gotoff", 6, CGC_SUFFIX_GOTOFF },
    { "gotplt", 6, CGC_SUFFIX_GOTPLT },
    { "pltoff", 6, CGC_SUFFIX_PLTOFF },
    { "tlsgd", 5, CGC_SUFFIX_TLS_GD },
    { "gotntpoff", 9, CGC_SUFFIX_TLS_GOTIE },
    { "indntpoff", 9, CGC_SUFFIX_TLS_IE },
    { "tlsldm", 6, CGC_SUFFIX_TLS_LDM },
    { "dtpoff", 6, CGC_SUFFIX_TLS_LDO },
    { "ntpoff", 6, CGC_SUFFIX_TLS_LE },
    { NULL,  0, CGC_SUFFIX_NONE }
  };
	...
	if (*str == '-' || *str == '+')
	  {
	    ...
	    /* If s390_cgc_suffix has not been called with
...
static cgc_suffix_type
s390_lit_suffix (char **str_p, expressionS *exp_p, cgc_suffix_type suffix)
{
  bfd_reloc_code_real_type reloc;
  char tmp_name[64];
  char *str = *str_p;
  ...
  if (suffix != CGC_SUFFIX_NONE && reloc == BFD_RELOC_UNUSED)
  ...
  *str_p = str;
  ...
  /* We change the suffix type to CGC_SUFFIX_NONE, because
...
static void
s390_cgc_cons (int nbytes /* 1=.byte, 2=.word, 4=.long */)
{
  expressionS exp;
  cgc_suffix_type suffix;
  ...
  do
    {
	  ...
	  && *input_line_pointer == '@'
	  && (suffix = s390_cgc_suffix (&input_line_pointer, &exp)) != CGC_SUFFIX_NONE)
	{
	  bfd_reloc_code_real_type reloc;
	  ...
	  if (nbytes == 2)
		...
		{
		  BFD_RELOC_UNUSED, 		/* CGC_SUFFIX_NONE  */
		  BFD_RELOC_390_GOT16,		/* CGC_SUFFIX_GOT  */
		  BFD_RELOC_UNUSED,		/* CGC_SUFFIX_PLT  */
		  BFD_RELOC_UNUSED,		/* CGC_SUFFIX_GOTENT  */
		  BFD_RELOC_16_GOTOFF,		/* CGC_SUFFIX_GOTOFF  */
		  BFD_RELOC_UNUSED,		/* CGC_SUFFIX_GOTPLT  */
		  BFD_RELOC_390_PLTOFF16,	/* CGC_SUFFIX_PLTOFF  */
		  BFD_RELOC_UNUSED,		/* CGC_SUFFIX_TLS_GD  */
		  BFD_RELOC_UNUSED,		/* CGC_SUFFIX_TLS_GOTIE  */
		  BFD_RELOC_UNUSED,		/* CGC_SUFFIX_TLS_IE  */
		  BFD_RELOC_UNUSED,		/* CGC_SUFFIX_TLS_LDM  */
		  BFD_RELOC_UNUSED,		/* CGC_SUFFIX_TLS_LDO  */
		  BFD_RELOC_UNUSED		/* CGC_SUFFIX_TLS_LE  */
		};
	      reloc = tab2[suffix];
	    }
	  else if (nbytes == 4)
		...
		{
		  BFD_RELOC_UNUSED, 		/* CGC_SUFFIX_NONE  */
		  BFD_RELOC_32_GOT_PCREL,	/* CGC_SUFFIX_GOT  */
		  BFD_RELOC_390_PLT32,		/* CGC_SUFFIX_PLT  */
		  BFD_RELOC_UNUSED,		/* CGC_SUFFIX_GOTENT  */
		  BFD_RELOC_32_GOTOFF,		/* CGC_SUFFIX_GOTOFF  */
		  BFD_RELOC_390_GOTPLT32,	/* CGC_SUFFIX_GOTPLT  */
		  BFD_RELOC_390_PLTOFF32,	/* CGC_SUFFIX_PLTOFF  */
		  BFD_RELOC_390_TLS_GD32,	/* CGC_SUFFIX_TLS_GD  */
		  BFD_RELOC_390_TLS_GOTIE32,	/* CGC_SUFFIX_TLS_GOTIE  */
		  BFD_RELOC_390_TLS_IE32,	/* CGC_SUFFIX_TLS_IE  */
		  BFD_RELOC_390_TLS_LDM32,	/* CGC_SUFFIX_TLS_LDM  */
		  BFD_RELOC_390_TLS_LDO32,	/* CGC_SUFFIX_TLS_LDO  */
		  BFD_RELOC_390_TLS_LE32	/* CGC_SUFFIX_TLS_LE  */
		};
	      reloc = tab4[suffix];
	    }
	  else if (nbytes == 8)
		...
		{
		  BFD_RELOC_UNUSED, 		/* CGC_SUFFIX_NONE  */
		  BFD_RELOC_390_GOT64,		/* CGC_SUFFIX_GOT  */
		  BFD_RELOC_390_PLT64,		/* CGC_SUFFIX_PLT  */
		  BFD_RELOC_UNUSED,		/* CGC_SUFFIX_GOTENT  */
		  BFD_RELOC_390_GOTOFF64,	/* CGC_SUFFIX_GOTOFF  */
		  BFD_RELOC_390_GOTPLT64,	/* CGC_SUFFIX_GOTPLT  */
		  BFD_RELOC_390_PLTOFF64,	/* CGC_SUFFIX_PLTOFF  */
		  BFD_RELOC_390_TLS_GD64,	/* CGC_SUFFIX_TLS_GD  */
		  BFD_RELOC_390_TLS_GOTIE64,	/* CGC_SUFFIX_TLS_GOTIE  */
		  BFD_RELOC_390_TLS_IE64,	/* CGC_SUFFIX_TLS_IE  */
		  BFD_RELOC_390_TLS_LDM64,	/* CGC_SUFFIX_TLS_LDM  */
		  BFD_RELOC_390_TLS_LDO64,	/* CGC_SUFFIX_TLS_LDO  */
		  BFD_RELOC_390_TLS_LE64	/* CGC_SUFFIX_TLS_LE  */
		};
	      reloc = tab8[suffix];
	    }
	  else
		    ...
		    const struct s390_opcode *opcode)
{
  ...
  for (opindex_ptr = opcode->operands; *opindex_ptr != 0; opindex_ptr++)
	...
	{
	  s390_lit_suffix (&str, &ex, CGC_SUFFIX_NONE);
      ...
      else
	{
	  ...
	  else if (suffix == CGC_SUFFIX_GOTENT)
	    {
	      if ((operand->flags & S390_OPERAND_PCREL)
		  && (operand->bits == 32))
		reloc = BFD_RELOC_390_GOTENT;
	    }
	  else if (suffix == CGC_SUFFIX_GOTOFF)
	    {
	      if ((operand->flags & S390_OPERAND_SIGNED)
		  && (operand->bits == 16))
		reloc = BFD_RELOC_16_GOTOFF;
	    }
	  else if (suffix == CGC_SUFFIX_PLTOFF)
	    {
	      if ((operand->flags & S390_OPERAND_SIGNED)
		  && (operand->bits == 16))
		reloc = BFD_RELOC_390_PLTOFF16;
	    }
	  else if (suffix == CGC_SUFFIX_GOTPLT)
	    {
	      if ((operand->flags & S390_OPERAND_DISP)
		  && (operand->bits == 12))
	  ...
	  else if (suffix == CGC_SUFFIX_TLS_GOTIE)
	    {
	      if ((operand->flags & S390_OPERAND_DISP)
		  && (operand->bits == 12))
	  ...
	  else if (suffix == CGC_SUFFIX_TLS_IE)
	    {
	      if ((operand->flags & S390_OPERAND_PCREL)
		       && (operand->bits == 32))
...
void
s390_cgc_final_processing (void)
{
  if (set_highgprs_p)
    cgc_cgcheader (stdoutput)->e_flags |= EF_S390_HIGH_GPRS;
}
