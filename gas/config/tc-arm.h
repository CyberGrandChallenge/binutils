...
# endif
#elif defined OBJ_CGC
# define ARM_BI_ENDIAN
# define TARGET_FORMAT	cgc32_arm_target_format ()
#endif
...
/* For CGC objects THUMB_IS_FUNC is inferred from
...
#ifdef OBJ_CGC
# define obj_frob_symbol(sym, punt)	armcgc_frob_symbol ((sym), & (punt))
# define md_cgc_section_change_hook()	arm_cgc_change_section ()
# define md_cgc_section_type(str, len)	arm_cgc_section_type (str, len)
...
extern const char * cgc32_arm_target_format (void);
extern void arm_cgc_change_section (void);
