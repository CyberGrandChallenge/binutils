...
#define TARGET_FORMAT (target_big_endian ? "cgc32-mep" : "cgc32-mep-little")
...
#define md_cgc_section_letter		mep_cgc_section_letter
extern bfd_vma mep_cgc_section_letter (int, char **);
#define md_cgc_section_flags		mep_cgc_section_flags
extern flagword mep_cgc_section_flags  (flagword, bfd_vma, int);

#define CGC_TC_SPECIAL_SECTIONS \
