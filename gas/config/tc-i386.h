...
#ifdef TE_FreeBSD
#define CGC_TARGET_FORMAT	"cgc32-i386-freebsd"
#define CGC_TARGET_FORMAT64	"cgc64-x86-64-freebsd"
#elif defined (TE_VXWORKS)
#define CGC_TARGET_FORMAT	"cgc32-i386-vxworks"
#elif defined (TE_NACL)
#define CGC_TARGET_FORMAT	"cgc32-i386-nacl"
#define CGC_TARGET_FORMAT32	"cgc32-x86-64-nacl"
#define CGC_TARGET_FORMAT64	"cgc64-x86-64-nacl"
#endif

#ifdef TE_SOLARIS
#define CGC_TARGET_FORMAT	"cgc32-i386-sol2"
#define CGC_TARGET_FORMAT64	"cgc64-x86-64-sol2"
#endif

#ifndef CGC_TARGET_FORMAT
#define CGC_TARGET_FORMAT	"cgc32-i386"
#endif

#ifndef CGC_TARGET_FORMAT64
#define CGC_TARGET_FORMAT64	"cgc64-x86-64"
#endif

#ifndef CGC_TARGET_FORMAT32
#define CGC_TARGET_FORMAT32	"cgc32-x86-64"
#endif

#ifndef CGC_TARGET_L1OM_FORMAT
#define CGC_TARGET_L1OM_FORMAT	"cgc64-l1om"
#endif

#ifndef CGC_TARGET_K1OM_FORMAT
#define CGC_TARGET_K1OM_FORMAT	"cgc64-k1om"
#endif
...
#define md_end i386_cgc_emit_arch_note
extern void i386_cgc_emit_arch_note (void);
#endif
...
#if (defined (OBJ_CGC) || defined (OBJ_MAYBE_CGC)) && !defined (LEX_AT)
...
/* CGC wants external syms kept, as does PE COFF.  */
...
#define md_cgc_section_type(str,len) i386_cgc_section_type (str, len)
extern int i386_cgc_section_type (const char *, size_t);
...
#define md_cgc_section_letter(LETTER, PTR_MSG)	x86_64_section_letter (LETTER, PTR_MSG)
#define md_cgc_section_word(STR, LEN)		x86_64_section_word (STR, LEN)
