...
#ifdef OBJ_CGC
/* This code is to handle mapping symbols as defined in the ARM AArch64 CGC
   spec.  (See "Mapping symbols", section 4.5.4, ARM AACGC64 version 0.05).
...
const pseudo_typeS md_pseudo_table[] = {
  ...
  {"word", s_aarch64_cgc_cons, 4},
  {"long", s_aarch64_cgc_cons, 4},
  {"xword", s_aarch64_cgc_cons, 8},
  {"dword", s_aarch64_cgc_cons, 8},
#endif
  {0, 0, 0}
};

...
const char *
cgc64_aarch64_target_format (void)
{
  if (target_big_endian)
    return ilp32_p ? "cgc32-bigaarch64" : "cgc64-bigaarch64";
  else
    return ilp32_p ? "cgc32-littleaarch64" : "cgc64-littleaarch64";
}

void
aarch64cgc_frob_symbol (symbolS * symp, int *puntp)
{
