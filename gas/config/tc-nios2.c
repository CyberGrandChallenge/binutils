...
{
  return target_big_endian ? "cgc32-bignios2" : "cgc32-littlenios2";
}
...
int
nios2_cgc_section_letter (int letter, char **ptr_msg)
{
  if (letter == 's')
...
/* This is from the Alpha code tc-alpha.c.  */
flagword
nios2_cgc_section_flags (flagword flags, int attr, int type ATTRIBUTE_UNUSED)
{
