...
#define TARGET_FORMAT "cgc32-epiphany"
...
#define cgc_tc_final_processing		epiphany_cgc_final_processing
extern void epiphany_cgc_final_processing (void);

#define md_cgc_section_flags epiphany_cgc_section_flags
extern int epiphany_cgc_section_flags (int, int, int);
