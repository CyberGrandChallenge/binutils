...
#ifdef OBJ_CGC
/* CGC specific definitions.  */

/* Whether or not the target is big endian.  */
extern int target_big_endian;
#ifdef TE_LINUX
#define TARGET_FORMAT (!target_big_endian ? "cgc32-sh-linux" : "cgc32-shbig-linux")
#elif defined(TE_NetBSD)
#define TARGET_FORMAT (!target_big_endian ? "cgc32-shl-nbsd" : "cgc32-sh-nbsd")
#elif defined TARGET_SYMBIAN
#define TARGET_FORMAT (!target_big_endian ? "cgc32-shl-symbian" : "cgc32-sh-symbian")
#elif defined (TE_VXWORKS)
#define TARGET_FORMAT (!target_big_endian ? "cgc32-shl-vxworks" : "cgc32-sh-vxworks")
#elif defined (TE_UCLINUX)
#define TARGET_FORMAT sh_uclinux_target_format ()
extern const char * sh_uclinux_target_format (void);
#else
#define TARGET_FORMAT (!target_big_endian ? "cgc32-shl" : "cgc32-sh")
#endif

#define cgc_tc_final_processing sh_cgc_final_processing
extern void sh_cgc_final_processing (void);
