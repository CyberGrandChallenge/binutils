...
#define TARGET_FORMAT (target_big_endian ? "cgc32-rx-be" : "cgc32-rx-le")
...
#define cgc_tc_final_processing	rx_cgc_final_processing
extern void rx_cgc_final_processing (void);
