...
extern void ia64_cgc_section_change_hook (void);
#define md_cgc_section_change_hook	ia64_cgc_section_change_hook
...
extern bfd_vma ia64_cgc_section_letter (int, char **);
extern flagword ia64_cgc_section_flags (flagword, bfd_vma, int);
extern int ia64_cgc_section_type (const char *, size_t);
...
#define md_cgc_section_letter		ia64_cgc_section_letter
#define md_cgc_section_flags		ia64_cgc_section_flags
...
#define md_cgc_section_type(str,len)	ia64_cgc_section_type (str, len)
