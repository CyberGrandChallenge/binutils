/* This file isn't directly used by the test suite; it uses
   cgc_e_flags.s.  However, I figured it would be nice to provide the
   source code from which the .s file was generated.

   It was compiled as follows:

   mips64-cgc-gcc -m4650 -S -O cgc_e_flags.c
   ...
   would generate the same code when gas was configured for mips-cgc
   and for mips64-cgc.
