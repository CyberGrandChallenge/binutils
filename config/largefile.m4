...
changequote([,])dnl
    ...
    # are mutually exclusive; and without procfs support, the bfd/ cgc module
    # cannot provide certain routines such as cgccore_write_prpsinfo
    # or cgccore_write_prstatus.  So unless the user explicitly requested
