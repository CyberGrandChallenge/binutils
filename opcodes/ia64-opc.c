...
opcode_verify (ia64_insn opcode, int place, enum ia64_insn_type type)
{
  ...
  if (main_table[place].flags
	...
	{
	  o1 = cgc64_ia64_operands + IA64_OPND_F2;
	  o2 = cgc64_ia64_operands + IA64_OPND_F3;
      ...
      else
	{
	  ...
	  o1 = cgc64_ia64_operands + IA64_OPND_LEN6;
	  o2 = cgc64_ia64_operands + main_table[place].operands[2];
