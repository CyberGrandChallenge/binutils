/* cgccomm.c -- common code for CGC format file.
...
void (*byte_put) (unsigned char *, cgc_vma, int);

void
byte_put_little_endian (unsigned char * field, cgc_vma value, int size)
{
  switch (size)
    {
    case 8:
...
void
byte_put_big_endian (unsigned char * field, cgc_vma value, int size)
{
  switch (size)
    {
    case 8:
...
cgc_vma (*byte_get) (unsigned char *, int);
...
byte_get_little_endian (unsigned char *field, int size)
{
  switch (size)
    ...
    case 5:
      if (sizeof (cgc_vma) == 8)
	return  ((cgc_vma) (field[0]))
	  |    (((cgc_vma) (field[1])) << 8)
	  |    (((cgc_vma) (field[2])) << 16)
	  |    (((cgc_vma) (field[3])) << 24)
	  |    (((cgc_vma) (field[4])) << 32);
      else if (sizeof (cgc_vma) == 4)
...
void
byte_get_64 (unsigned char *field, cgc_vma *high, cgc_vma *low)
{
